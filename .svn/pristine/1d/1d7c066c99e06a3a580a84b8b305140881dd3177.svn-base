...
function upload(){// nhan nut cap nhat
	 var thang=document.forms["ChiTieuTTForm"].thang.value;
	  ...
	  if(thang==0){
		  document.forms["ChiTieuTTForm"].dataerror.value="Nhập tháng đặt chỉ tiêu";
			return; 
	  }
	  if(nam==0){
		  document.forms["ChiTieuTTForm"].dataerror.value="Nhập năm đặt chỉ tiêu";
			return;
	  }
	  if(kenhid==""){
		  document.forms["ChiTieuTTForm"].dataerror.value="Chọn kênh bán hàng";
			return;
	  }
...
function save(){
  ...
  //kiem tra xem thang nam dat chi tieu co hop le hay khong
	 ...
	 if(parseInt(nam)<parseInt(year_)){
		  document.forms["ChiTieuTTForm"].dataerror.value="Thời gian đặt chỉ tiêu không hợp lệ,phải đặt thời gian chỉ tiêu lớn hơn hoặc bằng thời gian hiện tại ";
			return; 
...
<form name ="ChiTieuTTForm" method="post" action="../../ChiTieuTTChoVungNewSvl" >
	...
	<TR>
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý chỉ tiêu &gt; Chỉ tiêu cho Khu Vực &gt;Tạo mới</TD> 
		...
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
			<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
							<TD width="30" align="left"><A href="../../chitieuttchovungSvl?userId=<%=userId%>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<td colspan="2">
							 <FIELDSET style=" width:99%">
									<LEGEND class="legendtitle" >Loại chỉ tiêu</LEGEND>
									<%
							...
							<TR>
				  		   ...
				  		   <TR>
						  	  	<TD class="plainlabel">Tổng số chỉ tiêu</TD>
						  	  <TD class="plainlabel">
						    ...
						    <%
						    	if(check1.equals("0")){
						    %>
						  	<input type="radio" value="0"  checked="checked" name="chon" id="auto1" onclick="checkradio(this.value)"> <label for="auto1"> Tự động phân bổ chỉ tiêu </label> <br>
						  	 <input type="radio" value="1" name="chon" id="noauto1" onclick="checkradio(this.value)"> <label for="noauto1" >Import từ file Excel  </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						  	 <%
 						  	 	}else{
 						  	 %>
						     <input type="radio" value="0"   name="chon" id="auto1" onclick="checkradio(this.value)"> <label for="auto1"> Tự động phân bổ chỉ tiêu </label> <br>
						...
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="0" >							
								<TR class="tbheader">
									...
									<TH >Tên Khu Vực </TH>
									<TH width="10%">Doanh số trung bình tháng </TH>
