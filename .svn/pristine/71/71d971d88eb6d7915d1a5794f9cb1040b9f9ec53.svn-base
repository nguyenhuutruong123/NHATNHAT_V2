...
<%@ page  import = "geso.dms.center.beans.bienbandoichieucongnoHO.*" %>
...
IBienbandoichieucongnoHO obj = (IBienbandoichieucongnoHO)session.getAttribute("obj"); %>
...
<% 
	...
	if(!util.check(userId, userTen, sum)){
		...
		int[] quyen = new  int[6];
		quyen = util.Getquyen("BienbandoichieucongnoHO","",userId);
...
<body>
<form name="ckParkForm" method="post" action="../../BienbandoichieucongnoHOSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý công nợ > Báo cáo  > Biên bản đối chiếu công nợ NPP
        </div>
                    ...
                    <tr>
                        <td colspan="6" class="plainlabel">
                           ...
                           <a class="button" href="javascript:inmau2()">
                                <img style="top: -4px; " src="../images/Printer30.png"  alt="">Biên bản đối chiếu công nợ</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a class="button2" href="javascript:inmau3()">
                                <img style="top: -4px;" src="../images/Printer30.png" alt="">Biên bản đối chiếu kiêm bù trừ công nợ</a>&nbsp;&nbsp;&nbsp;&nbsp;
