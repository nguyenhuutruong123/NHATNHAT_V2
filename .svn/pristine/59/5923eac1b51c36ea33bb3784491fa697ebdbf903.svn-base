...
<%@ page import = "geso.dms.center.beans.bcchartdoanhthudiaban.*" %>
...
<%	String userId = (String) session.getAttribute("userId");
	...
	IBcchartdoanhthudiaban obj =(IBcchartdoanhthudiaban)session.getAttribute("obj");
...
<form name="khtt" method="post" action="../../BCChartdoanhthudiabanSvl">
		...
		<TD colspan="4" align="left" valign="top" bgcolor="#FFFFFF">
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR height="22">
								<TD align="left" colspan="2" class="tbnavigation">&nbsp;Báo cáo quản trị > Biểu đồ > Báo cáo doanh thu theo địa bàn </TD>
			...
			<TABLE width="100%" cellpadding="0" cellspacing="1">
				...
				<TR>
					<TD width="100%">
						<FIELDSET>
							<LEGEND class="legendtitle">&nbsp;Báo cáo doanh thu theo địa bàn &nbsp;&nbsp;
							...
							<TABLE class="" width="100%">
								...
								<table align="left" id='myTable' >
									...
									<caption align="left" >Doanh thu theo địa bàn (Đơn vị tính: Triệu đồng)</caption>
										...
										<tr>
											...
											for(int j=0;j<=arrIdDiaBan.length-1;j++){
												if( arrIdDiaBan[j]!=null){
													%>
													<td><%= rs.getLong(arrIdDiaBan[j]) %></td>
											<%
												}
											}%>
										</tr>	
