...
<% String[] ngaynhapkho = (String[])dctkBean.getNgaynhapkho(); %>s
...
{	 	
	...
	for(var i=0; i < sodong ; i++)
	{
		...
		{ 
			...
			var dieu_chinh_1 = parseFloat(so_luong) - parseFloat(ton_kho);
			
		
			dieuchinh.item(i).value=dieu_chinh_1;
...
<body>
	<form name="dctkForm" method="post" action="../../DieuchinhtonkhoUpdateSvl">
		...
		<input type="hidden" name="id" value="<%=dctkBean.getId() %>"> 
										...
										<TR>
											<TD align="left" class="tbnavigation">
												<table width="100%" border="0" cellpadding="0" cellspacing="0">
													<tr height="22">
														<TD align="left" colspan="2" class="tbnavigation"> Quản lý tồn kho > Nghiệp vụ khác > Kiểm kho > Cập nhật</TD>
												...
												<FIELDSET>
													...
													<TABLE cellpadding="3" cellspacing="0" width="100%" border=0>
														...
														<TR>
															...
															<TD class="plainlabel"><input class="days" type="text" name="ngaydc" size="11" value="<%= dctkBean.getNgaydc() %>" readonly="readonly"></TD>
												...
												<fieldset>
													<TABLE id="tab" width=100% cellpadding="1" border="1" style="border-color: #80CB9B" cellspacing="0">
														<TR class="tbheader">
															...
															<TH width="10%" rowspan="2">Số nhập kho</TH>
															<TH width="10%" colspan="2">Tồn thực tế</TH>
															<TH width="10%" rowspan="2">Điều chỉnh</TH>
															
															<th align="left" width="10%" rowspan="2" > Ngày hết hạn</th>
															
															<TH width="15%" rowspan="2"  style="display:none;" >Gía mua TB</TH>
															<TH width="20%" rowspan="2"    style="display:none;" >T. tiền (w/o VAT)</TH>
															 -->
															
															
															
															<TH rowspan="2" width="10%">Mã sản phẩm</TH>
															<TH rowspan="2" width="34%">Tên sản phẩm</TH>
															<TH width="10%" colspan="2">Tồn hiện tại</TH>
															<TH width="10%" rowspan="2">Số Lô</TH>
                                            ...
                                            for(int i=0; i < size; i++){ 
												if(m%2 == 0){					%>
														...
														<TR class=<%=lightrow%>>
															...
															<TD>
																<input type="text" name='ngaynhapkho' id='ngaynhapkho' value="<%= ngaynhapkho[i] %>" readonly="readonly"  style="width: 100%; text-align: left; border: 0">
															</TD>
															<TD>
															...
															<TD>
																...
																<input type="text" name='dieuchinh' id='dieuchinh<%=i %>' value='<%=dc[i].equals("")?"":Integer.parseInt(dc[i])  %>' style="width: 100%; text-align: right;" readonly="readonly" >
															</TD>
