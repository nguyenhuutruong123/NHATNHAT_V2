...
public class DailyKHStocknpp extends HttpServlet {	
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = request.getContextPath() + "/pages/Center/rp_DailyKHStocknpp.jsp";
...
/*		IStockintransit obj = new Stockintransit();
	...
	private void CreateStaticHeader(Workbook workbook, String tungay, String denngay, String UserName)  throws Exception
	{
       ...
       cell.setStyle(style);
	    ...
	    cell = cells.getCell("EB1"); cell.setValue("KhachHang"); 
	    cell = cells.getCell("EC1"); cell.setValue("TenSanPham");
	    cell = cells.getCell("ED1"); cell.setValue("SoLuongQuyLe");
	    cell = cells.getCell("EE1"); cell.setValue("Ngay");	   
	    cell = cells.getCell("EF1"); cell.setValue("MaNhaPhanPhoi");
	    cell = cells.getCell("EG1"); cell.setValue("MaSanPham");
	    cell = cells.getCell("EH1"); cell.setValue("SoLuongThung");
	    cell = cells.getCell("EI1"); cell.setValue("Kho");
	    cell = cells.getCell("EJ1"); cell.setValue("DonViKinhDoanh");
	    cell = cells.getCell("EK1"); cell.setValue("ChungLoai");
	    cell = cells.getCell("EL1"); cell.setValue("NhanHang");
	    cell = cells.getCell("EM1"); cell.setValue("SoTien");
	    cell = cells.getCell("EN1"); cell.setValue("SanLuong");
	...
	{dbutils db = new dbutils();
	    ...
	    Utility util = new Utility();
		   ...
		   " kh.ten as KhachHang, b.ten as SKU, b.ma as SKUcode, a.ngay as Date, c.ten as Warehouse, g.ten as Province, "+
		   ...
		   " from khachhang_kho a inner join khachhang kh on a.kh_fk = kh.pk_seq inner join sanpham b on a.sanpham_fk = b.pk_seq inner join kho c on a.kho_fk = c.pk_seq "+ 
		...
		if(rs != null)
		{
			...
			{// se do rong cho cac cot se dung
				...
				{ 
					...
					cell = cells.getCell("EB" + Integer.toString(i)); cell.setValue(KhachHang);
					cell = cells.getCell("EC" + Integer.toString(i)); cell.setValue(SKU);
					cell = cells.getCell("ED" + Integer.toString(i)); cell.setValue(Piece);
					cell = cells.getCell("EE" + Integer.toString(i)); cell.setValue(Date);					
					cell = cells.getCell("EF" + Integer.toString(i)); cell.setValue(DistributorCode);
					cell = cells.getCell("EG" + Integer.toString(i)); cell.setValue(SkuCode);
					cell = cells.getCell("EH" + Integer.toString(i)); cell.setValue(Quantily);
					cell = cells.getCell("EI" + Integer.toString(i)); cell.setValue(Warehouse);			
					cell = cells.getCell("EJ" + Integer.toString(i)); cell.setValue(BusinessUnit);
					cell = cells.getCell("EK" + Integer.toString(i)); cell.setValue(Category);
					cell = cells.getCell("EL" + Integer.toString(i)); cell.setValue(Brands);
					cell = cells.getCell("EM" + Integer.toString(i)); cell.setValue(rs.getDouble("Amount"));
					cell = cells.getCell("EN" + Integer.toString(i)); cell.setValue(rs.getDouble("SanLuong"));
					i++;
