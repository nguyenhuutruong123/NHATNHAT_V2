...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../KhoaSoChiTieuSvl">
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Quản lý chỉ tiêu > Khai baó > Khóa sổ chỉ tiêu tháng</div>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle"> Khóa sổ chỉ tiêu tháng</legend>
								...
								<TR>
									...
									<!-- <td colspan="3"><a class="button"
										href="javascript:submitform2();"> <img style="top: -4px;"
											src="../images/button.png" alt=""> Báo cáo theo sản phẩm
									</a></td> -->
								</TR>
							</TABLE>
						</div>
