...
<body>
<form name="ckParkForm" method="post" action="../../ErpDenghidoihangSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý kho trung tâm > Duyệt đề nghị đổi hàng
        </div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle"> Duyệt đề nghị đổi hàng </span>&nbsp;&nbsp;
                 		...
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="center"> 
								...
								<%if(quyen[Utility.SUA]!=0){ %>
	                                <A href = "../../ErpDenghidoihangUpdateSvl?userId=<%=userId%>&update=<%=nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Chot.png" width="20px" title="Duyệt đề nghị đổi hàng" border=0></A>&nbsp;
	                               <% } %>
	                                
	                              	<%-- <A href = "../../ErpDenghidoihangSvl?userId=<%=userId%>&delete=<%= nhapkhoRs.getString("PK_SEQ") %>&loaidonhang=<%= obj.getLoaidonhang() %>"><img src="../images/Delete20.png" alt="Xóa" title="Xóa" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn xóa đề nghị đặt hàng này?')) return false;"></A>&nbsp;	 --%>							
			                    	<%-- <A href = "../../ErpDenghidoihangSvl?userId=<%=userId%>&chot=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Chot.png" title="Chốt" width="20px" border=0 onclick="if(!confirm('Bạn có muốn duyệt đề nghị đổi hàng?')) return false;" ></A>&nbsp; --%>
			                    <% } else { %>
			                    
			                    <%if(quyen[Utility.XEM]!=0){ %>
			                    	<A href = "../../ErpDenghidoihangUpdateSvl?userId=<%=userId%>&display=<%=nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" title="Hiển thị" border=0></A>&nbsp;
			                    	  <% } %>
