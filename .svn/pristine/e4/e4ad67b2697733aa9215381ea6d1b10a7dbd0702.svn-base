			...
			<TR>
				<TD align="left" class="tbnavigation">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr height="22">
   							<TD align="left" width="50%" class="tbnavigation">&nbsp;Quản lý tồn kho > Xuất chuyển, đổi hàng > Đổi số lô</TD>
							...
							<TD>
								<TABLE width="100%" border="0" cellspacing="1" cellpadding="2">
									<TR class="tbheader">
											...
											<TH align="center" width="10%">Kênh đổi</TH>
										...
										<TD align="center" valign="middle">
											<% if(ckRs.getString("trangthai").equals("0")) {%>
												...
												<%if(quyen[Utility.XOA]!=0){ %>
													<A href = "../../RouterSvl?task=<%= Utility.dongMa(getServletContext().getInitParameter("RedirectNoScript")+"ErpDoisoloNppSvl?userId="+userId+"&delete="+ ckRs.getString("pk_seq")) %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa đổi số lô này?')) return false;"></A>&nbsp;
												<%} %>
												
												<%if(quyen[Utility.CHOT]!=0){ %>
													<A href = "../../RouterSvl?task=<%= Utility.dongMa(getServletContext().getInitParameter("RedirectNoScript")+"ErpDoisoloNppSvl?userId="+userId+"&chotphieu="+ ckRs.getString("pk_seq")) %>" > <img src="../images/Chot.png" alt="Chot phieu chuyen" width="20" height="20" longdesc="Chot phieu chuyen" border = 0 onclick="if(!confirm('Bạn có muốn chốt đổi số lô này?')) return false; "></A>
												<%} %>
