	...
	function ngayvaolam2()
	{
	  ...
	  {  
	   ...
	   if(ngayvaolam < ngayhientai)
	   {
	    ...
	    alert('Bạn phải chọn ngày vào làm lớn hơn hoặc bằng ngày hiện tại !');
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng ETC/Đối tác > Bán hàng cho ETC > Duyệt đơn hàng ETC
        </div>
			...
			<hr />
				<table cellpadding="0px" cellspacing="1px" width="100%">
					<tr class="tbheader">
						...
						<th align="center" width="22%" rowspan="2" >Tên sản phẩm</th>
						<th align="center" width="10%" rowspan="2" >Đơn vị</th>
						<th align="center" width="11%" rowspan="2" >Số lượng</th>
