                ...
                <TR>
                    <TD align="left" class="tbnavigation">
                       <table width="100%" border="0" cellpadding="0" cellspacing="0">
                           <tr height="22">
                               <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền &gt; Bảng giá siêu thị &gt;Cập nhật
                               <TD colspan="2" align="right" class="tbnavigation">Chào mừng  <%= bgstBean.getNppTen() %> </TD>
                         </tr>
                      </table>
                  </TD>
              </TR> 
