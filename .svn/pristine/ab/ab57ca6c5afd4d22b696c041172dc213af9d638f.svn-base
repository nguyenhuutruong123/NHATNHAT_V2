			  	...
			  	<TR>
					<TD align="left" colspan="4" class="legendtitle">
				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
								<LEGEND class="legendtitle"><%=Utility.GLanguage("Thông tin khu vực",session,jedis) %>
								</LEGEND>
								...
								<TR>
									...
									<TR>
									  <TD width="15%" class="plainlabel required" ><%=Utility.GLanguage("Khu vực",session,jedis) %><FONT class="erroralert"></FONT></TD>
									  <TD  class="plainlabel" ><INPUT name="khuvuc"
										type="text" value='<%= kvBean.getTen() %>' style="width:300px"></TD>
								  </TR>
									<TR>
									  <TD class="plainlabel required" ><%=Utility.GLanguage("Diễn giải",session,jedis) %><FONT class="erroralert"></FONT></TD>
									  <TD class="plainlabel" ><INPUT name="diengiai"
										type="text" value='<%= kvBean.getDiengiai() %>' style="width:300px"></TD>
								  </TR>
								  <TR>
									  <TD class="plainlabel required" ><%=Utility.GLanguage("Vùng",session,jedis) %> miền<FONT class="erroralert"></FONT></TD>
								   ...
								   <TR>
								  <TD class="plainlabel"><%=Utility.GLanguage("Quản lý khu vực",session,jedis) %></TD>
								  <TD class="plainlabel"><SELECT name="asm">
									...
									<TR>
									  <TD width="15%" class="plainlabel" ><label>
										<% 
										System.out.println("trangthai::::: "+kvBean.getTrangthai());
								  ...
								  <TR>
								<TD class="plainlabel required"><%=Utility.GLanguage("Tỉnh thành",session,jedis) %></TD>
							...
							<TR>
						  	...
						  	<TD class="plainlabel"><%=Utility.GLanguage("Quận huyện",session,jedis) %></TD>
						  	<Td class="plainlabel">
						  	<select name="QhId"
