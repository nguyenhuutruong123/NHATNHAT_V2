...
public class KhachHangTBSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(view.equals("khachhangTB"))
		{
			...
			String nextJSP = request.getContextPath() + "/pages/Center/KhachHangTrungBayICP.jsp";
		    ...
		    query = "select cttb.*, sptb.*  " +
		    		...
		    		"( " +
		    			"select a.dktrungbay_fk, g.pk_seq as vungId, g.ten as vungTen, f.pk_seq as kvId, f.ten as kvTen, e.pk_seq as nppId, e.ten as nppTen,    " +
		    				...
		    				"isnull(a.thoidiem, getdate()) as thoidiem,  " +
		    ...
		    if(rsData != null)
		    {
		    	...
		    	try 
		    	{
					while(rsData.next())
					{
					    ...
					    {
						    //worksheet.getPictures().add(row, pos + 3, "D:\\project\\OneOneICP\\OneOne\\WebContent\\pages\\images\\404.jpg");
						    try
						    {
						    	worksheet.getPictures().add(row-1, pos + 3, "C:\\Program Files\\Apache Software Foundation\\Tomcat 7.0\\webapps\\OneOne\\pages\\upload\\" + img);
					    ...
					    if(img2.trim().length() > 0)
					    {
						    ...
						    try
						    {
						    	worksheet.getPictures().add(row-1, pos + 4, "C:\\Program Files\\Apache Software Foundation\\Tomcat 7.0\\webapps\\OneOne\\pages\\upload\\" + img2);
					    ...
					    if(img3.trim().length() > 0)
					    {
						    ...
						    try
						    {
						    	worksheet.getPictures().add(row-1, pos + 5, "C:\\Program Files\\Apache Software Foundation\\Tomcat 7.0\\webapps\\OneOne\\pages\\upload\\" + img3);
