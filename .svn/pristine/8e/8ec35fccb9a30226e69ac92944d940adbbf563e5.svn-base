...
<script language="javascript" type="text/javascript">
	...
	{    
	 ...
	 function saveform()
	 {	 
		 var r = confirm("Bạn chắc chắn muốn duyệt Kiểm kho này?");
		 if (r == false) {
		     return;
		 }
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý kho trung tâm > Kiểm kê > Tạo mới
        </div>
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
				...
				<%
					if(spRs != null)
					{
						...
						while(spRs.next())
						{
							String soluong = sp_soluong.get(spRs.getString("ma") + "__" + spRs.getString("solo"));
							if(soluong == null)
						...
						<tr>
							...
							<td> <input type="text" name="tonthucte" value="<%= formater.format(spRs.getDouble("tonthute")) %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);"  > </td>
						</tr>	
