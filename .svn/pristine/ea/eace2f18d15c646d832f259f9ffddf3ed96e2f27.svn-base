...
<%
	...
	String url = util.getChuyenNguUrl("CuaHieuMoiCoDoanhSo", "",session);
%>
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../CuaHieuMoiCoDoanhSo">
 ...
 <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle"><%=Utility.GLanguage("Cửa hiệu mới có doanh số",session,jedis) %></legend>
						...
						<div style="width: 100%; float: none" align="left"
							...
							<TABLE width="70%" cellpadding="6" cellspacing="0">
								<TR>
									...
									<TD class="plainlabel">
										<select  name="vung" onchange="search();" id="vungId" style="width:250px">
									...
									<TD class="plainlabel">
										<select  name="khuvuc" onchange="search();"  id="khuvucId" style="width:250px">
											<option value=""><%=Utility.GLanguage("All",session,jedis) %></option>
											<% if(rsKhuVuc!=null){
										 		while(rsKhuVuc.next()){
									...
									<TD class="plainlabel"><select onchange="search();"  name="kenhId" id="kenhId"  style="width:250px">
											<option value=""><%=Utility.GLanguage("All",session,jedis) %></option>
											<% if(rsKenh!=null){
													while(rsKenh.next()){
								...
								<TR>
									...
									<TD class="plainlabel">
										<select  name="npp" onchange="search();" id="nppId" style="width:250px">
											<option value=""><%=Utility.GLanguage("All",session,jedis) %></option>
											<% if(rsNpp!=null){
										 		while(rsNpp.next()){
