...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng OTC > Xuất HĐKM > Tạo mới
        </div>
								...
								if(scheme_sanpham.size() > 0)
								{
									...
									while(count < scheme_sanpham.size())
									{
										...
										<TR class= 'tblightrow'>
									        ...
									        <TD align = "center" ><input name="dgTrakm" type="text" value="<%= formatter2.format(Double.parseDouble(tkmSp.getDongia())) %>" readonly style="width:100%;text-align:right"></TD>							        									        	    
