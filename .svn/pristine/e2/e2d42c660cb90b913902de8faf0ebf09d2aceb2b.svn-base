										...
										<%}%>
												...
												<TD align="center" valign="middle">
													<% if(pxk.getTrangthai().equals("0")) {%>
														<A href = "../../PhieuxuatkhoUpdateSvl?userId=<%=userId%>&update=<%= pxk.getId() %>"><img src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A>&nbsp;
														<A href = "../../PhieuxuatkhoSvl?userId=<%=userId%>&chotphieu=<%= pxk.getId() %>"><img src="../images/Chot.png" alt="Chot phieu xuat" width="20" height="20" longdesc="Chot phieu xuat" border = 0></A>
													<%}else{ %>
														<A href = "../../PhieuxuatkhoUpdateSvl?userId=<%=userId%>&display=<%= pxk.getId() %>"><img src="../images/Display20.png" alt="Hien thi" width="20" height="20" longdesc="Hien thi" border = 0></A>
													<%} %>
												</TD>
											</TR>
								<%m++; }%>
