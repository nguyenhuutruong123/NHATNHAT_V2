    ...
    <TR>
        ...
        <!--begin common dossier info---> <!--End common dossier info--->
            ...
            <TABLE width="100%" cellpadding="0" cellspacing="2">
                ...
                <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                    <TR class = "tbdarkrow">
                        <TD width="30" align="left"><A href= "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"BanggiablSvl?userId="+userId +"")%>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
										...
										while (m < size){
	                                        ...
	                                        <%} %>                        	                                          
                                              ...
                                              <TD style="padding:4px">
                                              	...
                                              	<INPUT type="text" name="" onkeyup="Dinhdang(this)" value ="<%= sanpham.getGiaban() %>" style="text-align: right;" readonly="readonly" >
                                              </TD>
