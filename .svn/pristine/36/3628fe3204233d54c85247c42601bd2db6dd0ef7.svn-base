...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Xuất chuyển hàng > Nhập hàng trả lại  > Hiển thị
        </div>
    	...
    	<legend class="legendtitle"> Nhập hàng trả lại  </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                 ...
                 <TR>
                	<TD class="plainlabel" >Trả nguyên đơn</TD>
                	<TD class="plainlabel"  >
                ...
                <% if( lsxBean.getTraNguyenDon().equals("1")  ){ // thêm phần giao diện trả nguyên đơn %>
                ...
                <TABLE class="" width="100%">
						<TR>
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
								<TR class="tbheader">
									...
									<TH width="10%">Kho</TH>
									<TH width="15%"><%=Utility.GLanguage("Sản phẩm",session,jedis) %></TH>
						...
						<%  														
							...
							if(infoRs!=null && lsxBean.getDonhangId().trim().length() > 0)
							{%>
							<% try{								
                                while (infoRs.next()){
                                    ...
                                    <%} else {%>
                                       	<TR class= <%= darkrow%> >
											...
											<TD><div align="right"><%=  formater.format(infoRs.getDouble("giamua")) %></div></TD>  
											<TD><div align="right"><%=  formater.format(infoRs.getDouble("thanhtien"))%></div></TD>  
                ...
                <%} else {// kêt thúc phần giao diên trả nguyên dơn 
                
                
                // phần giao diên trả lẻ 
                %>
