...
public class CongthuDNDHSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = request.getContextPath() + "/pages/Center/CongThucDeNghiDatHang.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ICongthucdndh congthuc =new Congthucdndh();
	    String ngaytktoithieu = util.antiSQLInspection(request.getParameter("ngaytktoithieu"));
	    if(ngaytktoithieu == null) ngaytktoithieu = "0";
	    congthuc.setNgayTonKhoToithieu(ngaytktoithieu);
	    String muctangtruong = util.antiSQLInspection(request.getParameter("muctangtruong"));
	    if(muctangtruong == null) muctangtruong = "0";
	    congthuc.setMucTangTruong(muctangtruong);

	    String mucthue = util.antiSQLInspection(request.getParameter("mucthue"));
