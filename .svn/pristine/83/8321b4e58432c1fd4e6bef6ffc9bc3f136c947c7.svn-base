...
public class StockAlarmDistributor extends HttpServlet {
	...
	public String setQuery(HttpServletRequest request, String sql){
       String  query  = "SELECT * FROM ( " +
    			...
    			"		WHERE NHAPHANG.TRANGTHAI = '0' and NHAPHANG_SP.DONGIA > 0 AND NHAPHANG.NGAYNHAN ='"+ this.getDateTime() +"'" +
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = request.getContextPath() + "/pages/Distributor/StockAlarm.jsp";
