...
public class PhanBoKMApGameList extends Phan_Trang implements IPhanBoKMApGameList {
	...
	public PhanBoKMApGameList(String[] param)
	{
	...
	public void init(String search) 
	{
		...
		if (search.length() == 0)
		{
			...
			query = "\n select distinct top(100) a.PK_SEQ as ctkmId, a.scheme, substring(a.diengiai,1,100) as diengiai, a.TUNGAY, a.DENNGAY, case when " +
					...
					/*"\n   inner join CTKM_NPP ctn on ctn.CTKM_FK = a.PK_SEQ "+
					"\n     inner join phamvihoatdong pv on pv.npp_fk = ctn.npp_fk 	 "+
					"\n     inner join nhaphanphoi npp on npp.PK_SEQ = ctn.NPP_FK	and pv.Npp_fk = npp.PK_SEQ and pv.Nhanvien_fk = '"+userId+"'  "+*/
