    ...
    function AjaxNpp()
	{
		...
		function kiemtraChonPhepToan(){
			...
			if(dkkmPheptoan.item(0) == null || trakmPheptoan.item(0) == null 
				...
				return "Chưa chọn phép toán cho Điều kiện KM hoặc Trả KM";
			}
			return "";
		}
                    ...
                    <%} %>
                     ...
                     <% if(ctkmBean.getType().equals("3")) {%>
					  <TR>
                        ...
                        <TD class="plainlabel" ><%=Utility.GLanguage("Ngày tính toán doanh số",session,jedis) %>:&nbsp;&nbsp;&nbsp;&nbsp;<%=Utility.GLanguage("Từ ngày",session,jedis) %></TD>
                        <TD class="plainlabel" colspan="3" >
                            <input type="text" size="10" class="days" 
			...
			<br />
                        ...
                        <% if (ctkmBean.getPhanbomucTDV().equals("1")){ %> 
                        	...
                        	<%-- <% if (ctkmBean.getXuatHDCoVAT().equals("1")){ %> 
                        		<input type="checkbox" name="xuatHDCoVAT" value="1" checked="checked"><i> suất hóa đơn có VAT</i>
                        	<% } else { %>
                        		<input type="checkbox" name="xuatHDCoVAT" value="1" ><i> suất hóa đơn có VAT</i>
                        	 <% }  %> 
				                ...
				                <div style='display:none'>
			                        <div id='dieukienkhuyenmai<%= i %>' style='padding:0px 5px; background:#fff;'>
										...
										<table cellpadding="4px" cellspacing="2px" width="100%" align="center">
			                                ...
			                                <tr>
			                                	<td  align="left">Tổng lượng / Tổng tiền</td>
			                                    <td  align="left">
			                                ...
			                                <tr>
			                                	<td  align="left">Nhóm sản phẩm</td>
			                                    <td  align="left">		                                    	
			                                    ...
			                                    <td  align="left">
			                                    	<select name="trakhuyenmai<%= pos %>.loaitra" id = "trakhuyenmai<%= pos %>.loaitra">
			                                    		...
			                                    		<%}else { %>
			                                    			...
			                                    			<option value="1"><%=Utility.GLanguage("Trả tiền",session,jedis) %></option>
			                                    			<option value="2"><%=Utility.GLanguage("Trả tiền chiết khấu",session,jedis) %></option>
			                                    			<option value="4"><%=Utility.GLanguage("Trả tiền theo điểm",session,jedis) %></option>
			                                    		 <%}  %>
			                                    	</select>
			                                    </td>
