 ...
 function saveform()
{
 ...
 function upload(){
		var value=	document.forms["bgmuanppForm"].check.value;
		var dvkdId=document.forms["bgmuanppForm"].dvkdId.value;
		if(dvkdId==""){
			document.forms["bgmuanppForm"].dataerror.value="Ban Phai Nhap Kho Truoc Khi Import Bang Gia";
				...
				<TR>
					<TD align="left" class="tbnavigation">
					   <table width="100%" border="0" cellpadding="0" cellspacing="0">
						   <tr height="22">
 							   <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền &gt; Dữ liệu nền sản phẩm &gt; Bảng giá vốn trung tâm &gt; Tạo mới</TD>
