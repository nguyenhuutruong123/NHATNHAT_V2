		 ...
		 request.setCharacterEncoding("UTF-8");
		    ...
		    if(action.equals("update")){
		    	...
		    	session.setAttribute("obj", obj);		   
		    	 nextJSP = request.getContextPath() + "/pages/Center/PhieuChuyenKhoTTUpdate.jsp";
		    	...
		    	obj = new PhieuChuyenKhoTT(id);	
		    	session.setAttribute("obj", obj);		   
		    	 nextJSP = request.getContextPath() + "/pages/Center/PhieuChuyenKhoTTDisplay.jsp";
		    	
		    }else if(action.equals("chot")){
		    	obj = new PhieuChuyenKhoTT(id);	
		    	session.setAttribute("obj", obj);		   
		    	 nextJSP = request.getContextPath() + "/pages/Center/PhieuChuyenKhoTTChot.jsp";	
		    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] soluongchuyen = request.getParameterValues("soluongchuyen");
		 ...
		 //lay thong tin ve ngaynhapkho
			...
			String khott_nhan=util.antiSQLInspection(request.getParameter("khottnhan"));
			ctbean.setKhoId_Nhan(khott_nhan);
			String phieunhapkho=util.antiSQLInspection(request.getParameter("phieunhapkho"));
			ctbean.setId_PhieuNhap(phieunhapkho);
			String khochuyenid=util.antiSQLInspection(request.getParameter("khottchuyen"));
			...
			if(tenform.equals("newform")){
				nextJSP= request.getContextPath() + "/pages/Center/PhieuChuyenKhoTTNew.jsp";
			}else{
				nextJSP= request.getContextPath() + "/pages/Center/PhieuChuyenKhoTTUpdate.jsp";
			}
			String madhsua=util.antiSQLInspection(request.getParameter("madhsua"));
	    	session.setAttribute("madhsua", madhsua);
			ctbean.setListSanPham(spList);
			  ...
			  //sau khi luu xong thi thuc hien quay lai form PhieuNhapKhoTT.jsp
				...
				nextJSP= request.getContextPath() + "/pages/Center/PhieuChuyenKhoTT.jsp";
			  }
