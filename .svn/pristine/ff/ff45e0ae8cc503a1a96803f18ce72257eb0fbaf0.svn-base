...
public class ErpDenghidoihangUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
    		...
    		{
    			nextJSP = request.getContextPath() + "/pages/Center/ErpDeNghiDoiHangUpdate.jsp";
    		}
    		else
    		{
    			nextJSP = request.getContextPath() + "/pages/Center/ErpDeNghiDoiHangDisplay.jsp";
    		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			{	
				if(id == null)
				{
					...
					if(!kq)
					{
						lsxBean.createRs();
	    		    	session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = request.getContextPath() + "/pages/Center/ErpDeNghiDoiHangNew.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
			    		...
			    		String nextJSP = request.getContextPath() + "/pages/Center/ErpDeNghiDoiHang.jsp";
			    		response.sendRedirect(nextJSP);
					}
				}
				else
				{
					...
					if(!kq)
					{
						lsxBean.createRs();
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = request.getContextPath() + "/pages/Center/ErpDeNghiDoiHangUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
			...
			else
			{
				...
				nextJSP = request.getContextPath() + "/pages/Center/ErpDeNghiDoiHangNew.jsp";
				if(id != null)
				{
					nextJSP = request.getContextPath() + "/pages/Center/ErpDeNghiDoiHangUpdate.jsp";
				}
