		...
		<TABLE width="100%" cellpadding="0" cellspacing="1">
				...
				<TR>
					<TD align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <TD align="left" colspan="2" class="tbnavigation">Dữ liệu nền > Kinh doanh  > Thành thị nông thôn</TD>
					...
					<TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
						<TR>
							...
							<TABLE  width="100%" cellpadding="6" cellspacing="0">
								<%-- <TR>
								    <TD width="20%" class="plainlabel"><%=Utility.GLanguage("Khu vực",session,jedis) %></TD>
							    ...
							    <TR>
									...
									<a class="button2" href="javascript:refresh()"> <img style="top: -4px;" src="../images/button.png" alt=""><%=Utility.GLanguage("Nhập lại",session,jedis) %></a>&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<TABLE width="100%" cellpadding="0" cellspacing="0">			
				<TR>
					<TD width="100%">
						<FIELDSET>
							<LEGEND class="legendtitle">&nbsp;Thành thị nông thôn &nbsp;&nbsp;
						...
						<TR>
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
								<TR class="tbheader">
									<TH width="4%">STT</TH>
									<TH width="13%">Thành thị nông thôn</TH>
										...
										<%}%>
												...
												<TABLE border = 0 cellpadding="0" cellspacing="0">
													...
													<%if(quyen[Utility.SUA]!=0) {%>
														<A href = "../../ThanhthinongthonUpdateSvl?userId=<%=userId%>&update=<%=kv.getId()%>"><img src="../images/Edit20.png" alt="Cap nhat" title="Cập nhật" width="20" height="20" longdesc="Cap nhat" border = 0></A>
													<%} %>
													</TD>
													<TD>&nbsp;</TD>
													<TD>
													<%if(quyen[Utility.XOA]!=0) {%>
														<A href = "../../ThanhthinongthonSvl?userId=<%=userId%>&delete=<%=kv.getId()%>"><img src="../images/Delete20.png" alt="Xoa" title="Xóa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa Thành thị nông thôn này ?')) return false;"></A></TD>
													<%} %>
													</TR></TABLE>
												</TD>
											</TR>
