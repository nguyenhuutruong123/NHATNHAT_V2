					...
					<TD align="left" class="tbnavigation">
					   <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <TR height="22">
						  	...
						  	<TD colspan="2" align="right" class="tbnavigation">Chào mừng  <%= mckBean.getNppTen() %>&nbsp;&nbsp; </TD>
						 </TR>
					  </table>
					</TD>
			  </TR>
			...
			<TABLE width="100%" cellpadding="0" cellspacing="2">
				<TR >
					<TD >
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR class = "tbdarkrow">
								<TD width="30" align="left"><A href= "../../MucchietkhauSvl?userId=<%=userId %>">		 		
				...
				<tr>
							<TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
		                        	...
		                        	<textarea id="dataerror" style="width: 100%" rows="2" style="width: 100%" readonly="readonly"><%= mckBean.getMessage() %></textarea>
		                        	<% mckBean.setMessage(""); %>
                        		</FIELDSET>
						   </TD>
					</tr>
				<TR>
				  <TD height="100%" width="100%">
						...
						<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
							<TR>
								<TD width="24%" class="plainlabel"><%=Utility.GLanguage("Diễn giải",session,jedis) %> mức chiết khấu <FONT class="erroralert">*</FONT></TD>
        ...
        <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
				<TR>
					<TD colspan = "6" width="100%">
						<FIELDSET><LEGEND class="legendtitle">Khách hàng hưởng chiết khấu</LEGEND>
