                ...
                <% int m = 0;
                	try{
                		...
                		if(kh != null){
							...
							<TD align="right"><input type ="text" name =<%="tn" + kh.getString("khId") %>  id =<%="tn" + kh.getString("khId") %>  size="10" value ='<%=Math.round(Double.parseDouble(kh.getString("tongno"))) %>' readonly></TD>
