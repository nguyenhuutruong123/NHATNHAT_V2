...
<% List<ISanPhamDhNpp> splist = (List<ISanPhamDhNpp>)dhBean.getSanPhamList();
  ...
  Hashtable<String,Integer> spthieu = (Hashtable<String,Integer>)dhBean.getSPThieuList();
...
function Kiemtratonkho(){
	...
	var masp = document.getElementsByName("masp");
	 ...
	 for(var k = 0; k < masp.length; k++)
	 {
		...
		if(nhappmua.value == "")
		{
			alert("vui lòng chọn Chi nhánh / NPP mua hàng...");
			return;
		}
		
		document.getElementById("btnKTraTK").innerHTML = "<img src='../images/waiting.gif'  title='cho thuc hien..' border='1' longdesc='cho thuc hien..' style='border-style:outset'>";
...
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Xử lý đơn hàng > Đơn hàng bán>Bán cho Chi nhánh / NPP > Tạo mới </TD>								   
			 								   <TD align="right" class="tbnavigation">Chào mừng <%= dhBean.getTenNPPBan() %> &nbsp; </TD>
					    				 </TR>
									  </TABLE>
								  </TD>
							  </TR>	
							...
							<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
											<TD width="30" align="left"><A href = "../../DonhangnppSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
								...
								<TR>
									<TD  align="left">						
										...
										<TABLE cellpadding = "6" cellspacing = "0" width = "100%" border = 0>
											...
											<TR >
												<TD width="22%" class="plainlabel"><%=Utility.GLanguage("Nhà phân phối",session,jedis) %> bán hàng</TD>
												<TD colspan="3" class="plainlabel"><%= dhBean.getTenNPPBan() %> </TD>
												</TR>							
											
											<TR class="tblightrow">
												<TD  class="plainlabel"><%=Utility.GLanguage("Nhà phân phối",session,jedis) %> mua hàng</TD>
								  ...
								  <label id="btnKTraTK">
								  <a class="button2" href="javascript:Kiemtratonkho()">
	<img style="top: -4px;" src="../images/button.png" alt="" >Kiểm tra tồn kho</a>&nbsp;&nbsp;	&nbsp;&nbsp;
							   ...
							   <TR>
							   		<TD>
										<TABLE width = "100%"  cellpadding="0px" cellspacing="1" >
										<tbody id="san_pham">
												<TR class="tbheader" >
							...
							while (m < size){
								...
								%>
									<TR class= 'tblightrow' >
										 ...
										 <TD align="left" >
									<input name="masp" type="text" autocomplete='off'  value="<%=sanpham.getMaSanPham()%>"  style="width:100%;" onkeyup="ajax_showOptions(this,'abc',event)">
									</TD>
									<TD align="left" >
						        ...
						        <% if ( spthieu.containsKey(sanpham.getMaSanPham())){ 
						        	//System.out.println(spthieu.get(sanpham.getMaSanPham()));
						        %>
									<TD align="left" >
								...
								<% m++; }}%>
								<% if(!dhBean.getTrangthai().equals("3")){//day la truong hợp thêm mới, neu trang thai set gia tri =3 la trong truong hop sua hoặc thêm mới
									int soSp=0;
									while(soSp < 30){ 
								%>
								<TR class= 'tblightrow'>
