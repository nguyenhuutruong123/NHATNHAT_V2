		...
		<TD colspan="4" align='left' valign='top' bgcolor="#FFFFFF">
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="0">
				  ...
				  <TD height="100%" width="100%">
						<FIELDSET>
						<LEGEND class="legendtitle" style="color:black"><%=Utility.GLanguage("Thông tin ",session,jedis) %><%= nppBean.getIsKhachhang().equals("1") ? "Khách hàng" : "Chi nhánh / NPP" %> </LEGEND>
										...
										<% if(tructhuocRs != null) { 
											while(tructhuocRs.next())
											{
												if(tructhuocRs.getString("Id").equals(nppBean.getTructhuocId())) { %>
													<option value="<%= tructhuocRs.getString("Id") %>" selected="selected" ><%= tructhuocRs.getString("TEN") %>
