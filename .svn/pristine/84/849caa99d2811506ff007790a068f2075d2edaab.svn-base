...
public class BCCongNoKH implements IBCCongNoKH, Serializable {
	...
	public void init1()
	{
		...
		if(this.nppId==null)
		{
			...
			System.out.println("query ne2: "+ query);
			this.NppRs = this.db.get(query);
			
			
			query ="select PK_SEQ, isnull(maFAST,'')+ ' - '+ TEN as TEN from KHACHHANG where TRANGTHAI = '1'";
