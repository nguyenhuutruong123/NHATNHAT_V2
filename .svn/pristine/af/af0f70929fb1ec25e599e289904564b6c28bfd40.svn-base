...
<% 
	...
	//	url = util.getUrl("ErpDondathangSvl","&loaidonhang="+obj.getLoaidonhang()+"");
		int[] quyen = new  int[5];
		quyen = util.Getquyen("BCChietKhauThangSvl","&loaick=1",userId);%>
...
<head>
    ...
    <SCRIPT language="javascript" type="text/javascript">
		 ...
		 function xuatExcel()
		 {
		 	document.forms['ckParkForm'].action.value= 'excel11';
		 	document.forms['ckParkForm'].submit();
		 }
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Báo cáo quản trị > Theo dõi Doanh số > Chiết khấu tháng
        </div>
                    ...
                    <select name="tdvId" id="tdvId" style="width:250px"  onchange="search();" class="notuseselect2" >
						...
						<TR>
								...
								if(obj.getType().equals("0")){
									%>
									<input type="radio" name="type" value="1" /> Chưa trả chiết khấu &nbsp; &nbsp;
									<input type="radio" name="type" value="0"  checked="checked"/>  Trả chiết khấu 
									<%
								}
								else
								{
									%>
										<input type="radio" name="type" value="1"  checked="checked"/> Chưa trả chiết khấu  &nbsp; &nbsp;
										<input type="radio" name="type" value="0"  /> Trả chiết khấu  
									<%
								}
								%>
