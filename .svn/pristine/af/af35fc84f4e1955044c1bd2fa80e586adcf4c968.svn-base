...
public class DondathangDisplaySvl extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		} else
		{
			...
			String nextJSP = request.getContextPath() + "/pages/Distributor/DonDatHangDisplay.jsp";
	...
	private void CreateDondathangHPC(Document document, ServletOutputStream outstream, IDondathang ddhBean) throws IOException
	{
		try
		{
			...
			float[] with =
			{ 15.0f, 40.0f, 30f, 18.0f }; // set chieu rong cac columns
			...
			PdfPCell cell3 = new PdfPCell(new Paragraph("Fax OneOne: ", font3));
			...
			float[] withs =
			{ 16.0f, 42.0f, 11.0f, 12.0f, 22.0f, 14.0f, 12.0f, 13.0f, 12.0f, 22.0f };
			table.setWidths(withs);

			String[] th = new String[]
			{ "Mã Code", "Diễn Giải", "Quy cách", "ĐV", "Đơn Giá NPP", "Đặt hàng" };
			String[] th2 = new String[]
			{ "(Trước VAT)", "Số Lượng", "KL(kg)", "TT(m3)", "Thùng", "TT(Trước VAT)" };
			...
			for (int j = 0; j < Integer.valueOf(ddhBean.getSize()).intValue(); j++)
			{
				if (Float.parseFloat(sl[j]) > 0)
				{
					...
					tongsoluong += Double.valueOf(sl[j]).doubleValue() * Double.valueOf(qc[j]).doubleValue();
					...
					tongkhoiluong += Double.parseDouble(khoiluongtmp.replaceAll(",", ""));
					...
					tongthetich += Double.parseDouble(thetichtmp.replaceAll(",", ""));
					...
					tongthung += Double.parseDouble(sl[j]);
					...
					tongtien += Double.parseDouble(tienbVAT[j]);
			...
			cell[2] = new PdfPCell(new Paragraph("Tổng cộng", font4));
			cell[2].setHorizontalAlignment(Element.ALIGN_CENTER);
			cell[2].setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell[2].setPadding(4);
			cell[2].setColspan(5);
			...
			cell[5] = new PdfPCell(new Paragraph(formatter.format(tongsoluong), font4));
			cell[5].setHorizontalAlignment(Element.ALIGN_CENTER);
			cell[5].setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell[5].setPadding(4);
			table.addCell(cell[5]);

			cell[6] = new PdfPCell(new Paragraph(formatter.format(tongkhoiluong), font4));
			cell[6].setHorizontalAlignment(Element.ALIGN_RIGHT);
			cell[6].setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell[6].setPadding(4);
			table.addCell(cell[6]);

			cell[7] = new PdfPCell(new Paragraph(formatter.format(tongthetich), font4));
			cell[7].setHorizontalAlignment(Element.ALIGN_RIGHT);
			cell[7].setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell[7].setPadding(4);
			table.addCell(cell[7]);

			cell[8] = new PdfPCell(new Paragraph(formatter.format(tongthung) + "", font4));
			cell[8].setHorizontalAlignment(Element.ALIGN_RIGHT);
			cell[8].setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell[8].setPadding(4);
			table.addCell(cell[8]);

			cell[9] = new PdfPCell(new Paragraph(formatter.format(tongtien), font4));
			cell[9].setHorizontalAlignment(Element.ALIGN_RIGHT);
			cell[9].setVerticalAlignment(Element.ALIGN_MIDDLE);
			cell[9].setPadding(4);
			table.addCell(cell[9]);
			...
			/*
			 * cell11 = new PdfPCell(new Paragraph("Thuế VAT (10%): ", new
			 * Font(bf, 9, Font.BOLDITALIC)));
			 * cell11.setHorizontalAlignment(Element.ALIGN_LEFT); cell12 = new
			 * PdfPCell(new
			 * Paragraph(formatter.format(Double.parseDouble(ddhBean.getVat())),
			 * new Font(bf, 9, Font.ITALIC))); cell11.setBorder(0);
			 * cell12.setBorder(0);
			 * cell12.setHorizontalAlignment(Element.ALIGN_RIGHT);
			 * tableFooter.addCell(cell11); tableFooter.addCell(cell12);
			 */

			/*
			 * cell11 = new PdfPCell(new Paragraph("Tổng Giá Trị: ", new
			 * Font(bf, 9, Font.BOLD)));
			 * cell11.setHorizontalAlignment(Element.ALIGN_LEFT); cell12 = new
			 * PdfPCell(new
			 * Paragraph(formatter.format(Double.parseDouble(ddhBean
			 * .getTongtienaVAT())), new Font(bf, 9, Font.ITALIC)));
			 * cell11.setBorder(0); cell12.setBorder(0);
			 * cell12.setHorizontalAlignment(Element.ALIGN_RIGHT);
			 * tableFooter.addCell(cell11); tableFooter.addCell(cell12);
			 */
