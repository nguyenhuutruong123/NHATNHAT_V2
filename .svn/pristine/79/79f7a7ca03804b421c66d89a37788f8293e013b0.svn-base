...
public class Thongtinsanpham implements IThongtinsanpham, Serializable
{
	...
	public void init() 
	{
		...
		try
		{
			...
			String query ="select a.pk_seq as id, a.ma as masp, a.ten as tensp, b.donvikinhdoanh as dvkd, b.pk_seq as dvkdId, c.pk_seq as clId, c.ten as chungloai, e.pk_seq as nhId, d.donvi, e.ten as nhanhang, d.pk_seq as dvdlId, a.trangthai, isnull(f.giabanlechuan, 0) as giablc, h.TEN as nganhhang ";
			...
			query = query  + " left join banggiablc_sanpham f on a.pk_seq = f.sanpham_fk left join banggiabanlechuan g on f.bgblc_fk = g.pk_seq left join NGANHHANG h on a.NGANHHANG_FK = h.PK_SEQ ";
				     
			query = query + " where a.pk_seq = '" + this.id + "'";
			System.out.println("Thong TIn San Pham Nha Phan Phoi:  "+query);
			System.out.println("DVDL ID: "+this.dvdlId);
	    	...
	    	this.nganhhang =  rs.getString("nganhhang");
...
//	   	this.msg =query;
		...
		try
		{
			String query ="select a.pk_seq as id, a.ma as masp, a.ten as tensp, b.donvikinhdoanh as dvkd, b.pk_seq as dvkdId, c.pk_seq as clId, c.ten as chungloai, e.pk_seq as nhId, d.donvi, e.ten as nhanhang, d.pk_seq as dvdlId, a.trangthai,f.giabanlechuan as giablc, a.type, a.DVDL_ETC_FK,h.TEN as nganhhang,a.spchuluc,a.spmoi  ";
			...
			query = query  + " inner join banggiablc_sanpham f on a.pk_seq = f.sanpham_fk inner join banggiabanlechuan g on f.bgblc_fk = g.pk_seq left join NGANHHANG h on a.NGANHHANG_FK = h.PK_SEQ";
