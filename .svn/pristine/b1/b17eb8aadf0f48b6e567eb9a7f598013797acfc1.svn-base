...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý tồn kho > Mua hàng từ nhà cung cấp > Đề nghị đặt hàng > Cập nhật
        </div>
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					...
					<%
						if(spRs != null)
						{
							...
							<tr>
								<td><input type="text" name="spMA"  value="<%= spRs.getString("MA") %>" readonly="readonly" style="width: 100%;" > </td>
								<td><input type="text" value="<%= spRs.getString("TEN") %>" readonly="readonly" style="width: 100%;" > </td>
								<td><input type="text" value="Thùng" readonly="readonly" style="width: 100%;" > </td>
								<td><input type="text" value="<%= formater.format(spRs.getDouble("tbBAN")) %>" readonly="readonly" style="text-align: right;width: 100%;" > </td>
								<td><input type="text" value="<%= formater.format(tontoithieu) %>" readonly="readonly" style="text-align: right;width: 100%;" > </td>
								<td><input type="text" value="<%= formater.format(dukienban) %>" readonly="readonly" style="text-align: right;width: 100%;" > </td>
								<td><input type="text" value="<%= formater.format(tonhientai) %>" readonly="readonly" style="text-align: right;width: 100%;" > </td>
								<td><input type="text" name="spSOLUONG" value="<%= formater.format(denghi) %>" style="text-align: right;width: 100%;" onkeypress="return keypress(this);" > </td>
								...
								<td><input type="text" name="spTHANHTIEN" value="<%= formater.format(thanhtien) %>" readonly="readonly" style="text-align: right;width: 100%;" > </td>
							</tr>	
