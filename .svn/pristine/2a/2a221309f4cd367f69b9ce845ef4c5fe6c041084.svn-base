...
import geso.dms.distributor.beans.hoadonphelieu.imp.ErpHoadonphelieu;
import geso.dms.distributor.beans.hoadonphelieu.imp.ErpHoadonphelieuList;
...
public class ErpHoadonphelieuUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
        ...
        String nextJSP = request.getContextPath() + "/pages/Distributor/ErpHoaDonPheLieuUpdate.jsp";
        if(querystring.indexOf("display") >= 0)
        {
        	nextJSP = request.getContextPath() + "/pages/Distributor/ErpHoaDonPheLieuDisplay.jsp";
        }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
 		...
 		if(action.equals("save"))
 		{
 			if(id == null)
 			{
	 			if (!(csxBean.createGiamgia()))
				{
					...
					String nextJSP = request.getContextPath() + "/pages/Distributor/ErpHoaDonPheLieuNew.jsp";
					response.sendRedirect(nextJSP);
				}
				else
				{
		...
		else
		{
			...
			if( id != null )
			{
				 nextJSP = request.getContextPath() + "/pages/Distributor/ErpHoaDonPheLieuUpdate.jsp";
			}
