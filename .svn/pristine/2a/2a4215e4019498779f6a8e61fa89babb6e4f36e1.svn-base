					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <%} else{ %>
		                    		...
		                    		<A href = "../../ErpInphieuxuatkhoHOSvl?userId=<%=userId%>&id=<%= nhapkhoRs.getString("PK_SEQ") %>&type=PXK"><IMG src="../images/Printer20.png" alt="In phiếu xuất kho" title="In phiếu xuất kho" border=0></A>
