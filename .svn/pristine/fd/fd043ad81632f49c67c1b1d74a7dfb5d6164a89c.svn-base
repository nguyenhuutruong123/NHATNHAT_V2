...
public class catalog implements Icatalog, Serializable
{
	...
	public String saveNsp()
	{
		...
		try
		{
			...
			{
				this.msg = "Vui lòng nhập Tên nhãn hàng";
				return this.msg;
			}
	...
	public boolean updateNsp()
	{
		...
		try
		{
			...
			query = " update Catalog set nhanhang=N'"+this.nhanhang+"',Ma=N'"+this.ma+"',duongdan=N'"+this.duongdan+"',ten = N'" + this.ten + "', " +
					" chungloai_fk = N'" + this.chungloai + "',ghichu = N'" + this.ghichu + "', ngaysua = '" + getDateTime() + "', "+
