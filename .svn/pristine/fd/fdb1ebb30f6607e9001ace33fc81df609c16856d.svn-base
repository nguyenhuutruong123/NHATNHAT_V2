  		...
  		function checkSlgTraKm(name)
  		{
  			...
  			for(i = 0; i < slg.length; i++)
  			{
  				if(slg.item(i).value != '')
  				{
  					...
  					{
  						alert('Số lượng bạn nhập vào,lớn hơn số lượng trả khuyến mãi đã xuất kho (' + soluongDxk.item(i).value + '), Vui lòng điều chỉnh ...');
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr height="25px">
		...
		<TD colspan="2" align="right" class="tbnavigation">Chào mừng    <%= "Hoang Van Luong" %> &nbsp;</TD>
	</tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<TR class="tbdarkrow">
...
<fieldset>
    ...
    <table class="tabledetail" id="content" width="100%" border="0" cellspacing="1" cellpadding="2">
    	<tr class="tbheader">
            ...
            <th width="13%" align="center"><%=Utility.GLanguage("Sản phẩm",session,jedis) %></th>
