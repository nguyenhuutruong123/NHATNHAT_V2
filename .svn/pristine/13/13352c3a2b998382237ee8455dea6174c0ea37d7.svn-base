                ...
                <TR>
                    <TD align="left" class="tbnavigation">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr height="22">
                                <TD align="left" colspan="2" class="tbnavigation">Thiết lập dữ liệu nền > Dữ liệu Kinh doanh > Nhân viên giao nhận</TD>
                                        ...
                                        <%}%>
                                                ...
                                                <TABLE border = 0 cellpadding="0" cellspacing="0">
                                                    ...
                                                    <%if(quyen[Utility.XOA]!=0){ %>
                                                        <A href = "../../RouterSvl?task=<%= Util.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"NhanviengiaonhanSvl?userId="+userId+"&delete="+nvgn.getId()+"")%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border="0" onclick="if(!confirm('Bạn chắc chắn muốn xóa nhân viên giao nhận này?')){ return false;}"></A></TD>
                                                    <%} %>
