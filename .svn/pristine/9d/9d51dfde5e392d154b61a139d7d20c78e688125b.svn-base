...
public class ErpInBienbannghiemthuNPPSvl extends HttpServlet{

	public ErpInBienbannghiemthuNPPSvl()
	{
		super();
	}
	...
	private void form_phieunghiemthu1( Document document,ServletOutputStream outstream,IErpHoadontaichinhNPP hdBean){
		...
		if (hdBean.getLoaiXHD().equals("1")) {
			...
			"\n  from KHACHHANG kh where kh.pk_seq="+hdBean.getKhId();  
		...
		String	 query_sp = "select  a.MA as MA, isnull(a.ten,'') as TEN,solo as solo, a.donvi AS DONVI, a.soluong AS SOLUONG, a.dongia  AS DONGIA, ngayhethan as handung  "+    
		"\n from ERP_HOADONNPP_SP_CHITIET a where a.hoadon_fk ="+hdBean.getId(); 
		...
		String qr_hopdong="select hdg.pk_seq as sohopdong , hdg.tungay as ngayhopdong "+    
					 ...
					 "\n inner join erp_hopdongnpp hdg on dh.HOPDONG_FK=hdg.pk_seq "+    
