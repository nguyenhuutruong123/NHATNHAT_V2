...
<%@ page import="geso.traphaco.erp.beans.loaitaikhoan.*"%>
<%@ page import="geso.traphaco.erp.beans.loaitaikhoan.imp.*"%>
...
<script type="text/javascript">
	...
	function Save() {
		...
		document.forms['tkForm'].action.value = 'Create';
						...
						<tr>
							<td align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kế toán &gt; Loại tài khoản > Tạo mới</TD>
