...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Công nợ phải trả > Phiếu chi > Tạo mới
        </div>
...
<%// THANH TOAN HOA DON VNĐ			%>
	<%}else{ %>
				...
				<% //Riêng đối tượng chi phí: khác thì cho 10 dòng %>
				<%if(tthdBean.getDoiTuongChiPhiKhac().equals("3")){ %>
                    <TD class="plainlabel" >Thuế VAT (VND) </TD>
			...
			<%} %>
           	...
           	<% if(!tthdBean.getDoiTuongChiPhiKhac().equals("3") && !tthdBean.getDoiTuongChiPhiKhac().equals("4") ){  // ĐỐI TƯỢNG NCC/NV/KH/BP %>
           	<hr> 
