...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý tồn kho > Đổi hàng > Khách hàng đổi hàng > Tạo mới
        </div>
			...
			<hr />
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					<tr class="tbheader">
						...
						<th align="center" width="15%" >Ngày sản xuất</th>
							...
							<tr>
								...
								<td>
									<% if(sp_solo.get(spRs.getString("PK_SEQ")) != null ) { %>
										<input type="text" name="spSOLO" value="<%= sp_solo.get(spRs.getString("PK_SEQ")) %>" style="width: 100%;"  > 
									<% } else { %>
										<input type="text" name="spSOLO" value="" style="width: 100%;"  > 
									<% } %>
								</td>
								<td>
									<% if(sp_nsx.get(spRs.getString("PK_SEQ")) != null ) { %>
										<input type="text" name="spNGAYSANXUAT" value="<%= sp_nsx.get(spRs.getString("PK_SEQ")) %>" style="width: 100%;" class="days" > 
									<% } else { %>
										<input type="text" name="spNGAYSANXUAT" value="" style="width: 100%;" class="days" > 
									<% } %>
								</td>
								<td>
