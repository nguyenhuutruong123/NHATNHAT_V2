...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Phiếu thu tiền > Hien thi
        </div>
                		...
                		String chungloaiCN = hoadon.getChungloai();
	               		...
	               		<%}else{ %>
           	 			...
           	 			<%} %> 
           	 				...
           	 				<td align="center">
           	 					<input type="text" style="width: 60%; text-align: right;" value="<%= formatter.format(Double.parseDouble(hoadon.getThanhtoan().replaceAll(",",""))) %>" name= "thanhtoan" id="thanhtoan<%= i %>"  onchange="ThanhToan(500);" onKeyPress = "return keypress(event);">
