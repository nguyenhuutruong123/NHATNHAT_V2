...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý tồn kho > Đổi hàng > Khách hàng đổi hàng
        </div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle"> Khách hàng đổi hàng </span>&nbsp;&nbsp;
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" style="width: 8%" >Ngày đổi</TH>
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="center"> 
								<% if(tt.equals("0")) { %>
	                                <A href = "../../ErpKhachhangdoihangUpdateSvl?userId=<%=userId%>&update=<%=nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Edit20.png" alt="Cập nhật" title="Cập nhật" border=0></A>&nbsp;
	                              	<A href = "../../ErpKhachhangdoihangSvl?userId=<%=userId%>&delete=<%= nhapkhoRs.getString("PK_SEQ") %>&loaidonhang=<%= obj.getLoaidonhang() %>"><img src="../images/Delete20.png" alt="Xóa" title="Xóa" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn xóa đổi hàng này?')) return false;"></A>&nbsp;								
			                    	<A href = "../../ErpKhachhangdoihangUpdateSvl?userId=<%=userId%>&chot=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Chot.png" title="Chốt" width="20px" border=0  ></A>&nbsp;
			                    <% } else { %>
			                    	<A href = "../../ErpKhachhangdoihangUpdateSvl?userId=<%=userId%>&display=<%=nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" title="Hiển thị" border=0></A>&nbsp;
			                    <% } %>
		                    </TD>
		                </TR>
                     <% m++; } nhapkhoRs.close(); } %>
