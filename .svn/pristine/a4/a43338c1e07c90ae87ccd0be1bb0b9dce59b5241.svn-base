...
import geso.dms.distributor.beans.dondathang.IErpDuyetDdhKhacList;

import java.sql.ResultSet;

public class ErpDuyetDdhKhacList extends Phan_Trang implements IErpDuyetDdhKhacList
{
	...
	public void init(String search)
	{
		...
		{
			query = "select a.PK_SEQ, a.trangthai, a.ngaydonhang, isnull(c.ten, d.ten) as nppTEN, a.loaidonhang, NV.TEN as nguoitao, b.ten as khonhan, a.NGAYSUA, a.NGAYTAO, NV2.TEN as nguoisua, isnull(a.NOTE, '') as NOTE, isnull(SOTIENTHU, 0) as SOTIENTHU, a.hopdong_fk   " +
					...
					"inner join NHANVIEN nv2 on a.NGUOISUA = nv2.PK_SEQ where a.tructhuoc_fk = '" + this.nppId + "' and a.trangthai = '1' ";
		} 		
