...
<script type="text/javascript">
	...
	/*	if (document.forms["frm"]["ddkds"].value == "0") {
			setErrors("Ch?n đ?i di?n kinh doanh");
			return false;
		}
		if (document.forms["frm"]["khachs"].value == "0") {
			setErrors("Ch?n khách hàng");
			return false;
		}
		*/
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../BangKeCongNoKH">
	<input type="hidden" name="action" value='1'>
	<input type="hidden" name="userId" value='<%=userId%>'>
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">bao cao &#62; Báo Cáo Công N? Khách Hàng</div>
				<div align="right" style="padding: 5px" class="tbnavigation">
					Chào m?ng b?n <%= userTen %></div>
			</div>
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					<legend class="legendtitle"> Báo l?i nh?p li?u</legend>
										...
										<tbody id="ShowFields">
											...
											<tr class="tbdarkrow">
												...
												<td align="center"><input name="fieldsHien"
													type="checkbox" value="Ngày Xu?t Bán"></td>
											</tr>
											<tr class="tblightrow">
												<td>S? hóa đơn</td>
												<td align="center"><input name="fieldsHien"
													type="checkbox" value="S? Hóa Đơn"></td>
											</tr>
											<tr class="tbdarkrow">
												<td>T?ng ti?n Hóa Đơn</td>
												<td align="center"><input name="fieldsHien"
													type="checkbox" value="T?ng Ti?n HĐ"></td>
											</tr>
											<tr class="tblightrow">
												<td>Ngày thanh toán</td>
												<td align="center"><input name="fieldsHien"
													type="checkbox" value="Ngày Thanh Toán"></td>
											</tr>
											<tr class="tbdarkrow">
												<td>S? Ti?n Thanh Toán</td>
												<td align="center"><input name="fieldsHien"
													type="checkbox" value="S? Ti?n Thanh Toán"></td>
											</tr>
											<tr class="tblightrow">
												<td>C?n N?/Dư N?</td>
												<td align="center"><input name="fieldsHien"
													type="checkbox" value="C?n N?/Dư N?"></td>
											</tr>											
										</tbody>
									</TABLE>
								</fieldset>
...
<%
 	...
 	if(khachhang != null) khachhang.close();
