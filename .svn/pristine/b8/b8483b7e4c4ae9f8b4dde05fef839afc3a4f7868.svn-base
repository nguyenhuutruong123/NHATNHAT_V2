...
<form name="kmForm" method="post" action="../../KhuyenmaiTTSvl">
...
<input type="hidden" name="ETC" value='<%= xlkm.getETC() %>'>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr height="25px">
		...
		<TD colspan="2" align="right" class="tbnavigation"><%=Utility.GLanguage("Chào mừng bạn",session,jedis) %>   <%= userId %> &nbsp;</TD>
	</tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<TR class="tbdarkrow">
...
<fieldset>
    ...
    <table class="tabledetail" id="content" width="100%" border="0" cellspacing="1" cellpadding="2">
    	<tr class="tbheader">
            ...
            <th width="19%" align="center"><%=Utility.GLanguage("Sản phẩm",session,jedis) %> mua</th>
           							...
           							<% } else {
	       								...
	       								%>	           								
		           							...
		           							<%}%>
	           									...
	           									<input type="hidden" id="<%= ctkm.getId() + "." + trakm2.getId() + ".tongluong" %>" value="<%= Math.round((trakm2.getTongluong() * ctkm.getSoxuatKM()) - 0.5) %>">
