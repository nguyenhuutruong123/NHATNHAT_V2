				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý công nợ > Nộp tiền > Hiển thị
			...
			<TR ><TD >
				<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
					<TR class = "tbdarkrow">
				    	...
				    	<TD align="left" >
				    		<A href="../../NoptienPdfSvl?userId=<%= khBean.getUserId() %>&id=<%= khBean.getId() %>" >
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							<TR>
								...
								<TD width="250" class="plainlabel" colspan="3">
									<INPUT type="text" name="ngaynop" id="ngaynop"  value="<%= khBean.getNgaynop() %>" >
								</TD>							
