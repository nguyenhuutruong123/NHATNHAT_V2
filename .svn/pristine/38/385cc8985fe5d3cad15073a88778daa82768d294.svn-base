...
<input type="hidden" name="action" value='1'>
   ...
   <div id="main" style="width:99%; padding-left:2px">
    ...
    <div align="left" style="width:100%; float:none">
    <fieldset>
    	<legend class="legendtitle"> <%=Utility.GLanguage("Đăng ký trưng bày",session,jedis) %> </legend>
        ...
        <TABLE width="100%" cellpadding="5px" cellspacing="0px">
            ...
            <tr class="plainlabel">
		  		<TD class="plainlabel" ><%=Utility.GLanguage("File duyệt đăng ký",session,jedis) %></TD>
		  	...
		  	<tr class="plainlabel">
		  		<td colspan="2">&nbsp;
					...
					<A class="button2" href="javascript:excel();">
						<img src="../images/excel.gif" alt="Excel" width="24px" title="Excel"><%=Utility.GLanguage("Xuất Excel",session,jedis) %>
					</A>				
		  		</td>
		  	</tr>    				
        </TABLE>
        ...
        <table style="width: 100%" cellpadding="0" cellspacing="1">
        	<Tr class="tbheader">
        		...
        		<td width="7%" ><%=Utility.GLanguage("Mã",session,jedis) %></td>
        		<td width="20%" ><%=Utility.GLanguage("DDKD",session,jedis) %></td>
        		<td width="7%" ><%=Utility.GLanguage("Mã KH",session,jedis) %></td>
        		<td width="20%" ><%=Utility.GLanguage("Tên khách hàng",session,jedis) %></td>
        		<td width="20%"><%=Utility.GLanguage("Chi nhánh/ Nhà PP",session,jedis) %></td>
        		<td width="15%" align="center"><%=Utility.GLanguage("Số suất đăng ký",session,jedis) %></td>
        		<td width="15%" align="center"><%=Utility.GLanguage("Số suất duyệt",session,jedis) %></td>
