...
public class DuyettradonhangList implements IDuyettradonhangList
{
	...
	public void init(String search) 
	{
		...
		if (search.length() == 0)
		{
			...
			query = query + " where a.trangthai in (1, 3) and a.donhang_fk is not null order by a.pk_seq desc";
