...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:50%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Chuyển kho > Tạo mới
        </div>
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle">Phiếu chuyển kho </legend>
        	
        	<div style="float:none; width:100%" align="left">
            	<table width="100%" cellspacing="0" cellpadding="6px">
                    <tr>
                    	<td class="plainlabel" width="20%" valign="middle">Ngày chuyển</td>
                    	<td class="plainlabel">
                    ...
                    <tr>
           				<td class="plainlabel"><%=Utility.GLanguage("NHÂN VIÊN BÁN HÀNG",session,jedis) %><FONT class="erroralert"> *</FONT></td> 
                        <td class="plainlabel">
                    ...
                    <tr>
           				<td class="plainlabel">Kho chuyển<FONT class="erroralert"> *</FONT></td> 
                        <td class="plainlabel">
                 ...
                 <table width="100%" cellpadding="0px" cellspacing="1px">
                 	<tr>
                        ...
                        <th class="tbheader" align="center" width="10%">Số lượng chuyển</th>
                        <th class="tbheader" align="center" width="10%">Số lô</th>
                    </tr>
	                    		...
	                    		<a href="" id="scheme_<%= spRs.getString("spId") %>" rel="subcontent_<%= spRs.getString("spId") %>">
				                    ...
				                    <table width="95%" align="center">
			                        		...
			                        		if(soloRs != null)
			                        		{
			                        			...
			                        			<tr>
			                        				...
			                        				<% if(sp_sl.get( spRs.getString("spId") + "__" + soloRs.getString("SOLO") ) != null ) { %>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= spRs.getString("spId") %>_spSOLUONG" value="<%= formatter.format(Double.parseDouble( spRs.getString("spId") )) %>" onkeyup="Dinhdang(this);" >
			                        				<% } else { %>
				                     ...
				                     <div align="right">
				                     	...
				                     	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                     	<a href="javascript:dropdowncontent.hidediv('subcontent_<%= spRs.getString("spId") %>')" > Đóng lại </a>
				                     </div>
					            </DIV> 
