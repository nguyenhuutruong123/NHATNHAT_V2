...
public class MucchietkhauUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(!cutil.check(userId, userTen, sum)){
	        ...
	        String nextJSP = request.getContextPath() + "/pages/Distributor/MucChietKhauUpdate.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
	    ...
	    if (!error){
	    	if(action.equals("save"))
	    	{
	    		...
	    		String nextJSP;
	    		if (id == null){			
	    			nextJSP = request.getContextPath() + "/pages/Distributor/MucChietKhauNew.jsp";
	    		}else{
	    			nextJSP = request.getContextPath() + "/pages/Distributor/MucChietKhauUpdate.jsp";   						
	    		}
	    		response.sendRedirect(nextJSP);	    	
	    	}
	    }
