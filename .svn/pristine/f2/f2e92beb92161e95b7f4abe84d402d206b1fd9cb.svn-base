        ...
        <div style="width:100%; float:none" align="left">
                ...
                <TABLE width="100%" cellpadding="4" cellspacing="0">								
                    ...
                    <%} %>
                        ...
                        <%-- <TD class="plainlabel" width="120px"  >Loại chương trình </TD>
                        ...
                        <TD class="plainlabel" width="120px"  ><%=Utility.GLanguage("Kho nhận",session,jedis) %> </TD>
                        <TD class="plainlabel"  >
                       ...
                       <%--  <TD class="plainlabel" width="120px"  >CT Trưng bày </TD>
                        <TD class="plainlabel"  >
                            <select name="cttbId" >
                            <option value="" ></option>
                            <% while(cttbRs.next()) 
                     ...
                     <% if(ctkmBean.getType().equals("3")) {%>
					  <TR>
                        ...
                        <TD class="plainlabel" ><%=Utility.GLanguage("Ngày tính doanh số",session,jedis) %>:&nbsp;&nbsp;&nbsp;&nbsp;<%=Utility.GLanguage("Từ ngày",session,jedis) %>y</TD>
                        <TD class="plainlabel" colspan="3" >
                            <input type="text" size="10" class="days" 
			...
			<br />
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" colspan="3" >
                            ...
                            <%}else{ %>
                            	<input type="radio" name="loains" value = "1"  id="apphanbo" ><%=Utility.GLanguage("Áp phân bổ",session,jedis) %> &nbsp;&nbsp;
                        ...
                        <TD class="plainlabel" colspan="3" >
                            ...
                            <!-- 	<input type="radio" name="loains" value = "1" checked = "checked" id="apphanbo" >Áp phân bổ &nbsp;&nbsp; -->
                            	<input type="radio" name="loains" value = "0"  id="khonggh" checked="checked" >Không giới hạn ngân sách
                            <%}else{ %>
                   ...
                   <%--      <TD class="plainlabel">Loại áp dụng</TD>
                        ...
                        <TD class="plainlabel" colspan="5" >
                         <% if (ctkmBean.getAp_dung_npp().equals("1")){ %> 
                        	...
                        	<% } else { %>
                        		<input type="checkbox" name="sanphamdautien"   value="0" ><i><%=Utility.GLanguage("Áp dụng KH lần đầu mua SP",session,jedis) %></i>
                        	 <% }  %> 	
                        	 </br>
                        ...
                        <% if (ctkmBean.getPhanbomucTDV().equals("1")){ %> 
                           ...
                           <%--   <% if (ctkmBean.getApdungchoDHLe().equals("1")){ %> 
                        	...
                        	<%-- <% if (ctkmBean.getXuatHDCoVAT().equals("1")){ %> 
                        		<input type="checkbox" name="xuatHDCoVAT"  value="1" checked="checked"><i> Xuất hóa đơn có VAT</i>
                        	<% } else { %>
                        		<input type="checkbox" name="xuatHDCoVAT"   value="1" ><i> Xuất hóa đơn có VAT</i>
                        	 <% }  %> 
                        	...
                        	<% } else { %>
                        		<input type="checkbox" name="PHANBOTHEODH" value="0" onchange="submitform()" ><i> <%=Utility.GLanguage("Phân bổ ngân sách theo số suất",session,jedis) %></i>
                        		</br>
                        	 ...
                        	 if (ctkmBean.getInchung().equals("1")){ %> 
                        		<input type="checkbox" name="inchung"  value="1" checked="checked"><i> In chung hóa đơn hàng bán</i>
                        	<% } else { %>
                        		<input type="checkbox" name="inchung"   value="1" ><i>In chung hóa đơn hàng bán</i>
                        	 <% }  %>  --%>
	                        ...
	                        <TD align="center">
				                ...
				                <div style='display:none'>
			                        <div id='dieukienkhuyenmai<%= i %>' style='padding:0px 5px; background:#fff;'>
			                        	<h4 align="left"><%=Utility.GLanguage("Tạo mới",session,jedis) %> điều kiện khuyến mại</h4>
				                ...
				                <div style='display:none'>
			                        <div id='trakhuyenmai<%= j %>' style='padding:0px 5px; background:#fff;'>
										...
										<table cellpadding="4px" cellspacing="2px" width="100%" align="center">
			                                ...
			                                <tr>
			                                	<td  align="left" colspan="2">
			                                		<input type="checkbox" name="trakhuyenmai<%= j %>.tinhtheothung" id="trakhuyenmai<%= j %>.tinhtheothung"  value='1' > <span style="font-style: italic;">Số lượng tính theo thùng</span> 
			                                	</td>
			                                </tr>
			                                <tr>
			                                	<td colspan="2">
