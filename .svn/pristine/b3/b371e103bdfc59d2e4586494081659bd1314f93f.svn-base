...
<div id="main" style="width:100%">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kế toán &gt; Nhân viên công ty &gt; Hiển thị
        </div>
								...
								<LEGEND class="legendtitle">Nhân viên công ty</LEGEND>
									<TABLE class="tblight" width="100%" cellpadding="6" cellspacing = "0">
										<TR>
										  ...
										  <TD  class="plainlabel" ><INPUT name="ma" type="text" size="40" value="<%=obj.getMa() %>" ></TD>
										</TR>

										<TR>
											<TD width="15%" class="plainlabel" >Họ tên </TD>
										  <TD  class="plainlabel" ><INPUT name="ten" type="text" size="40" value="<%=obj.getTen()%>" ></TD>
										</TR>
										<TR>
					                    ...
					                    <TR>
										  ...
										  <TD  class="plainlabel" >
										 	<SELECT class="select2" name = "tkktId" style="width: 200px;">
														<OPTION VALUE = "">&nbsp;</OPTION>
										<% 
										tkktRs.beforeFirst();
										if (tkktRs != null){
										...
										<TR>
										  ...
										  <TD  class="plainlabel" >
										 	<SELECT class="select2" name = "tkduId" style="width: 200px;">
														<OPTION VALUE = "">&nbsp;</OPTION>
										<%
										tkktRs.beforeFirst();
