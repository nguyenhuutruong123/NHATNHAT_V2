...
import geso.dms.distributor.beans.thutienNPP.IErpThutienKhNPPList;
import geso.dms.distributor.beans.thutienNPP.imp.ErpThutienKhNPP;
import geso.dms.distributor.beans.thutienNPP.imp.ErpThutienKhNPPList;
...
public class ErpThutienKhNPPSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
       
    public ErpThutienKhNPPSvl() {
        super();
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		IErpThutienKhNPPList obj;
	    ...
	    else
	    {
	    	...
	    	{
				IErpThutienKhNPP tthd = new ErpThutienKhNPP(tthdId);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    {
	    	IErpThutienKhNPP tthdBean = new ErpThutienKhNPP();
	    ...
	    else
	    {
	    	if(action.equals("view") || action.equals("next") || action.equals("prev"))
	    	{
		    	...
		    	session.setAttribute("obj", obj);
		    	response.sendRedirect(request.getContextPath() + "/pages/Distributor/ErpThuTienKhNPP.jsp");	
		    }
	    	else if (action.equals("excel"))
	 	    {
	    		obj = (IErpThutienKhNPPList) new ErpThutienKhNPPList();	 	    	
	 		    obj.setCtyId(ctyId);	 		    
	 		   // String search = getSearchQuery(request, obj);
	...
	private String getQueryExcelThuTien(HttpServletRequest request, String pages, String soDong, IErpThutienKhNPPList obj)
	{    	
	...
	private String getQueryExcelThuTienHoaDon(HttpServletRequest request, String pages, String soDong, IErpThutienKhNPPList obj)
	{    	
    	String query =  
	...
	private String getSearchQuery(HttpServletRequest request, IErpThutienKhNPPList obj)
	{
		Utility util = new Utility();
/*	String 	query =  
		...
		String query =
			 " select distinct a.pk_seq as tthdId, a.trangthai, a.ngaychungtu,  a.ngaytao, a.ngaysua, isnull(noptienids, '') as noptienids, \n" + 
			 " d.ten as nguoitao, e.ten as nguoisua,  isnull(a.SOTIENTHU,0) AS THUCTHU, a.CONLAI AS SOTIENCONLAI, isnull(tennguoinop, '') as tennguoinop, \n" +
			 "        ISNULL(   (Select distinct KH.MAFAST + ' - ' + KH.TEN  + ',' AS [text()]  \n"+
		  	 "           From ERP_THUTIENNPP_HOADON K1 inner join KHACHHANG KH on K1.KHACHHANG_FK = Kh.PK_SEQ \n"+
		  	 "           Where K1.THUTIENNPP_FK = a.PK_SEQ  and isnull(a.NOPTIENIDS,'') = '' \n"+
		  	 "           For XML PATH ('') ) , '' ) as khachhangs  \n"+ 
			...
			" where a.pk_seq > 0 and a.noidungtt_fk = 100001 \n";
	...
	private String Delete(String tthdId)
	{
		...
		try 
		{
			...
			db.update("update ERP_THUTIENNPP set trangthai='2'  where PK_SEQ = '" + tthdId + "'");			
