		...
		<TD colspan="4" align='left' valign='top' bgcolor="#ffffff">
			...
			<TABLE width="100%" border="0" cellpadding="3" cellspacing="0">
				<TR ><TD >
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									<TD width="30" align="left"><A href="../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"PhuongxaSvl?userId="+userId)%>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									...
									<TR>
								    <TD width="20%" class="plainlabel"><%=Utility.GLanguage("Tỉnh thành",session,jedis) %><FONT class="erroralert"> *</FONT></TD>
									...
									<TR>
										<TD width="20%" class="plainlabel"><%=Utility.GLanguage("Quận huyện",session,jedis) %><FONT class="erroralert"> *</FONT></TD>
