		...
		// Analyze the servlet exception       
	      ...
	      else if (statusCode != null)
	      {
	    	 ...
	    	 /* String table = "<table width='99%' border='0' cellspacing='0' cellpadding='0' style='padding-left:2px;' >" +
	    	  					...
	    	  					"</tr>" +
	    	  					"<tr>" +
	    	  						"<td style='vertical-align:top;' width='410px'><img src='/HADIPHAR/pages/images/Loi1.png' /><br />" +
	    	  						 									"<img src='/HADIPHAR/pages/images/Loi2.png' /></td>" +
	    	  						 "<td style='vertical-align:top;' ><img src='/HADIPHAR/pages/images/404.jpg' /></td>" +
	    	  					"</tr>";*/
	    	   ...
	    	   String table = "<table width='99%' border='0' cellspacing='0' cellpadding='0' style='padding-left:2px;' >" +
								...
								"</tr>" +
								"<tr>" +
									 "<td style='vertical-align:top;' ><img src='/NHATNHAT/pages/images/404.jpg' /></td>" +
								"</tr>";
