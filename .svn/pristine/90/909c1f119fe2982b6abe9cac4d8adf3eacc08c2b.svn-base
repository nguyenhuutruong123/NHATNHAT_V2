						...
						<TR>
							<TD height="100%" width="100%">
								<FIELDSET>
									...
									<TR> 
									<TD class="plainlabel" colspan="1"><%=Utility.GLanguage("Tên cửa hiệu",session,jedis) %> <FONT
								...
								<!-- 	<TD class="plainlabel" colspan="1">Nhóm khách hàng </TD>
									...
									<TR>
									<TD class="plainlabel" colspan="1"><%=Utility.GLanguage("Người mua hàng",session,jedis) %><FONT
												class="erroralert"> *</FONT></TD>
											<TD class="plainlabel" colspan="1"><INPUT type="text"
									...
									<TR>
									<TD class="plainlabel" colspan="1"><%=Utility.GLanguage("Số nhà",session,jedis) %> <FONT
												class="erroralert"> *</FONT></TD>
									<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="sonha" id="sonha" value = "<%=khBean.getSonha()%>"></TD>
									<TD class="plainlabel" colspan="1"><%=Utility.GLanguage("Tên đường",session,jedis) %> <FONT
												class="erroralert"> *</FONT></TD>
									<TD class="plainlabel" colspan="1"><INPUT type="text"
							...
							<TR>
									...
									<%-- 	<TR>
										...
										<TR  style="vertical-align: top;">										
											...
											<TD class="plainlabel"><img src="<%=getServletContext().getInitParameter("pathhinhJSP")+"AnhDaiDien/"+khBean.getAnh(0) %>" alt="Ảnh 1" width="100" height="100" onclick="window.open('<%=getServletContext().getInitParameter("pathhinhJSP")+"AnhDaiDien/"+khBean.getAnh(0) %>', '_blank');"/></TD>
											<TD class="plainlabel">Ảnh 2</TD>
											<TD class="plainlabel" ><img src="<%=getServletContext().getInitParameter("pathhinhJSP")+"AnhDaiDien/"+khBean.getAnh(1) %>" alt="Ảnh 2" width="100" height="100" onclick="window.open('<%=getServletContext().getInitParameter("pathhinhJSP")+"AnhDaiDien/"+khBean.getAnh(1) %>', '_blank');"/></TD>
											<TD class="plainlabel" >Ảnh đại diện</TD>
											<TD class="plainlabel" ><img src="<%=getServletContext().getInitParameter("pathhinhJSP")+"AnhDaiDien/"+khBean.getTenAnhDaiDien() %>" alt="Ảnh đại diện" width="100" height="100" onclick="window.open('<%=getServletContext().getInitParameter("pathhinhJSP")+"AnhDaiDien/"+khBean.getTenAnhDaiDien() %>', '_blank');"/></TD>>
										</TR>
										
										<TR style="vertical-align: top;">										
											<TD class="plainlabel">Ảnh 3</TD>
											<TD class="plainlabel"><img src="<%=getServletContext().getInitParameter("pathhinhJSP")+"AnhDaiDien/"+khBean.getAnh(2) %>" alt="Ảnh 3" width="100" height="100" onclick="window.open('<%=getServletContext().getInitParameter("pathhinhJSP")+"AnhDaiDien/"+khBean.getAnh(2) %>', '_blank');"/></TD>
											<TD class="plainlabel">Ảnh 4</TD>
											<TD class="plainlabel" ><img src="<%=getServletContext().getInitParameter("pathhinhJSP")+"AnhDaiDien/"+khBean.getAnh(3) %>" alt="Ảnh 4" width="100" height="100" onclick="window.open('<%=getServletContext().getInitParameter("pathhinhJSP")+"AnhDaiDien/"+khBean.getAnh(3) %>', '_blank');"/></TD>
