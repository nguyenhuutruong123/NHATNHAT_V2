...
import geso.dms.distributor.beans.thanhtoanhoadon.*;
import geso.dms.distributor.beans.thanhtoanhoadon.imp.*;
...
public class ErpTTHoadonUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String sum = (String) session.getAttribute("sum");		
		{
	        ...
	        if(request.getQueryString().indexOf("display") >= 0 ) 
	        {
	        	...
	        	nextJSP = request.getContextPath() + "/pages/Distributor/ErpThanhToanHoaDonDisplay.jsp";
	        }
	        else
	        {
	        	tthdBean.init();
	        	nextJSP = request.getContextPath() + "/pages/Distributor/ErpThanhToanHoaDonUpdate.jsp";
	        }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		
		{
	    	...
	    	System.out.println("Dinh khoan noId: " + dinhkhoanno);
	    	...
	    	System.out.println("matendoituongdinhkhoan:"+matendoituongdinhkhoan);
	    	...
	    	System.out.println("tienhang_VAT = "+ tienhang_VAT +", thuesuat_VAT = "+thuesuat_VAT +", tienthue_VAT = "+tienthue_VAT);
			...
			{	
				...
				else
				{
					if(!tthdBean.updateTTHD())
					{
						...
						session.setAttribute("tthdBean", tthdBean);
						String nextJSP = request.getContextPath() + "/pages/Distributor/ErpThanhToanHoaDonUpdate.jsp";
						response.sendRedirect(nextJSP);
					}
					else
					{
				...
				if (id == null){
					nextJSP = request.getContextPath() + "/pages/Distributor/ErpThanhToanHoaDonNew.jsp";
				}
				else{
					nextJSP = request.getContextPath() + "/pages/Distributor/ErpThanhToanHoaDonUpdate.jsp";   						
				}
