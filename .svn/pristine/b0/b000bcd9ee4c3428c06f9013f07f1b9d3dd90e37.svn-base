...
<form name="khtt" method="post" action="../../BCChartViengthamSvl">
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR height="22">
								<TD align="left" colspan="2" class="tbnavigation">&nbsp;Báo cáo quản trị > Báo cáo chart > Báo cáo viếng thăm </TD>
			...
			<TABLE width="100%" cellpadding="0" cellspacing="1">
						...
						<TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
							<TR>
								...
								<TR>
									...
									<TD class="plainlabel" style="width :100px" >Theo mức </TD>
									<TD class="plainlabel"  >
										<select name="theomuc" id = "theomuc" style="width: 150px" >
										<% if( obj.getTheomuc().equals("0") ) { %>
											<option value="0" selected="selected" >Công ty</option>
										<% } else { %>
										...
										<% if( obj.getTheomuc().equals("2") ) { %>
											<option value="2" selected="selected" ><%=Utility.GLanguage("NHÂN VIÊN BÁN HÀNG",session,jedis) %></option>
										<% } else { %>
											<option value="2" ><%=Utility.GLanguage("NHÂN VIÊN BÁN HÀNG",session,jedis) %></option>
										<% } %>
										</select>
									</TD>
				...
				<TR>
					<TD width="100%">
						...
						<FIELDSET>
							<LEGEND class="legendtitle">&nbsp;Báo cáo viếng thăm &nbsp;&nbsp;
