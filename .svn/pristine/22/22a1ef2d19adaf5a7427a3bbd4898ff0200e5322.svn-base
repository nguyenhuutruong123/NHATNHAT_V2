...
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
			...
			<TR>
				<TD align="left" class="tbnavigation">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr height="22">
   							<TD align="left" colspan="2" class="tbnavigation">&nbsp;Xử lý đơn hàng > Đơn hàng thu hồi</TD>
	...
	<img style="top: -4px;" src="../images/button.png" ><%=Utility.GLanguage("Nhập lại",session,jedis) %></a>&nbsp;&nbsp;&nbsp;&nbsp;	
							<!--  
