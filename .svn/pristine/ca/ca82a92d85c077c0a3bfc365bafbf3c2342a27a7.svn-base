	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{	
        	...
        	String selecteddiem = dkkm.isTheothung() == 2 ? "selected" :"";
              ...
              table+= 	"  <tr>" +
              			...
              			"				 <option value=\"0\"  "+selectedChuan+" >đơn vị chuẩn</option> "	+
              			"				 <option value=\"1\"  "+selectedthung+">Đơn vị thùng</option> "	+
              			"				 <option value=\"2\"  "+selecteddiem+">Điểm</option> "	+
              			"			</select> " +	
            			"		</td>"+
                "</tr>"+
                "<tr>"+
		...
		}else if(type.equals("AjaxTraKM"))
		{
          ...
          table+=
            ...
            "        			<option value=\"4\">Trả tiền theo điểm</option> ";
            ...
            "        			<option value=\"4\">Trả tiền theo điểm</option> ";
                                ...
                                "        			<option value=\"3\">Trả sản phẩm</option> "+
                                "        			<option value=\"1\">Trả tiền</option> "+
                                "        			<option value=\"4\" selected>Trả tiền theo điểm</option> ";
                    		}else {
             table+=      			
