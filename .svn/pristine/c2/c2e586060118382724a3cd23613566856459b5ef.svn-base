...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý công nợ > Bù trừ công nợ KH > Tạo mới
        </div>
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle"> Bù trừ công nợ KH </legend>       	
                ...
                <TR>
               	<TD class="plainlabel"><%=Utility.GLanguage("NHÂN VIÊN BÁN HÀNG",session,jedis) %></TD>
					...
					<TD class="plainlabel">
						...
						<input name="ckKh" id="ckKh" type="checkbox" value ="1" checked onChange = "submitform();" >
						 <%} else {%>
						<input name="ckKh" id="ckKh" type="checkbox" value ="1" onChange = "submitform();">
						<%} %> 
					</TD>
             ...
             <div id="xoanokh" align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
	             <table width="100%" border="0" cellspacing="1" cellpadding="1">
	                    ...
	                    {	
							...
							double duno = Float.parseFloat(HdDuno[i].trim().length() <= 0 ? "0" : HdDuno[i]);
							if(duno > 0 )
							{
						...
						<TR>
							...
							<TD align="right">								
								<input type="text" name="hdghino1" id="hdghino1" readonly="readonly" style="width: 100%; text-align:right" value="<%= _GHINO[i] %>"  onChange="ThanhToan( <%= i  %> );" onkeypress="return keypress(event);" > <!-- Ghi nợ -->
							</TD>
							<TD align="right">								
								<input type="text"  name="hdghico1" id="hdghino1" readonly="readonly"  style="width: 100%; text-align:right" value="<%= _GHICO[i] %>"  onChange="ThanhToan( <%= i  %> );" onkeypress="return keypress(event);" > <!-- Ghi có -->
							</TD>
					   ...
					   <% 
					   System.out.println("vao day nnnnn");
	                    int n = 0;
	                    int stt=1;
	                    if(hdKhid != null )
	                    {	 System.out.println("vao day nnnnn1");
	                    	int k =  hdKhid.length;
	                    	String[] _NO=new String[k];
							String[] _CO=new String[k];
							String[] _GHINO = new String[k];
