...
<form name="hctmhForm" method="post" action="../../ErpDenghidoihangUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý kho trung tâm > Duyệt đề nghị đổi hàng > Cập nhật
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
        ...
        <span id="btnSave">
	        <A href="javascript:saveform()" >
	        	<IMG src="../images/Save30.png" title="Lưu thông tin" border ="1px" style="border-style:outset"></A>
        </span>
        <span id="btnDuyet">
	        <A href="javascript:duyetform()" >
	        	<IMG src="../images/Chot.png" title="Duyệt đổi hàng" border ="1px" style="border-style:outset"></A>
        </span>
    </div>
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle">Duyệt đề nghị đổi hàng </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                    ...
                    <TD class="plainlabel" >Kho NPP đổi hàng </TD>
                    <TD class="plainlabel"  >
                ...
                <TR>
                    <TD class="plainlabel" >Kho TT đổi hàng </TD>
                    <TD class="plainlabel" >
                    ...
                    <TD class="plainlabel" >Kho TT nhận hàng </TD>
                    <TD class="plainlabel" >
                    	<select name = "khottNhanId" class="select2" style="width: 200px" disabled="disabled" >
                        	<option value="100016" >Kho hàng hỏng</option>
                    	</select>
                    </TD>         	
                </TR>
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					<tr class="tbheader">
						...
						<th align="center" width="15%" >Số lượng / Số tiền duyệt</th>
					...
					<%
						if(spRs != null)
						{
							...
							<tr>
								...
								<td><input type="text" name="spSOLO" value="<%= spRs.getString("SOLO") %>" readonly="readonly" style="width: 100%;" > </td>
