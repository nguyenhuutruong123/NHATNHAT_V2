...
public class AjaxTaoTCMoi extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String nhomtc = request.getParameter("nhomtc");
		String tctId = request.getParameter("id");
	...
	private String createTCMoi(String tctId, String diengiai, String nhomtc, String nguoitao)
	{
		...
		try 
		{
			...
			query = 
				"INSERT INTO TIEUCHITHUONG_CHITIET (noidungDDKD,noidungNpp,TIEUCHITINHTHUONG_FK, DIENGIAI, TIEUCHI, NOIDUNG, NGUOISUA, NGAYSUA, TOITHIEU, TOIDA, NHOMSP_FK, THUONG, DSTOITHIEUDH, LOAI, LOAIDS, LOAINVBH) " +
				"SELECT '"+ noidung.substring(0, noidung.length()-1) +"','"+ noidung.substring(0, noidung.length()-1) +"','"+ tctId +"' AS TIEUCHITINHTHUONG_FK, N'"+ diengiai +"' AS DIENGIAI, '"+ tieuchi +"' AS TIEUCHI, '"+ noidung.substring(0, noidung.length()-1) +"' AS NOIDUNG, '"+ nguoitao +"' AS NGUOISUA, '"+ this.getDateTime() +"' AS NGAYSUA, " +
