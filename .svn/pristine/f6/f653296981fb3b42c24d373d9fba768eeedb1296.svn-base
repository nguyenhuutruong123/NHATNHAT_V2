...
<form name="rpForm" method="post" action="../../DailySecondarySalesTTSvl">
				...
				<TR>
					<TD width="100%" align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <TD align="left" colspan="2" class="tbnavigation">&nbsp;Báo cáo quản trị &gt; Doanh số &gt; Bán hàng hằng ngày</TD>
