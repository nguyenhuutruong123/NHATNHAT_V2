...
public class TieuchithuongTBUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/SGP/pages/Center/TieuChiThuongTBUpdate.jsp";
        if(querystring.indexOf("display") >= 0)
        	nextJSP = "/SGP/pages/Center/TieuChiThuongTBDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
 		...
 		{    
    		if (id == null )
    		{
    			if (!tctskuBean.createTctSKU())
    			{
    				...
    				String nextJSP = "/SGP/pages/Center/TieuChiThuongTBNew.jsp";
    				response.sendRedirect(nextJSP);
    			}
    			else
    			{
		...
		{		
			...
			String nextJSP;
			if (id == null){
				nextJSP = "/SGP/pages/Center/TieuChiThuongTBNew.jsp";
			}
			else{
				nextJSP = "/SGP/pages/Center/TieuChiThuongTBUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);
		}
	}
