				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Kinh doanh > Tiêu chí thưởng SKU tập trung > Hiển thị</TD> 
				...
				<TR>
				  <TD height="100%" width="100%">
						  ...
						  <TR>
						  	  	...
						  	  	<TD class="plainlabel" colspan="3">
						  	  		<% if(obj.getIsthung().equals("1")){ %>
						  	  			<input type="checkbox" name="IsThung" value="1" checked="checked"> Số lượng tính theo thùng
						  	  		<%} else { %> 
						  	  			<input type="checkbox" name="IsThung" value="1" > Số lượng tính theo thùng
						  	  		<% } %> 
						  	  	</TD>
						  </TR>
                    ...
                    <TR class="tbheader">
                        ...
                        <TH align="left" width="15%"><%=Utility.GLanguage("Diễn giải",session,jedis) %> </TH>
	                        ...
	                        <TD align="center">
				                ...
				                <div style='display:none'>
			                        <div id='nhomsanpham<%= i %>' style='padding:0px 5px; background:#fff;'>
			                        	<h4 align="left"><%=Utility.GLanguage("Tạo mới",session,jedis) %> nhóm sản phẩm thưởng</h4>
										<table cellpadding="4px" cellspacing="2px" width="100%" align="center">
			                            	<tr>
			                                	<td width="150px" valign="top" align="left"><span style="font-size: 12px"><%=Utility.GLanguage("Diễn giải",session,jedis) %></span></td>
