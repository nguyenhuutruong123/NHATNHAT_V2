...
<%@page import="geso.dms.center.beans.report.IBangKeHoaDonCNSpList"%>
...
<%
	...
	IBangKeHoaDonCNSpList obj = (IBangKeHoaDonCNSpList) session.getAttribute("obj");
	...
	String url="";
	url = util.getUrl("BangKeHoaDonSpCNTTSvl","");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="ckParkForm" method="post" action="../../BangKeHoaDonSpCNTTSvl">
			...
			<div align="left"
				...
				<%
					...
					while(totalRs!=null && totalRs.next())
					{
						...
						DoanhSo=totalRs.getDouble("DOANHSO");
						DoanhThu=totalRs.getDouble("DOANHSOTRUTRALAI");
					}
					...
					<TR>
						<TD class="plainlabel" colspan="6"></TD>
								<TR>
									...
									<td class="plainlabel"><input type="text" name="ds" size="6" value="<%= formatter.format(DoanhSo   ) %>"></td>
									<TD class="plainlabel" >DOANH SỐ TRỪ TRẢ LẠI</TD>
									<td class="plainlabel"><input type="text" name="dt" size="6" value="<%= formatter.format(  DoanhThu) %>"></td>
					...
					<TR>
						<TD class="plainlabel" colspan="6">
								<a class="button2" href="javascript:search();" style="height: 26px; margin-left : 10px;"> 
									<img style="top: -4px;" src="../images/button.png" alt=""> <%=Utility.GLanguage("Tìm kiếm",session,jedis) %></a>
							<a class="button2" href="javascript:xuatExcel();" style="height: 26px; margin-left : 10px;"> 
		...
		<div id="tabKM" class="tab_content">
											...
											<table class="table table-bordered table-extra" style="width : 100%; margin : 2px;">
												<TR class="plainlabel" valign="bottom">
													...
													<th  width="7%" align="center">Đơn vị tính</th>
													<th  width="5%" align="center">Miền</th>
													<th  width="5%" align="center">Địa bàn</th>
													<th  width="17%" align="center">CN/DT</th>
													<th  width="3%"  align="center">Số lượng</th>
													<th  width="8%" align="center">Đơn giá</th>
													<!-- <th  width="8%" align="right"> DOANH THU </th>
													<th  width="8%" align="right">THUẾ GTGT</th>
													<th  width="8%" align="right"> TỔNG TIỀN</th> -->
													
													<th  width="8%" align="center">Doanh số</th>
													<th  width="8%" align="center">DS trừ trả lại</th>
												</TR>
												...
												if(hdRs!=null){
													try{
														...
														<%}%>
															...
															<Td align="left"><%=hdRs.getString("vung") %></Td>
															<Td align="left"><%=hdRs.getString("diaban") %></Td>
															<Td align="left"><%=hdRs.getString("tennpp") %></Td>
															...
															<Td align="right"><%= formatter_Gia.format(dongia) %></Td>
															<Td align="right"><%= formatter.format(hdRs.getDouble("DOANHSO")) %></Td>
															<Td align="right"><%= formatter.format(hdRs.getDouble("DOANHSOTRUTRALAI")) %></Td>
												<% m++;}}catch(Exception e){}} %>
												</TR>
												<tr class="tbfooter">
