...
<% 
	...
	String url = util.getUrl("VungmienSvl", "");
%>
			  	...
			  	<TR>
					<TD align="left" colspan="4" class="legendtitle">
				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
								<LEGEND class="legendtitle"><%=Utility.GLanguage("Thông tin vùng miền",session,jedis) %>
								</LEGEND>
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									<TR>
									  <TD width="15%" class="plainlabel" ><%=Utility.GLanguage("Vùng miền",session,jedis) %>  <FONT class="erroralert">*</FONT></TD>
