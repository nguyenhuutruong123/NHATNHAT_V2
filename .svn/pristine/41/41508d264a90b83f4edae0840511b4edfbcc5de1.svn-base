...
<% 
   ...
   String url = util.getChuyenNguUrl("StockInTransit", "",session);
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../StockInTransit">
	...
	<input type="hidden" name="userId" value='<%=userId%>'>
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle"><%=Utility.GLanguage("Hàng chưa nhập kho",session,jedis) %></legend>
