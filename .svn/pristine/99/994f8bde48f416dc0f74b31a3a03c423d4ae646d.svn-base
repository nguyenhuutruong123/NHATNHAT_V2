...
//	    PrintWriter out = response.getWriter();
		...
		String sku = util.ValidateParam(request.getParameter("sku"));
    	if (sku == null)
    		sku = "";
    	this.sku = sku.split("-")[0].trim();
    	
    	String tungay = util.ValidateParam(request.getParameter("tungay"));
    	if (tungay == null)
    		tungay = "";    	
    	this.tungay = tungay;

    	String denngay = util.ValidateParam(request.getParameter("denngay"));
    	if (denngay == null)
    		denngay = "";    	
    	this.denngay = denngay;
    	   	
    	String trangthai = util.ValidateParam(request.getParameter("trangthai"));   	
    	if (trangthai == null)
    		trangthai = "";    	
