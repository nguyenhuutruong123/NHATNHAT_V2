	                    	...
	                    	<td align="center" >
	                    		...
	                    		<a href="" id="scheme_<%= spRs.getString("spId") %>" rel="subcontent_<%= spRs.getString("spId") %>">
				                    ...
				                    <table width="95%" align="center">
		                            	...
		                            	<%
		                            		ResultSet soloRs = pxkBean.getSoloTheoSp(spRs.getString("spId"), spRs.getString("avaiNVBH"));
			                        		if(soloRs != null)
			                        		{
			                        			while(soloRs.next())
			                        			{
			                        			...
			                        			<tr>
			                        				...
			                        				<% } else { %>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= spRs.getString("spId") %>_spSOLUONG" value="<%= formatter.format(soloRs.getDouble("AVAILABLE")) %>" onkeyup="Dinhdang(this);" >
			                        				<% } %>
			                        				</td>
			                        				<td>
