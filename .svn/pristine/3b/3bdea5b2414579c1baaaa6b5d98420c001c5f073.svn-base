				...
				<fieldset>
					...
					<div style="width: 100%; float: none" align="left" class="plainlabel">
							...
							<TR>
								...
								<TR>
									<TD class="plainlabel"><%=Utility.GLanguage("Nhà phân phối",session,jedis) %> chuyển </TD>
									<TD class="plainlabel" > 
									...
									<TD class="plainlabel"><%=Utility.GLanguage("Nhà phân phối",session,jedis) %> thay thế</TD>
									<TD class="plainlabel">
								...
								<TR>
									...
									<TD class="plainlabel">Ngày khóa sổ</TD>
									<TD class="plainlabel" > 
