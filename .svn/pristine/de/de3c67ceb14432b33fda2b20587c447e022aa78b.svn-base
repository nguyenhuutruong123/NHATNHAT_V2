...
<form name="ckForm" method="post" action="../../TrahangSvl">
	...
	<TR>
			...
			<TR>
				<TD align="left" class="tbnavigation">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr height="22">
   							<TD align="left" width="50%" class="tbnavigation">&nbsp;Quản lý tồn kho > Trả hàng</TD>
		...
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
			<TR>
					<TD width="100%"> 
					<FIELDSET>
					<LEGEND class="legendtitle">Trả hàng &nbsp;&nbsp;&nbsp;&nbsp;
							...
							<TD>
								<TABLE width="100%" border="0" cellspacing="1" cellpadding="2">
									<TR class="tbheader">
											...
											<TH align="center" width="8%">Ngày trả</TH>
									...
									{ 
										...
										<TD align="center" valign="middle">
											<% if(ckRs.getString("trangthai").equals("0")) {%>
												...
												<A href = "../../TrahangSvl?userId=<%=userId%>&delete=<%= ckRs.getString("pk_seq") %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa phiếu chuyển kho này?')) return false;"></A>&nbsp;
												<A href = "../../TrahangSvl?userId=<%=userId%>&chotphieu=<%= ckRs.getString("pk_seq") %>" > <img src="../images/Chot.png" alt="Chot phieu chuyen" width="20" height="20" longdesc="Chot phieu chuyen" border = 0 onclick="if(!confirm('Bạn có muốn chốt phiếu chuyển kho này?')) return false; "></A>
											<%}else{ %>
