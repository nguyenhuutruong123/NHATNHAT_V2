...
<form name="dhForm" method="post" action="../../MuaHangNhaPPDisplay">
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý tồn kho >Mua hàng từ nhà cung cấp khác > Hiển thị </TD>								   
			 								   <TD align="right" class="tbnavigation">Chào mừng <%= tennhapp %> &nbsp; </TD>
					    				 </TR>
									  </TABLE>
								  </TD>
							  </TR>	
