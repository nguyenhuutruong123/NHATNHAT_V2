...
<%
	...
	ResultSet rsTtDuyet=(ResultSet)dmhBean.getDuyet();
	...
	function replaces()
	{
		...
		if(loaidoituong=="0"){
				...
				else
				{
					if(parseInt(tem.indexOf(" - ")) > 0)
					{
						nvId.value = tem.substring(0, parseInt(tem.indexOf(" - ")));
						
						tem = tem.substr(parseInt(tem.indexOf(" - ")) + 3);
						nvTen.value = tem.substring(0, tem.indexOf(" [ ") );
						if(nvId.value != '')
						{
							document.forms['dmhForm'].action.value='changeNV';
						    document.forms["dmhForm"].submit();
						}
					}
				} 
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../ErpPhieuThanhToanUpdateSvl">
		...
		<input type="hidden" name="duyetdn" value="<%=dmhBean.getDuyetdntt()%>" />
		...
		<input type="hidden" name="chucnang" value='<%=dmhBean.getChucnang()%>'>
			...
			<div align="left" id="button" style="width: 100%; height: 32px; padding: 0px; float: none" class="tbdarkrow">
				...
				<A href="" id="ttduyet" rel="subcontentttduyet">&nbsp; 
								<img alt="Thông tin duyệt phiếu" src="../images/vitriluu.png">
										</A>
											 <DIV id="subcontentttduyet" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 720px; max-height:250px; overflow-y:scroll; padding: 4px; z-index: 1;">
	                    						<table width="100%" align="center">
							                        <tr>
							                            <th width="200px">Tên cấp</th>
							                            <th width="300px">Tên nhân viên</th>
							                            <th width="250px"><%=Utility.GLanguage("Trạng thái",session,jedis) %></th>
							                            <th width="150px">Lý do mở</th>
							                            <th width="150px">Lý do sửa</th>	
							                            <th width="150px">Lý do xóa</th>									                       
							                        </tr>
						                            ...
						                            %>
								                     ...
								                     <div align="right">
								                     	...
								                     	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								                     	<a href="javascript:dropdowncontent.hidediv('subcontentttduyet')">Hoàn tất</a>
								                     </div>
	                							</DIV>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<TR>
								...
								<TD   class="plainlabel" valign="top" >
									<input type="text" class="days" id="ngaymuahang" name="ngaymuahang" style= "border-radius:4px; height: 20px;"
							...
							<TR>
								...
								<TD colspan="3" class="plainlabel" width="250px">
								...
								<TD class="plainlabel" style="display: none" >
									...
									Chi phí khác <input type="text" name="cpKhac" id="cpKhac" readonly="readonly" style="text-align: right;border-radius:4px; height: 20px;"   ></span>
                          			...
                          			<DIV id="cpKHAC" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                        ...
				                        <% int count2 = 0; 
				                        	...
				                        	{ %>
				                        	 ...
				                        	 <tr>
					                        	<td><input type="text" style="width: 100%; border-radius:4px; height: 20px;" value="<%= cpkDienGiai[i] %>"  name="diengiaiCPK" ></td>
					                        	<td><input type="text" style="width: 100%; text-align: right;border-radius:4px; height: 20px;" value="<%= cpkSotien[i] %>"  name="sotienCPK"  ></td>
					                        </tr>
				                        ...
				                        <% for(int i = count2; i < 4; i++ ) { %>
				                        	<tr>
					                        	<td><input type="text" style="width: 100%; border-radius:4px; height: 20px;" name="diengiaiCPK" ></td>
					                        	<td><input type="text" style="width: 100%; text-align: right;border-radius:4px; height: 20px;" name="sotienCPK"  ></td>
					                        </tr>
				                        <% } %>
							...
							<% if(dmhBean.getLoaidoituong().equals("0")){ %>
								...
								<TR>
									...
									<TD class="plainlabel">
										<select name="nccId" id="nccId" style="width: 200px; border-radius:4px; height: 20px;" onChange = "submitform();" >
								...
								<TR>
									...
									<TD class="plainlabel" colspan="3"><input type="text" name="diachincc" id="diachincc" value="<%= dmhBean.getDiachiNCC()%>" style=" width: 500px;border-radius:4px; height: 20px;"> 
									</TD>
								</TR>
							...
							<%}else{ %>
								...
								<TD class="plainlabel" width = "20%">	
									<select name="khId" id="khId" style="width: 200px; border-radius:4px; height: 20px;" onChange = "submitform();" >
										<% if (khRs != null)
										{
											while (khRs.next())
											{
							...
							<TR  class="plainlabel">
								...
								<TD class="plainlabel" > 
										<select name="loaihh" id="loaihh" onChange="changeNoiDung();" style="width: 200px; border-radius:4px; height: 20px;">		
	                    						...
	                    						<table width="100%" align="center">
						            	            ...
						            	            {                   			
								                      ...
								                      %>
					                        			<tr>
					                        				<td>
					                        					<input type="text" style="width: 100%; border-radius:4px; height: 20px;" readonly="readonly" name="ngaychungtu" value="<%= pcl.getNgaychungtu() %>" />
					                        					<input type="hidden" style="width: 100%; border-radius:4px; height: 20px;" readonly="readonly" name="tthdid" value="<%= pcl.getSochungtu() %>" />
					                        				</td>
								                            <td>											                            	
								                            	<input type="text" style="width: 100%; border-radius:4px; height: 20px;" readonly="readonly" name="sochungtu" value="<%= pcl.getSochungtu() %>" />
								                            </td>
								                            <td>
								                            	<input type="text" style="width: 100%; border-radius:4px; height: 20px;" readonly="readonly" name="noidungtt" value="<%= pcl.getNoidungtt() %>" style="text-align: left" /></td>
								                            <td>
								                            	<input type="text"  style="width: 100%; border-radius:4px; height: 20px;" name="sotienavat" readonly="readonly" value= "<%= pcl.getSotienAvat()  %>" />
								                            <td>
								                            	<input type="text"  style="width: 100%; border-radius:4px; height: 20px;" name="cantru" value="<%= pcl.getSotienCantru()  %>" onchange="TinhtienCantru(100);" />
								                            </td>
								                            <td>
								                            	<input type="text"  style="width: 100%; border-radius:4px; height: 20px;" name="conlai" value="<%= pcl.getConlai()  %>" readonly="readonly" />
								                            </td>
								                            <td>
								                                <% 	if(pcl.getChon().equals("1")){ %>
								                            	<input type="checkbox"  style="width: 100%; text-align: center; border-radius:4px; height: 20px;" name="chon" id="chon<%= j %>" checked="checked"  value="<%= pcl.getChon()  %>" onchange="TinhtienCantru(<%= j %>)" />
								                            	<%}else{ %>
								                            	<input type="checkbox"  style="width: 100%; text-align: center; border-radius:4px; height: 20px;" name="chon" id="chon<%= j %>" value="<%= pcl.getChon()  %>" onchange="TinhtienCantru(<%= j %>)" />
								                            	<%} %>
								                            </td>
								                            <td>
								                            	<% 	if(pcl.getConlai().equals("0")){ %>
								           	 					<input type="checkbox" style="width: 100%; text-align: center; border-radius:4px; height: 20px;" value="<%= pcl.getSochungtu() %>" name = "trahet" id="trahet<%= j %>" checked="checked" onchange="TinhtienCantru(<%= j %>)" >
								           	 				<%} else { %>
								           	 					<input type="checkbox" style="width: 100%; text-align: center; border-radius:4px; height: 20px;"  value="<%= pcl.getSochungtu() %>" name = "trahet" id="trahet<%= j %>" onchange="TinhtienCantru(<%= j %>)" >
								           	 				<%} %>
								                            </td>
								                        </tr>
									               <% } %>
							...
							<TR style="display: none">
		                            	...
		                            	<%
		                            		...
		                            		if(ghichuArr != null)
		                            		{
		                            			for(int i = 0; i < ghichuArr.length; i++)
		                            			{
		                            				%>
		                            				<Tr>
					                            		<td><input type="text" name="ghichu" value="<%= ghichuArr[i] %>" style="width: 100%; border-radius:4px; height: 20px;" /></td>
					                            	</Tr>
		                            			<% sodong++; }
		                            		}
		                            		...
		                            		while(sodong < 5)
		                            		{
		                            			...
		                            			<Tr>
				                            		<td><input type="text" name="ghichu" value="" style="width: 100%; border-radius:4px; height: 20px;" /></td>
				                            	</Tr>
								...
								<TD class="plainlabel" ><input type="text" name="sothamchieu" id="sothamchieu" value="<%= dmhBean.getSoThamChieu() %>" style="text-align: left;border-radius:4px; height: 20px;"></TD>
							</TR>
								...
								if(spList.size() > 0) { 
									for(int i = 0; i < spList.size(); i++) { 
										...
										<tr>
											...
											<!-- LOẠI CẤP 10004 || 10003 || 10002 || 10001 ĐƯỢC GẮN MÃ CHI PHÍ  -->
								 			 <%if(! ( dmhBean.getChucnang().equals("10000") || dmhBean.getChucnang().equals("9999")) ){ %>
											...
											<td align="right">
								                 ...
								                 background-color: white; width: 1000px; padding: 4px; max-height: 200px; overflow: auto;">
											      ...
											      List<IHoadon> HdList = sp.getHoadonList();
											      		...
											      		<td>
											      			<input type="text" name=<%= "tienhang" + i %> value = "<%= formatter.format(Double.parseDouble(hd.getTienhang())) %>" style="width: 100%; border-radius:4px; height: 20px;" onkeypress="return keypress(event);" onkeyup="Dinhdangdukien(this)" onChange="tinhthue();">
											      		</td>

											      		<td>
											      			<input type="text" name=<%= "thuesuat" + i  %> value = "<%= formatter.format(Double.parseDouble(hd.getThuesuat())) %>" style="width: 100%; border-radius:4px; height: 20px;" onkeypress="return keypress(event);" onkeyup="Dinhdangdukien(this)" onChange="tinhthue();">
											      			<input type="hidden" name=<%= "thuesuat_goc" + i  %> value = "<%= hd.getThuesuat() %>" style="width: 100%" >
											      		</td>

											      		<td>
											      			<input type="text" name=<%= "thue" + i %> value = "<%= formatter.format(Double.parseDouble(hd.getTienthue())) %>"  onkeyup="Dinhdangdukien(this)" style="width: 100%; border-radius:4px; height: 20px;" onkeypress="return keypress(event);" onclick="tinhthue1();"  >
											      		</td>

											      		<td>
											      			<input type="text" name=<%= "cong" + i %> value = "<%= formatter.format(Double.parseDouble(hd.getTienhang()) + Double.parseDouble(hd.getTienthue())) %>" style="width: 100%; border-radius:4px; height: 20px;" readonly=readonly>
											      		</td>
											      ...
											      // Thêm 5 dòng trống để có thể thêm hóa đơn	 
										      		...
										      		<tr>	
														...
														<%if(!dmhBean.getLoaidoituong().equals("0")) {%>
											      		...
											      		<td>
											      			<input type="text" name=<%= "tienhang" + i %> value = "" style="width: 100%; border-radius:4px; height: 20px;" onkeypress="return keypress(event);" onkeyup="Dinhdangdukien(this)" onChange="tinhthue();">
											      		</td>

											      		<td>
											      			<input type="text" name=<%= "thuesuat" + i  %> value = "" style="width: 100%; border-radius:4px; height: 20px;" onkeypress="return keypress(event);" onkeyup="Dinhdangdukien(this)" onChange="tinhthue();">
											      			<input type="hidden" name=<%= "thuesuat_goc" + i  %> value = "" style="width: 100%; border-radius:4px; height: 20px;" >
											      		</td>

											      		<td>
											      			<input type="text" name=<%= "thue" + i %> value = ""  onkeyup="Dinhdangdukien(this)" style="width: 100%; border-radius:4px; height: 20px;" onkeypress="return keypress(event);" onclick="tinhthue1();"    >
											      		</td>

											      		<td>
											      			<input type="text" name=<%= "cong" + i %> value = "" style="width: 100%; border-radius:4px; height: 20px;" readonly=readonly>
											      		</td>
...
<script type="text/javascript">
	...
	dropdowncontent.init('ttduyet', "right-bottom", 300, "click");
</script>	
