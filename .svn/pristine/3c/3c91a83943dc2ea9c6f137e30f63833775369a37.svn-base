				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu &gt; Dữ liệu Kinh doanh  &gt; Nhóm Chi nhánh / NPP > Hiển thị</TD> 
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
				...
				<TR>
				  <TD height="100%" width="100%">
						<FIELDSET >
						<LEGEND class="legendtitle" style="color:black">Thông tin nhóm Chi nhánh / NPP </LEGEND>
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR  style="display:none;">
                              ...
                              <% if (nnppBean.getLoainhom().equals("1")){ %>                                
                                	<OPTION value="1" selected >Nhóm Chi nhánh / NPP</OPTION>
                                	<OPTION value="2" ><%=Utility.GLanguage("Nhà phân phối",session,jedis) %> </OPTION>
                              <%}else{ %>
                                	<OPTION value="1" >Nhóm Chi nhánh / NPP</OPTION>
                                	<OPTION value="2" selected><%=Utility.GLanguage("Nhà phân phối",session,jedis) %></OPTION>
							  <%} %>                              
						  ...
						  <TR>
						  	  	...
						  	  	<TD class="plainlabel">
						  	  		...
						  	  		<% if(kenhRs!= null){						  	  			
						   					while (kenhRs.next()){
						  	  					if (  nnppBean.getKenhId().indexOf(kenhRs.getString("pk_seq"))>=0)   {%>
						  		...
						  		<TR>
						  	  	...
						  	  	<TD class="plainlabel">
						  	  		...
						  	  		<% if(kvRs!= null){						  	  			
						   					while (kvRs.next()){
						  	  					if (nnppBean.getKvId() .indexOf(kvRs.getString("pk_seq"))  >=0){%>
						  	  	...
						  	  	<SELECT name="vungId" id="vungId"  id="vungId" onChange = "ajaxOption('tbNpp')" style="width:150px" multiple>	
						  	  		...
						  	  		<% if(vungRs!= null){					  	  			
							   				while (vungRs.next()){
						  	  					...
						  	  					if (nnppBean.getVungId().indexOf(vungRs.getString("pk_seq"))>=0){%>
						  	  	...
						  	  	<SELECT name="tinhId"  id="tinhId" onChange = "ajaxOption('tbNpp')" style="width:150px" multiple>	
						  	  		...
						  	  		<% if(tinhRs!= null){					  	  			
							   				while (tinhRs.next()){
						  	  					...
						  	  					if ( nnppBean.getTinhId().indexOf(tinhRs.getString("pk_seq"))>=0){%>
						  	  	...
						  	  	<TD class="plainlabel">
						  	  		...
						  	  		<% if(quanhuyeRs!= null){					  	  			
							   				while (quanhuyeRs.next()){
						  	  					...
						  	  					if (nnppBean.getQuanhuyenId().indexOf(quanhuyeRs.getString("pk_seq"))>=0) {%>
						...
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="4" >							
								...
								<%}else{ %>
									...
									<TH width="10%"><%=Utility.GLanguage("Vùng",session,jedis) %></TH>
									<TH width="10%"><%=Utility.GLanguage("Khu vực",session,jedis) %></TH>
									<TH width="10%">Tỉnh thành</TH>
									<TH width="10%">Quận huyện</TH>
									<TH width="10%">Mã Chi nhánh / NPP</TH>
									<TH width="25%"><%=Utility.GLanguage("Nhà phân phối",session,jedis) %></TH>
