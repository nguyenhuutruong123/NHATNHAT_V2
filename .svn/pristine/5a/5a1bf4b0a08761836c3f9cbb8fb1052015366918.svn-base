...
package geso.dms.center.servlets.chuyentuyen;

import geso.dms.center.db.sql.dbutils;
import geso.dms.center.util.Utility;
import geso.dms.center.beans.chuyentuyen.IChuyenTuyen;
import geso.dms.center.beans.chuyentuyen.imp.ChuyenTuyen;
...
public class ChuyenTuyenTTSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{
			System.out.println("da vao day ne :::::::::::::::::::::::;"+ userId);
			out.println(userId);
			...
			String nextJSP = request.getContextPath() + "/pages/Center/SoHoaDon.jsp";
		...
		else
		{
			...
			if(action.equals("saveSOHOADON"))
			{
				...
				*/
				...
				String nextJSP;
				nextJSP = request.getContextPath() + "/pages/Center/SoHoaDon.jsp";
				response.sendRedirect(nextJSP);
			}
			//else
			{/*
