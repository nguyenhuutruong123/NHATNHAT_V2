...
function luulai()
{
	document.forms['mksForm'].action.value= 'updatehm';
	document.forms['mksForm'].submit();
}
						...
						<TABLE border="0" width="100%"  cellpadding="6" cellspacing="0">
							...
							<TR>  
							    <TD class="plainlabel" width="50px" ><%=Utility.GLanguage("Từ ngày",session,jedis) %></TD>
										  	<TD class="plainlabel" width="100px" ><INPUT class="days" name="tungay" type="text" size="40" value="<%=obj.getTungay() %>" ></TD>
											
							   	</TR>
                        	
							<TR>  
											<TD class="plainlabel" width="50px"><%=Utility.GLanguage("Đến ngày",session,jedis) %> </TD>
												<TD class="plainlabel" width="100px" ><INPUT class="days" name="denngay" type="text" size="40" value="<%=obj.getDenngay() %>" ></TD>		
                        	</TR>
                        	<TR>  
														...
														<%}%>
									      					...
									      					<input type="hidden" name="npp" value="<%=rsnpp.getString("pk_seq")%>" />	
									      					 ...
									      					 <Td width="20%" align="center">
									      				 		 ...
									      				 		 <input type="text"  name="hanmuc" value="<%=rsnpp.getString("tienhanmuc")%>">
