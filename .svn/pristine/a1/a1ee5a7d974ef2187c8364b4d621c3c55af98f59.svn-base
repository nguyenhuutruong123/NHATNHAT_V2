            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" border = "0">							
                ...
                <TR>
    	             ...
    	             <TD class="plainlabel" valign="top" colspan = 5>
						<input type="text"  id="thuduoc" name="thuduoc" value="<%= formatter.format(Double.parseDouble(tthdBean.getThuduoc().replaceAll(",",""))) %>"  style="text-align: right;"  onKeyPress = "return keypress(event);" onchange="PhanBoTien();"/>
					 </TD>
                </TR>
