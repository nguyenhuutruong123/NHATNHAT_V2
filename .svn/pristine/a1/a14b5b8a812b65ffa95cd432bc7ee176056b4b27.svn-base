...
public class TieuchithuongDPUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/SGP/pages/Center/TieuChiThuongDPUpdate.jsp";
        if(querystring.indexOf("display") >= 0)
        	nextJSP = "/SGP/pages/Center/TieuChiThuongDPDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String dieukienNhom = util.antiSQLInspection(request.getParameter("nhomdieukienID"));
 		...
 		{    
    		if (id == null )
    		{
    			if (!tctskuBean.createTctSKU())
    			{
    				...
    				String nextJSP = "/SGP/pages/Center/TieuChiThuongDPNew.jsp";
    				response.sendRedirect(nextJSP);
    			}
    			else
    			{
				    ...
				    String nextJSP = "/SGP/pages/Center/TieuChiThuongDP.jsp";
					response.sendRedirect(nextJSP);
    			}	
    		}
    		else
		...
		{		
			...
			String nextJSP;
			if (id == null){
				nextJSP = "/SGP/pages/Center/TieuChiThuongDPNew.jsp";
			}
			else{
				nextJSP = "/SGP/pages/Center/TieuChiThuongDPUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);
		}
	}
