...
<% Hashtable<String, String> sp_ngaynhapkho = (Hashtable<String, String>)pxkBean.getSp_ngaynhapkho(); %>
<% Hashtable<String, String> sp_ngaynhapkhoOLD = (Hashtable<String, String>)pxkBean.getSp_ngaynhapkhoOLD(); %>
...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:50%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Xuất chuyển, đổi hàng > Đổi số lô > Tạo mới
        </div>
                    ...
                    <tr>
                    	...
                    	<td class="plainlabel">
                            <input type="text" size="11"  class="days"
                                onchange="submitform()" id="ngaychuyen" name="ngaychuyen" value="<%= pxkBean.getNgaychuyen() %>" maxlength="10" readonly />
                    	</td> 
