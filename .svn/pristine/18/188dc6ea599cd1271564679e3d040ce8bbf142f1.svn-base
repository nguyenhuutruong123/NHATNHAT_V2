				...
				<TR>
					<TD width="100%" align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <TD align="left" colspan="2" class="tbnavigation">&#160; Quản lý tồn kho &#62; Báo cáo &#62; Xuất Nhập Tồn Khách Hàng </TD>
				...
				<TR>
					...
					<TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
						<TR>
							...
							<FIELDSET>
							  <LEGEND class="legendtitle">Báo cáo xuất nhập tồn của khách hàng</LEGEND>
