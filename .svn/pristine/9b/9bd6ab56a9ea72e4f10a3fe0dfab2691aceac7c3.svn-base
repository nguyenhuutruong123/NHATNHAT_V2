...
public class GioihancongnoUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = request.getContextPath() + "/pages/Distributor/GioiHanCongNoUpdate.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(action.equals("save"))
		{
			if ( id == null)
			{
				if (!(ghcnBean.CreateGhcn(khIds))){	
					ghcnBean.createRS();
					session.setAttribute("ghcnBean", ghcnBean);			
					String nextJSP = request.getContextPath() + "/pages/Distributor/GioiHanCongNoNew.jsp";
					response.sendRedirect(nextJSP);
				}else{
					...
					String nextJSP = request.getContextPath() + "/pages/Distributor/GioiHanCongNo.jsp";
					response.sendRedirect(nextJSP);			    			    									
				}
		...
		}else
		{
			...
			String nextJSP;
			if (id == null){			
				nextJSP = request.getContextPath() + "/pages/Distributor/GioiHanCongNoNew.jsp";
			}else{
				nextJSP = request.getContextPath() + "/pages/Distributor/GioiHanCongNoUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);		
		}}
	}
