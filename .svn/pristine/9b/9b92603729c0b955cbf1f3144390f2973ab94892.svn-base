...
<input type="hidden" name="id" value="<%=tuBean.getId()%>">
<input type="hidden" name="duyettu" value="<%=tuBean.getduyettu()%>" />
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">Quản lý công nợ > Công nợ phải trả > Đề nghị tạm ứng > Cập nhật</TD> 
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
		                  ...
		                  <TR>
                           ...
                           <%if(tuBean.getDoiTuongTamUng().equals("1")) {%>
                          <TR>
                          		<TD class="plainlabel" valign="middle" width="120px" >Mã và tên nhân viên </TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                  ...
		                  <%  if(tuBean.getDoiTuongTamUng().equals("2")){ %>
		                   <TR>											
                          		<TD class="plainlabel" valign="middle" width="120px" >Mã và tên nhà cung cấp</TD>                        									
		                     	 <TD class="plainlabel" valign="middle"  >								
		                 ...
		                 <TR>
                          		<TD class="plainlabel" valign="middle" width="120px" >Lý do tạm ứng </TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                  ...
		                  <%  if(tuBean.getDoiTuongTamUng().equals("2")){ %>
		                  <TR>											
                          		<TD class="plainlabel" valign="middle" width="120px" >Số PO</TD>                        									
		                     	 <TD class="plainlabel" valign="middle"  >								
		                  ...
		                  <TR> 
		                   ...
		                   <TR>
                          		<TD class="plainlabel" valign="middle" width="120px" >Số tiền tạm ứng </TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                  ...
		                  <%  if(tuBean.getDoiTuongTamUng().equals("1")){ %>            
		                  <TR>
                          		<TD class="plainlabel" valign="middle" width="120px" >Thời gian hoàn ứng</TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                     ...
		                     <TR>
                          		<TD class="plainlabel" valign="middle" width="120px" >Hình thức hoàn ứng</TD>   
		                        <TD class="plainlabel" valign="middle"  >
