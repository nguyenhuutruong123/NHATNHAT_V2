	...
	<tr>
		<td colspan="4" align='left' valign='top' bgcolor="#ffffff">
			...
			<tr>
					...
					<tr height="22">
						<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kế toán &gt; Cấp quản lý &gt; Cập nhật </TD>
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="0">
				<tr>
					...
					<tr>
						...
						<tr>
							 <TD class="plainlabel">Loại cấp quản lý</TD>
                       		 <TD class="plainlabel" colspan="3">
				                  <select class="select2" name="loaicapId" id="loaicapId" style="width: 200px" >
				                  	<option value=""> </option>
		                        	<%
		                        		if(loaicapRs != null)
		                        		{
						...
						<tr>
					  		<td class="plainlabel">Quản lý cấp</td> 
					  		<TD class="plainlabel" colspan="3">
				                  <select name="quanlycapId" id="quanlycapId" class="select2" style="width: 200px" onChange="submitform();" >
				                  	<option value=""> </option>
		                        	<%
		                        		if(quanlycapRs != null)
		                        		{
