...
public class NhomfocusKPIList extends Phan_Trang  implements INhomfocusKPIList
{
	...
	public void init(String query) 
	{
		String sql="";
		 if(query=="")
			 sql="select a.pk_seq,isnull(a.diengiai,'khong xac dinh') as diengiai, a.trangthai,a.thang,a.nam,a.dvkd_fk,b.diengiai as tendvkd,a.doituong,c.diengiai as tenkbh,a.kbh_fk,NV.TEN as TENNV,a.NGAYSUA,a.NGAYTAO,NV.PK_SEQ as MANV,NV2.TEN as TENNVS,NV2.PK_SEQ as MANVS" +
			 ...
			 sql=query;
		 System.out.println("Query focus : "+sql);
