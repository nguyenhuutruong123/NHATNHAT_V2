				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Sản phẩm >  <%= obj.getLoai().equals("0")?"Bảng giá B2B":"Bảng giá bán NPP" %> > Tạo mới</TD> 
		                  ...
		                  <TR>
		                  		<td colspan="4">
		                  			...
		                  			<ul class="tabs">
			                  			...
			                  			<li><a   href="#"   <%= obj.getLoai().equals("0")?"style=' display: none;' ":"" %> ><%=Utility.GLanguage("Nhà phân phối",session,jedis) %></a></li>
		                  			...
		                  			<div class="panes" >
										<div  <%= obj.getLoai().equals("0")?"style=' display: none;' ":"" %> >
											<a class="button2" href="javascript:changeKhachHang();" <%= obj.getLoai().equals("0")?"style=' display: none;' ":"" %> >
												<img style="top: -4px;" src="../images/button.png" alt="">Lọc sản phẩm </a>&nbsp;&nbsp;&nbsp;&nbsp;	<br /><br />
