...
<body>
<form name="ckParkForm" method="post" action="../../ErpDuyetddhSvl">  
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">Quản lý mua hàng NPP > Chức năng > Duyệt đơn đặt hàng</div>
