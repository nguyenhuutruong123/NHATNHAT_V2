										...
										<TD>
											<FIELDSET>
												...
												<tr>
													...
													<TD class="plainlabel" >
													<TD class="plainlabel" >
													<TD class="plainlabel" ><%=Utility.GLanguage("Sản phẩm không tính tích lũy",session,jedis) %> &nbsp; <%
														 	if (spBean.getIsKtl().equals("1"))
														 		{
														 %> <input name="isKtl" type="checkbox" value="1" checked> <%
														 	} else
														 		{
														 %> <input name="isKtl" type="checkbox" value="0"> <%
														 	}
														 %>
														</TD> 
													<TD class="plainlabel" >
