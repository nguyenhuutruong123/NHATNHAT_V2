...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng> Bán hàng OTC > Xuất HĐTC > Cập nhật
        </div>
				...
				<%
				                        		...
				                        		if(spRs != null)
				                        		{
				                        			...
				                        			<tr>
				                        				...
				                        				<% if(sanpham_soluong.get( temID ) != null ) { %>
				                        					<input readonly="readonly" type="text" style="width: 100%;text-align: right;" name="<%= spId[i] %>_spSOLUONG" value="<%= formater.format(Double.parseDouble( sanpham_soluong.get( temID ))) %>" onkeyup="CheckSoLuong_DeXuat(this);" >
				                        				<% } else { %>
				                        					<input  readonly="readonly" type="text" style="width: 100%;text-align: right;" name="<%= spId[i] %>_spSOLUONG" value="<%= tudeXUAT  %>" onkeyup="CheckSoLuong_DeXuat(this);" >
				                        				<% } %>
				                        				</td>
				                        				<td>
				                        				...
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: center;" name="<%= spId[i] %>_spNGAYNHAPKHO" value="<%= spRs.getString("NGAYNHAPKHO") %>" readonly="readonly">
				                        				</td>
					...
					<tr>
							<td>
								...
								<%-- <input type="hidden" name="spLoai1" value="<%= spLoai[i] %>" style="width: 100%"   >  --%>
