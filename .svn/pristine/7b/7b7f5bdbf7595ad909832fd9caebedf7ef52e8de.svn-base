...
<script language="javascript" type="text/javascript">
	...
	function replaces()
	{
	 ...
	 function changeSL()
	 {
		 document.forms['hctmhForm'].action.value='changeSL';
	     document.forms["hctmhForm"].submit();
	 }
	 function submitform()
	 { 
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Xuất chuyển, đổi hàng > Xuất chuyển nội bộ > Tạo mới
        </div>
    	...
    	<legend class="legendtitle">Xuất chuyển nội bộ </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
               <TR>
                    ...
                    <TD  class="plainlabel" >
                    	<input type="text" class="days" readonly="readonly"  name="ngaychuyen" onchange="submitform()" value="<%= lsxBean.getNgayyeucau() %>"/></TD>
				...
				<%
					...
					if(spMa != null )
					{
						...
						<tr>
							...
							<td > <input type="text" name="soluong" value="<%= spSoluong[i] %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" onchange="changeSL();" > </td>
							<td align="center" > 
