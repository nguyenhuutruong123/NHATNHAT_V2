...
<% 
	...
	String[] spSoluongton = lsxBean.getSpSoluongton();
	for(int i=0;i<spSoluongton.length;i++)
	System.out.println("so luong ton ;"+i+"="+spSoluongton[i] );
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng ETC/Đối tác > Bán hàng cho ETC > Hiển thị
        </div>
					...
					<%
						...
						if(spMa != null)
						{
							...
							<tr>
								...
								<%} %>
								<td> 
									<input type="text" name="soluongton" value="<%=spSoluongton[i] %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" readonly > 
								</td>
