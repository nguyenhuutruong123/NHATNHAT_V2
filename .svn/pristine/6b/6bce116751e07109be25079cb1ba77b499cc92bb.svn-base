	...
	public class DonvikinhdoanhList implements IDonvikinhdoanhList
	{
		...
		public ResultSet getDvkdList(){
			if (this.query.length() == 0){
		    	this.query = "select a.pk_seq, a.donvikinhdoanh, d.ten as nhacungcap, a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua, d.pk_seq as nccId, a.diengiai from donvikinhdoanh a, nhanvien b, nhanvien c, nhacungcap d, nhacungcap_dvkd e where a.PK_SEQ = e.DVKD_FK and d.PK_SEQ = e.NCC_FK and a.nguoitao = b.PK_SEQ and a.nguoisua = c.PK_SEQ ";
//		    			+ "and e.checked='1'  ";
