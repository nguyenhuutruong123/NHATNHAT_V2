package geso.dms.center.beans.bcchartdoanhthumien.imp;
...
public class Bcchartdoanhthumien extends Phan_Trang implements IBcchartdoanhthumien{
	...
	public void init()
	{
		...
		query="declare @cols varchar(max), @sql varchar(max) " + 
				...
				"			FROM( " + 
				"				select VUNG_PK as PK_SEQ, sum(db.doanhthu)/100000 as doanhthu " + 
				"			from (   " + 
