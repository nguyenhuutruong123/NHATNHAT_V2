...
<% IErpDonDatHangKhac lsxBean = (IErpDonDatHangKhac)session.getAttribute("lsxBean"); %>
...
<form name="hctmhForm" method="post" action="../../ErpDonDatHangKhacUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Duyệt đơn hàng > Duyệt đơn hàng khác
        </div>
				                        		...
				                        		if(spRs != null)
				                        		{
				                        			...
				                        			<tr>
				                        				...
				                        				<% if(sanpham_soluong.get(spMa[i] + "__" + spRs.getString("SOLO") + "__" +  spRs.getString("NGAYHETHAN") ) != null ) { %>
				                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spSOLUONG" value="<%= formater2.format(Double.parseDouble( sanpham_soluong.get(spMa[i] + "__" + spRs.getString("SOLO") + "__" +  spRs.getString("NGAYHETHAN") ))) %>" onkeyup="CheckSoLuong_DeXuat(this);" >
				                        				<% } else { %>
