				...
				<TR>
					<TD align="left" class="tbnavigation">
					   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation"> Quản lý bán hàng > Bán hàng OTC > Phân bổ đơn hàng cho NVGN
			...
			<TR>
				...
				<FIELDSET><LEGEND class="legendtitle">&nbsp;<%=Utility.GLanguage("Tiêu chí tìm kiếm",session,jedis) %></LEGEND>
							<TABLE width="100%" cellpadding="6" cellspacing="0">
								<TR>
									<TD class="plainlabel" style="width:200px">Phân bổ từ ngày</TD>
			                    ...
			                    <TR>
			                    <TD class="plainlabel" style="width:200px">Phân bổ đến ngày</TD>
							      <td class="plainlabel" colspan="5">
			                            <input type="text"  class="days" size="11"
				...
				<TR>
					<TD width="100%">
					<FIELDSET>
					<LEGEND class="legendtitle">&nbsp;Phân bổ chờ &nbsp;&nbsp;&nbsp; 

					<%if(quyen[Utility.THEM]!=0){ %>
						<a class="button3"  onclick="newform()">
	    					<img style="top: -8px; " src="../images/New.png" alt=""><%=Utility.GLanguage("Tạo mới",session,jedis) %></a>
	    				<%} %>                            
					...
					<TABLE class="" width="100%">
						<TR>
							...
							<TABLE width="100%" border="0" cellspacing="1px" cellpadding="4px">
								...
								<TR class="tbheader">
									<th width="6%" align="center">Mã phân bổ</th>
									<th width="9%" align="center">Ngày phân bổ</th>
									...
									<th width="18%" align="center"><%=Utility.GLanguage("Người tạo",session,jedis) %></th>
									<th width="18%" align="center"><%=Utility.GLanguage("Người sửa",session,jedis) %></th>
												...
												<TABLE border = 0 cellpadding="0" cellspacing="0" >
													<TR><TD>
														...
														<%if(quyen[Utility.SUA]!=0 && pbList.getInt("trangthai") != 1){ %>
															<A href = "../../PhanBoNvgnSvl?userId=<%=userId%>&update=<%= pbList.getString("pk_seq") %>"><img src="../images/Edit20.png" alt="Cập nhật" width="20" height="20" longdesc="Cập nhật" border = 0></A>&nbsp;
														<%} %>
														
														<%if(quyen[Utility.CHOT]!=0 && pbList.getInt("trangthai") != 1){ %>
															<A href = "../../PhanBoNvgnSvl?userId=<%=userId%>&chot=<%= pbList.getString("pk_seq") %>"><img src="../images/Chot.png" alt="Cập nhật" width="20" height="20" longdesc="Cập nhật" border = 0></A>&nbsp;
														<%} %>
														
														<%if(quyen[Utility.XOA]!=0 && pbList.getInt("trangthai") != 1){ %>
															<A href = "../../PhanBoNvgnSvl?userId=<%=userId%>&delete=<%=pbList.getString("pk_seq")%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xoá phân bổ này?')) return false;"></A>&nbsp;
														<%} %>	
														</TD>
