...
public class ErpYeucauxuatkhoNppList extends Phan_Trang implements IErpYeucauxuatkhoNppList
{
	...
	public void init(String search)
	{
		...
		{
			query = "select a.sonetId,a.PK_SEQ, a.trangthai, a.ngayyeucau, isnull(c.ten, d.ten) as nppTEN, b.ten as khoTEN, NV.TEN as nguoitao, b.ten as khonhan, a.NGAYSUA, a.NGAYTAO, NV2.TEN as nguoisua, " +
		...
		this.khRs = db.get(" select PK_SEQ, maFAST + ' - ' + TEN as TEN from NHAPHANPHOI where TRANGTHAI = '1'   and loaiNPP = '4' and TRUCTHUOC_FK='"+this.nppId+"' union all select PK_SEQ, maFAST + ' - ' + TEN as TEN from KHACHHANG where TRANGTHAI = '1' and kbh_fk= 100052  and NPP_FK='"+this.nppId+"'");
	}
