...
<% IErpXuatkho lsxBean = (IErpXuatkho)session.getAttribute("lsxBean"); %>
...
<form name="hctmhForm" method="post" action="../../ErpXuatkhoUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý kho trung tâm > Xuất kho > Cập nhật
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpXuatkhoSvl?userId=<%= userId %>" >
        ...
        <A href="../../ErpXuatkhoPdfSvl?userId=<%= lsxBean.getUserId() %>&id=<%= lsxBean.getId() %>&task=xuatkho" >
	        	<IMG src="../images/Printer30.png" title="In phieu giao hang" alt="In phieu giao hang" border ="1px" style="border-style:outset"></A>
    	 <A href="../../ErpXuatkhoPdfSvl?userId=<%= lsxBean.getUserId() %>&id=<%= lsxBean.getId() %>&task=layhang" >
	        	<IMG src="../images/layhang.JPG" title="In phieu lay hang" height="30px" width="40px" alt="In phieu lay hang" border ="1px" style="border-style:outset"></A>  
    </div>
    ...
    <fieldset>
    	<legend class="legendtitle">Xuất kho </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    <TD width="130px" class="plainlabel" valign="top">Ngày yêu cầu </TD>
