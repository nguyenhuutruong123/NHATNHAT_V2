				...
				<TD colspan="4" align='left' valign='top' bgcolor="#ffffff">
					...
					<TABLE width=100% cellpadding="4" cellspacing="0" border="0">
						...
						<tr>
							<TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
									<LEGEND class="legendtitle"><%=Utility.GLanguage("Thông tin quyền",session,jedis) %> </LEGEND>
									<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
										<TR>
											<TD width="15%" class="plainlabel"><%=Utility.GLanguage("Tên quyền",session,jedis) %> <FONT class="erroralert">*</FONT></TD>
									...
									<TR>
										...
										<TD class="plainlabel">
											<% if(obj.getLoaiMenu().equals("0")){%>
												<input type="radio" name="loaiMenu"	value="0"  checked="checked" onchange="changeView()"/><%=Utility.GLanguage("Trung tâm",session,jedis) %>  &nbsp;&nbsp;&nbsp; 
												<input type="radio" name="loaiMenu" value="1" onchange="changeView()"/><%=Utility.GLanguage("Nhà phân phối",session,jedis) %>
											<%}else{ %>
											<input type="radio" name="loaiMenu"	value="0"   onchange="changeView()"/><%=Utility.GLanguage("Trung tâm",session,jedis) %>  &nbsp;&nbsp;&nbsp; 
											<input type="radio" name="loaiMenu" value="1" checked="checked" onchange="changeView()"/><%=Utility.GLanguage("Nhà phân phối",session,jedis) %>
											<%} %>
										...
										<TR>
											<TD class="plainlabel"><label> <input name="trangthai" type="checkbox" value="1" checked> <%=Utility.GLanguage("Hoạt động",session,jedis) %>
											</label></TD>
											...
											<TD width="98%">
												<TABLE ID="sku" width="100%" border="1" cellspacing="1" cellpadding="4">
													<TR class="tbheader">
														...
														<TH width="22%"><%=Utility.GLanguage("Ứng dụng",session,jedis) %></TH>
														<TH width="7%"> <%=Utility.GLanguage("Hiển thị",session,jedis) %> <input type="checkbox" name="cbAll_HienThi_" value="1" onclick="check_all(this.checked,'cbHienThi')"></TH>
														<TH width="7%"><%=Utility.GLanguage("Tạo mới",session,jedis) %> <input type="checkbox" name="cbAll_Them" value="1" onclick="check_all(this.checked,'cbThem')"></TH>
														<TH width="7%"> <%=Utility.GLanguage("Xóa",session,jedis) %><input type="checkbox" name="cbAll_Xoa" value="1" onclick="check_all(this.checked,'cbXoa')"></TH>
														<TH width="7%"><%=Utility.GLanguage("Sửa",session,jedis) %> <input type="checkbox" name="cbAll_Sua" value="1" onclick="check_all(this.checked,'cbSua')"></TH>
														...
														<TH width="7%"><%=Utility.GLanguage("Chốt",session,jedis) %> <input type="checkbox" name="cbAll_Chot" value="1" onclick="check_all(this.checked,'cbChot')"></TH>
														<TH width="7%"> <%=Utility.GLanguage("Hủy Chốt",session,jedis) %><input type="checkbox" name="cbAll_HuyChot" value="1" onclick="check_all(this.checked,'cbHuyChot')"></TH>
