...
<%String url = util.getChuyenNguUrl("ErpBCHangnhapSvl", "",session); %>
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> <%=Utility.GLanguage("Tiêu chí tìm kiếm",session,jedis) %></legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    ...
                    <tr style="display: none">
                        <td class="plainlabel"><%=Utility.GLanguage("Lấy số lượng lớn hơn",session,jedis) %> 0 </td>
                        <td class="plainlabel">
				            ...
				            <DIV id="subcontentCl" style="margin-top:0px;margin-left:190px; visibility: hidden; border: 9px solid #80CB9B;
				                    ...
				                    <table width="90%" align="center">
				                        <tr>
				                            ...
				                            <th width="100px" align="center">Chọn hết<%=Utility.GLanguage("",session,jedis) %> <input type="checkbox" onchange="sellectAll2()" id="chkAll2" ></th>
				                        </tr>
		                            	<%
			                        		if(clRs != null)
			                        		{
				                     ...
				                     <div align="right">
				                     	...
				                     	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                     	<a href="javascript:dropdowncontent.hidediv('subcontentCl')" onclick="locsanpham()" ><%=Utility.GLanguage("Hoàn tất",session,jedis) %></a>
				                     </div>
				            </DIV>               
    </div>  
...
<%=Utility.GLanguage("",session,jedis) %>
</body>
<script type="text/javascript">
