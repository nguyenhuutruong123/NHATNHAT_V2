...
public class DailysalesTT extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = request.getContextPath() + "/pages/Center/DailySecondarySalesReportCenter.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String groupCustomer = util.antiSQLInspection(request.getParameter("groupCus"));
		if(groupCustomer==null)
			groupCustomer = "";
		String gorupSKU = util.antiSQLInspection(request.getParameter("groupSKU"));
		if(gorupSKU==null)
			gorupSKU="";

		obj.setdiscount(util.antiSQLInspection(request.getParameter("discount")));
