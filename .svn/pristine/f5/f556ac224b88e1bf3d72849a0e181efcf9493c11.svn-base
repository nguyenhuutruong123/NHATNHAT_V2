				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý chỉ tiêu &gt; Phân bổ chỉ tiêu &gt;Tạo mới</TD> 
							 <TD colspan="2" align="right" class="tbnavigation">Chào mừng  <%=objbean.GetTenNpp() %>&nbsp;  </TD></tr>
						</table>
			 		</TD>
				</TR>
			</TABLE>
