	...
	for(i=0; i < masp.length; i++)
	{
		if(masp.item(i).value != "")
		{
			...
			if(pos > 0)
			{
				...
				sp = sp.substr(parseInt(sp.indexOf("] [")) + 3);
				var valuetien=sp.substring(0, parseInt(sp.indexOf("]")));
				dongia.item(i).value =formattien(valuetien);
			}
...
<form name="dhForm" method="post" action="../../HoaDonGTGTNewSvl">
						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý bán hàng > Xuất hóa đơn tài chính > tạo mới </TD>								   
							...
							<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
											<TD width="30" align="left"><A href = "../../HoaDonGTGTSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
									...
									<TD align="left" class="khoatest">						
										...
										<TABLE class="khoatest" border="0" bordercolor="white" width="100%" cellpadding = "1" cellspacing = "2" style="padding-left:2px ;" >
											...
											<TR class="plainlabel">
											  ...
											  <TD   class="plainlabel">
											  	<input name="tongtienkm"  id='tongtienkm' type="text" readonly value="<%=Math.round(hdBean.getTongtiensauVAT()-hdBean.getSoTienTraKM())%>">
									          VND </TD>
									         <td>
