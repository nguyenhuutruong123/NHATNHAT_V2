...
<form name="bgmuanppForm" method="post" action="../../BanggiabandoitacSvl">
				  ...
				  <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
					<TR height="22">
					  	<TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền > Dữ liệu nền sản phẩm > Bảng giá bán cho đối tác </TD>
   						<TD colspan="2" align="right" class="tbnavigation"><%=Utility.GLanguage("Chào mừng bạn",session,jedis) %>  <%= obj.getNppTen() %>  &nbsp;</TD>
					</TR>
				  </TABLE></TD>
			</TR>
		</TABLE>
							  ...
							  <%}%>
									...
									<%} %>
										...
										<TD align="center">
											...
											<A href = "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"BanggiabandoitacUpdateSvl?userId="+userId+"&update="+ bglist.getString("id")+"") %>"><img src="../images/Display.png" alt="Hiển thị" width="20" height="20" longdesc="Hiển thị" border = 0></A>
