...
<form name="rpForm" method="post" action="../../DailyKHStockTTSvl">
				...
				<TR>
					<TD width="100%" align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <TD align="left" colspan="2" class="tbnavigation">&#160; Quản lý tồn kho &#62; Báo cáo &#62; Tồn Kho Hàng Ngày Của Khách Hàng </TD>
				...
				<TR>
					...
					<TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
						<TR>
							...
							<FIELDSET>
							  <LEGEND class="legendtitle">Tồn Kho Hàng Ngày Của Khách Hàng</LEGEND>
							<TABLE  width="100%" cellpadding="6px" cellspacing="0px">
								<TR>
									...
									<TD class="plainlabel" width="130px"><%=Utility.GLanguage("Đến ngày",session,jedis) %></TD>
									<td class="plainlabel">
