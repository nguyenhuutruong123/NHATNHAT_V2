		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 50%; padding: 5px; float: left"
					class="tbnavigation">Quản lý trưng bày > Đăng ký trưng bày >
					Tạo mới</div>
					...
					<div style="width: 100%; float: non; clear: left; font-size: 0.7em">
						<TABLE width="100%" cellpadding="5px" cellspacing="0px">
							...
							<TR>
								...
								<TD class="plainlabel" colspan="2"><%=dktbBean.getscheme() %>
								</TD>
							</TR>
							<TR>
							...
							<TR>
								<TD class="plainlabel">Thời gian đăng ký
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:Từ
									ngày</TD>
								<TD class="plainlabel" colspan="2"><input type="text"
									size="15" name="batdau" value="<%=dktbBean.getTgktTinhds() %>"
									readonly="readonly" style="border-color: gray; color: gray;" />
									&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Đến
									ngày&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text"
									size="15" name="ketthuc"
									value="<%= dktbBean.getThoigianbd() %>" readonly="readonly"
									style="border-color: gray; color: gray;" /></TD>
							</TR>
							<% } else {%>
							<TR>
								...
								<TD class="plainlabel" colspan="2"><input type="text"
									...
									&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Đến
									ngày&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" size="15"
									name="ketthuc" value="<%=dktbBean.getThoigiankt()  %>"
									readonly="readonly" style="border-color: gray; color: gray;" />
								</TD>
							</TR>
							<%} %>
							...
							<TR>
								...
								<TD class="plainlabel" colspan="2"><a href="" id="nvbh"
