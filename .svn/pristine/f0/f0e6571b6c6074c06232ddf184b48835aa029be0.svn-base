...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Dữ liệu nền > Kinh doanh > Chiết khấu > Tạo mới
        </div>
    ...
    <fieldset>
    	<legend class="legendtitle">Thông tin chiết khấu </legend>
            ...
            <TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
				<TR>
				  <TD width="15%" class="plainlabel" ><%=Utility.GLanguage("Diễn giải",session,jedis) %></TD>
           ...
           <TABLE class="tabledetail" width="100%" border="0" cellpadding="1" cellspacing="1" >
                <TR class="tbheader">                   
                 	<TH align="center" width="25%"> Mã Đối tác </TH>
                	<TH align="left" width="65%"> Tên Đối tác </TH>
