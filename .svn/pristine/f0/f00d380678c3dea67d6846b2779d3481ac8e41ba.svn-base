...
<%@ page import="geso.dms.erp.beans.lenhsanxuat.imp.*" %>
<%@ page import="geso.dms.erp.beans.lenhsanxuat.*" %>
...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function save()
	{
		if(confirm('Bạn có chắc chắn muốn lưu và chốt không?')) {
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý cung ứng > Sản xuất > Bundle > Tạo mới</TD> 
			...
			<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
						    ...
						    <div id="btnSave">
						    <A href="javascript: save()" ><IMG src="../images/Chot.png" title="Lưu & chốt" alt="Lưu & chốt" border = "1"  style="border-style:outset"></A>
						    </div>
						    </TD>
							<TD >&nbsp; </TD>						
						</TR>
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          ...
                          <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle" > CN/NPP </TD>   
		                        <TD class="plainlabel" valign="middle" >
		                            <select name="nppDatId" style="width: 200px" onchange="submitform();"  >
		                            	<option value="" ></option>
		                            	<% if(nppRs != null) { 
		                            		while(nppRs.next())
		                            		{
		                            			if(nppRs.getString("pk_seq").equals(obj.getNppDatId())) 
		                            			{
		                            				%>
		                        ...
		                        <TD class="plainlabel" valign="middle" >Kho CN/NPP </TD>   
		                        <TD class="plainlabel" valign="middle" >
		                  ...
		                  <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle" colspan="3">
		                            <select name="kbhId" style="width: 200px" onchange="submitform();"  >
		                            	<option value="" ></option>
		                            	<% if(kbhRs != null) { 
		                            		while(kbhRs.next())
		                            		{
