		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Quản lý kho trung tâm > Nhập kho > Tạo
					mới</div>
			...
			<div align="left" id="button"
				...
				class="tbdarkrow">
				<A href="../../ErpNhapkhoSvl?userId=<%=userId%>"> <img
				...
				<fieldset>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<TR>
								<TD width="120px" class="plainlabel" valign="top">Ngày nhập
								</TD>
								<TD colspan="3" class="plainlabel" valign="top"><input
									type="text" class="days" readonly="readonly" name="ngaychuyen"
									value="<%=lsxBean.getNgayyeucau()%>" /></TD>
							</TR>
							<TR>
								<TD class="plainlabel" valign="top">Ghi chú</TD>
								<TD colspan="3" class="plainlabel" valign="top"><input
									type="text" name="ghichu" value="<%=lsxBean.getGhichu()%>" />
								</TD>
							</TR>
											...
											<table width="95%" align="center">
												...
												<tr>
													...
													<td><input type="text"
														...
														onchange="Update_NSX(<%=count%>, this );"></td>
													<td><input type="text"
														style="width: 100%; text-align: right;"
														name="dong<%=count%>_spNGAYHETHAN" value=""
														readonly="readonly"></td>
												</tr>
												...
												<tr>
													...
													<td><input type="text"
														style="width: 100%; text-align: center;"
														name="dong<%=count%>_spNGAYSANXUAT" value=""
