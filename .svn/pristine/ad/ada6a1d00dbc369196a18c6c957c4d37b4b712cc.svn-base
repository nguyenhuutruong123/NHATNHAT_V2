...
<body>
<form name="erpDmhForm" method="post" action="../../BCPhanBoNvgn">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	&#160; Quản lý bán hàng > Bán hàng OTC > Báo cáo phân bổ giao hàng
        </div>
    ...
    <div align="left" style="width: 100%; float: none; clear: left">
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> Báo cáo phân bổ giao hàng </legend>
            <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                			...
                			<TD class="plainlabel"><%=Utility.GLanguage("NHÂN VIÊN BÁN HÀNG",session,jedis) %></TD>
									<TD class="plainlabel" colspan="3">
										<select name="ddkd" id="ddkd"	 style="width: 300px; text-align: left !important;">
											<option value="" selected></option>
											<% try {
											if (ddkd != null)
													while (ddkd.next()) {
