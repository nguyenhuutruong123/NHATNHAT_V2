...
<%@ page  import = "geso.dms.center.beans.thutien.imp.*" %>
...
//							alert("I am here 1");
		 	...
		 	var ck = 0;
				...
				var conlai = parseFloat(tongtienAvat) - parseFloat(tongtienVND) - parseFloat(phiNH);
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ >  Thu tiền khách hàng > Cập nhật
        </div>
