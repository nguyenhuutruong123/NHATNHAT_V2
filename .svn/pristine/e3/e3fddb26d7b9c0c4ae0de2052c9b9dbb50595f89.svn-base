...
<form name='kvForm' method="post" action="../../DiabanUpdateSvl">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">
							   	<%if(kvBean.getId() != null && kvBean.getId().trim().length() > 0){ %>
							   		Dữ liệu nền > Kinh doanh > Địa bàn > Cập nhật </TD>
							   		<%} else { %>
							   		Dữ liệu nền > Kinh doanh > Địa bàn > Tạo mới </TD>
							   		<%} %>
			  	...
			  	<TR>
					<TD align="left" colspan="4" class="legendtitle">
				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
								<LEGEND class="legendtitle">Thông tin Địa bàn
								</LEGEND>
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									<TR>
									  <TD width="15%" class="plainlabel" >Địa bàn<FONT class="erroralert">*</FONT></TD>
