...
public class ErpHoadontaichinhNPPUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
    		...
    		{
    			nextJSP = request.getContextPath() + "/pages/Distributor/ErpHoaDonTaiChinhNPPUpdate.jsp";	
    		}
    		else
    		{
    			nextJSP = request.getContextPath() + "/pages/Distributor/ErpHoaDonTaiChinhNPPDisplay.jsp";
    		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			String[] spghichu = request.getParameterValues("ghichusp");
			...
			{	
				...
				else
				{
					if(!lsxBean.update())
					{
						...
						lsxBean.setSohoadon(sohoadon);
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = request.getContextPath() + "/pages/Distributor/ErpHoaDonTaiChinhNPPUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
			...
			else
			{
				...
				else
				{
					...
					if(id == null)
					{
						lsxBean.createRs();	
						session.setAttribute("lsxBean", lsxBean);					
						nextJSP = request.getContextPath() + "/pages/Distributor/ErpHoaDonTaiChinhNPPNew.jsp";
					}
					if(id != null)
					{
						lsxBean.init();
