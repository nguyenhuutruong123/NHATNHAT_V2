	   ...
	   String[] recipient;
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		    ...
		    if(action.equals("id")){
				...
				String nextJSP = request.getContextPath() + "/pages/Center/ThieuhangUpdate.jsp";
		    	...
		    	String nextJSP = request.getContextPath() + "/pages/Center/Theodoithieuhang.jsp";
		    	response.sendRedirect(nextJSP);
		    }
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		    ...
		    String bosung = util.antiSQLInspection(request.getParameter("bosung"));
