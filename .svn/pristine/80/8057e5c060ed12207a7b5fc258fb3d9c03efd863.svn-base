...
<form name="bgstForm" method="post" action="../../ThuongdauthungSvl">
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    ...
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý chỉ tiêu > Khai báo > Thưởng đầu thùng</TD>  
        ...
        <TABLE width="100%" cellpadding="0" cellspacing="1">
            <TR>
                ...
                <TR>
                    <TD width="100%">
                        <FIELDSET>
                            <LEGEND class="legendtitle">&nbsp;Quản lý thưởng đầu thùng  &nbsp;&nbsp;	   
