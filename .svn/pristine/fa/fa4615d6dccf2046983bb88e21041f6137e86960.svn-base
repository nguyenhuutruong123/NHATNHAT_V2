...
<% 	ITieuchithuong tctBean = (ITieuchithuong)session.getAttribute("tctBean"); 
	...
	//Trang Display Set lại là Hiển thị
	action = "Hiển thị";
%>
...
{	
    ...
    document.tctForm.action.value='display';
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation"><%= url %> > <%=Utility.GLanguage("Hiển thị",session,jedis) %>
										...
										<TR>
							                ...
							                <div style='display:none'>
						                        <div id="taomoitc" style='padding:0px 5px; background:#fff;'>
						                        	<h4 align="left" style="text-decoration: underline;"><%=Utility.GLanguage("Tạo mới",session,jedis) %> tiêu chí<%=Utility.GLanguage("",session,jedis) %></h4>
															...
															try{tct.beforeFirst();while(tct.next()){ 
																%>
																	...
																	<TR <% if(tctBean.getLoai().equals("0")) { %> style='display: none'  <%} %>   >
														  				<TD style="font-weight: bold;"><%=Utility.GLanguage("Tối thiểu",session,jedis) %>(%) </TD>
													  	  				<TD>
