...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý tồn kho > Mua hàng từ nhà cung cấp > Đơn đặt hàng khác > Tạo mới
        </div>
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle">Đơn đặt hàng khác </legend>
                    	...
                    	<select name = "khonhapId" class="select2" style="width: 200px" >
                        	<%
                        		if(khonhapRs != null)
                        		{
                        			...
                        			{  System.out.print("kho nhan id la "+lsxBean.getKhoNhapId());
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					...
					<% for(int i = count; i < 50; i++) { %>
						...
						<tr>
							...
							<td> <input type="text" name="dongia" value="" style="width: 100%; text-align: right;" <%= lsxBean.getKbhId().equals("100052") ? "" : "readonly='readonly'"  %>  onkeypress="return keypress(event);" > </td>
