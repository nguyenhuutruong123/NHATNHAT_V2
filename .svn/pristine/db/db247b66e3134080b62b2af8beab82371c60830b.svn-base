        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<TABLE class="tabledetail" width="100%"  border='1'  cellspacing="1" cellpadding="0">
				                    ...
				                    <TH style="width:8%" align="center"><%=Utility.GLanguage("Từ ngày",session,jedis) %></TH>
				                    <TH style="width:8%" align="center"><%=Utility.GLanguage("Đến ngày",session,jedis) %></TH>
				                    <TH style="width:30%" align="center"><%=Utility.GLanguage("Diễn giải",session,jedis) %></TH>
				                   ...
				                   <TH style="width:15%" align="center"><%=Utility.GLanguage("Sản phẩm",session,jedis) %></TH>
				                    <TH style="width:5%" align="center">Số lượng</TH>
