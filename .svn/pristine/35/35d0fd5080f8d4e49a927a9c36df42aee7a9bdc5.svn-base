...
<%@ page import="geso.dms.distributor.beans.hoadonphelieu.imp.*" %>
<%@ page import="geso.dms.distributor.beans.hoadonphelieu.*" %>
			...
			<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
							...
							<TD width="30" align="left" ><A href="../../RouterSvl?task=<%= Utility.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"ErpHoaDonPheLieuPdfSvl?userId="+userId+"&ddhId="+obj.getId()+"&loaihd=2") %>" ><img src="../images/Printer30.png" alt="Print"  title="Print" border="1" longdesc="Print" style="border-style:outset"></A></TD>
							<TD align="left" >&nbsp;</TD>
						</TR>
					</TABLE>
			</TD></TR>
