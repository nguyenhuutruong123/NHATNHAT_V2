...
<script type="text/javascript" src="../scripts/ajax.js"></script>
	...
	function saveform()
	{
		...
		if(type == '')
		{
			alert('Vui lòng chọn loại điều kiện trưng bày.');
			return;
		}
		if(type == 2)
		{
...
<div id="main" style="width:99%; padding-left:2px">
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle"> <%=Utility.GLanguage("Điều kiện trưng bày",session,jedis) %> </legend>
            ...
            <TABLE width="100%" cellpadding="6" cellspacing="0">							
                ...
                <TR>
                    ...
                    <TD class="plainlabel">
                        ...
                        <% if(nsptbBean.getType().equals("1")){ %>                           
                            <option value="1" selected><%=Utility.GLanguage("Số lượng từng sản phẩm bắt buộc",session,jedis) %></option>
                        ...
                        <%}else{if(nsptbBean.getType().equals("2")){ %>                      	
                            ...
                            <option value="1"><%=Utility.GLanguage("Số lượng từng sản phẩm bắt buộc",session,jedis) %></option>
                            <option value=""> </option>
                        <%}else{ %>
                ...
                <TR>
                  ...
                  <TR style="display: none;">
                    <TD class="plainlabel"><%=Utility.GLanguage("Số lượng tính theo thùng",session,jedis) %></TD>
                    <TD class="plainlabel">
           ...
           <TABLE width="100%" border="0" cellpadding="1" cellspacing="1">
                ...
                <% if(nsptbBean.getNhomspId().length() > 0)
                {
                	...
                	%>
                		<TR class='tbdarkrow'>	                    	
	                    	<td align="center"><input type="text"  value="<%= sp.getMasanpham() %>" name="masp" onkeyup="ajax_showOptions(this,'abc',event)" style="width:100%"></td>
