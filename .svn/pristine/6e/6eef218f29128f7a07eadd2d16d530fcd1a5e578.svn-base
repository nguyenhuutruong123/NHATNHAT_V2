...
public class Dailysecondarysalesnpp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		String nextJSP = request.getContextPath() + "/pages/Center/DailySecondarySalesnpp.jsp";
    	...
    	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
				...
				obj.settungay(util.antiSQLInspection(request.getParameter("tungay")) != null ? request
						.getParameter("tungay") : "");
	
				obj.setdenngay(util.antiSQLInspection(request.getParameter("denngay")) != null ? request
						.getParameter("denngay") : "");
				obj.setuserId(util.antiSQLInspection(request.getParameter("userId")) != null ? request
						.getParameter("userId") : "");
		...
		private boolean CreateStaticData(Workbook workbook,IStockintransit obj) throws Exception
    	{
    	 ...
    	 String sql ="select  v.ten as region, kv.ten as area, npp.ten as distributor, npp.sitecode as distcode, nh.ten as brand,cl.ten as category, sp.ma + '_' + sp.ten as SKU, "+ 
    	 		...
    	 		" isnull(m.diengiai, 'Chua Xac Dinh') as outlettype, kbh.diengiai as chanel, dh.ngaynhap as offdate, dhsp.soluong as piece, dhsp.giamua*dhsp.soluong as amount,"+  
