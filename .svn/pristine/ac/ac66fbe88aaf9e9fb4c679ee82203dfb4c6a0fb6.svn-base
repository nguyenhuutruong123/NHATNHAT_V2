...
public class DailySalesReport extends HttpServlet {
	...
	public void setQuery(HttpServletRequest request){
        ...
        obj.setFromDate(year + "-" + month + "-" + request.getParameter("Sdays"));
        obj.setToDate( year + "-" + month + "-" + request.getParameter("Edays"));
        ...
        obj.setBusinessUnit(request.getParameter("dvkds"));
