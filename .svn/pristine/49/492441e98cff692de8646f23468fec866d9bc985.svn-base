...
public class GioiHanCongNoTTSvl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if (action.equals("new"))
	    {
    		...
    		String nextJSP = request.getContextPath() + "/pages/Center/GioiHanCongNoTTNew.jsp";
    		response.sendRedirect(nextJSP);
	    ...
	    if (action.equals("search"))
	    {
    		...
    		response.sendRedirect(request.getContextPath() + "/pages/Center/GioiHanCongNoTT.jsp");	    		    	
	    }
	}
