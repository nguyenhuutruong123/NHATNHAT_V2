    	...
    	<legend class="legendtitle"><%=Utility.GLanguage("Xuất chuyển nội bộ",session,jedis) %> </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <tr>
                    ...
                    <TD class="plainlabel" >
                    	<select name = "nppId" style="width: 200px" class="select2" >
                    		<option value=""> </option>
                        	<%
                        		if(nppRs != null)
                        		{
				...
				<%
					...
					if(spMa != null)
					{
						...
						<tr>
							...
							<td > <input type="text" readonly name="tonkho" value="<%= spTonkho[i] %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" > </td>
					                    ...
					                    <table width="95%" align="center">
			                            	...
			                            	<%
				                        		...
				                        		if(spRs != null)
				                        		{
				                        			...
				                        			{
				                        				String tudeXUAT = "";
				                        			/* 	if(lsxBean.getKodexuat() == null && spRs.getString("tuDEXUAT").trim().length() > 0)
				                        				{
				                        					System.out.println("vo roi nhessssss Vu");
				                        					tudeXUAT = formater.format(spRs.getDouble("tuDEXUAT")); 
				                        				} */
				                        				System.out.println("sp la "+spMa[i]);
				                        					System.out.println("san pham soluong "+sanpham_soluong.get(spMa[i] + "__" + spRs.getString("SOLO")+"__" + spRs.getString("ngayhethan")+"__" + spRs.getString("ngaynhapkho")));
				                        				System.out.println("solo de xuat "+spRs.getString("SOLO")+"__" + spRs.getString("ngayhethan")+"__" + spRs.getString("ngaynhapkho"));
				                        					String temID = spMa[i];
				                        			%>
				                        			...
				                        			<tr>
				                        				...
				                        				<% 
				                        					System.out.println("hahaha: " + spMa[i] + "__" + spRs.getString("SOLO")+"__" + spRs.getString("ngayhethan")+"__" + spRs.getString("ngaynhapkho"));
				                        				if(sanpham_soluong.get(spMa[i] + "__" + spRs.getString("SOLO")+"__" + spRs.getString("ngayhethan")+"__" + spRs.getString("ngaynhapkho")) != null ) { %>
				                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spSOLUONG" value="<%= formater.format(Double.parseDouble( sanpham_soluong.get( spMa[i] + "__" + spRs.getString("SOLO")+"__" + spRs.getString("ngayhethan")+"__" + spRs.getString("ngaynhapkho") ))) %>"  >
				                        				<% } else { 	System.out.println("tuDEXUAT = "+tudeXUAT ); %>
