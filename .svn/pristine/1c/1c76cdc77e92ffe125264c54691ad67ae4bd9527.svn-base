							...
							<TD align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
											...
											Dữ liệu nền> Dữ liệu Kinh doanh > Khách hàng > Hiển thị
							...
							<TD height="100%" width="100%">
								<FIELDSET>
									...
									<%} %>
										...
										<TR>
											<TD  class="plainlabel">Tên khách hàng<FONT class="erroralert"> *</FONT>
											</TD>
										...
										<TR>
											...
											<%-- <TD class="plainlabel">Điện thoại di động</TD>
											<TD class="plainlabel" colspan="3"><INPUT type="text"
