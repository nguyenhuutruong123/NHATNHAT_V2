...
public class ChiTieuList   extends Phan_Trang implements IChiTieuList, Serializable   
{
  ...
  private static final long serialVersionUID = 8092745136245984000L;
	...
	public void init(String query)
	{
		...
		this.rsTieuchi = this.createSplittingData(super.getItems(), super.getSplittings(), "nam,thang desc", sql);
	}
