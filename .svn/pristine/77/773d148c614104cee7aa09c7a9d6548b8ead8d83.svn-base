...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function upload()
	{
		...
		if(document.forms["khtt"].filename.value==""){
			   
			   document.forms["khtt"].dataerror.value="Chưa tìm được file upload. Vui lòng chọn file cần upload.";
		   }else{
			 document.forms["khtt"].setAttribute('enctype', "multipart/form-data", 0);
			  document.forms["khtt"].action.value = "upload";
			 document.forms["khtt"].submit();	
		   }
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          <TR>
		                   ...
		                   <%--  <TD class="plainlabel" valign="middle" width="120px" >Nhóm sản phẩm </TD>   
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<select name="bgbleId" id="bgbleId"  onchange="submitform();">
										<option value=""></option>
										<% if (bgList != null)
										{
											while (bgList.next())
		                  ...
		                  <TR  class="plainlabel">
						  	 ...
						  	 <a class="button2" href="javascript:upload()">
											<img style="top: -4px;" src="../images/button.png" alt="">Upload giá sản phẩm </a>
