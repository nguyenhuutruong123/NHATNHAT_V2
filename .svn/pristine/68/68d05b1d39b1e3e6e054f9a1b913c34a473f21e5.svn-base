...
<% IGioiHanCongNoTT obj = (IGioiHanCongNoTT)session.getAttribute("obj"); %>
<% List<IGioiHanCongNoTT> ghcnlist = (List<IGioiHanCongNoTT>)obj.getListGioiHanCongNo(); %>
...
<form name="ghcnForm" method="post" action="../../GioiHanCongNoTTSvl">
			...
			<TR>
				<TD align="left" class="tbnavigation">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr height="22">
   							<TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền > Dữ liệu Kinh doanh > Mức tín dụng</TD>
						...
						<TR>
							<TD>
								<TABLE width="100%" border="0" cellspacing="1" cellpadding="2">
									<TR class="tbheader">
											<TH width="18%">Diễn giả mức tín dụng</TH>
									...
									while (m < size){
										...
										<%}%>
												...
												<TR>
												<TD>
													<A href = "../../GioiHanCongNoTTNewSvl?userId=<%=userId%>&update=<%= ghcn.getId()%>"><img src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A>
												</TD>
												<TD>&nbsp;</TD>
												<TD>
													<A href = "../../GioiHanCongNoTTNewSvl?userId=<%=userId%>&delete=<%= ghcn.getId()%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có chắc chắn muỗn xóa  GioiHanCongNo này?')) return false;"></A></TD>
												</TR></TABLE>
												</TD>
											</TR>
								<%m++; }%>
