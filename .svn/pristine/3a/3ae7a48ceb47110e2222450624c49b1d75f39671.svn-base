...
<form name="dvdlForm" method="post" action="../../DonvidoluongNewSvl">
								...
								<TABLE  width="100%" cellspacing="0" cellpadding="6">
									...
									<TR>
										<TD  class="plainlabel" colspan="4" ><label>
										  <input name="trangthai" type="checkbox" value="1" checked ><%=Utility.GLanguage("Hoạt động",session,jedis) %></label>
									   </TD>
