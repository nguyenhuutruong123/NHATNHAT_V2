								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Xử lý đơn hàng > Đơn hàng trả về > Cập nhật </TD>								   
										...
										<TABLE cellpadding = "6" cellspacing = "0" width = "100%" border = 0>
											<TR >
											  ...
											  <table border=0 cellpadding="0" cellspacing="0">
                                                <TR><TD>
											    <input type="text" name="tungay" size="20" value="<%= dhtvBean.getNgaygiaodich() %>" >
											</TD><TD>
											...
											<TR class="tblightrow">
												...
												<TD colspan="3" class="plainlabel"> 
									 			<SELECT name="khoTen" id="khoTen">
													  <% if(kho != null){
														  try{ while(kho.next()){
											    			if(kho.getString("khoId").equals(dhtvBean.getKhoId())){ session.setAttribute("khoId", kho.getString("khoId")); %>
