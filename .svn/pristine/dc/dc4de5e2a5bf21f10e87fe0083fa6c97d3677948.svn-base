...
<BODY  leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../BCAnhQuaTang">
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Quản lý trưng bày &#62; Báo cáo &#62; Báo cáo ảnh quà tặng</div>
...
<!-- session.getAttribute("errors") -->
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Báo cáo ảnh quà tặng</legend>
								...
								<TR>
									<TD width="98%">
										<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
											<TR class="tbheader">
												<TH width="5%">STT</TH>
												<TH width="5%" align="center">Mã NVBH</TH>
												<TH width="10%" align="center">Tên NVBH</TH>
		                               ...
		                               while (dataRs.next()){
		                                   ...
		                                   <%} else {%>
		                                   	...
		                                   	<%}%>
												...
												<td>
												<img style=" width: 100px; height: 100px;" src="<%=getServletContext().getInitParameter("pathhinhJSP") + "AnhQuaTang/"+dataRs.getString("anhchup") %>" >																																							
												</td>											
