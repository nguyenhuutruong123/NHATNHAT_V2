package geso.dms.distributor.beans.bienbandoichieucongnoNPP.imp;
...
public class BienbandoichieucongnoNPP extends Phan_Trang implements IBienbandoichieucongnoNPP
{
	...
	public BienbandoichieucongnoNPP()
	{
		this.tungay = "";
		this.denngay = "";
		this.nppTen = "";	
	...
	public void init()
	{
		...
		query = "select 'ETC--' + cast(PK_SEQ as nvarchar(20)) as PK_SEQ,  N'ETC / ' + isnull(maFAST,'') + '-' + TEN as TEN " +
				...
				" \n union all "+    
				"\n select 'OTC--' + cast(PK_SEQ as nvarchar(20)) as PK_SEQ , maFAST + ' - ' + TEN AS TEN from KHACHHANG  "+    
