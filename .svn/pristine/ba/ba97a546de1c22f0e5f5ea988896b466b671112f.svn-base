		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation"><%=url %> > <%=Utility.GLanguage("Tạo mới",session,jedis) %></div>
				...
				<fieldset>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<TR>
								<TD width="120px" class="plainlabel" valign="top"><%=Utility.GLanguage("Ngày nhập",session,jedis) %>
								</TD>
						...
						<table cellpadding="0px" cellspacing="1px" width="100%">
							...
							<tr>
								...
								<td align="center"><a href="" id="sanpham_<%=count%>"
									rel="subcontent_<%=count%>"> &nbsp; <img alt="Chọn số lô"
									...
									<DIV id="subcontent_<%=count%>"
										...
										<div align="right">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
												...
												<%=Utility.GLanguage("Đóng lại",session,jedis) %> </a>
										</div>
							...
							<tr>
								...
								<td align="center"><a href="" id="sanpham_<%=i%>"
									rel="subcontent_<%=i%>"> &nbsp; <img alt="Chọn số lô"
										src="../images/vitriluu.png">
								</a>
