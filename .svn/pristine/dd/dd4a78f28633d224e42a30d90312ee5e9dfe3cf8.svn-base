    	...
    	<legend class="legendtitle"> Trả khuyến mại </legend>
        	...
        	<div style="float:none; width:100%" align="left">
            	<table width="100%" cellspacing="0" cellpadding="6px">
                    ...
                    <tr>
                    	<td class="plainlabel" width="30%" valign="middle"><%=Utility.GLanguage("Từ ngày",session,jedis) %></td>
                    	<td class="plainlabel">
                    ...
                    <tr>
                    	<td class="plainlabel" width="30%" valign="middle"><%=Utility.GLanguage("Đến ngày",session,jedis) %></td>
                    	<td class="plainlabel">
                 ...
                 <table width="100%" cellpadding="4px" cellspacing="1px">
                 	<tr>
                    	<th class="tbheader" width="20%" align="center">Mã sản phẩm</th>
                        <th class="tbheader" width="40%"  align="center">Tên sản phẩm</th>
                        <th class="tbheader" width="10%"  align="center">Đơn giá</th>
                        <th class="tbheader" width="10%"  align="center">Tồn hiện tại</th>
                        <th class="tbheader" width="10%"  align="center" width="15%">Thứ tự ưu tiên</th>
                    </tr>
