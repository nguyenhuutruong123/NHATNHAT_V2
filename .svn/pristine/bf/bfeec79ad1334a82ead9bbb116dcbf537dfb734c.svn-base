...
public class ErpXuatkhoNppSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
       
    public ErpXuatkhoNppSvl() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String nextJSP = request.getContextPath() + "/pages/Center/ErpXuatKho.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if(action.equals("Tao moi"))
	    {
    		...
    		String nextJSP = request.getContextPath() + "/pages/Center/ErpXuatKhoNew.jsp";
    		response.sendRedirect(nextJSP);
	    }
	    else
	    {
	...
	private String getSearchQuery(HttpServletRequest request, IErpXuatkhoList obj)
	{
		...
		String query =  "select a.PK_SEQ, a.trangthai, a.ngayyeucau, c.ten as nppTEN, b.ten as khoTEN, NV.TEN as nguoitao, b.ten as khonhan, a.NGAYSUA, a.NGAYTAO, NV2.TEN as nguoisua,   " +
						...
						"inner join NHANVIEN nv2 on a.NGUOISUA = nv2.PK_SEQ where a.pk_seq > 0 and a.trangthai >= 1  AND A.NPP_FK IN  "+util.quyen_npp(obj.getUserId()) +"   AND A.KHO_FK IN "+util.quyen_khoTT(obj.getUserId(),util.KICHHOAT)+"   ";
