...
public class TieuchithuongKMDiemList implements ITieuchithuongKMDiemList 
{
	String userId;
	...
	public TieuchithuongKMDiemList()
	{
		this.thang = "";
		this.nam = "";
		this.trangthai = "";
	...
	public void init(String query)
	{
		...
		else
		{
			...
			sql = "select a.scheme, a.pk_seq, a.tungay thang, a.denngay nam, a.diengiai, isnull(a.trangthai,0)trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua " +
					"from CTKhuyenmai a inner join NHANVIEN b on a.NGUOITAO = b.pk_seq inner join NHANVIEN c on a.NGUOISUA = c.pk_seq " +
					 " where 1=1 and loaict = 4" +
					"order by tungay desc,denngay desc";
		}
