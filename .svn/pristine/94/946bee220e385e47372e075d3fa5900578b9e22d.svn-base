...
<script language="javascript" type="text/javascript">
	...
	function replaces()
	{
	 ...
	 { 
		...
		var spSoluongtongoc = document.getElementsByName("soluongtongoc") ;
		var ngaydh = document.getElementById("hopdong_tungay").value ;
		...
		(
			{
		    url: "../../ErpDonhangNppETCSvl?type=GetDonGia&spMa=" + spMa.item(pos).value + "&dvdlId=" + dvdlId.item(pos).value + "&nppId=" + nppId+"&ngaydh="+ngaydh+"&dvkdId="+dvkdId+"    "  ,
		    type : 'GET',
		    dataType: 'json',
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng ETC / Đối tác > Bán hàng cho ETC > Tạo mới
        </div>
			...
			<hr />
				<table cellpadding="0px" cellspacing="1px" width="100%">
					...
					<%
						...
						if(spMa != null)
						{
							System.out.println(" spMa.length="+ spMa.length);
							...
							<tr>
								<td>
									...
									<%-- <%if(spSoluonton!=null){ %>
								<input type="hidden" name="soluongton" value="<%=spSoluonton[i]  %>"  > 
								<%} %> --%>
								</td>
								...
								<td> 
								<input type="text" name="soluongton" value="<%= spSoluonton[i] %>" style="width: 100%; text-align: right;" readonly  >
								 <input style="display:none;" type="text" name="soluongtongoc" value="0"   onkeyup="Dinhdang(this);" >
								
								 </td>
								<td> <input type="text" name="dongia" readonly="readonly" value="<%= spGianhap[i] %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);"  > </td>
					...
					if(lsxBean.getMahopdong().trim().length()<=0)
					{
						 System.out.print("vao day here::::::::::::::::::"+count);
					for(int i = count; i < 20; i++) { %>
						...
						<tr>
							...
							<td> <input type="text" name="dongia" readonly="readonly" value="" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" > </td>
