...
public class PhieuthutienUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = request.getContextPath() + "/pages/Distributor/PhieuThuTienUpdate_2.jsp";
        
        if(querystring.indexOf("display") >= 0 ) 
        	nextJSP = request.getContextPath() + "/pages/Distributor/PhieuThuTienDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
    	...
    	String tongsotien = util.antiSQLInspection(request.getParameter("tongsotien"));
		if (tongsotien == null)
			tongsotien = "";				
    	...
    	if(action.equals("save"))
		{
			if ( id == null){
				if (!(pttBean.CreatePtt(request))){	
					pttBean.initNew();
					session.setAttribute("pttBean", pttBean);			
					String nextJSP = request.getContextPath() + "/pages/Distributor/PhieuThuTienNew_2.jsp";
					response.sendRedirect(nextJSP);
				}else{
				...
				if(action.equals("claim")){
					...
					if(khIds != null){
						if (id == null){
							nextJSP = request.getContextPath() + "/pages/Distributor/PhieuThuTienNew_2.jsp";
							pttBean.initNew();
						}else{
							nextJSP = request.getContextPath() + "/pages/Distributor/PhieuThuTienUpdate_2.jsp";
							pttBean.initUpdate();						
						}
					}else{
						if (id == null){
							nextJSP = request.getContextPath() + "/pages/Distributor/PhieuThuTienNew_1.jsp";
							pttBean.initNew();
					...
					if(action.equals("noclaim")){
						...
						if (id == null){
							...
							nextJSP = request.getContextPath() + "/pages/Distributor/PhieuThuTienUpdate_1.jsp";
							pttBean.initUpdate();						
						}					
					}else{
						pttBean.setClaim(false);
