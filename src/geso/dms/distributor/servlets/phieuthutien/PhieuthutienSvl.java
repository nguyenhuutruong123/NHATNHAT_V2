...
public class PhieuthutienSvl extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if(action.equals("Tao moi"))
	    {
    		...
    		String nextJSP = request.getContextPath() + "/pages/Distributor/PhieuThuTienNew_1.jsp";
    		response.sendRedirect(nextJSP);    		
	    }
	    else
	      ...
	      else
	    {
    		...
    		response.sendRedirect(request.getContextPath() + "/pages/Distributor/PhieuThuTien.jsp");	
	    }
	}
