...
public class ChiTieuNppPriSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = request.getContextPath() + "/pages/Distributor/ChiTieuNppPri.jsp";//default
		...
		String sql_getchiteu_pri="select kbh.ten as kenhbanhang, a.chitieu_fk,nhapp_fk,a.chitieu,c.donvikinhdoanh,thang,nam,songaylamviec,ngayketthuc,dvkd_fk from chitieu_nhapp a inner join chitieu b  on a.chitieu_fk=b.pk_seq inner join donvikinhdoanh c on c.pk_seq=b.dvkd_fk inner join kenhbanhang kbh on kbh.pk_seq=b.kenh_fk   where a.nhapp_fk="+nhappid;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  //lay id nha phan phoi va ten nha pp
	    ...
	    String tumuc=request.getParameter("tumuc");
	    String toimuc=request.getParameter("toimuc");
	    String action =request.getParameter("action");
	    String dvkd_fk=request.getParameter("selectdvkd");
