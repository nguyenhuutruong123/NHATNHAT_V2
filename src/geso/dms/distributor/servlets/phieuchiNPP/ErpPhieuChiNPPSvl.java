...
import geso.dms.distributor.beans.phieuchiNPP.IErpPhieuChiNPPList;
import geso.dms.distributor.beans.phieuchiNPP.imp.ErpPhieuChiNPP;
import geso.dms.distributor.beans.phieuchiNPP.imp.ErpPhieuChiNPPList;
...
public class ErpPhieuChiNPPSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
       
    public ErpPhieuChiNPPSvl() {
        super();
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		IErpPhieuChiNPPList obj;
	    ...
	    else
	    {
	    	...
	    	{
	    		IErpPhieuChiNPP tthd = new ErpPhieuChiNPP(tthdId);
		...
		String nextJSP = request.getContextPath() + "/pages/Distributor/ErpPhieuChiNPP.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    {
	    	IErpPhieuChiNPP tthdBean = new ErpPhieuChiNPP();
    		...
    		String nextJSP = request.getContextPath() + "/pages/Distributor/ErpPhieuChiNPPNew.jsp";
    		response.sendRedirect(nextJSP);
	    }
	    else
	    {
	    	if(action.equals("view") || action.equals("next") || action.equals("prev"))
	    	{
		    	...
		    	session.setAttribute("obj", obj);
		    	response.sendRedirect(request.getContextPath() + "/pages/Distributor/ErpPhieuChiNPP.jsp");	
		    }
	    	else if (action.equals("excel"))
	 	    {
	    		obj = (IErpPhieuChiNPPList) new ErpPhieuChiNPPList();	 	    	
	 		    obj.setCtyId(ctyId);	
	 		   obj.setView(view);
	 		   // String search = getSearchQuery(request, obj);
	...
	private String getQueryExcelThuTien(HttpServletRequest request, String pages, String soDong, IErpPhieuChiNPPList obj)
	{    	
	...
	private String getQueryExcelThuTienHoaDon(HttpServletRequest request, String pages, String soDong, IErpPhieuChiNPPList obj)
	{    	
    	String query =  
	...
	private String getSearchQuery(HttpServletRequest request, IErpPhieuChiNPPList obj)
	{
		Utility util = new Utility();
	...
	private String Delete(String tthdId)
	{
		...
		try 
		{
			...
			String	query  = "delete PhieuChi_SoChungTu   where tableName = 'Erp_PhieuChi' and Id_FK = '" + tthdId + "'";
			...
			query  = "update Erp_PhieuChi set trangthai='2'   where trangthai =0  and PK_SEQ = '" + tthdId + "'";
		...
		{ 
			db.update("rollback");
			db.shutDown(); 
			return "Khong the xoa Erp_PhieuChi"; 
		}
