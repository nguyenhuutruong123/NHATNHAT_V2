...
public class ErpInPhieuChiSvl extends HttpServlet{	
	...
	private void form_phieuthu( Document document,ServletOutputStream outstream,IErpPhieuChiNPP pttBean,
		...
		try {
			...
			chunk=new Chunk("Mẫu số: 02-TT",font10_Bold);
			cell.addElement(chunk);
			tableheader.addCell(cell);
			// trai
			cell = new PdfPCell();
			...
			chunk=new Chunk("PHIẾU CHI",new Font(bf,19,Font.BOLD));
			cell.addElement(chunk);
			tableheader.addCell(cell);
			...
			cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell.setVerticalAlignment(Element.ALIGN_BOTTOM);
			chunk=new Chunk("   Số: " +sonetid,new Font(bf,12,Font.BOLD));
			...
			chunk=new Chunk("Họ tên người nhận tiền: "+tennguoinop,font12_normal);
			cell.addElement(chunk);
			...
			chunk=new Chunk("Lý do chi: "+lydo,font12_normal);
			cell.addElement(chunk);
		...
		cell.addElement(chunk);*/
			...
			{
				para=new Paragraph("Giám đốc", font12_Bold);				
			}
			else
			{			
				para=new Paragraph("Ban Tổng giám đốc", font12_Bold);
			}
			...
			cell = new PdfPCell();				
			para=new Paragraph("Kế toán trưởng", font12_Bold);
			para.setAlignment(Element.ALIGN_CENTER);
			cell.addElement(para);
			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			cell.setBorder(0);
			...
			cell1=new PdfPCell(new Paragraph("            Người nhận", font12_Bold));
			cell1.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell1.setBorder(0);
			tbl_fotter.addCell(cell1);
