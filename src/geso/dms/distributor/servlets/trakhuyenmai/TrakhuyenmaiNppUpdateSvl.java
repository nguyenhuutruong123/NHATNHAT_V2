...
public class TrakhuyenmaiNppUpdateSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    String tkmId = request.getParameter("tkmId");
		...
		String nextJSP = request.getContextPath() + "/pages/Distributor/TraKhuyenMaiNppSanPham.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(action.equals("save"))
		{
			...
			else
			{
				...
				String nextJSP = request.getContextPath() + "/pages/Distributor/TraKhuyenMai.jsp";
				response.sendRedirect(nextJSP);
			}
		}
		else
