...
import geso.dms.distributor.beans.bangkehoadonsp.BangKeHoaDonSpList;
import geso.dms.distributor.beans.bangkehoadonsp.IBangKeHoaDonSpList;
...
@WebServlet("/BcDoanhSoDeNghiSvl")
public class BcDoanhSoDeNghiSvl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public BcDoanhSoDeNghiSvl() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  	{
  		...
  		nextJSP = request.getContextPath() + "/pages/Distributor/BcDoanhSoDeNghi.jsp";
      ...
      if (action.equals("excel")  )
      {
  	    ...
  	    { 
  				...
  				response.setHeader("Content-Disposition", "attachment; filename=BcDoanhSoDeNghi.xlsm");
  	      FileInputStream fstream = new FileInputStream(getServletContext().getInitParameter("path") + "\\BcDoanhSoDeNghi.xlsm");
      	...
      	session.setAttribute("obj", obj);
      	response.sendRedirect(request.getContextPath() + "/pages/Distributor/BcDoanhSoDeNghi.jsp");
      }
