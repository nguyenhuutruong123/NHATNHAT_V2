...
import geso.dms.distributor.beans.reports.imp.BCCongNoChiTiet;
...
public class BCCongNoChiTietSvl extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
       
    public BCCongNoChiTietSvl() {
        super();
    }
	...
	//	PrintWriter out = response.getWriter();
		...
		String nextJSP = request.getContextPath() + "/pages/Distributor/BCCongNoChiTiet.jsp";
	...
	private void CreatePivotTable(OutputStream out,
		...
		// TODO Auto-generated method stub
		IBCCongNoChiTiet obj = new BCCongNoChiTiet();
