...
public class BCThieuHangNpp extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
			...
			String nextJSP = request.getContextPath() + "/pages/Distributor/BCThieuHangNpp.jsp";
...
//			FileInputStream fstream = new FileInputStream("D:\\Best Stable\\OneOne\\WebContent\\pages\\Templates\\BCDonHangBanTrongKyNPP.xlsm");	
