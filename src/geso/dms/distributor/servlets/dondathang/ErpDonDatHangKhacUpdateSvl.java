...
import geso.dms.distributor.beans.dondathang.imp.ErpDonDatHangKhac;
...
@WebServlet("/ErpDonDatHangKhacUpdateSvl")
public class ErpDonDatHangKhacUpdateSvl extends HttpServlet
{
	private static final long serialVersionUID = 1L;
	PrintWriter out;
	public ErpDonDatHangKhacUpdateSvl()
	{
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
		    ...
		    IErpDonDatHangKhac lsxBean = new ErpDonDatHangKhac(id);
    		...
    		{
    			nextJSP = request.getContextPath() + "/pages/Distributor/ErpDonDatHangKhacDisplay.jsp";	
    		}
    		else if(querystring.contains("duyet"))
    		{
    			nextJSP = request.getContextPath() + "/pages/Distributor/ErpDonDatHangKhacDuyetDisplay.jsp";
    		}
    		else
    		{
    			nextJSP = request.getContextPath() + "/pages/Distributor/ErpDonDatHangKhacUpdate.jsp";
    		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			IErpDonDatHangKhac lsxBean;
			
			Utility util = new Utility();	
			String id = util.antiSQLInspection(request.getParameter("id"));
		    if(id == null)
		    {  	
		    	lsxBean = new ErpDonDatHangKhac("");
		    }
		    else
		    {
		    	lsxBean = new ErpDonDatHangKhac(id);
		    }
			...
			{	
				if(id == null)
				{
					...
					if(!kq)
					{
						lsxBean.createRs();
	    		    	session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = request.getContextPath() + "/pages/Distributor/ErpDonDatHangKhacNew.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
						/*IErpDonDatHangKhacList obj = new ErpDonDatHangKhacList();
			    		...
			    		String nextJSP = request.getContextPath() + "/pages/Distributor/ErpDonDatHangKhac.jsp";
			    		response.sendRedirect(nextJSP);*/
					}
				}
				else
				{
					...
					if(!kq)
					{
						lsxBean.createRs();
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = request.getContextPath() + "/pages/Distributor/ErpDonDatHangKhacUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
				...
				else
				{
					if(action.equals("duyet"))
					{
						...
						if(!lsxBean.duyetDH())
						{
							lsxBean.createRs();
							session.setAttribute("lsxBean", lsxBean);
		    				String nextJSP = request.getContextPath() + "/pages/Distributor/ErpDonDatHangKhacDuyetDisplay.jsp";
		    				response.sendRedirect(nextJSP);
						}
						else
						{
					...
					else
					{
						...
						nextJSP = request.getContextPath() + "/pages/Distributor/ErpDonDatHangKhacNew.jsp";
						if(id != null)
						{
							nextJSP = request.getContextPath() + "/pages/Distributor/ErpDonDatHangKhacUpdate.jsp";
						}
