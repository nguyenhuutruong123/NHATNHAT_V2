...
public class Erp_DuyetthanhtoanSvl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ddmhBean.setLydosua(lydosua);		
   	    ...
   	    if(action.equals("duyet")){ // DUYỆT => CÓ || CHƯA CÓ USER TRONG BẢNG ERP_DUYETMUAHANG
   	    ...
   	    else if(action.equals("xoaphieu")) // XÓA => CÓ || CHƯA CÓ USER TRONG BẢNG ERP_DUYETMUAHANG
	    {
	    	ddmhBean.Xoamuahang(Id);
	    }
   	    else if(action.equals("suaphieu")) // SỬA => CÓ || CHƯA CÓ USER TRONG BẢNG ERP_DUYETMUAHANG
	    {
