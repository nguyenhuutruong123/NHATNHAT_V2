...
public class DenghidathangnppUpdateSvl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if(!util.check(userId, userTen, sum)){
				...
				if(ngaydn.length()==0){
					dndhBean.setMessage("Vui lòng nhập ngày đặt hàng");
					error = true;
				}else{
				...
				try{
					...
					dndhBean.setMessage("Vui lòng nhập tần số bán hàng là số ");
					error = true;
				}
	...
	private void CreateDondathangHPC(Document document, ServletOutputStream outstream, IDenghidathang dndhBean) throws IOException
	{
		try{			
			...
			Paragraph ddh = new Paragraph("Ã„ï¿½Ã¡Â»ï¿½ NghÃ¡Â»â€¹ Ã„ï¿½Ã¡ÂºÂ·t HÃƒÂ ng", font);
			...
			PdfPCell cell1 = new PdfPCell(new Paragraph("TÃƒÂªn NPP: ", font3));
			PdfPCell cell2 = new PdfPCell(new Paragraph(dndhBean.getNppTen(), font2));
			PdfPCell cell3 = new PdfPCell(new Paragraph("SÃ¡Â»â€˜ Fax ICP: ", font3));
			...
			PdfPCell cell5 = new PdfPCell(new Paragraph("TÃ¡Â»â€°nh/ TP: ", font3));
			PdfPCell cell6 = new PdfPCell(new Paragraph("", font2));
			PdfPCell cell7 = new PdfPCell(new Paragraph("Ã„ï¿½T/ Fax NPP: ", font3));
			...
			PdfPCell cell9 = new PdfPCell(new Paragraph("NgÃƒÂ y Ã„ï¿½Ã¡Â»ï¿½ NghÃ¡Â»â€¹: ", font3));
			...
			String[] th = new String[]{"MÃƒÂ£", "TÃƒÂªn", "TÃ¡Â»â€œn Ã„â€˜Ã¡ÂºÂ§u", "TÃ¡Â»â€œn cuÃ¡Â»â€˜i","BÃƒÂ¡n/tuÃ¡ÂºÂ§n","TB BÃƒÂ¡n/ngÃƒÂ y", "TÃ¡Â»â€œn ngÃƒÂ y", "DÃ¡Â»Â± kiÃ¡ÂºÂ¿n", "Ã„ï¿½Ã¡Â»ï¿½ nghÃ¡Â»â€¹", "Ã„ï¿½. giÃƒÂ¡","T.TiÃ¡Â»ï¿½n"};
...
//				if(j % 2 != 0) 	font4.setColor(BaseColor.GREEN);
			...
			PdfPCell cell11 = new PdfPCell(new Paragraph("TÃ¡Â»â€¢ng TiÃ¡Â»ï¿½n: ", new Font(bf, 9, Font.BOLD)));
			...
			cell11 = new PdfPCell(new Paragraph("ThuÃ¡ÂºÂ¿ VAT (10%): ", new Font(bf, 9, Font.BOLDITALIC)));
			cell11.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			cell11 = new PdfPCell(new Paragraph("TÃ¡Â»â€¢ng GiÃƒÂ¡ TrÃ¡Â»â€¹: ", new Font(bf, 9, Font.BOLD)));
			cell11.setHorizontalAlignment(Element.ALIGN_LEFT);
