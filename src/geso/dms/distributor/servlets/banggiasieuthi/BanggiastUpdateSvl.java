...
public class BanggiastUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = request.getContextPath() + "/pages/Distributor/BangGiaSieuThiUpdate.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String nccId = request.getParameter("nccTen");
		if (nccId == null)
			nccId = "";
		...
		}else
		{
			...
			String nextJSP;
			if (id == null){			
				nextJSP = request.getContextPath() + "/pages/Distributor/BangGiaSieuThiNew.jsp";
			}else{
				nextJSP = request.getContextPath() + "/pages/Distributor/BangGiaSieuThiUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);		
		}
		}
