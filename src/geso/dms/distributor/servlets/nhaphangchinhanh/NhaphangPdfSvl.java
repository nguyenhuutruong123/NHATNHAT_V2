...
public class NhaphangPdfSvl extends HttpServlet
{
	private static final long serialVersionUID = 1L;

	public NhaphangPdfSvl()
	{
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (querystring.contains("nhaphang"))
		{
			//pxkBean.initPdf();
	...
	private void CreatePxk_HOCHIMINH(Document document, ServletOutputStream outstream, INhaphang pxkBean) throws IOException
	{
		try
		{
...
/*			String  sql = " select xuattaikho as khoxuat," +
			   ...
			   String sql =
				   " select a.NGAYCHUNGTU, isnull(c.TEN, 'HÀNG BÁN') as KHONHAN, b.TEN as TENNPP \n"+
				   " from NHAPHANG a INNER JOIN NHAPHANPHOI b on a.NPP_FK = b.PK_SEQ \n"+
			...
			String query =
				...
				" from NHAPHANG d inner join NHAPHANG_SP a on d.PK_SEQ = a.nhaphang_fk " +
