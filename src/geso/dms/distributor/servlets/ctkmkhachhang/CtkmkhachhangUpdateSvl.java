...
//		    out.println(action);
	    	...
	    	String nextJSP = request.getContextPath() + "/pages/Distributor/CtkmkhachhangUpdate.jsp";
	   ...
	   // this.out = response.getWriter();
	    ...
	    { 
	    	...
	    	else
	    	{
    	    	...
    	    	String nextJSP = request.getContextPath() + "/pages/Distributor/Ctkmkhachhang.jsp";
    			response.sendRedirect(nextJSP);
	    	}
	    }
	    else
