...
import geso.dms.distributor.beans.hoadontaichinh.imp.Soathoadon;
...
public class SoathoadonSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
       
    public SoathoadonSvl() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{
	    	//obj.init();
			nextJSP = request.getContextPath() + "/pages/Distributor/SoatHoaDon.jsp";
		}
		else
		{
			//obj.initETC();
			nextJSP = request.getContextPath() + "/pages/Distributor/DoiSoHoaDon.jsp";
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    else
	    {
			...
			{
				System.out.println("vào đây2222!!!");
				obj.initETC();
				nextJSP = request.getContextPath() + "/pages/Distributor/DoiSoHoaDon.jsp";
			}
			response.sendRedirect(nextJSP);  
