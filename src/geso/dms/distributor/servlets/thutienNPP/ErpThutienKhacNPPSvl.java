...
import geso.dms.distributor.beans.thutienNPP.IErpThutienKhacNPPList;
import geso.dms.distributor.beans.thutienNPP.imp.ErpThutienKhacNPP;
import geso.dms.distributor.beans.thutienNPP.imp.ErpThutienKhacNPPList;
...
public class ErpThutienKhacNPPSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
       
    public ErpThutienKhacNPPSvl() {
        super();
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		IErpThutienKhacNPPList obj;
	    ...
	    else
	    {
	    	...
	    	{
	    		IErpThutienKhacNPP tthd = new ErpThutienKhacNPP(tthdId);
	    		tthd.setUserId(userId);
	    		obj.setmsg(tthd.Chot());
	    	}
	    }
		...
		String nextJSP = request.getContextPath() + "/pages/Distributor/ErpThutienKhacNPP.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    {
	    	IErpThutienKhacNPP tthdBean = new ErpThutienKhacNPP();
	    	tthdBean.setView(view);
	    	tthdBean.setUserId(userId);

	    	tthdBean.createRs();
    
	    	session.setAttribute("obj", tthdBean);

    		String nextJSP = request.getContextPath() + "/pages/Distributor/ErpThutienKhacNPPNew.jsp";
    		response.sendRedirect(nextJSP);
	    }
	    else
	    {
	    	if(action.equals("view") || action.equals("next") || action.equals("prev"))
	    	{
		    	...
		    	session.setAttribute("obj", obj);
		    	response.sendRedirect(request.getContextPath() + "/pages/Distributor/ErpThutienKhacNPP.jsp");	
		    }
	    	else if (action.equals("excel"))
	 	    {
	    		obj = (IErpThutienKhacNPPList) new ErpThutienKhacNPPList();	 	    	
	 		    obj.setCtyId(ctyId);	
	 		   obj.setView(view);
	 		   // String search = getSearchQuery(request, obj);
	...
	private String getQueryExcelThuTien(HttpServletRequest request, String pages, String soDong, IErpThutienKhacNPPList obj)
	{    	
	...
	private String getQueryExcelThuTienHoaDon(HttpServletRequest request, String pages, String soDong, IErpThutienKhacNPPList obj)
	{    	
    	String query =  
	...
	private String getSearchQuery(HttpServletRequest request, IErpThutienKhacNPPList obj)
	{
		Utility util = new Utility();
		...
		if(sophieunop.length() > 0)
			query += " and "+sophieunop+" in (select NOPTIEN_FK from ERP_THUTIENKHAC_NOPTIEN where THUTIENKHAC_FK = a.pk_seq ) ";
	...
	private String Delete(String tthdId)
	{
		...
		try 
		{
			...
			String	query  = "delete PhieuThu_SoChungTu   where tableName = 'ERP_THUTIENKHAC' and Id_FK = '" + tthdId + "'";
			...
			query  = "update ERP_THUTIENKHAC set trangthai='2'   where trangthai =0  and PK_SEQ = '" + tthdId + "'";
		...
		{ 
			db.shutDown(); 
			return "Khong the xoa ERP_THUTIENKHAC"; 
		}
