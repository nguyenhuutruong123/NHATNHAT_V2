...
public class ErpThutienKhacNPPUpdateSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;

	public ErpThutienKhacNPPUpdateSvl()
	{
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{
			IErpThutienKhacNPP btthBean = new ErpThutienKhacNPP(hdId);
			btthBean.setView(view);
			btthBean.setUserId(userId);
			btthBean.setnppId(util.getIdNhapp(userId));
			btthBean.Init();
			session.setAttribute("obj", btthBean);
			String nextJSP = request.getContextPath() + "/pages/Distributor/ErpThutienKhacNPPUpdate.jsp";
		...
		else if (action.equals("display"))
		{
			...
			btthBean.Init();
			session.setAttribute("obj", btthBean);
			String nextJSP = request.getContextPath() + "/pages/Distributor/ErpThutienKhacNPPDisplay.jsp";
			response.sendRedirect(nextJSP);
		}
	}
...
//		String sum = (String) session.getAttribute("sum");
		
		{
			...
			IErpThutienKhacNPP btthBean = new ErpThutienKhacNPP();
			...
			if (id == null)
			{
				nextJSP = request.getContextPath() + "/pages/Distributor/ErpThutienKhacNPPNew.jsp";
			} else
			{
				nextJSP = request.getContextPath() + "/pages/Distributor/ErpThutienKhacNPPUpdate.jsp";
			}
			if (action.equals("save"))
			{
				if (id == null)
				{
					...
					{
						IErpThutienKhacNPPList btthList = new ErpThutienKhacNPPList();
						...
						nextJSP = request.getContextPath() + "/pages/Distributor/ErpThutienKhacNPP.jsp";
						response.sendRedirect(nextJSP);
					}
				} 
				else
