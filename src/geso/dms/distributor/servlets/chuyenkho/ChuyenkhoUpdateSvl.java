...
public class ChuyenkhoUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        {
        	nextJSP = request.getContextPath() + "/pages/Distributor/ChuyenKhoDisplay.jsp";
        }
        else
        {
        	nextJSP = request.getContextPath() + "/pages/Distributor/ChuyenKhoUpdate.jsp";
        }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(action.equals("save"))
		{
			...
			else
			{
				...
				{	
					...
					pxkBean.createRS();
					session.setAttribute("pxkBean", pxkBean);			
					String nextJSP = request.getContextPath() + "/pages/Distributor/ChuyenKhoUpdate.jsp";
					response.sendRedirect(nextJSP);
				}
				else{
					IChuyenkhoList obj = new ChuyenkhoList();
		...
		else
		{
			...
			if (id == null)
			{			
				nextJSP = request.getContextPath() + "/pages/Distributor/ChuyenKhoNew.jsp";
			}
			else
			{
				nextJSP = request.getContextPath() + "/pages/Distributor/ChuyenKhoUpdate.jsp";   						
