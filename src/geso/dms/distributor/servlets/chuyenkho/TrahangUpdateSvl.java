...
public class TrahangUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        {
        	nextJSP = request.getContextPath() + "/pages/Distributor/TraHangDisplay.jsp";
        }
        else
        {
        	nextJSP = request.getContextPath() + "/pages/Distributor/TraHangUpdate.jsp";
        }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(action.equals("save"))
		{
			...
			else
			{
				...
				{	
					...
					pxkBean.createRS();
					session.setAttribute("pxkBean", pxkBean);			
					String nextJSP = request.getContextPath() + "/pages/Distributor/TraHangUpdate.jsp";
					response.sendRedirect(nextJSP);
				}
				else{
					ITrahangList obj = new TrahangList();
		...
		else
		{
			...
			if (id == null)
			{			
				nextJSP = request.getContextPath() + "/pages/Distributor/TraHangNew.jsp";
			}
			else
			{
				nextJSP = request.getContextPath() + "/pages/Distributor/TraHangUpdate.jsp";   						
