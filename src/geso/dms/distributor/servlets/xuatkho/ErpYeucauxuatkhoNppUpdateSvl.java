...
public class ErpYeucauxuatkhoNppUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
    		...
    		{
    			nextJSP = request.getContextPath() + "/pages/Distributor/ErpYeuCauXuatKhoNppUpdate.jsp";	
    		}
    		else
    		{
    			nextJSP = request.getContextPath() + "/pages/Distributor/ErpYeuCauXuatKhoNppDisplay.jsp";
    		}
			...
			{	
				...
				else
				{
					if(!lsxBean.update())
					{
						lsxBean.createRs();
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = request.getContextPath() + "/pages/Distributor/ErpYeuCauXuatKhoNppUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
