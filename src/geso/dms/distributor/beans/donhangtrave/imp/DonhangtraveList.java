...
public class DonhangtraveList implements IDonhangtraveList
{
	...
	public void init(String search) 
	{
		...
		if (search.length() == 0)
		{
			query = "select a.pk_seq as dhtvId, a.ngaynhap, a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua, d.ten as khTen,d.smartid, d.pk_seq as khId, e.pk_seq as ddkdId, e.ten as ddkdTen, f.ten as nppTen, a.VAT";
			...
			query = query + " where a.npp_fk = '" + this.nppId + "' order by a.pk_seq";
