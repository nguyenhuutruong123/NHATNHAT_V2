...
public class NhaphangList implements INhaphangList, Serializable
{
	...
	public void createNhaphanglist(String querystr)
	{
		...
		else 
		{
			...
			query=
				...
				"\n	) km " +
				"\n	where a.npp_fk = '" + nppId + "' and npp.loainpp='0' and capCn=1  "+// and a.kho_fk in "+utilCenter.quyen_kho(this.userId)+
