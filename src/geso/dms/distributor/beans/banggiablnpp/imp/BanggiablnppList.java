...
public class BanggiablnppList implements IBanggiablnppList
{
	...
	public void init(String search) 
	{
		...
		if (search.length() == 0)
		{
			// Sua : Chi cho hien ra nhung bang gia theo don vi kinh doanh cua nha phan phoi.them dieu kien where npp in (dieu kien ket nha phan phoi thụuoc nha cung cap _dvkd)
				...
				query = "select a.pk_seq as BGBLID, a.ten as BGBLTEN, d.ten as nguoitao, a.ngaytao as ngaytao, e.ten as nguoisua, a.ngaysua as ngaysua,  " +
				...
				/*query = "select a.pk_seq as BGBLID, a.tungay,a.denngay, a.ten as BGBLTEN, a.trangthai as trangthai, d.ten as nguoitao, a.ngaytao as ngaytao, e.ten as nguoisua, a.ngaysua as ngaysua, " +
								"b.donvikinhdoanh as DVKDTENVIETTAT, c.ten as kenh, c.pk_seq as kenhId, b.pk_seq as dvkdId " +
						...
						"		and a.pk_seq in ( select BANGGIAMUANPP_FK from BANGGIAMUANPP_NPP where NPP_FK = '" + nppId + "' ) ";*/
