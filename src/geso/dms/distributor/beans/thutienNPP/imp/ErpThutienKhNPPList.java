...
public class ErpThutienKhNPPList  extends Phan_Trang  implements IErpThutienKhNPPList
{
	...
	public void init(String search)
	{
		...
		{			
			query =  
		     ...
		     " where a.NPP_FK= '"+ this.nppId +"' and a.trangthai != 2 ";*/
			 ...
			 " where a.NPP_FK= '"+ this.nppId +"' and a.noidungtt_fk = 100001 ";		
		}
		else
