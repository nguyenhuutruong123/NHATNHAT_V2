	...
	public void init(String search)
	{
		...
		else
		{
			query = "select a.PK_SEQ, a.trangthai, a.ngaydonhang, c.ten as nppTEN,  " +
					"	case when len ( isnull(c.tructhuoc_fk, -1) ) < 6 then  b.ten else d.ten end as khoTEN, NV.TEN as nguoitao, b.ten as khonhan, a.NGAYSUA, a.NGAYTAO, NV2.TEN as nguoisua, a.NPP_DACHOT,isnull(a.isKm,0) as isKm,isnull(a.isdhkhac,0) as isdhkhac   " +
					"	,a.sotienthu tongtien  "+
