...
public class XLkhuyenmaiTT 
{
	...
	{   
		...
		/*sql = " select a.pk_seq, a.scheme, a.tungay, a.denngay, a.loaict, a.kho_fk,  isnull(a.diengiai, '') as diengiai, d.ngansach, isnull(d.dasudung, '0') as dasudung from ctkhuyenmai a, ctkm_npp b, phanbokhuyenmai d ";
		sql = sql + " where a.loaict <> '3' and b.chon='1' and a.pk_seq = b.ctkm_fk and a.pk_seq = d.ctkm_fk and b.npp_fk = d.npp_fk and b.npp_fk='" + this.nppId + "' and a.tungay <= '" + date + "' and '" + date + "' <= a.denngay ";
		...
		sql =  "select a.pk_seq, a.scheme, a.tungay, a.denngay, a.loaict, a.kho_fk,  isnull(a.diengiai, '') as diengiai,  " +
				...
				"where a.loaict <> '3' and b.chon='1' and a.tungay <= '" + date + "' and '" + date + "' <= a.denngay   " +
