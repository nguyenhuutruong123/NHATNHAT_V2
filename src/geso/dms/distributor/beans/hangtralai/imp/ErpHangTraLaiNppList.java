...
public class ErpHangTraLaiNppList extends Phan_Trang implements IErpHangTraLaiNppList
{
	...
	public void init(String search)
	{
		...
		"			c.ten as nppTEN, a.NGAYSUA, a.NGAYTAO, NV2.TEN as nguoisua,isnull(npp.mafast,kh.maFAST) as khMA,isnull(kh.TEN,npp.ten)    as khTEN,kbh.TEN  as kbhTEN,a.SoHoaDon,a.Seri  "+				
