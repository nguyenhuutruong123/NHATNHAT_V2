...
import geso.dms.distributor.beans.reports.IBCPhanTichCongNoKH;
import geso.dms.distributor.db.sql.dbutils;

public class BCPhanTichCongNoKH implements IBCPhanTichCongNoKH, Serializable {
	...
	public void init1()
	{
		...
		//getNppInfo();
		String query ="select PK_SEQ, isnull(maFAST,'')+ ' - '+ TEN as TEN from KHACHHANG where TRANGTHAI = '1' and npp_fk ='"+ this.nppId +"' ";
