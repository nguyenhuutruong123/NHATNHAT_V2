...
public class TrakhuyenmaiNppList extends Phan_Trang implements ITrakhuyenmaiNppList 
{
	...
	public void init(String search) 
	{
		...
		if(search.length() == 0)
		{
			...
			query = "select a.pk_seq as ctkmId, a.SCHEME, a.diengiai as ctkmDiengiai, c.PK_SEQ as tkmId, c.DIENGIAI, c.HINHTHUC, a.TUNGAY, a.DENNGAY, isnull(d.trakm_fk, '0') as dathietlap " +
			...
			System.out.println("Query khoi tao du lieu: " + query + "\n");
		}
		else
			query = search;
