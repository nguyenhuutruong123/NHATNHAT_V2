...
public class ErpKhachhangdoihangList extends Phan_Trang implements IErpKhachhangdoihangList
{
	...
	public ErpKhachhangdoihangList()
	{
		this.tungay = "";
		this.denngay = "";
		this.nppTen = "";
	...
	public void init(String search)
	{
		...
		else
		{
			query = "select a.PK_SEQ, a.trangthai, a.ngaydenghi as ngaydonhang, c.ten as nppTEN, b.ten as khoTEN, NV.TEN as nguoitao, b.ten as khonhan, a.NGAYSUA, a.NGAYTAO, NV2.TEN as nguoisua   " +
					"from ERP_KhachHangdoihang a inner join KHO b on a.kho_fk = b.pk_seq inner join NHAPHANPHOI c on a.NPP_FK = c.pk_seq  " +
