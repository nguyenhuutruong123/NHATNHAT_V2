...
public class ChiTieuNhanVienList  extends Phan_Trang implements IChiTieuNhanVienList, Serializable
{
	/**
   * 
   */
  private static final long serialVersionUID = 8092745136245984000L;
	...
	public void init(String query)
	{
		...
		{
			sql = "select a.ma, a.pk_seq, isnull(a.thang,a.Quy) as Thang, a.nam, a.ten , a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua  " +
					"from ChiTieu a inner join NHANVIEN b on a.NGUOITAO = b.pk_seq inner join NHANVIEN c on a.NGUOISUA = c.pk_seq " +
					" where 1=1 and a.LoaiChiTieu='"+this.type+"' and a.tructhuoc_fk='"+this.tructhuocId+"' " ;
		}
		
		this.rsTieuchi = this.createSplittingData(super.getItems(), super.getSplittings(), "nam desc,thang desc", sql);
	}
