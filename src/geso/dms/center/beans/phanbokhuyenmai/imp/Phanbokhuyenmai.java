...
public class Phanbokhuyenmai implements IPhanbokhuyenmai, Serializable
{
	...
	private void getNppInfo()
	{
		...
		this.nppId=util.getIdNhapp(db, userId);  //getIdNhapp(this.userId,this.db);
	}
	...
	String vỉew = "";
	public String getVỉew() {
		return vỉew;
	}
	public void setVỉew(String vỉew) {
		this.vỉew = vỉew;
	}
	...
	@Override
	public String getPhanboTDV() {
		// TODO Auto-generated method stub
		return this.phanbotdv;
	}

	@Override
	public void setPhanboTDV(String phanbotdv) {
		// TODO Auto-generated method stub
		this.phanbotdv = phanbotdv;
	}
