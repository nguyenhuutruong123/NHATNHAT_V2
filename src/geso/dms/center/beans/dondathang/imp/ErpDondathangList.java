	...
	public void init(String search)
	{
		...
		else
		{
			query = 
					...
					+ "  and a.NPP_DACHOT = '1' and a.kbh_fk in "+util.quyen_kenh(this.userId);
		...
		System.out.println("DON DAT HANG KHO: " + query);
		this.DondathangRs =  createSplittingDataNew(db,50, 10, " trangthai asc,ngaydonhang desc ", query);
