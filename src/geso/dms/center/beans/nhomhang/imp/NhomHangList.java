...
public class NhomHangList  extends Phan_Trang implements INhomHangList
{
	...
	public NhomHangList(String id, String ma, String ten, String msg, String userId, dbutils db)
	{
		this.id = id;
		this.ma = ma;
		this.ten = ten;
	...
	public void init_search(String search)
	{
		this.nhomRs=this.db.get(search);
	}
