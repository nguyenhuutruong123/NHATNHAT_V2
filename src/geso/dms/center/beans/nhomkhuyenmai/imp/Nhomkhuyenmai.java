...
public class Nhomkhuyenmai implements INhomkhuyenmai, Serializable
{
	...
	public boolean saveNewNkm(){
		...
		command = "insert into nhomsanpham (DIENGIAI,NSP_PARENT_FK,LOAITHANHVIEN,NGAYTAO,NGAYSUA,NGUOITAO,NGUOISUA,TRANGTHAI,TEN,TYPE,loainhom) values(N'" + this.diengiai + "', '0', '2', '" + this.ngaytao + "', '" + this.ngaysua +"', '" + this.nguoitao + "', '" + this.nguoisua + "', '"+this.trangthai+"', N'" + this.ten + "','1','0')";
