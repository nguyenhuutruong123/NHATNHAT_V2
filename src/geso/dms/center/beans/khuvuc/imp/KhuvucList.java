...
public class KhuvucList implements IKhuvucList 
{
	...
	public void init(String search) 
	{
		...
		if (!Utility.isValid(search))
		{
			query = "\n select a.ma,a.pk_seq as id, a.ten as kvTen, a.trangthai as trangthai, " +
			"\n b.pk_seq as vmId, b.ten as vmTen, c.ten as nguoitao, a.ngaytao as ngaytao, " +
			"\n d.ten as nguoisua, a.ngaysua as ngaysua, a.diengiai " +
			"\n from khuvuc a, vung b, nhanvien c, nhanvien d " +
			"\n where a.vung_fk = b.pk_seq and a.nguoitao = c.pk_seq and a.nguoisua = d.pk_seq ";
		}
		else
		{
			query = search;
