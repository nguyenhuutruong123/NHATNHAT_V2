	...
	public ResultSet getMucdocungung(){
		...
		if(this.search.length()== 0 ){
			query = " select distinct " + 
					...
					" cast( (ddh_sp.soluong/qc.soluong1 + th.soluong) as decimal) as dadat, qc.soluong1 as quycach, kho.ten as kho, " +
					...
					" inner join erp_khott kho on kho.pk_seq=th.khott_fk  " +
					" order by ddh.ngaydat desc, loai " ;
		}else{
			query = search;
