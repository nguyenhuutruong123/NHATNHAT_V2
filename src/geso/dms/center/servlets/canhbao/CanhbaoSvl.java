...
public class CanhbaoSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    String nextJSP = request.getContextPath() + "/pages/Center/CanhBao.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if(action.equals("new"))
	    {
    		...
    		response.sendRedirect(request.getContextPath() + "/pages/Center/NganhHangNew.jsp");
	    }
	    else
	    {
	    	obj = new CanhbaoList();
    		...
    		response.sendRedirect(request.getContextPath() + "/pages/Center/CanhBao.jsp");	
	    }
	}
