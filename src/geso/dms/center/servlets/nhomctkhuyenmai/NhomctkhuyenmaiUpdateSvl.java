...
public class NhomctkhuyenmaiUpdateSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = request.getContextPath() + "/pages/Center/NhomCTKMUpdate.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
 		...
 		if(action.equals("save"))
 		{
    		if (id == null )
    		{
    			if (!nctkmBean.save())
    			{
    				...
    				String nextJSP = request.getContextPath() + "/pages/Center/NhomCTKMNew.jsp";
    				response.sendRedirect(nextJSP);
    			}
    			else
    			{
    				...
    				response.sendRedirect(request.getContextPath() + "/pages/Center/NhomCTKhuyenMai.jsp");	    	
    			}		
    		}
    		else
    		{
		...
		else
		{
			...
			if (id == null)
			{
				nextJSP = request.getContextPath() + "/pages/Center/NhomCTKMNew.jsp";
			}
			else
			{
				nextJSP = request.getContextPath() + "/pages/Center/NhomCTKMUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);
		}		
	}
