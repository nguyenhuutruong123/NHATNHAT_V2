...
public class PhieuThanhToanTTNewSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("update")){
			String nextJSP = request.getContextPath() + "/pages/Center/PhieuThanhToanTTUpdate.jsp";
			response.sendRedirect(nextJSP);
		}else if(action.equals("display")){
			String nextJSP = request.getContextPath() + "/pages/Center/PhieuThanhToanTTDiplay.jsp";
			response.sendRedirect(nextJSP);
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nppId = util.antiSQLInspection(request.getParameter("nhappid"));
    	...
    	String sotien = util.antiSQLInspection(request.getParameter("thanhtoan"));
		if (sotien == null)
			sotien = "0";
		try{
    	...
    	String ngayhoadon1=util.antiSQLInspection(request.getParameter("ngayhoadon1"));
    	...
    	if(action.equals("new") || action.equals("update")){
        	...
        	//System.out.println("tong so chuoi2:"+thanhtoan.length);
     		...
     		if(formname.equals("newform")){
     			nextJSP = request.getContextPath() + "/pages/Center/PhieuThanhToanTTNew.jsp";
     		}else{
     			nextJSP = request.getContextPath() + "/pages/Center/PhieuThanhToanTTUpdate.jsp";
     		}
				  ...
				  response.sendRedirect(nextJSP);
    				...
    				if(!obj.saveThanhToan())
    				{
		    			...
		    			session.setAttribute("obj", dh);		    					
		    			 nextJSP = request.getContextPath() + "/pages/Center/PhieuThanhToanTT.jsp";
		    			response.sendRedirect(nextJSP);
    				}
