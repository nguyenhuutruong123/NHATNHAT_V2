...
public class GioiHanCongNoTTNewSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  //truyen qua rskhuvuc
		...
		String nextJSP = request.getContextPath() + "/pages/Center/GioiHanCongNoTTUpdate.jsp";                                    
		response.sendRedirect(nextJSP);
	    	...
	    	obj.DeleteGioiHanCongNoTT();
	 		...
	 		String nextJSP = request.getContextPath() + "/pages/Center/GioiHanCongNoTT.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String formname=util.antiSQLInspection(request.getParameter("formname"));
		String nextJSP;
		if(formname.equals("newform")){
			nextJSP = request.getContextPath() + "/pages/Center/GioiHanCongNoTTNew.jsp";
		}else{
			nextJSP = request.getContextPath() + "/pages/Center/GioiHanCongNoTTUpdate.jsp";
		}
		...
		{		if(error ==false){
				if ((ghcnBean.SaveGioiHanCongNoTT())){	
					...
					session.setAttribute("obj", ghcnBean);
					 nextJSP = request.getContextPath() + "/pages/Center/GioiHanCongNoTT.jsp";
				}
				}
