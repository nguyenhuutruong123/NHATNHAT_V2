...
public class BangGiaUpdateSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String nextJSP = request.getContextPath() + "/pages/Center/BangGiaUpdate.jsp";
		if (querystring.indexOf("display") >= 0)
		{
			nextJSP = request.getContextPath() + "/pages/Center/BangGiaDisplay.jsp";
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
			...
			if (id == null)
			{
				if(loai.equals("0"))
				{
					if (!(csxBean.createBanggia_B2B()))
					{
						...
						String nextJSP = request.getContextPath() + "/pages/Center/BangGiaNew.jsp";
						response.sendRedirect(nextJSP);
					} else
					{
		...
		} else
		{
			...
			if (id != null)
			{
				nextJSP = request.getContextPath() + "/pages/Center/BangGiaUpdate.jsp";
			}
			response.sendRedirect(nextJSP);
		}
	}
