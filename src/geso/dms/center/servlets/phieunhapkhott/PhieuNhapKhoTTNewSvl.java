...
public class PhieuNhapKhoTTNewSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("update")){
			...
			String nextJSP = request.getContextPath() + "/pages/Center/PhieuNhapKhoTTUpDate.jsp";//default
			response.sendRedirect(nextJSP);
		}
		else if(action.equals("display")){
			String nextJSP = request.getContextPath() + "/pages/Center/PhieuNhapKhoTTDisplay.jsp";//default
			response.sendRedirect(nextJSP);
		}
		else if(action.equals("chot")){
			String nextJSP = request.getContextPath() + "/pages/Center/PhieuNhapKhoTTChot.jsp";//default
			response.sendRedirect(nextJSP);
		}
	}
	/**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] soluong = request.getParameterValues("soluong");
		 ...
		 String check=util.antiSQLInspection(request.getParameter("check"));
		  session.setAttribute("check",check);
		 //lay thong tin ve ngaynhapkho
		  String ngaynhapkho=util.antiSQLInspection(request.getParameter("ngaynhapkho"));
		  ctbean.setNgayNhap(ngaynhapkho);
		  
		  String	nextJSP;
		  String tenform=request.getParameter("tenform");	
			String khott=util.antiSQLInspection(request.getParameter("khott"));
		...
		if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {//truong hop co file dinh kem
		  ...
		  if(tenform.equals("newform")){
			  nextJSP= request.getContextPath() + "/pages/Center/PhieuNhapKhoTTNew.jsp";
		  }else{
			  nextJSP= request.getContextPath() + "/pages/Center/PhieuNhapKhoTTUpDate.jsp";
		  }
			  ...
			  if(ctbean.SavePhieuNhapKhoTT()){
				  ...
				  nextJSP= request.getContextPath() + "/pages/Center/PhieuNhapKhoTT.jsp";
			  }
				 ...
				 if(ctbean.ChotPhieuNhapKhoTT()){
					 ...
					 nextJSP= request.getContextPath() + "/pages/Center/PhieuNhapKhoTTChot.jsp";
				 }
			 }
