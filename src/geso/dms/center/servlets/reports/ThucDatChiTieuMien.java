...
public class ThucDatChiTieuMien extends HttpServlet {
	
	private static final long serialVersionUID = 1L; 
	
	public ThucDatChiTieuMien() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = request.getContextPath() + "/pages/Center/ThucDatChiTieuVung.jsp";
	...
	private void TaoBaoCao(com.aspose.cells.Workbook workbook, IStockintransit obj, int sheetNum )throws Exception
	{
		try
		{
			...
			//B1 Lấy tiêu chí
			query =  " select b.PK_SEQ, b.DIENGIAI, b.NHOMSP_FK, b.TIEUCHI, dbo.[Getthuong_chitieu](b.pk_seq,3,1"+
				 ") as noidung, b.loaiDS   "+
			...
			while( rs.next() )
			{
				...
				sqlThucdat02 += " left join dbo.ufn_KPI_Vung('" + dauthang + "', " + rs.getString("PK_SEQ") + ", " + rs.getString("TIEUCHI") + ", " + rs.getString("nhomsp_fk") + ") [" + rs.getString("PK_SEQ") + "] on a.PK_SEQ = [" + rs.getString("PK_SEQ") + "].NhanVien_FK ";
			...
			if( sqlThucdat01.trim().length() > 0 )
			{
				...
				queryTHUCDAT = "select a.PK_SEQ as manhanvien, " + sqlThucdat01 + " from vung a " + sqlThucdat02;
				...
				queryCHITIEU =   "\nselect manhanvien, tennhanvien, " + sqlTieuchi + 
								 ...
								 "\n	from CHITIEUNHANVIEN a inner join chitieunhanvien_vung b on a.pk_seq = b.CTNV_FK " + 
								 "\n		inner join VUNG c on b.NhanVien_FK = c.PK_SEQ " + 
