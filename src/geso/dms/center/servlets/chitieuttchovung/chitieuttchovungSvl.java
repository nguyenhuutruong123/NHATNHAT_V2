...
public class chitieuttchovungSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = request.getContextPath() + "/pages/Center/ChiTieuTTChoVung.jsp";//default
		...
		// TODO Auto-generated method stub
		    ...
		    else if(action.equals("new"))
		    {
		       ...
		       // List<ChiTieuTTKhuVuc> listkhuvuc=new ArrayList<ChiTieuTTKhuVuc>();
		    	...
		    	String	nextJSP= request.getContextPath() + "/pages/Center/ChiTieuTTChoVungNew.jsp";
		    	response.sendRedirect(nextJSP);
