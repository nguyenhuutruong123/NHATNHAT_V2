...
public class ChiTieuTTChoVungNewSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("update")){
			...
			String nextJSP = request.getContextPath() + "/pages/Center/ChiTieuTTChoVungUpdate.jsp";//default
			...
			*/
			...
			String nextJSP = request.getContextPath() + "/pages/Center/ChiTieuTTChoVungDisplay.jsp";//default
			response.sendRedirect(nextJSP);
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String loaichitieu=util.antiSQLInspection(request.getParameter("loaict"));
		...
		String[] sosku=request.getParameterValues("sosku");
		  ...
		  try{
			 tongchitieu= Double.parseDouble(util.antiSQLInspection(request.getParameter("tongchitieu")));
		  }catch(Exception ex){
		  ...
		  String check=util.antiSQLInspection(request.getParameter("chon"));
		  ...
		  if(tenform.equals("update")){
			  nextJSP= request.getContextPath() + "/pages/Center/ChiTieuTTChoVungUpdate.jsp";
		  }else{
			  nextJSP= request.getContextPath() + "/pages/Center/ChiTieuTTChoVungNew.jsp";
		  }
		  ...
		  if(action.equals("new")){ // mode them moi
			  if(loaichitieu.equals("0")){
				  if(ctbean.SaveChiTieu()){//truong hop nay them duoc,quay tro  lai trang main
				    ...
				    nextJSP= request.getContextPath() + "/pages/Center/ChiTieuTTChoVung.jsp"; 	 
			 }
			  }else{
