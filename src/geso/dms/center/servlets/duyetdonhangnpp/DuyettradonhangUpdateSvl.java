...
public class DuyettradonhangUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
        ...
        String nextJSP = request.getContextPath() + "/pages/Center/DuyetDonHangTraUpdate.jsp";
        
        if(request.getQueryString().indexOf("display") >= 0 ) 
        	nextJSP = request.getContextPath() + "/pages/Center/DuyetDonHangTraDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    String dhId = util.antiSQLInspection(request.getParameter("madonhang"));
	    if(dhId == null)
	    	dhId = "";
	    dtdhBean.setDhId(dhId);
	    
	    String ngaytra = util.antiSQLInspection(request.getParameter("tungay"));
