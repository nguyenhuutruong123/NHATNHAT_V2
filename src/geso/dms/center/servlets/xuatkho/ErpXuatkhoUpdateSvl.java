...
public class ErpXuatkhoUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
    		...
    		{
    			nextJSP = request.getContextPath() + "/pages/Center/ErpXuatKhoUpdate.jsp";	
    		}
    		else
    		{
    			nextJSP = request.getContextPath() + "/pages/Center/ErpXuatKhoDisplay.jsp";
    		}
			...
			{	
				...
				else
				{
					if(!lsxBean.update())
					{
						lsxBean.createRs();
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = request.getContextPath() + "/pages/Center/ErpXuatKhoUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
