...
public class KhuvucUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    String id = "";
        String nextJSP = request.getContextPath() + "/pages/Center/KhuVucUpdate.jsp";
        id = util.antiSQLInspection(request.getParameter("update"));
        if(action.equals("display")) {
        	nextJSP = request.getContextPath() + "/pages/Center/KhuVucDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String khuvuc = util.antiSQLInspection(util.antiSQLInspection(request.getParameter("khuvuc")));
		if (khuvuc == null)
			khuvuc = "";				
    	kvBean.setTen(khuvuc);
    	
    	String vung = util.antiSQLInspection(util.antiSQLInspection(request.getParameter("vungmien")));
		if (vung == null)
			vung = "";				
    	kvBean.setVmId(vung);
    	String asm = util.antiSQLInspection(util.antiSQLInspection(request.getParameter("asm")));
    	if(asm == null)
    		asm="";
    	kvBean.setAsm(asm);
		...
		String Ma = util.antiSQLInspection(util.antiSQLInspection(request.getParameter("Ma")));
		if (Ma == null)
			Ma = "";
		kvBean.setMa(Ma);
		...
		String trangthai = util.antiSQLInspection(util.antiSQLInspection(request.getParameter("trangthai")));
	    ...
	    if (!error){
	    	if(action.equals("save"))
	    	{
	    		...
	    		String nextJSP;
	    		if (id == null){			
	    			nextJSP = request.getContextPath() + "/pages/Center/KhuVucNew.jsp";
	    		}else{
	    			nextJSP = request.getContextPath() + "/pages/Center/KhuVucUpdate.jsp";   						
	    		}
	    		response.sendRedirect(nextJSP);
