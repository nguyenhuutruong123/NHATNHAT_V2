   ...
   static final long serialVersionUID = 1L;
	...
	private void CreateDondathangHPC(Document document, ServletOutputStream outstream, IDondathang ddhBean) throws IOException
	{
		try{			
			...
			String[] th = new String[]{"Mã Code", "Diễn Giải", "Quy cách", "DV", "Đơn Giá NPP", "Đặt hàng"};
			String[] th2 = new String[]{"(Trước VAT)", "Số Lượng", "Thùng", "TT(Trước VAT)"};
...
//				if(j % 2 != 0) 	font4.setColor(BaseColor.GREEN);
				...
				cell[6] = new PdfPCell(new Paragraph("Thùng", font4));		
			...
			cell12 = new PdfPCell(new Paragraph("Xác Nhận Giám Sát ICP", new Font(bf, 11, Font.BOLD)));
