        ...
        else if(action.equals("display"))
        {
        	...
        	{        		
        		IERP_DonDatHang dhBean=new ERP_DonDatHang(ddhId);
   		 	  	...
   		 	  	{   		 	  		
   		 	  		nextJSP = request.getContextPath() + "/pages/Center/Erp_DonMuaHangKmDisplayDuyet.jsp";
   		 	  	}
   		 	  	else
   		 	  	{
   		 		nextJSP = request.getContextPath() + "/pages/Center/Erp_DonDatHangDisplayDuyet.jsp";
   		 	  	}
        	...
        	else
        	{
        		...
        		String  nextJSP = request.getContextPath() + "/pages/Center/Erp_DonTraHangDisplayDuyet.jsp";
        		session.setAttribute("obj", dhBean);
        		response.sendRedirect(nextJSP);     	
        	}
        	return;
		        ...
		        String nextJSP = request.getContextPath() + "/pages/Center/Erp_KTDuyetDonHang.jsp";
		        response.sendRedirect(nextJSP);
