...
public class TrakhuyenmainppUpdateSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (userId.length()==0)
 		...
 		if(action.equals("delete"))
 		{
 			xoa(id);
 				...
 				String nextJSP = request.getContextPath() + "/pages/Center/TraKhuyenMaiNpp.jsp";
		...
		String nextJSP = request.getContextPath() + "/pages/Center/TraKhuyenMaiNppNew.jsp";
		response.sendRedirect(nextJSP);
 		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		    ...
		    if(tongtien == null)
		    	tongtien ="0";
		    obj.setTongtien(tongtien.replaceAll(",", ""));
