		...
		else 
		{
			...
			if(q != null)
			{
				...
				try 
				{
					...
					rs.close();
					header = 
					/*"Hộp thư đến  <span class=\"label label-danger pull-center\">"+ soTB +"</span>";*/
					...
					header +=
						...
						"<span class=\"dropdown-item dropdown-header\">Hộp thư đến</span>";
					
				} 
				catch(Exception e) 
				{
					header = //"Hộp thư đến <span class=\"label label-danger pull-center\">0</span>";
						"<li class=\"nav-item dropdown\"> "+
						"<a class=\"nav-link\" data-toggle=\"dropdown\" href=\"#\"> " +
						"<i class=\"far fa-lg fa-bell\"></i> " +
						"</a> " +
				...
				footer_div = 
					...
					"<div class=\"dropdown-divider\"></div> " +
					"<a href=\"../../ThongbaoSvl?userId="+ id +"&task=1\" class=\"dropdown-item dropdown-footer\">Xem thông báo</a> " +
					"</div> </li> ";
