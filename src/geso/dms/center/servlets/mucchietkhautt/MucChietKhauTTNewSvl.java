...
public class MucChietKhauTTNewSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if (action.equals("update")){	   		  	    	
	    	...
	    	String nextJSP = request.getContextPath() + "/pages/Center/MucChietKhauTTUpdate.jsp";                                    
	    	response.sendRedirect(nextJSP);
	    }else if(action.equals("delete")){
	    	obj.DeleteMucChietKhauTT();
	    	 obj.setListMucChietKhau("");
	 		session.setAttribute("obj", obj);	 				
	 		String nextJSP = request.getContextPath() + "/pages/Center/MucChietKhauTT.jsp";	 		                                     
	 		response.sendRedirect(nextJSP);
	    }
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String mucchietkhau = util.antiSQLInspection(request.getParameter("mucchietkhau"));
		...
		if(formname.equals("newform")){
			nextJSP = request.getContextPath() + "/pages/Center/MucChietKhauTTNew.jsp";
		}else{
			nextJSP = request.getContextPath() + "/pages/Center/MucChietKhauTTUpdate.jsp";
		}
		...
		{		if(error ==false){
				if ((ghcnBean.SaveMucChietKhauTT())){	
					...
					session.setAttribute("obj", ghcnBean);
					 nextJSP = request.getContextPath() + "/pages/Center/MucChietKhauTT.jsp";
				}
				}
