...
public class HoaDonKMNewSvl extends HttpServlet {
    ...
    //	System.out.println(sql_infonpp);
		...
		//Lấy danh sách các chương trình khuyễn mãi được chọn
		...
		if(action.equals("save"))//thuc hien save lai don hàng
		{
			if(id == null)
			{
		...
		}else if(action.equals("loadnpp")){//trường hợp load lại nhà phân phối
			session.setAttribute("nhappid", nhappid);
