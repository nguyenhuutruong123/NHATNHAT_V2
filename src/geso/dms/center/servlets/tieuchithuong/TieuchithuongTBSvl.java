...
public class TieuchithuongTBSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	PrintWriter out;
   
    public TieuchithuongTBSvl() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if(action.trim().equals("duyet"))
	    {
	    	...
	    	db.update("update TieuchithuongTB set trangthai = '1' where pk_seq = '" + ctskuId + "'");
	    	db.shutDown();
	    }
	    ...
	    String nextJSP = "/SGP/pages/Center/TieuChiThuongTB.jsp";
	...
	private void XoaChiTieu(String ctskuId) 
	{
    	...
    	try 
    	{
			...
			System.out.println("delete TieuchithuongTB_TIEUCHI where thuongdp_fk = '" + ctskuId + "'");
	    	if(!db.update("delete TieuchithuongTB_TIEUCHI where thuongdp_fk = '" + ctskuId + "'"))
	    	{
	    		db.getConnection().rollback();
				return;
	    	}
	    	
	    	if(!db.update("delete TieuchithuongTB where pk_seq = '" + ctskuId + "'"))
			{
				db.getConnection().rollback();
				return;
			}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    {
    		ITieuchithuongTB tctsku = new TieuchithuongTB();
    		...
    		response.sendRedirect("/SGP/pages/Center/TieuChiThuongTBNew.jsp");
	    }
	    else
	    {
	    	obj = new TieuchithuongTBList();
		    obj.setUserId(userId);
    		...
    		response.sendRedirect("/SGP/pages/Center/TieuChiThuongTB.jsp");	
	    }
	}
	
	private String getSearchQuery(HttpServletRequest request, ITieuchithuongTBList obj) 
	{
		...
		String sql = "select a.scheme, a.pk_seq, a.thang, a.nam, a.diengiai, a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua  " +
					"from TieuchithuongTB a inner join NHANVIEN b on a.NGUOITAO = b.pk_seq " +
