...
public class TieuchithuongSKUUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/SGP/pages/Center/TieuChiThuongSKUUpdate.jsp";
        if(querystring.indexOf("display") >= 0)
        	nextJSP = "/SGP/pages/Center/TieuChiThuongSKUDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) 
			{	
				...
				if (filename.length() > 0)
				{
					if(!readExcel(filename,userId,tctskuBean))
					{
						...
						{
							    nextJSP =  "/SGP/pages/Center/TieuChiThuongSKUUpdate.jsp";
						}
						else nextJSP =  "/SGP/pages/Center/TieuChiThuongSKUNew.jsp";
				...
				{
					String nextJSP =  "/SGP/pages/Center/TieuChiThuongSKUNew.jsp";
		   ...
		   String id = util.antiSQLInspection(request.getParameter("id"));
			...
			String phaidat =  util.antiSQLInspection(request.getParameter("phaidat"));
			if (phaidat == null)
				phaidat = "";
			tctskuBean.setPhaidat(phaidat);
			
			String thuong =  util.antiSQLInspection(request.getParameter("thuong"));
			if (thuong == null)
				thuong = "";
			tctskuBean.setThuong(thuong);
			
			String thuongtoida = util.antiSQLInspection(request.getParameter("thuongtoida"));
			if(thuongtoida == null)
				thuongtoida = "";
			tctskuBean.setThuongtoida(thuongtoida);
			
			String thuongGS =  util.antiSQLInspection(request.getParameter("thuongGS"));
			if (thuongGS == null)
				thuongGS = "";
			tctskuBean.setThuongGS(thuongGS);
			
			String thuongtoidaGS = util.antiSQLInspection(request.getParameter("thuongtoidaGS"));
			if(thuongtoidaGS == null)
				thuongtoidaGS = "";
			tctskuBean.setThuongtoidaGS(thuongtoidaGS);
			...
			for(int i = 0; i < dkkmId.length; i++)
			{
				...
				{*/
					String diengiaiD = request.getParameter("nhomsanpham" + Integer.toString(i) + ".diengiai");
					if(diengiaiD == null)
						diengiaiD = "";
 		...
 		{    
    		...
    		if (id == null )
    		{
    			...
    			else
    			{
				    ...
				    String nextJSP = "/SGP/pages/Center/TieuChiThuongSKU.jsp";
					response.sendRedirect(nextJSP);
    			}	
    		}
    		else
		...
		{		
			...
			String nextJSP;
			if (id == null){
				nextJSP = "/SGP/pages/Center/TieuChiThuongSKUNew.jsp";
			}
			else{
				nextJSP = "/SGP/pages/Center/TieuChiThuongSKUUpdate.jsp";   						
			}
