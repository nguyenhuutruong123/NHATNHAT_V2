...
public class AjaxTctSKU extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String tongluong = request.getParameter("trongso");
		String sanpham = request.getParameter("sanpham");
		String thuongSS = request.getParameter("thuongSS");
		String thuongTDSS = request.getParameter("thuongTDSS");
		String thuongSR = request.getParameter("thuongSR");
		String thuongTDSR = request.getParameter("thuongTDSR");
		String thuongASM = request.getParameter("thuongASM");
		String thuongTDASM = request.getParameter("thuongTDASM");
