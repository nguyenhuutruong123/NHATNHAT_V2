...
public class ThongkekhaosatSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    String nextJSP = request.getContextPath() + "/pages/Center/ThongKeKhaoSat.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(action.equals("xuatBC"))
		{
			...
			try 
			{
				...
				if(tungay.trim().length() >=0)
					query +=" and  convert(varchar(10), [NGÀY TRẢ LỜI],120) >='" + tungay + "'"; 
				if(denngay.trim().length() >=0)
					query +=" and  convert(varchar(10), [NGÀY TRẢ LỜI],120) <='" + denngay + "'"; 
				
				query+=" order by  [NGÀY TRẢ LỜI] ";
		...
		else
		{
			...
			response.sendRedirect(request.getContextPath() + "/pages/Center/ThongKeKhaoSat.jsp");	
		}
