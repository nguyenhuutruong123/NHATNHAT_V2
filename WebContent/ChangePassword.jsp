...
<form name="passForm" method="post" action=request.getContextPath() + "/LoginSvl">
...
<table width="100%"	height="35%" border="0" cellpadding="0" cellspacing="0">
  	<tr bgcolor="#FFFFFF">
    	<td width="14%" height="52"  align="right" valign="middle" colspan=2><img style="display:none;" src="pages/images/dms.jpg" height="80px" align="right" /></td>
	...
	<tr class="tblightrow" height="1">
  	...
  	<tr class="tblightrow" height="1">
  		<td  colspan="2" align="right" class="blanc"><%=Utility.GLanguage("Nhập lại",session,jedis) %> mật mã mới&nbsp;		</td>
	  	<td class="blanc" align="left">	
