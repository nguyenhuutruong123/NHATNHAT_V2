				...
				<TR>
					<TD align="left" class="tbnavigation">
					   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation"> &nbsp;Mua hàng từ nhà cung cấp >Mua hàng từ nhà PP khác  
							   <TD colspan="2" align="right" class="tbnavigation">Chào mừng  <%= tennhapp %>&nbsp;</tr>
						</TABLE>
					</TD>
		  </TR>
			<TR>
				...
				<FIELDSET><LEGEND class="legendtitle">&nbsp;<%=Utility.GLanguage("Tiêu chí tìm kiếm",session,jedis) %></LEGEND>
							...
							<TR>
									<TD class="plainlabel"> Chi nhánh / NPP bán hàng</TD>
									<TD class="plainlabel">
						...
						<TR>
							...
							<TABLE width="100%" border="0" cellspacing="1px" cellpadding="4px">
								<TR class="tbheader">
									...
									<TH align="center"><%=Utility.GLanguage("Nhà phân phối",session,jedis) %> bán</TH>
									...
									while (dhlist.next()){	
										...
										<%}%>
												...
												<TABLE border = 0 cellpadding="0" cellspacing="0">
													...
													<TR><TD>
														<A href = "../../MuaHangNhaPPKhacSvl?userId=<%=userId%>&update=<%=dhlist.getString("pk_seq") %>"><img src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A>
													</TD>
													<TD>&nbsp;</TD>
														</TR>
													<%}else{ %>
													<TR><TD>
														<A href = "../../MuaHangNhaPPKhacSvl?userId=<%=userId%>&display=<%=dhlist.getString("pk_seq") %>"><img src="../images/Display20.png" alt="Hien thi" width="20" height="20" longdesc="Hien thi" border = 0></A>
													</TD></TR>
													<%} %>
												</TABLE>
												</TD>
