...
<form name ="tctsku" method="post" action="../../DonhangtraTBUpdateSvl" >
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý trưng bày > Đơn hàng trả trưng bày > Cập nhật</TD> 
