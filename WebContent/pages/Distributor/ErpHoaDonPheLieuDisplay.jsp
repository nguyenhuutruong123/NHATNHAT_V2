				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý bán hàng > Bán hàng OTC > Xuất HĐ khác > Hiển thị</TD> 
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">                        
			                  ...
			                  <TR  >
			                        ...
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input type="text"  id="tienvat" name="tienvat" style="text-align:right;" value="<%= obj.getThuevat() %>"   > 
			                        </TD>          
			                  </TR> 
