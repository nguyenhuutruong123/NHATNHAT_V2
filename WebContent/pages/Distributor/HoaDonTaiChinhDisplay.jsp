...
<%  
	...
	ResultSet Rsspkm=lsxBean.getRsspkm();
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng OTC > Xuất HĐTC > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
        	...
        	<% String ur = Utility.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"HoadontaichinhSvl?userId="+userId);  %>			
     ...
     <%--      <A href="../../HoadontaichinhPdfSvl?userId=<%= lsxBean.getUserId() %>&id=<%= lsxBean.getId() %>&task=hoadon" >
                ...
                <TR>
         								...
         								while(ddhRs.next()){ %>
  										...
  										<% 
   										 if(lsxBean.getDondathangId().contains(ddhRs.getString("pk_seq").trim())){%>
       										<TD align="center"><input type ="checkbox" checked="checked" name ="ddhid" value ="<%= ddhRs.getString("pk_seq") %>" onclick="return false;" ></TD>
       									<%}else{ %>
       										<TD align="center"><input type ="checkbox" id="ddhid" name ="ddhid" value ="<%= ddhRs.getString("pk_seq") %>" onclick="return false;" ></TD>
       									<%}%>
   										</tr>
   									<% } ddhRs.close(); } %>                   								                  							
                   			</table>
                    ...
                    <TD class="plainlabel" colspan="2" valign="bottom" >
                		<table class="plainlabel" width="100%"  style="padding-top:0 ; margin-top:0">                 								                   								                   								
                  				<tr>
                  					<td width="190">Tổng tiền(đã có chiết khấu) </td>
                  					<td>
                  				...
                  				<tr>
                  					...
                  					<td>
                  						...
                  						<%System.out.println("tien sau vat la "+lsxBean.getTongtienAVAT()); %>
                  					</td>
                  				</tr>
                  		</table>
                  	</TD>  
				...
				<%
					...
					if(spMa != null)
					{
						...
						<tr>
							...
							<td>
								<input type="text" name="scheme"  value="<%=0 %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event); " >							
							</td>
					...
					<tr>
							<td>
								<input type="hidden" name="spId1" value="<%=Rsspkm.getString("SPID") %>" style="width: 100%"   > 
								<%-- <input type="hidden" name="spLoai" value="<%= spLoai[i] %>" style="width: 100%"   >  --%>
								<input type="text" name="spMa1" value="<%= Rsspkm.getString("MA") %>" style="width: 100%"  readonly="readonly"  > 
							</td>
							<td> <input type="text" name="spTen1" value="<%= Rsspkm.getString("ten") %>" style="width: 100%" readonly="readonly"> </td>
							<td>
								<input type="text" name="donvi1" value="<%= Rsspkm.getString("donvi") %>" style="width: 100%; text-align: right;" readonly="readonly">							
							</td>
							<td>
								<input type="text" name="soluong1" value="<%= formater.format(Double.parseDouble(Rsspkm.getString("soluong"))) %>" style="width: 100%; text-align: right;" readonly="readonly">							
							</td>
							<td>
								<input type="text" name="spDongia1" value="<%= formatter2.format(Double.parseDouble("0")) %>" style="width: 100%; text-align: right;" readonly="readonly">							
							</td>
							<td>
								<input type="text" name="spVat1" value="<%= formater.format(Double.parseDouble("0")) %>" style="width: 100%; text-align: right;" readonly="readonly">							
							</td>
							<td>
								<input type="text" name="spChietkhau1" value="<%= formater.format(Double.parseDouble("0")) %>" style="width: 100%; text-align: right;" readonly="readonly">							
							</td>
							<td>
								<input type="text" name="spTienthue1" value="<%= formater.format(Double.parseDouble("0")) %>" style="width: 100%; text-align: right;" readonly="readonly">							
							</td>
							<td>
								<input type="text" name="thanhtien1" value="<%= formater.format(Double.parseDouble("0")) %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event); " >							
							</td>
							<td>
								<input type="text" name="scheme1"  value="<%=0 %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event); " >							
							</td>
