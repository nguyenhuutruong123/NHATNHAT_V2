            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" border = "0">							
       			...
       			<TR>
                    ...
                    <TD class="plainlabel" colspan = 5>
                        <input type="text" style="text-align: right;" name="sotienthanhtoan" id = "sotienthanhtoan" 
                        		value="<%= formatter.format(Double.parseDouble(tthdBean.getSotientt().replaceAll(",","")))%>"  AUTOCOMPLETE="off" onchange="PhanBoTien();"> 
                     </TD>
                ...
                <TR>
    	             ...
    	             <TD class="plainlabel" valign="top" colspan = 5>
						<input type="text"  id="thuduoc" name="thuduoc" value="<%= formatter.format(Double.parseDouble(tthdBean.getThuduoc().replaceAll(",",""))) %>"  style="text-align: right;"  onchange="ThanhToan(100);" onKeyPress = "return keypress(event);"/>
					 </TD>
                </TR>
    	            ...
    	            for(i = 0; i < hoadonList.size(); i++)
                	{
                		IHoadonKHTT hoadon = hoadonList.get(i);
	               		...
	               		<tr>
           	 				...
           	 				<td align="center">
           	 					<input type="hidden" style="width: 100%;" value="<%= hoadon.getKhId() %>" name= "nppId"  >
           	 					<input type="text" style="width: 100%;" value="<%= hoadon.getKhMa() %>" name= "nppMa"  >           					
           	 				</td>
           	 				<td align="center">
