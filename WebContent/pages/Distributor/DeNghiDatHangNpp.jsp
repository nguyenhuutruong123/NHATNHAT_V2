                                                ...
                                                <%}else if (dndhlist.getString("trangthai").equals("1")) {%>
                                                 ...
                                                 <%} %>
                            	                    ...
                            	                    <TABLE border = 0 cellpadding="0" cellspacing="0">
                                        	            ...
                                        	            <% if (dndhlist.getString("trangthai").equals("0")){ %>
														<TD>
				         	                    			<A href = "../../DenghidathangnppSvl?userId=<%=userId%>&delete=<%=dndhlist.getString("chungtu") %>"><img src="../images/Delete20.png" alt="Xóa" onclick="if(!confirm('Bạn chắc chắn muốn xóa đề nghị đặt hàng này không?')){ return false;}" width="20" height="20" longdesc="Xóa" border = 0 "></A>
                                        	            </TD>      
                                        	            <%} %>                                  	            
