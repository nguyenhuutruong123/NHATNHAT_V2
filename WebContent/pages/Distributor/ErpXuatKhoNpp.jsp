...
<% IErpXuatkhoList obj = (IErpXuatkhoList)session.getAttribute("obj"); %>
...
<% obj.setNextSplittings();
	...
	if(!util.check(userId, userTen, sum)){
		...
		int[] quyen = new  int[6];
		quyen = util.Getquyen("ErpXuatkhoSvl","",userId);
%>
...
<body>
<form name="ckParkForm" method="post" action="../../ErpXuatkhoSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý kho trung tâm > Xuất kho
        </div>
        	...
        	<fieldset>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" style="width: 14%" >Nhà phân phối</TH>
                 		...
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <% if(tt.equals("1")){ %>
                                ...
                                <%if(quyen[Utility.SUA]!=0){ %>
                                	<A href = "../../ErpXuatkhoUpdateSvl?userId=<%=userId%>&update=<%= nhapkhoRs.getString("PK_SEQ") %>"><img src="../images/Chot.png" alt="Duyệt xuất kho" title="Duyệt xuất kho" width="20" height="20" border=0 ></A>&nbsp;
                                <% } %>
                                
                                 <%if(quyen[Utility.XOA]!=0){ %>
                              	<A href = "../../ErpXuatkhoSvl?userId=<%=userId%>&delete=<%= nhapkhoRs.getString("PK_SEQ") %>"><img src="../images/Delete20.png" alt="Xóa" title="Xóa" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn bỏ duyệt yêu cầu xuất kho này?')) return false;"></A>
                              	    <% } %>
                              										
		                    <%} else{ %>
		                    
		                    	<%if(quyen[Utility.XEM]!=0){ %>
		                    		<A href = "../../ErpXuatkhoUpdateSvl?userId=<%=userId%>&display=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>
		                    	<% } %>
