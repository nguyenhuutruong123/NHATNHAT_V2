...
<%
	System.out.println("");
		...
		IErpThutienKhacNPP btthBean = (IErpThutienKhacNPP) session.getAttribute("obj");
		
		int count = 0;

			count = btthBean.getCount() ;
		
		System.out.println("Count jsp: " + count);
		...
		String url = util.getUrl("ErpThutienKhacNPPSvl","&view="+btthBean.getView())+" > Cập nhật";
%>
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0"
	...
	<form name="btth" method="post"
		action="../../ErpThutienKhacNPPUpdateSvl">
					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
						...
						<TR>
							<TD height="100%" width="100%">
								<FIELDSET>
									<LEGEND class="legendtitle" style="color: black">Thu tiền khác</LEGEND>
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										...
										<TR>
											<TD class="plainlabel" valign="middle" width="120px">Người nộp tiền</TD>
