...
<form name="ckForm" method="post" action="../../ChuyenkhoSvl">
							...
							<TD>
								<TABLE width="100%" border="0" cellspacing="1" cellpadding="2">
									<TR class="tbheader">
											...
											<TH align="center" width="16%"><%=Utility.GLanguage("NHÂN VIÊN BÁN HÀNG",session,jedis) %></TH>
											...
											<TH align="center" width="16%"><%=Utility.GLanguage("Người tạo",session,jedis) %> </TH>
											<TH align="center" width="10%"><%=Utility.GLanguage("Ngày sửa",session,jedis) %></TH>
											<TH align="center" width="16%"><%=Utility.GLanguage("Người sửa",session,jedis) %> </TH>
									...
									{ 
										...
										<TD align="center" valign="middle">
											<% if(ckRs.getString("trangthai").equals("0")) {%>
												<A href = "../../ChuyenkhoUpdateSvl?userId=<%=userId%>&update=<%= ckRs.getString("pk_seq") %>"><img src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A>&nbsp;
												<A href = "../../ChuyenkhoSvl?userId=<%=userId%>&delete=<%= ckRs.getString("pk_seq") %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa phiếu chuyển kho này?')) return false;"></A>&nbsp;
												<A href = "../../ChuyenkhoSvl?userId=<%=userId%>&chotphieu=<%= ckRs.getString("pk_seq") %>" > <img src="../images/Chot.png" alt="Chot phieu chuyen" width="20" height="20" longdesc="Chot phieu chuyen" border = 0 onclick="if(!confirm('Bạn có muốn chốt phiếu chuyển kho này?')) return false; "></A>
											<%}else{ %>
												<A href = "../../ChuyenkhoUpdateSvl?userId=<%=userId%>&display=<%= ckRs.getString("pk_seq") %>"><img src="../images/Display20.png" alt="Hien thi" width="20" height="20" longdesc="Hien thi" border = 0></A>
