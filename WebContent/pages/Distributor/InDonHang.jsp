				...
				<TR>
					<TD align="left" class="tbnavigation">
					   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation"> &nbsp;Xử lý đơn hàng > Đơn hàng bán
						...
						<TR>
							...
							<TABLE width="100%" border="0" cellspacing="1px" cellpadding="4px">
								<TR class="tbheader">
									...
									<th width="6%" align="left"><%=Utility.GLanguage("Trạng thái",session,jedis) %></th>
									<th width="7%" align="center">Ngày DH</th>
									<th width="7%" align="center"><%=Utility.GLanguage("Ngày tạo",session,jedis) %></th>
									<th width="6%" align="left"><%=Utility.GLanguage("Người tạo",session,jedis) %></th>
									<th width="6%" align="center"><%=Utility.GLanguage("Ngày sửa",session,jedis) %></th>
									<th width="6%" align="left"><%=Utility.GLanguage("Người sửa",session,jedis) %> </th>
									...
									while (m < size){
										...
										<%}%>
												...
												<TABLE border = 0 cellpadding="0" cellspacing="0" >
													<TR><TD>
														<A href = "../../InDonhangSvl?userId=<%=userId%>&display=<%=donhang.getId() %>"><img src="../images/Display20.png" alt="Hien thi" width="20" height="20" longdesc="Hien thi" border = 0></A>
														<A href = "../../InDonHangpdfSvl?userId=<%=userId%>&display=<%=donhang.getId() %>"><img src="../images/Printer30.png" alt="In don hang" width="20" height="20" longdesc="Hien thi" border = 0></A>
													</TD>
													</TR>
												</TABLE>
												</TD>
