...
//							alert("I am here 1");
		...
		{
			if( _sotienTT.item(i).value != '' && _sotienTT.item(i).value != '0' )
			{
				var thanhtoanTONG = _sotienTT.item(i).value.replace(/,/g,"");
				document.getElementsByName("thanhtoan2").item(i).value = thanhtoanTONG;
				
				var chungloaiTEN = document.getElementsByName(_hdId.item(i).value + "_clTen");
				var chungloaiSOTIEN = document.getElementsByName(_hdId.item(i).value + "_clSotien");
				var chungloaiTHANHTOAN = document.getElementsByName(_hdId.item(i).value + "_clThanhtoan");
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
       ...
       <A href="../../ErpThutienNPPPdfSvl?userId=<%= tthdBean.getUserId() %>&inBangke=<%= tthdBean.getId() %>" >
	        <IMG src="../images/Printer30.png" title="In bảng kê thu tiền" alt="In bảng kê thu tiền" border ="1px" style="border-style:outset"></A>
    </div>
    	...
    	<legend class="legendtitle"> Thu tiền</legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" border = "0">						
                  ...
                  <% if(tthdBean.getHinhthucTT().equals("Chuyển khoản")) {%>   
                   <TR>
	                     <TD class="plainlabel">Số tài khoản </TD>
	                  		<TD class="plainlabel" colspan="3" >                      
	                  		<select name="sotaikhoan" id="sotaikhoan" style="width: 610px" >                        	
	                        	<%
	                        		if(sotkRs != null)
	                        		{
	                        			try
                ...
                <TR>    
                       <TD class="plainlabel">Khách hàng</TD>
                  		<TD class="plainlabel" colspan="3">                        
                  		<select name="khSearchId" style="width: 610px" onChange="ChangeSearch();" class="select2"  >
                           <option value=""> </option>
                        	<%
                        		if(khList != null)
                        		{
                        			...
                        			while(khList.next())
                        			{  
                        			if( tthdBean.getKhIds().equals(khList.getString("pk_seq")) ){ %>
                 ...
                 <TR>
                    <TD class="plainlabel">Tìm đối tác</TD>
                  		<TD class="plainlabel" colspan="3">                        
                  		<select name="nppSearchId" style="width: 610px" multiple="multiple" onChange="ChangeSearch();" class="select2"  >
                           <option value=""> </option>
                        	<%
                        		if(nppList != null)
                        		{
                 ...
                 <%if(tthdBean.getNhanvienBHIds().trim().length() > 0 || tthdBean.getNhanvienGNIds().trim().length() > 0 || tthdBean.getKhIds().trim().length() > 0 || tthdBean.getNppIds().trim().length() > 0   ){ %>
                    ...
                    <%-- <TR>
                      <TD class="plainlabel">Tìm hóa đơn tài chính</TD>
                  		<TD class="plainlabel" colspan="3">                        
                  		<select name="hdId" id="hdId" style="width: 610px" multiple="multiple" onChange="ChangeSearch();" class="select2"  >
                            <option value=""> </option>
                        	<%
                        		if(hdTCList != null)
                        		{
             ...
             <%} %>
       			<TR>
                    ...
                    <TD class="plainlabel" >
                        <input type="text" style="text-align: right;" name="tongtien" id = "tongtien" 
            ...
            <TABLE class="tabledetail" width="100%" border="0" cellpadding="1" cellspacing="1" >
                ...
                <TR class="tbheader">
                	...
                	<TH align="center" width="9%">Tổng số tiền<br /> (đã có VAT)</TH>
               	 	<TH align="center" width="9%">Thanh toán (VNĐ)</TH>
               	 	<TH align="center" width="9%">Còn lại</TH>
               	 	<TH align="center" width="9%">Số tiền KH<br /> đưa dư</TH>
               	 	<TH align="center" width="8%">Chiết khấu<br /> tháng</TH>
                ...
                <TR>                	
                  ...
                  <% 	String sohoadon="";
                     		...
                     		String thanhtoanna = tthdBean.get_add_thanhtoan().replaceAll(",","");
                     		if(thanhtoanna==""||thanhtoanna== null)
                     			thanhtoanna="0";
                     		
                     	%>
                     <TD class="plainlabel">
                     	<input type="text" style="width: 100%;" readonly value="<%=tthdBean.get_add_makh() %>" id= "add_madt"  name= "add_madt"  >                     	  
                     </TD>
                     ...
                     <TD class="plainlabel">
                     	<input type="text" style="width: 100%;" name= "add_sohoadon" id= "add_sohoadon" value="<%=sohoadon %>"  onKeyPress = "return keypress(event);">
                     </TD>
                     
                     <TD class="plainlabel">
                    	<input type="text" style="width: 100%;" class="days" id="add_ngayhd" value="<%=tthdBean.get_add_ngayhd() %>" name="add_ngayhd" />
                   	 </TD> 
                     
                     <TD class="plainlabel">
                     	<input type="text" style="width: 100%;" readonly="readonly" name= "add_trangthai" value="" >
                     </TD>
                     ...
                     <td align="center">
           	 		...
           	 		<td align="center">
           	 			<input type="text" style="width: 100%; text-align: right;" name= "add_thanhtoan" id= "add_thanhtoan" value="<%= formatter.format(Double.parseDouble(thanhtoanna)) %>"  onchange="ThanhToan(500)" onkeyup="Dinhdang(this)" onKeyPress = "return keypress(event);">
           	 		</td>
           	 		...
           	 		<%if(tthdBean.get_add_makh()!=""){ %>
           	 		<td align="center">
           	 			<input type="checkbox" id="add_check" name="add_check" checked="checked" onchange="ThanhToan(500)">             	 		
           	 		</td>
           	 		<%} else{ %>
           	 		<td align="center">
                ...
                <%   
    	            ...
    	            for(i = 0; i < hoadonList.size(); i++)
                	{
                		...
                		if(hsTHANHTOAN.get(hoadon.getId()) != null)
                			thanhtoan = hsTHANHTOAN.get(hoadon.getId());
                		...
                		String chungloaiCN = hoadon.getChungloai();
	               		%>
           	 			...
           	 			<%if(hoadon.getTrangthaihd().equals("Đã hủy") || hoadon.getTrangthaihd().equals("Đã xóa") ) {%>
           	 				<td align="center">							           	 				
           	 					<input type="text" style="width: 100%; text-align: left; color: red;" value="<%= hoadon.getTrangthaihd() %>" name= "trangthaihd" readonly="readonly" >          	 				
           	 				</td>
	               		<%}else{ %>
           	 				 <td align="center">							           	 				
           	 			...
           	 			<%} %> 
           	 				...
           	 				<td align="center">
           	 					<input type="text" readonly="readonly" style="width: 60%; text-align: right;" value="<%= formatter.format(Double.parseDouble(hoadon.getThanhtoan().replaceAll(",",""))) %>" name= "thanhtoan" id="thanhtoan<%= i %>"  onchange="ThanhToan(500);" onKeyPress = "return keypress(event);">
			                            	...
			                            	<%
				                        		if(chungloaiCN.trim().length() > 0 )
				                        		{
				                        			...
				                        			<tr>
				                        				...
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_clSotien" value="<%= formatter.format(Utility.parseDouble(detail[1]) - datra) %>" readonly="readonly">
				                        				</td>
				                        				<td >
				                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_clThanhtoan" value="<%= formatter.format(tudeXUAT) %>" onkeyup="TinhTongTT('<%= hoadon.getId() %>');" >
				                        				</td>
				                        			</tr>
...
<%
	...
	if(noptienList != null) noptienList.close(); 
