...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        		Quản lý trưng bày > Đề nghị thanh toán trưng bày > Cập nhật
        </div>
        ...
        <TABLE width="100%" cellpadding="5px" cellspacing="0px">
             <TR>
                ...
                <TD class="plainlabel" colspan="2">
                    <select name="cttbTen" id="cttbTen" >
                        <option value="">&nbsp;</option>
                            <% if(cttrungbay != null){
                ...
                <% if(khSelectedList != null){
				  	try{ while(khSelectedList.next()){ m++; %>
    					 <tr class="tbdarkrow">
		                    ...
		                    <td align="center">
		                    	<input type="text" name="soxuat" id="<%= "soxuat" + Integer.toString(m) %>" value="<%= khSelectedList.getString("soxuat") %>" style="text-align:right" size="6" readonly></td>
		                    <td align="center">
	     			...
	     			<%} khSelectedList.close(); }catch(java.sql.SQLException e){e.printStackTrace();} }%>  
	     		<% if(khList != null){
	     			...
	     			<%} khList.close(); }catch(java.sql.SQLException e){e.printStackTrace();} }%>              
                <tr class="plainlabel"><td colspan="8">&nbsp;</td></tr>
             </table>
        </div>  
    </fieldset>
    </div>   
