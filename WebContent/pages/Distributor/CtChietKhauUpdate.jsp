 ...
 function RemoveDisable()
	{
	 	...
	 	document.getElementById("hopdongId").removeAttribute('disabled');	
	...
	<TR>
		<TD colspan="4" align='left' valign='top' bgcolor="#FFFFFF">
					   ...
					   <table width="100%" border="0" cellpadding="0" cellspacing="0">
						   <tr height="22">
 							   <TD align="left" colspan="2" class="tbnavigation">
 							   		&nbsp;Quản lý bán hàng&gt;Đơn hàng ETC  &gt;Chiết khấu bác sĩ&gt; Cập nhật/Hiển thị </TD>
			...
			<TR ><TD >
				...
				<%if(  bgblcBean.getTrangthai().equals("0")){ %>
		...
		<TABLE width="100%"  border = "0" cellspacing="0" cellpadding="0">
		 		...
		 		<TR>
									<TD width="120px" class="plainlabel">Khách hàng</TD>
										...
										<SELECT name="khId" id = "khId"  disabled>
											  <option value=""> </option>
											  <% if(khRs != null){
											  	try{ while(khRs.next()){ 
	                                 ...
	                                 <TD width="120px" class="plainlabel">Hợp đồng</TD>
										<TD class="plainlabel" width="250px" >
										<SELECT name="hopdongId" id = "hopdongId"   disabled >
											  <option value=""> </option>
											  <% if(hopdongRs != null){
														...
														<TH width="30%">Chiết khấu</TH>		
															...
															while(sanpham.next())
															{
																...
																if(sanpham_chietkhau!= null && sanpham_chietkhau.containsKey(bacsiId+ "-" +spId))
																	ckStr =  sanpham_chietkhau.get(bacsiId+ "-" +spId).toString();	
																 if (j % 2 != 0) {%> 
																<TR class= '<%=lightrow%>'> <%
																} else {%> 
																<TR class= "<%=darkrow%>"> <%} %> 
