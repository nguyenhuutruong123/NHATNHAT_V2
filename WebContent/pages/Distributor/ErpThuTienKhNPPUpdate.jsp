...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Phiếu thu tiền - KH > Cập nhật
        </div>
                		...
                		double thanhtoan = Double.parseDouble(hoadon.getThanhtoan().replaceAll(",",""));
	               		...
	               		<tr>           	 				
			                  ...
			                  <input type="text" style="width: 100%;" value="<%= hoadon.getKhMa() %>" name= "khMa" readonly="readonly" >                  
           	 				...
           	 				<td align="center">
           	 					<input type="text" style="width: 100%; text-align: right;" value="<%= formatter.format(thanhtoan) %>" name= "thanhtoan" id="thanhtoan<%= i %>"  onchange="ThanhToan(500)" onKeyPress = "return keypress(event);">
           	 				</td>
