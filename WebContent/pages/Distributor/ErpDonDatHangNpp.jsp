...
<head>
    ...
    <SCRIPT language="javascript" type="text/javascript">
	 ...
	 {   
	    ...
	    document.forms["ckParkForm"].ddh.value = "";
	  //document.forms["ckParkForm"].nppId.value = "";
	  	document.forms["ckParkForm"].iskm.value = "";
	    document.forms["ckParkForm"].submit();
	 }
	 function thongbao()
	 {
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý tồn kho > Mua hàng từ nhà cung cấp > Đơn đặt hàng
        </div>
            ...
            <legend class="legendtitle"> <%=Utility.GLanguage("Tiêu chí tìm kiếm",session,jedis) %></legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >
                     ...
                     <TR>
                        ...
                        <TD class="plainlabel" width="100px" ><%=Utility.GLanguage("Trạng thái",session,jedis) %> </TD>
                        <TD class="plainlabel" width="250px" >
                        ...
                        <TD class="plainlabel" width="100px">Mã đơn đặt hàng</TD>
                        <TD class="plainlabel"  >
                            <input type="text"  name="ddh" value="<%=obj.getMaDDH() %>" maxlength="10" onchange="submitform();" />
                        </TD>             
                    </TR>    
        	...
        	<fieldset>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" style="width: 8%">Loại đơn hàng</TH>
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="center"><%= nhapkhoRs.getString("NGAYDONHANG") %></TD>
		                      <TD align="center">
		                    	<%=nhapkhoRs.getString("isdhkhac").equals("1")?"Đơn hàng khác, KM":"Đơn hàng bán" %>
		                    </TD>
		                    ...
		                    <TD ><%= nhapkhoRs.getString("khoTEN") %></TD>  
		                    	...
		                    	<%
		                    		...
		                    		{
		                    			if((tt.equals("1") && NPP_DACHOT.equals("1")) || (tt.equals("0") && NPP_DACHOT.equals("1")) ) //Sua dk thanh && tu ||
		                    			{
		                    				trangthai = "Chờ duyệt";
		                    			}
		                    			else if(tt.equals("2"))
							...
							<TD align="center"><%= formatter2.format(nhapkhoRs.getDouble("tongtien")) %></TD>
										
		                    <TD align="center"> 
		                    <% if(tt.equals("0") && NPP_DACHOT.equals("0") ){ %>
		                    	
		                    	<%if(quyen[Utility.SUA]!=0){ %>
                                	<A href = "../../RouterSvl?task=<%= Util.dongMa(getServletContext().getInitParameter("RedirectNoScript")+"ErpDondathangNppUpdateSvl?userId="+userId+"&update="+nhapkhoRs.getString("PK_SEQ")+"") %>"><IMG src="../images/Edit20.png" alt="Cập nhật" title="Cập nhật" border=0></A>&nbsp;
                                <%} %>	
		                    ...
		                    <%} else{ %>
		                    	...
		                    	<%if(quyen[Utility.XEM]!=0){ %>
		                    		<A href = "../../RouterSvl?task=<%= Util.dongMa(getServletContext().getInitParameter("RedirectNoScript")+"ErpDondathangNppUpdateSvl?userId="+userId+"&display="+ nhapkhoRs.getString("PK_SEQ")+"") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>
		                   		<%} %>
		                    <% } %>
		                    </TD>
		                </TR>
