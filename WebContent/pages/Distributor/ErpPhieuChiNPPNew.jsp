...
<%
	System.out.println("");
		...
		String url = util.getUrl("ErpPhieuChiNPPSvl","&view="+btthBean.getView())+" > Tạo mới";
%>
...
$( document ).on( "mousemove", function( event ) {
	...
	document.forms["btth"].pageX.value = event.pageX;
	document.forms["btth"].pageY2.value = event.pageY;
							...
							<TD height="100%" width="100%">
								<FIELDSET>
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										...
										<TR class="plainlabel">
											<TD colspan="4">
												<a class="button3" id="themclick"  href="javascript: addThem()" >
									...
									<table cellpadding="0px" cellspacing="1px" width="100%">
										...
										<TR>
											<TD align="center" >
												<select style="width:150px " name="nghiepvuketoanId" id="nghiepvuketoanId_<%=i%>" onchange="nghiepvuChange('<%=i%>',this);">
														<option value=""></option>
														<%
