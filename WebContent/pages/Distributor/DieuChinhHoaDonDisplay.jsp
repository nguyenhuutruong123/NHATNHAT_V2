                   									...
                   									<td>                   										
                   										...
                   										<% 
                   										 if(htbddh.containsValue(ddhRs.getString("pk_seq").trim())){%>
                       											<TD align="center"><input type ="checkbox" checked="checked" name ="ddhid" value ="<%=ddhRs.getString("pk_seq") %>" ></TD>
                       											<%}else{ %>
                       											<TD align="center"><input type ="checkbox" id="ddhid" name ="ddhid" value ="<%=ddhRs.getString("pk_seq") %>"></TD>
                       											<%}
                   											%>
                   										</tr>
                   									<%} %>                   								                  							
