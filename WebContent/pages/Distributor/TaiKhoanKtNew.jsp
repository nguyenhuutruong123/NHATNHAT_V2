<%@page import="com.cete.dynamicpdf.Document"%>
		...
		<TD colspan="4" align='left' valign='top' bgcolor="#ffffff">
			<TABLE width="100%">
				<TR>
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Kế toán > Tài khoản kế toán > Tạo mới </TD>
			...
			<TABLE width="100%" border="0" cellpadding="3" cellspacing="0">
				<TR ><TD >
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									<TD width="30" align="left"><A href="../../TaikhoanketoanSvl?userId=1000" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
						   ...
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									<TR>
									  ...
									  <TD  class="plainlabel" ><input maxlength="50" type="text" class="txtsearch" size="20" id="SoHieuTaiKhoan" name="SoHieuTaiKhoan" value="<%= tkktBean.getSoHieuTaiKhoan() %>"></TD>
								  </TR>
								  <TR>
								  ...
								  <TR>
								 	...
								 	<TR>
								   		...
								   		<%-- <TR>
						    				...
						    				<TD width="80%" class="plainlabel" >
						   						<select id="CongTyId"  name="CongTyId" >
													<option value=""> </option>
												<%
												if(CongTyRs != null)
												{
