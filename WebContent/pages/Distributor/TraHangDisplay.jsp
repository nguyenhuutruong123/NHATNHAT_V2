...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:50%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Trả hàng > Hiển thị
        </div>
				                    ...
				                    <table width="95%" align="center">
		                            	...
		                            	<%
			                        		...
			                        		if(soloRs != null)
			                        		{
			                        			...
			                        			<tr>
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= spRs.getString("spId") %>_spSOLUONG" value="<%= formatter.format(soloRs.getDouble("SOLUONG")) %>" readonly="readonly" >
			                        				</td>
			                        				<td>
