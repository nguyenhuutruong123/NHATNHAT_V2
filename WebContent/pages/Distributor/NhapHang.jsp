                                	                    ...
                                	                    <TR><TD>
                                	                    	<% if (nhaphanglist.getString("trangthai").equals("0") ) {%>
                                	                    		...
                                	                    		<%if(quyen[Utility.SUA]!=0){ %>
	                                    	                    	<A href = "../../RouterSvl?task=<%= Util.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"NhaphangUpdateSvl?userId="+userId+"&update="+nhaphanglist.getString("chungtu")+"") %>"><img src="../images/Chot.png" alt="Nhận hàng" width="20" height="20" longdesc="Nhận hàng" border = 0 "></A>
																<%} %>
																
															<%}else{ %>
															
																<%if(quyen[Utility.XEM]!=0){ %>
                                	                    			<A href = "../../RouterSvl?task=<%= Util.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"NhaphangUpdateSvl?userId="+userId+"&display="+nhaphanglist.getString("chungtu")+"") %>"><img src="../images/Display20.png" alt="Hiển thị" width="20" height="20" title="Hiển thị" longdesc="Hiển thị" border = 0 "></A>
