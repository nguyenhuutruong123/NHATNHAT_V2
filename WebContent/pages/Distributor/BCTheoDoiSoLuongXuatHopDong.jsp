...
<body>
<form name="erpDmhForm" method="post" action="../../BCTheoDoiSoLuongXuatHopDong">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	&#160; Quản lý bán hàng > Báo cáo > Báo cáo theo dõi số lượng xuất của hợp đồng
        </div>
    ...
    <div align="left" style="width: 100%; float: none; clear: left">
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> Báo cáo theo dõi số lượng xuất của hợp đồng </legend>
