								...
								<TABLE width="100%" border="0" cellspacing="1" cellpadding="2">
									...
									while (m < size){
										...
										<%}%>
												...
												<TD>&nbsp;</TD>
												<TD>
													<A href = "../../GioihancongnoSvl?userId=<%=userId%>&delete=<%= ghcn.getId()%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có chắc chắn muỗn xóa  GioiHanCongNo này?')) return false;"></A></TD>
												</TR></TABLE>
												</TD>
											</TR>
								<%m++; }%>
