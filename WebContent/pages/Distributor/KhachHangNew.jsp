 ...
 <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
							...
							<TD align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										...
										<TD colspan="2" align="right" class="tbnavigation"><%=Utility.GLanguage("Chào mừng bạn",session,jedis) %>  <%= khBean.getNppTen() %>&nbsp;
									</tr>
								</table></TD>
						</TR>
					</TABLE>
						...
						<TR>
							<TD height="100%" width="100%">
								<FIELDSET>
									...
									<TR>
									<TD class="plainlabel" colspan="1">Mã khách hàng<FONT class="erroralert"> *</FONT></TD>
									<TD class="plainlabel" colspan="1" ><INPUT readonly type="text" name="maFAST" value="<%= khBean.getMaFAST() %>" ></TD>
									<TD class="plainlabel" colspan="1">Vị trí khách hàng
									</TD>
									...
									<TR>
											<TD  class="plainlabel" colspan="1">Tên khách hàng<FONT class="erroralert"> *</FONT>
											</TD>
											<TD class="plainlabel" colspan="1"><INPUT type="text" name="khTen" id="khTen" value="<%= khBean.getTen() %>">
											</TD>
											<TD class="plainlabel" colspan="1">Loại khách hàng</TD>
											<TD  class="plainlabel"  colspan="3" >
									...
									<TR> 
									<TD class="plainlabel" colspan="1">Tên cửa hiệu<!-- <FONT class="erroralert"> *</FONT> -->
												</TD>
											  <TD class="plainlabel" colspan="1"><INPUT type="text"
												name="tencuahieu" id="tencuahieu" value = "<%=khBean.getTencuahieu()%>"></TD>
												<TD class="plainlabel" colspan="1">Hạng khách hàng</TD>
								...
								<!-- 	<TD class="plainlabel" colspan="1">Nhóm khách hàng </TD>
									...
									<TR>
									<TD class="plainlabel" colspan="1">Người mua hàng<!-- <FONT class="erroralert"> *</FONT> -->
									</TD>
											<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="nguoimuahang" id="nguoimuahang"
												value="<%= khBean.getNguoimuahang() %>" size="40">
											</TD>
									<TD class="plainlabel" colspan="1">Thành thị nông thôn</TD>
											<TD  class="plainlabel" colspan="3">
									...
									<TR>
									<TD class="plainlabel" colspan="1">Địa chỉ giao hàng<FONT
									...
									<TR>
									<TD class="plainlabel" colspan="1">Số nhà <!-- <FONT class="erroralert"> *</FONT> -->
									</TD>
									<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="sonha" id="sonha" value = "<%=khBean.getSonha()%>"></TD>
									<TD class="plainlabel" colspan="1">Tên đường <!-- <FONT class="erroralert"> *</FONT> -->
												</TD>
									<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="tenduong" id="tenduong" value = "<%=khBean.getTenduong()%>"></TD>
								 	<TD class="plainlabel" colspan="1">Ấp/khóm/tổ </TD>
									<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="apto" id="apto" value = "<%=khBean.getApto()%>"></TD> 
									</TR>
									<TR>
									<TD class="plainlabel" colspan="1">Tỉnh /Thành phố<FONT
												class="erroralert"> *</FONT>
											</TD>
											<TD class="plainlabel" colspan="1"><SELECT name="tpId" id="tpId" 
												onChange="submitform();">
													<option value=""></option>
													<% 
													if (tp!=null)
									...
									<TD  class="plainlabel" colspan="1">Quận/Huyện <FONT
												class="erroralert"> *</FONT>
											</TD>
											<TD  class="plainlabel" colspan="1"><SELECT name="qhId"
											...
											<TD class="plainlabel" colspan="1">Phường xã <FONT class="erroralert">*</FONT></TD>
											 <TD class="plainlabel" >
									...
									<TR>
											<TD class="plainlabel" colspan="1">Ngày sinh</TD>
											<TD class="plainlabel" colspan="1">
											<INPUT type="text" class="days" name="ngaysinh" readonly value="<%= khBean.getNgaysinh() %>" >
											</TD>
											<TD class="plainlabel" colspan="1">Mã số thuế</TD>
											<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="masothue" value="<%= khBean.getMasothue() %>"
												size="15">
											</TD>
												
											<TD class="plainlabel" colspan="1">CMND</TD>
											<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="cmnd" value="<%=khBean.getCmnd() %>">
											</TD>
									</TR>
									<TR>
											<TD class="plainlabel" colspan="1">Điện thoại</TD>
											<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="dienthoai" value="<%= khBean.getSodienthoai() %>"
												size="15">
											</TD>
											<TD class="plainlabel" colspan="1">Di động</TD>
											<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="didong" value="<%= khBean.getDidong() %>"
												size="15">
											</TD>
												<TD class="plainlabel" colspan="1">Mã hợp đồng</TD>
											<TD class="plainlabel" colspan="1"><INPUT type="text"
										...
										<TR>
										<TD class="plainlabel" colspan="1">Mức chiết khấu</TD>
											<TD class="plainlabel" colspan="1"><input type="text"
										...
										<TR>
											<TD class="plainlabel" colspan="1">Số tiền nợ</TD>
											<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="sotienno" value="<%=formatter.format(khBean.getSotienno()) %>"
												size="11">
											</TD>
										<TD class="plainlabel" colspan="1">Số ngày nợ</TD>
											<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="songayno" value="<%=formatter.format(khBean.getSongayno()) %>"
												size="15">
											<TD class="plainlabel" colspan="1">Mã kho SAP</TD>
											<TD class="plainlabel" colspan="1">
										...
										<TD class="plainlabel" colspan="1"><%=Utility.GLanguage("NHÂN VIÊN BÁN HÀNG",session,jedis) %></TD>
											...
											<TD class="plainlabel"  colspan="1">Nhân viên giao nhận
											</TD>
											...
											<TD  class="plainlabel"> 
											 ...
											 <TD  class="plainlabel">NPP Khác</TD>
											<TD class="plainlabel" colspan="3">
									 	...
									 	<TR>
										<TD class="plainlabel" colspan="1">Vợ/chồng</TD>
										<TD class="plainlabel" colspan="1"><INPUT type="text"
												name="vochong" id="vochong" value = "<%=khBean.getVochong()%>"></TD>
										<TD class="plainlabel" colspan="1">Ngày sinh vợ/chồng</TD>
									...
									<%} %>								
										...
										<TD width="120px" class="plainlabel" valign="top" >Giới tính</TD>
									...
									<TD class="plainlabel">Mối quan hệ với chủ nhà thuốc </TD>	
									<TD  class="plainlabel" ><INPUT type="text" name="moiquanhe" 
									id="moiquanhe" value="<%= khBean.getMoiquanhe() %>" size="40"></TD>
									
									<TD class="plainlabel">Thời gian gặp chủ nhà thuốc </TD>	
								...
								try{while(tbhRs.next()){ 
									if (i % 2 != 0) {%>
										...
										<TR class=<%= darkrow%>>
											...
											<TD align="center">
												<% 
												String[] tenloaicuahang = Utility.getTanSo(); //new  String[] {"F1-1","F1-2","F1-3","F1-4","F2-1","F2-2","F4","F8"} ; 
									  			String[] idloaicuahang = Utility.getTanSo(); //new  String[] {"F1-1","F1-2","F1-3","F1-4","F2-1","F2-2","F4","F8"}  ;
								  %> <select style="width: 130px" name="tanso">
								       	...
								       	%>
											...
											<TD align="center">
											<input name="tbhId" id = "tbhId" type="checkbox" value="<%= tbhRs.getString("tbhId") %>" checked>
	...
	<TABLE style="display:none;" width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR>
							<TD colspan="6" width="100%">
								<FIELDSET>
									<LEGEND class="legendtitle">Chiết khấu program</LEGEND>
									<table align="left" cellpadding="0px" cellspacing="1px" width="100%">
										<tr class="tbheader">
											...
											<th align="center" width="20%">Program</th>
											<th align="center" width="20%">Chiết khấu</th>
						...
						<TR>
								<TD style="padding : 7px;">
												<a class="btn btn-default" href="javascript: addThem(this)" > Thêm sản phẩm
	                           					</a>
											</TD>
