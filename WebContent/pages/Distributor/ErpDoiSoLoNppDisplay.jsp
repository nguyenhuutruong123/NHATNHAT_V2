...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:50%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Xuất chuyển, đổi hàng > Đổi số lô > Hiển thị
        </div>
                 ...
                 <table width="100%" cellpadding="0px" cellspacing="1px">
                    ...
                    <% try { 
                    	...
                    	while(spRs.next()){
                    		...
                    		String solo = sp_solo.get( spRs.getString("spId") + "__" + spRs.getString("soloOLD") + "__" + spRs.getString("NgayHetHanOLD")     ) != null ? sp_solo.get(spRs.getString("spId") + "__" + spRs.getString("soloOLD")  + "__" + spRs.getString("NgayHetHanOLD")       ) : "";
                    		String soluong = sp_sl.get(spRs.getString("spId") + "__" + spRs.getString("soloOLD") + "__" + spRs.getString("NgayHetHanOLD")    ) != null ? formatter.format(Double.parseDouble(Integer.toString(sp_sl.get(spRs.getString("spId") + "__" + spRs.getString("soloOLD")+ "__" + spRs.getString("NgayHetHanOLD")     )))) : "";
                    		String ngayhethan = sp_ngayhethan.get(spRs.getString("spId") + "__" + spRs.getString("soloOLD")+ "__" + spRs.getString("NgayHetHanOLD")     ) != null ? sp_ngayhethan.get(spRs.getString("spId") + "__" + spRs.getString("soloOLD")+ "__" + spRs.getString("NgayHetHanOLD")   ) : "";
                    	%>
		    			<tr class="tbdarkrow">
	                    	<td>
	                    	...
	                    	<td>
	                    		<input type="text" name="soloOLD" value="<%= spRs.getString("soloOLD") %>" style="width: 100%" readonly="readonly">	
	                    	</td>
	                    	
	                    	<td>
	                    		<input type="text" name="ngayhethanOLD" value="<%= spRs.getString("NgayHetHanOLD") %>" style="width: 100%" readonly="readonly">	
	                    	</td>
