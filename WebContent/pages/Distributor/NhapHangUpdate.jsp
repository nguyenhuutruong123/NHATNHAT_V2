...
<% 
	String[] spPK_SEQ = lsxBean.getPK_SEQ();
	...
	function Update_SoLuong()
	{
			...
			console.log('tphn tram'+ phantram);
				 ...
				 for(var i = 0; i < spMa.length; i++)
					...
					var tongtienKMHidden = document.getElementById("tongtienKMHidden").value ;
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                 ...
                 <TR>
                    ...
                    <TD class="plainlabel" valign="top" width="130px" >Tổng tiền</TD>
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
				...
				<%
					...
					if(spMa != null)
					{
						...
						<tr <%= style %> >
							<td >
								<input type="hidden" name="spPK_SEQ" value="<%= spPK_SEQ[i] %>" style="width: 100%"   > 
							...
							<td>
								<input type="text" name="soluong" value="<%= spSoluong[i] %>" style="width: 100%; text-align: right; background-color: silver; " onkeypress="return keypress(event); " onkeyup="Dinhdang(this);" readonly="readonly" >							
							</td>
							<td>
							...
							if(kmRs != null)
								...
								%>
									<tr>
										...
										<td>
											<input type="text"  value="" style="width: 100%;text-align: right; color: red" readonly  > 
										</td>
										...
										<td>
											<input type="text"  value="<%= formater.format( kmRs.getDouble("soluong")) %>" style="width: 100%; color: red ; text-align: right;" readonly> 
										</td>
										<td>
