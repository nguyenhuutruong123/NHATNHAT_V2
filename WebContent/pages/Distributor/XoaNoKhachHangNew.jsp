...
<% IXoanokhachhang nvgnBean = (IXoanokhachhang)session.getAttribute("nvgnBean");
   ...
   String[] hdLoaiHd = nvgnBean.getHdLoaiHd();
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý công nợ > Xóa nợ khách hàng > Tạo mới
        </div>
        ...
        <div style="float:none; width:100%" align="left">
            <table width="100%" cellspacing="0" cellpadding="6px">
                ...
                <TR>
                    ...
                    <TD  class="plainlabel">
                        <INPUT type="text" name="sotientu" id= "sotientu"    size="15" value="<%= nvgnBean.getSotientu() %>" onKeyPress = "return keypress(event);"  onchange="DinhDang();">
                    </TD>

                     <TD class="plainlabel">Số tiền đến</TD>
                     <TD  class="plainlabel">
                        <INPUT type="text" name="sotienden"  id= "sotienden"  size="15" value="<%= nvgnBean.getSotienden() %>" onKeyPress = "return keypress(event);"  onchange="DinhDang1();"></TD>
                </TR>
                <TR>
	             ...
	             <table width="100%" border="0" cellspacing="1" cellpadding="1">
						...
						<TR>
							...
							<TD align="center">
							    ...
							    <%System.out.println("Loaihd:"+hdLoaiHd[i] );%>
							    <input type="hidden" name="loaihd"  value="<%= hdLoaiHd[i]%>" >
							...
							<TD align="left">
								<input type="text" name="hdsohoadon" style="width: 100%" value="<%= hdSohd[i] %>" >
							</TD>
							<TD align="left">
								<input type="text" name="hdkyhieu" style="width: 100%" value="<%= hdKyhieu[i]%>" >
							</TD>
							<TD align="left">
								<input type="text" name="hdsotien" style="width: 100%" value="<%= formatter.format(Double.parseDouble(hdSotien[i])) %>" >
							</TD>									
							<TD align="center">
							<% if (hdChon[i].equals("1")){ %>
								<input name="hdids" id="hdids"  value="<%= hdId[i] %>" type="checkbox"  checked  onChange="UnCheckedAll()">
							<%}else{ %>											
								<input name="hdids" id="hdids" type="checkbox" value="<%= hdId[i] %>"  onChange="UnCheckedAll()">
							<%} %>
						</TD> 
	                    </TR> <%
							} %> 
