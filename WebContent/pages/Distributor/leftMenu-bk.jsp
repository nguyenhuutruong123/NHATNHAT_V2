...
<ul id="theMenu">
	...
	<ul style="display: block;">
		...
		<ul id="xtraMenu1">
			...
			<ul style="display: none;">
				...
				<li>
				<h5 class="head"><a
					href="../../GioihancongnoSvl?userId=<%=userId %>" target="content">Mức
				tín dụng </a></h5>
				</li>
				<li>
				<h5 class="head"><a
	...
	<ul style="display: block;">
		...
		<ul id="xtraMenu7">
			<li>
			<h5 class="head"><a
				href="../../ChiTieuNppSvl?userId=<%=userId %>" target="content">Chỉ
			tiêu Secondary</a></h5>
			</li>
			<li>
			<h5 class="head"><a
				href="../../ChiTieuNppPriSvl?userId=<%=userId %>" target="content">Chỉ
			tiêu Primary</a></h5>
			</li>
	...
	<ul style="display: block;">
		...
		<ul id="xtraMenu2">
			...
			<ul style="display: none;">
				...
				<li>
				<h5 class="head"><a
					href="../../DondathangSvl?userId=<%=userId %>" target="content">Đặt
				hàng</a></h5>
				</li>
				<li>
				<h5 class="head"><a
					href="../../NhaphangSvl?userId=<%=userId %>" target="content">Nhận
				hàng</a></h5>
				</li>
			...
			<h5 class="head"><a
				...
				target="content">Mua hàng từ Đối tác khác</a></h5>
			</li>
			...
			<ul style="display: none;">
				...
				<li>
				<h5 class="head"><a
					href="../../SecondarySalesPurchaseInventoryReportDis?userId=<%=userId %>"
	...
	<ul style="display: block;">
		...
		<ul id="xtraMenu3">
			...
			<li>
			<h5 class="head"><a
				href="../../PhieuxuatkhoSvl?userId=<%=userId %>" target="content">Phiếu
			xuất kho</a></h5>
			</li>
			<li>
			<h5 class="head"><a
	...
	<ul style="display: block;">
		<li>
			<h5 class="head"><a
				href="../../PhieuthutienSvl?userId=<%=userId %>" target="content">
			Phiếu thu tiền </a></h5>
			</li>
		<li>
			<h5 class="head"><a
				href="../../PhieuthanhtoanSvl?userId=<%=userId %>" target="content">
			Phiếu thanh toán</a></h5>
			</li>
	...
	<ul style="display: block;">
		...
		<ul id="xtraMenu5">
			...
			<li>
				<h5 class="head" ><a href="../../TrakhuyenmaiNppSvl?userId=<%=userId %>" target="content" ><%=Utility.GLanguage("Sản phẩm",session,jedis) %> trả khuyến mãi</a></h5>
			</li> 
			<li>
		...
		<li>
			<ul id="xtraMenu4">
				<li>
					...
					<li>
						<li>
								<h5 class="head"><a href="../../KPInpp?userId=<%=userId %>"	target="content">Yếu tố nền tảng của NVBH</a></h5>
						</li>
					</li>
					</ul>
				</li>
					...
					<ul style="display: block;">
						...
						<li>
							...
							<h5 class="head"><a
								...
								target="content">Bảng kê tiền thu trong ngày</a></h5>
						</li>
					</ul>
				</li>			
		</ul>
