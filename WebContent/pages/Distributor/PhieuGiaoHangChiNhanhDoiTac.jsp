...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng> Bán hàng ETC / Đối tác > In phiếu giao hàng
        </div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle">In phiếu giao hàng ETC/Đối tác </span>&nbsp;&nbsp;
            	 </legend>
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    <TH align="center" style="width: 7%" >Mã số</TH>
	                    <TH align="center" style="width: 10%" >Ngày xuất HĐ</TH>
	                    <TH align="center" style="width: 10%" >Số hóa đơn</TH>
	                    <TH align="center" style="width: 20%" >Khách hàng ETC/Đối tác</TH>
	                    <TH align="center" style="width: 10%" >Tổng giá trị</TH>
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <%= trangthai %></TD>	
		                    <TD align="center">
		                    	<A href = "../../PhieugiaohangchinhanhdoitacPdfSvl?userId=<%=userId%>&pdf=<%= nhapkhoRs.getString("PK_SEQ") %>&nppId=<%= obj.getNppId()%>"><IMG src="../images/pdf.jpg" title="In phiếu giao hàng ETC / Đối tác" width="20" height="20" border=0 ></A>		                    
		                    </TD>
		                </TR>
                     <% m++; }  }  else {%>
