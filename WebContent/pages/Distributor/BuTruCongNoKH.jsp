                ...
                <TR>
                    <TD align="left" class="tbnavigation">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr height="22">
                                <TD align="left" colspan="2" class="tbnavigation">Quản lý công nợ > Bù trừ công nợ KH</TD>
      			                            ...
      			                            <%} %>
                                                ...
                                                <TABLE border = 0 cellpadding="0" cellspacing="0">
                                                    ...
                                                    { %>
	                                                    ...
	                                                    <TD>
	                                                        <A href = "../../ButrucongnoUpdateSvl?userId=<%=userId%>&update=<%=btcnList.getString("id")%>"><img src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cập nhật" border ="0" ></A>
	                                                    </TD>
	                                                    <%} %>
	                                                    <TD>&nbsp;</TD>
	                                                    <%if(quyen[Utility.CHOT]!=0){ %>
	                                                     <TD>
	                                                        <A href = "../../ButrucongnoSvl?userId=<%=userId%>&chot=<%=btcnList.getString("id")%>"><img src="../images/Chot.png" alt="Chot" width="20" height="20" longdesc="Chot" border="0" onclick="if(!confirm('Bạn chắc chắn muốn chốt phiếu này?')){ return false;}"></A>
	                                                    </TD>
	                                                    <%} %>
	                                                    <TD>&nbsp;</TD>
	                                                    <%if(quyen[Utility.XOA]!=0){ %>
	                                                    <TD>
	                                                        <A href = "../../ButrucongnoSvl?userId=<%=userId%>&delete=<%=btcnList.getString("id")%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border="0" onclick="if(!confirm('Bạn chắc chắn muốn xóa phiếu này?')){ return false;}"></A>
	                                                    </TD>
	                                                    <%} %>
	                                                ...
	                                                <%  }else{%>
	                                                    ...
	                                                    <TD>
	                                                        <A href = "../../ButrucongnoUpdateSvl?userId=<%=userId%>&display=<%=btcnList.getString("id")%>"><img src="../images/Display20.png" alt="Cap nhat" width="20" height="20" longdesc="Hiển thị" border ="0" ></A>
	                                                    </TD>
	                                                    <%}
	                                                  }%>
