...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function UpdateALL()
	{
		var _dongiaGOC = document.getElementsByName("dongiaGOC");
		for(i = 0; i < _dongiaGOC.length; i++ )
		{
			CapNhatDonGia(i);
		}
	}
...
<form name ="khtt" method="post" action="../../BanggiabandoitacUpdateSvl" >
	...
	<TR>
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền > Dữ liệu nền sản phẩm > Bảng giá bán cho đối tác > Hiển thị</TD> 
							 <TD colspan="2" align="right" class="tbnavigation"><%=Utility.GLanguage("Chào mừng bạn",session,jedis) %>  <%= obj.getNppTen() %></TD></tr>
						</table>
			 		</TD>
				</TR>
			</TABLE>
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
			<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
							<TD width="30" align="left"><A href="../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"BanggiabandoitacSvl?userId="+ userId+"") %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          <TR>
		                   ...
		                   <TR>
                          		<TD class="plainlabel" valign="middle"  ><%=Utility.GLanguage("Từ ngày",session,jedis) %> </TD>   
		                   ...
		                   <%--  <TD class="plainlabel" valign="middle" width="120px" >Nhóm sản phẩm </TD>   
		                        ...
		                        <TD class="plainlabel" valign="middle" >Bảng giá bán lẻ</TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                        	<select name="bgbleId" id="bgbleId"  >
										<option value=""></option>
										<% if (bgList != null)
										{
											while (bgList.next())
											{
												if (bgList.getString("pk_seq").equals(obj.getBgId()))
												{
												%>
													...
													{ %>
														<tr class="tbdarkrow" >
															...
															<td>
																...
																<% } else { %>
																	<input type="text" name="dongiaSAUCK" style="width: 100%; text-align: right;" value="" onkeypress="return keypress(event);" onkeyup="CapNhatChietKhau(<%= stt %>);" > 
																<% } %>
															</td>
														</tr>
