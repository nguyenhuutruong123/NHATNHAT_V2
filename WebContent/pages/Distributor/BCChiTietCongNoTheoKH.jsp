...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../BCChiTietCongNoTheoKH">
	<input type="hidden" name="action" value='1'>
	<input type="hidden" name="userId" value='<%=userId%>'>
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">bao cao &#62; Báo cáo chi tiết theo khách hàng</div>
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					<legend class="legendtitle"> Báo liệu</legend>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Báo Cáo chi tiết theo khách hàng</legend>
								...
								<fieldset style="min-height: 200px">
									...
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="4"
										...
										<tbody id="ShowFields">
											...
											<tr class="tblightrow">
												<td>Chi tiết công nợ </td>
												<td align="center"><input name="fieldsHien"
													type="checkbox" value="Chi_tiet_cong_no"></td>
											</tr>																				
										</tbody>
									</TABLE>
								</fieldset>
