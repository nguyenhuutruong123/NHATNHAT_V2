				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Tích lũy > Duyệt bán đúng giá > Cập nhật</TD> 
				  ...
				  <TD height="100%" width="100%">
						  ...
						  <TR>
						  	  	...
						  	  	<TD class="plainlabel" colspan="3">
						  	  		...
						  	  		<%-- <%if (obj.getKhongtinhtienthuve().equals("1")) { %>
						  	  			<input type="checkbox" name="khongtinhthuve" value="1" checked="checked"  ><i>Không tính tiền thu về</i> 
						  	  		<%} else {%>
						  	  		&nbsp;&nbsp;&nbsp;
						  	  		 			<input type="checkbox" name="khongtinhthuve" value="1"   ><i>Không tính tiền thu về</i> 
						  			<%} if(obj.getKhongtinhdoanhso().equals("1")) {%>
						  	  			<input type="checkbox" name="khongtinhdoanhso" value="1"    checked="checked"><i>Không tính doanh số</i> 
						  	  		<%} else {%>
						  	  			<input type="checkbox" name="khongtinhdoanhso" value="1"   ><i>Không tính doanh số</i> 
						  	  		...
						  	  		&nbsp;&nbsp;&nbsp;
						  	  		<%if (obj.getKhongtinhdoanhso().equals("1")) {%>
						  	  			<input type="checkbox" name="khongtinhdoanhso" value="0" checked="checked" disabled="disabled" ><i>Không tính doanh số</i> 
						  	 		<%} else { %>
						...
						<hr />
		                  ...
		                  <td align="center" width="10%">Mã khách hàng</td>
		                    	...
		                    	<td align="center" width="10%">Hưởng CK quý <input type="checkbox" name="checkAll3" id="checkAll3" onchange="SelectALL3();" > </td>
		                    	<%} %>
		                    	
		                    	<td align="center" width="10%"> CK Ủng hộ <input type="checkbox" name="checkAll2" id="checkAll2" onchange="SelectALL2();" > </td>
		                    </TR>
		                    			...
		                    			<tr>
		                    				...
		                    				<td align="center">
		                    					...
		                    					{ 	
		                    						...
		                    						while(i<ckquy.size())
		                    						{
		                    							System.out.println("::::::::::::::::::"+ckquy.size());
		                    						String[] part=ckquy.get(i).split("_");
	                    							 System.out.println("\n da vao check 1" +part[0] +"vi tri thu i="+i + "----" +part[1]+"-----"+part[2]);
		                 				...
		                 				<td align="center">
		                    					...
		                    					{ 	
		                    						...
		                    						String[] part=ckquy.get(j).split("_");
		                    						  System.out.println("\n da vao check 1" +part[0] +"vi tri thu i="+j);	
		                    						if(part[0].equals(khRs.getString("maFAST")))
		                    						{
