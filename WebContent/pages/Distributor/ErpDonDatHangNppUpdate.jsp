...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">&nbsp;Quản lý tồn kho > Mua hàng từ nhà cung cấp > Đơn đặt hàng > Cập nhật</div>
        <div align="right" style="padding:5px" class="tbnavigation">Chào mừng nhà phân phối <%= lsxBean.getNppTen() %> &nbsp;</div>
    </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
               ...
               <TR>
                   ...
                   <%--  <TD class="plainlabel"  > Đơn hàng KM có HĐTC </td>
                    ...
                    <TD class="plainlabel"  >
                           <input disabled="disabled" type="checkbox" onchange="clearform();"  name="isdhkhac"  id="isdhkhac"  <%=lsxBean.getIsdhKhac().equals("1")?"checked=\"checked\"":"" %>   value="1" style="text-align: right;"  />
                           <input  type="hidden"  name="isdhkhac"  id="isdhkhac"    value="<%= lsxBean.getIsdhKhac() %>"   />
                    </TD>
                </TR>
				...
				<tr class="tbheader">
					 ...
					 */
						if(spMa != null)
						{
							...
							<tr>
								...
								<td style="text-align: center;"><input type="text" readonly="readonly" value="<%= i + 1 %>"></td>
								<td>
								...
								<td> <input type="text" name="soluong" value="<%= spSoluong[i] %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" > </td>
					...
					<% for(int i = count; i < 5; i++) { %>
						<tr class="duplicate">
							...
							<td> <input type="text" name="soluong" id="soluong_<%=i %>" value="" style="width: 100%; text-align: right;" onkeypress="return keypress(event);"  > </td>
