<%@page import="geso.dms.distributor.beans.huychungtuketoan.IErpHuychungtuketoan"%>
...
<form name="hctmhForm" method="post" action="../../ErpHuyphieuchiUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý kế toán &gt; Huỷ chứng từ &gt; Huỷ chứng từ &gt; Hiển thị
        </div>
  	...
  	<div align="left" style="width:100%%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror"  rows="1" readonly="readonly" style ="width:100%; background-color: white;"><%= hctmhBean.getMsg() %></textarea>
		         <% hctmhBean.setMsg(""); %>
    	</fieldset>
  	</div>
