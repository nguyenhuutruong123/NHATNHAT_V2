...
<%
	IChuyenTuyen bean = (IChuyenTuyen) session
				.getAttribute("ctuyenBean");
%>
<%
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết
											lập dữ liệu nền &gt; Dữ liệu Kinh doanh &gt; Đảo tuyến
					...
					<TABLE width="100%" cellpadding="0" cellspacing="2">
						<TR>
							<TD>
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR class="tbdarkrow">
										<TD width="30" align="left" hidden><A
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
										...
										<TR>
											...
											<TD class="plainlabel"><SELECT name="ddkdFromId"
												id="ddkdFromId" onChange="submitform();">
													<option value=""></option>
													<%
														if (ddkdFrom != null)
																while (ddkdFrom.next()) {
										...
										<TR>
											...
											<TD class="plainlabel"><select name="tuyenFromId"
												id="tuyenFromId" onChange="submitform();">
													<option value=""></option>
													<%
														if (tuyenFrom != null)
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
										...
										<TR>
											...
											<TD class="plainlabel"><SELECT name="ddkdToId"
												id="ddkdToId" onChange="submitform();">
													<option value=""></option>
													<%
														if (ddkdTo != null)
																while (ddkdTo.next()) {
										...
										<TR>
											...
											<TD class="plainlabel"><select name="tuyenToId"
												id="tuyenToId" onChange="submitform();">
													<option value=""></option>
													<%
														if (tuyenTo != null)
																while (tuyenTo.next()) {
