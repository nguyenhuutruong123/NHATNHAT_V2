...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Công nợ phải trả > Ủy nhiệm chi
        </div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle"> Ủy nhiệm chi </span>&nbsp;&nbsp;
            	<%//if(quyen[0]!=0){ %>
								...
								while (tthdList.next())
								{
									...
									<TD align="center">
										...
										<img src="../images/Chot.png" alt="Chốt thanh toán" width="20" height="20" title="Chốt thanh toán" border="0"
											onclick="if(!confirm('Bạn có chắc chốt phiếu thanh toán này?')) {return false ;}else{ processing('<%="chotphieu"+tthdList.getString("tthdId")%>' , '../../ErpUynhiemchiSvl?userId=<%=userId%>&chot=<%= tthdList.getString("tthdId") %>');}">
										</A> <%}%> <% } %> 
