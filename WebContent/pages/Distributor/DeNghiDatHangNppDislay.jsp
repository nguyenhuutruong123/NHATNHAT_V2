...
<form name="dndhFormnpp" method="post" action="../../DenghidathangnppUpdateSvl">
        ...
        <TD colspan="4" align='left' valign='top'> <!--begin body Dossier-->
            ...
            <TABLE width="100%" border="0" cellpadding="3" cellspacing="0">
                <TR ><TD >
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR class = "tbdarkrow">
                            <TD width="30" align="left"><A href="../../DenghidathangnppSvl?userId=<%=userId%>"  ><img src="../images/Back30.png" alt="Quay về"  title="Quay về" border="1" longdesc="Quay về" style="border-style:outset"></A></TD>
