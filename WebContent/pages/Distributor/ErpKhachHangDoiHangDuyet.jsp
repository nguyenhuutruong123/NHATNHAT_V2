...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý tồn kho > Đổi hàng > Khách hàng đổi hàng > Duyệt đổi hàng
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
        ...
        <span id="btnSave">
	        <A href="javascript:duyetform()" >
	        	<IMG src="../images/Chot.png" title="Duyệt đổi hàng" alt="Luu lai" border ="1px" style="border-style:outset"></A>
        </span>
    </div>
			...
			<hr />
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					<tr class="tbheader">
						...
						<th align="center" width="8%" >Duyệt</th>
						<th align="center" width="20%" ><%=Utility.GLanguage("Sản phẩm",session,jedis) %> đổi</th>
						<th align="center" width="10%" >Số lô đổi</th>						
					</tr>
					...
					<%
						if(spRs != null)
						{
							...
							<tr>
								...
								<td>
									<input type="text" name="spSOLO" value="<%= spRs.getString("SOLO") %>" style="width: 100%;" readonly="readonly" > 
								</td>
								<td>
									<input type="text" name="spNGAYSANXUAT" value="<%= spRs.getString("NGAYSANXUAT") %>" style="width: 100%;" readonly="readonly" > 
								</td>
								<td>
								...
								<td>
									<%if(sp_soluong.get(spRs.getString("PK_SEQ")) != null ) { %>
										<input type="text" name="spDUYET" value="<%= formater.format( Double.parseDouble(sp_soluong.get(spRs.getString("PK_SEQ"))) ) %>"  style="text-align: right;width: 100%;" onkeyup="Dinhdang(this);" > 
									<% } else { %>
										<input type="text" name="spDUYET" value=""  style="text-align: right;width: 100%;" onkeyup="Dinhdang(this);" > 
									<% } %>
								</td>
								<td>
									<select style="width: 100%" name="spIDDUYET" >
										<option value="" ></option>
										<% if(spDOIRs != null) { 
											spDOIRs.beforeFirst();
											while(spDOIRs.next())
								...
								<td>
									<select name="spSOLODUYET" style="width: 100%" >
										<option value="" ></option>
										<% if(rsSOLO != null){ 
											while(rsSOLO.next()){ 
												...
												{
													%>
													<option value="<%= rsSOLO.getString("SOLO") %>" selected="selected" ><%= rsSOLO.getString("SOLO") %></option>
												<% } else { %>
													<option value="<%= rsSOLO.getString("SOLO") %>"  ><%= rsSOLO.getString("SOLO") %></option>
										<% }  }  rsSOLO.close(); } %>
									</select>
								</td>
							</tr>	
