...
function sellectAll(cbId1, cbId2) {
 ...
 function submitform()
 {
 	document.forms['dhForm'].action.value= 'searchnew';
 ...
 function PBform()
 {
 	...
 	document.forms['dhForm'].action.value= 'newPB';
 	document.forms['dhForm'].submit();
 }
 function clearform()
 {   
					...
					<TD align="left" class="tbnavigation">
					   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							   ...
							   <TD align="left" colspan="2" class="tbnavigation"> Quản lý bán hàng > Bán hàng OTC > Phân bổ đơn hàng cho NVGN > Tạo mới phân bổ
