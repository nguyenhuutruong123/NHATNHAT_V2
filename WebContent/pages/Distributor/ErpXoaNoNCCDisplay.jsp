...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng > Công nợ phải thu > Xóa khách hàng trả trước > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpXoakhachhangttSvl?userId=<%= userId %>" >
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle"> Xóa khách hàng trả trước </legend>
		                        		...
		                        		if(ctttList.size() > 0)
		                        		{
		                        			...
		                        			<tr>
		                        				...
		                        				<% if( hoadonTT.getConlai().equals("0") ){ %>
		                        					<input type="checkbox" name="ctttIds" id="ctttIds<%= i %>" checked="checked" onchange="TraHetCTTT()" >
		                        				<%}else{ %>
		                        					<input type="checkbox" name="ctttIds" id="ctttIds<%= i %>" onchange="TraHetCTTT()">
		                        				<%} %>
		                        				</td>
		                        			</tr>
                ...
                <%
                	for(int i = 0; i < hoadonList.size(); i++)
                	{
                		IHoadon hoadon = hoadonList.get(i);
	               		...
	               		<tr>
	               			<td align="center">
           	 					<input type="text" style="width: 100%;" value="<%= hoadon.getHopdong() %>" name= "sopo" readonly="readonly" >
           	 				</td>
           	 				<td align="center">
