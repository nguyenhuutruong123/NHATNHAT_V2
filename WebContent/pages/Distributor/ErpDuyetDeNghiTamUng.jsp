	...
	<% 					
						String daduyet = obj.getDaduyet(polist.getString("MHID"));
						 ...
						 { %>			
								 ...
								 <A id='<%= polist.getString("MHID") %>' href = "../../ErpTamUngUpdateSvl?userId=<%=userId%>&update=<%= polist.getString("MHID") %>&chucnang=<%= polist.getString("LOAICAP_FK") %>" rel="subcontent<%="suattid" + polist.getString("MHID") %>" >
									...
									<A id='xoa<%= polist.getString("MHID") %>' href="" rel="subcontent<%="xoattid" + polist.getString("MHID") %>" >
                              	 	...
                              	 	<DIV id="subcontent<%="xoattid" + polist.getString("MHID") %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
					                    ...
					                    <div align="right">
					                     	...
					                     	<a href="javascript:xoaform('<%= polist.getString("MHID") %>');" style="color: red; font-weight: bold;">Xác nhận mở duyệt</a>
