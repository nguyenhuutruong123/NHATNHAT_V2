...
<%@page import="geso.dms.distributor.beans.bcchietkhauconlai.IBcChietKhauConLai"%>
...
<%
	...
	IBcChietKhauConLai obj = (IBcChietKhauConLai) session.getAttribute("obj");
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Quản lý bán hàng &#62; Báo cáo &#62; BC Chiết khấu còn lại</div>
						...
						<div style="width: 100%; float: none" align="left"
							...
							<TR >
									...
									<TD class="plainlabel" width="250px" >
								 	<input type="text" name="Sdays"	class="days" value='<%=obj.getTuNgay()%>'   onchange="search();" /></TD> 
									<TD class="plainlabel" width="100px" > Đến ngày</TD>
									<TD class="plainlabel" colspan="3">
										<input type="text" name="Edays" class="days" value='<%=obj.getDenNgay()%>'   onchange="search();"  /></td> 
						   </TR>
							
								<%-- <TR>
									<TD class="plainlabel">Khách hàng </TD>
									<TD class="plainlabel">
										<select name="khId" id="khId" style="width:250px"   onchange="search();" >
									...
									<TD class="plainlabel" colspan="3">
										<select name="spId" id="spId" style="width:250px"  onchange="search();" class="notuseselect2" >
											<option value="" >All</option>
											<%if (spRs != null)
													while (spRs.next()) {
								...
								<TR>
									...
									<TD class="plainlabel">
										<select name="ddkdId" id="ddkdId" style="width:250px"  onchange="search();" class="notuseselect2" >
											<option value="" >All</option>
											<%if (ddkd != null)
													while (ddkd.next()) {
