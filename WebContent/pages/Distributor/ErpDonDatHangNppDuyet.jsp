...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Bán hàng cho ETC / Đối tác > Duyệt đơn hàng
        </div>
        	...
        	<fieldset>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" style="width: 7%" ><%=Utility.GLanguage("Ngày tạo",session,jedis) %></TH>
	                    <TH align="center" style="width: 11%" ><%=Utility.GLanguage("Người tạo",session,jedis) %></TH>
	                    <TH align="center" style="width: 7%" ><%=Utility.GLanguage("Ngày sửa",session,jedis) %></TH>
	                    <TH align="center" style="width: 11%" ><%=Utility.GLanguage("Người sửa",session,jedis) %></TH>
		                    ...
		                    <TD align="center">   
	                   			<%if(quyen[Utility.CHOT]!=0){ 
	                   				if(hopdong_fk.trim().length() > 0) {  %>
	                   					<% if(nhapkhoRs.getString("trangthai").equals("4")){ %>
                             		<A href = "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"ErpDonhangNppETCUpdateSvl?userId="+userId+"&duyet="+ nhapkhoRs.getString("PK_SEQ")+"") %>"><IMG src="../images/Display20.png" alt="Xem đơn đặt hàng" title="Xem đơn đặt hàng" border=0></A>
	                    			<%} else { %>
                             		<A href = "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"ErpDonhangNppETCUpdateSvl?userId="+userId+"&duyet="+ nhapkhoRs.getString("PK_SEQ") +"")%>"><IMG src="../images/Chot.png" alt="Duyệt đơn đặt hàng" title="Duyệt đơn đặt hàng" border=0></A>
	                    			
	                    		<% }  } else {
	                    			
	                    				if(!ldh.equals("4")) { %>
	                    					<% if(nhapkhoRs.getString("trangthai").equals("4")){ %>
	                    					<A href = "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"ErpDondathangDoitacUpdateSvl?userId="+userId+"&duyet="+ nhapkhoRs.getString("PK_SEQ")+"") %>"><IMG src="../images/Display20.png" alt="Xem đơn đặt hàng" title="Xem đơn đặt hàng" border=0></A>
	                    					<%} else {%>
	                    					<A href = "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"ErpDondathangDoitacUpdateSvl?userId="+userId+"&duyet="+ nhapkhoRs.getString("PK_SEQ")+"") %>"><IMG src="../images/Chot.png" alt="Duyệt đơn đặt hàng" title="Duyệt đơn đặt hàng" border=0></A>
                    				<%}} else { %>
                    						<% if(nhapkhoRs.getString("trangthai").equals("4")) {%>
	                    					<A href = "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"ErpDonDatHangKhacUpdateSvl?userId="+userId+"&duyet="+ nhapkhoRs.getString("PK_SEQ")+"") %>"><IMG src="../images/Display20.png" alt="Xem đơn đặt hàng" title="Xem đơn đặt hàng" border=0></A>
	                    					<% } else {%>
	                    					<A href = "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"ErpDonDatHangKhacUpdateSvl?userId="+userId+"&duyet="+ nhapkhoRs.getString("PK_SEQ")+"") %>"><IMG src="../images/Chot.png" alt="Duyệt đơn đặt hàng" title="Duyệt đơn đặt hàng" border=0></A>
	                    			<%} }%>                   			
	                    		<% } 
	                   			} %>
		                    </TD>
