...
<head>
    ...
    <script language="javascript" type="text/javascript">
		...
		{	
			...
			{
				alert('Bạn phải chọn ngày lập phiếu để lọc đơn hàng...');
				return;	
			}
			var nvgn = document.getElementById("nvgnList");
			if(nvgn.value == "")
			{
				alert('Bạn phải chọn nhân viên giao nhận...');
				return;
			}
			if(checkDonhangList() == false)
			{
				alert('Xin lỗi , không có đơn hàng...');
				return;
			}
...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng OTC > Phiếu xuất kho > tạo mới
        </div>
        	...
        	<div style="float:none; width:100%" align="left">
            	<table width="100%" cellspacing="0" cellpadding="6px">
                 ...
                 <table width="100%" cellpadding="4px" cellspacing="1px">
                 	<tr>
                    	<th class="tbheader" align="center">Số hóa đơn</th>
                        <th class="tbheader" align="center">Ngày hóa đơn</th>
                    ...
                    <% try{ while(donhangList.next()){ 
		    			...
		    			<tr class="tbdarkrow" <%= style %> >
	                    	<td align="center">
	                    		<%= donhangList.getString("SOHOADON") %>
	                    	</td>
