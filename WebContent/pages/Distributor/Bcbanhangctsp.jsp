...
<%@ page import = "geso.dms.distributor.beans.bcbanhangctsp.*" %>
...
<head>
	...
	document.forms["khtt"].ddkd.value= "";
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR height="22">
								<TD align="left" colspan="2" class="tbnavigation">&nbsp; Báo cáo quản trị > Doanh số > Báo cáo bán hàng chi tiết theo sản phẩm  </TD>
