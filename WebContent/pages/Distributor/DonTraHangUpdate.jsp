...
<script language="javascript" type="text/javascript">
	...
	function replaces()
	{
	 ...
	 { 
		 ...
		 document.forms['hctmhForm'].action.value='submit1';
	     document.forms["hctmhForm"].submit();
	 }
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Nghiệp vụ khác > Trả hàng > Cập nhật
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"DontrahangSvl?userId="+ userId+"") %>" >
    	...
    	<legend class="legendtitle">Trả hàng </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
               <TR>
                    ...
                    <TD  class="plainlabel" >
                    	<input type="text" class="days" readonly="readonly" onchange="submitform1()" name="ngaychuyen" value="<%= lsxBean.getNgayyeucau() %>"/></TD>
			...
			<td align="center" > 
				...
				<% for(int i = count; i < 50; i++) { %>
					...
					<tr>
						...
						<td > <input type="text" name="soluong" value="" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" onchange="ChangeSL();" > </td>
