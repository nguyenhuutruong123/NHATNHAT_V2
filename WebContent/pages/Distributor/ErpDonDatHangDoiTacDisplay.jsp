...
<script language="javascript" type="text/javascript">
	...
	function replaces()
	{
		...
		var ngayCL = document.getElementById("ngayCL").value;
		
		
		if(parseFloat(ngayCL) < 0 )
		{
	 ...
	 function TinhTien()
	 {
	   ...
	   var thuevat_chung=0;	
		...
		if(parseFloat(ngayCL) > 0) // Từ ngày 2015-01-27 hiện theo kiểu mới
		{
...
<input type="hidden" id="ngayCL" value='<%= lsxBean.getNgay_Chenhlech() %>'>

<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Bán hàng cho đối tác > Hiển thị
        </div>
        <div align="right" style="padding:5px" class="tbnavigation">
        	<%=Utility.GLanguage("Chào mừng bạn",session,jedis) %>  <%= lsxBean.getNppTen() %> &nbsp;
        </div>
    </div>
    ...
    <fieldset>
    	<legend class="legendtitle">Bán hàng cho đối tác </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <%if( lsxBean.getNgay_Chenhlech() > 0 ){ %>
                <TR >
                ...
                <TR>
                    ...
                    <TD class="plainlabel" >
                    	<textarea rows="" cols=""  name="ghichu"  >
                    	<%= lsxBean.getGhichu() %>
                    	</textarea>
                    </TD>
                    <%-- 
			...
			<hr />
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					<tr class="tbheader">
						...
						<th align="center" width="5%" >Tồn CN</th>
						...
						if(spMa != null)
						{
							...
							<tr>
								...
								<td> 
									...
									<td> <input type="text" name="soluongton" value="<%=spSoluonton[i] %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);"  > </td>
								...
								<td> 
									...
									<%if(lsxBean.getNgay_Chenhlech() < 0){ %>
									<input type="hidden" name="dongiagoc" value="<%= spGiagoc[i] %>" style="width: 100%; text-align: right;" readonly="readonly" >
									<%} %>
								</td>
