			...
			<TABLE width = 100% cellpadding = "3" cellspacing = "0" border = "0">
				  	...
				  	<tr>
						   <TD align="left" colspan="4">
			                    ...
			                    <tr>
			                    	<td class="plainlabel" width="20%" valign="middle"><%=Utility.GLanguage("Từ ngày",session,jedis) %></td>
			                    	<td class="plainlabel">
			                            <i><%= obj.getTungay() %></i>
			                    	</td>                
			                    </tr>     
			                    <tr>
			                    	<td class="plainlabel" width="20%" valign="middle"><%=Utility.GLanguage("Đến ngày",session,jedis) %></td>
			                    	<td class="plainlabel">
			                            <i><%= obj.getDenngay() %></i>
			                    	</td>               
			                    </tr> 
								  ...
								  <TR>
									  <TD width="20%" class="plainlabel" ><%=Utility.GLanguage("NHÂN VIÊN BÁN HÀNG",session,jedis) %> </TD>
