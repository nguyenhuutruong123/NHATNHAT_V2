...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng ETC / Đối tác > Xuất kho > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"ErpYeucauxuatkhoNppSvl?userId="+userId +"")%>" >
    ...
    <fieldset>
    	<legend class="legendtitle">Yêu cầu xuất kho </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                	<TD class="plainlabel" >Hóa đơn </TD>
                    <TD class="plainlabel" colspan="3" >
                    	<select name = "ddhIds" class="select2" style="width: 600px"  onchange="changePOform();" multiple="multiple" >
                    		<option value=""> </option>
                        	<%
                        		if(ddhRs != null)
                        		{
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
				<tr class="tbheader">
					...
					<th align="center" width="17%" >Mã CTKM</th>
		                            	...
		                            	<%
			                        		...
			                        		if(spRs != null)
			                        		{
			                        			while(spRs.next())
			                        			{
			                        				...
			                        				String key = spId[i] + "__" + spLoai[i] + "__" + spSCheme[i].trim() + "__" + spRs.getString("SOLO") + "__" + spRs.getString("NGAYHETHAN") + "__" + spRs.getString("NGAYNHAPKHO");
			                        			%>
			                        			
			                        			<tr>
			                        				<td>
			                        				<% if(sanpham_soluong.get( key ) != null ) { %>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spSOLUONG" value="<%= formater.format(Double.parseDouble( sanpham_soluong.get( key ) ) ) %>" onkeyup="Dinhdang(this);" >
			                        				<% } else { %>
