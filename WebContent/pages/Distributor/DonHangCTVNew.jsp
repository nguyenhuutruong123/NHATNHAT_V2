...
<div class="loader222"  id="divTIMKIEM" style="display: ">
	<img src="../images/PleaseWait.gif" style="margin-top:150px;" />
</div>
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Báo cáo CTV > BC cộng tác viên > Tạo mới
        </div>
					...
					if( spId != null )
					{
						...
						<tr>
							...
							<td>
		                    	...
		                    	<input type="hidden" name="spTen" value="<%= spten %>" style="width: 99%; text-align: right; padding: 4px 0px;" readonly="readonly"  >
							</td>

							<td > <input type="text" name="tonkho" value="<%= spTonkho[i] %>" style="width: 99%; text-align: right; padding: 4px 0px;" readonly="readonly"  > </td>
							<td > <input type="text" name="soluong" value="<%= spSoluong[i] %>" style="width: 99%; text-align: right; padding: 4px 0px;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" AUTOCOMPLETE="off" > </td>							
							<td>
