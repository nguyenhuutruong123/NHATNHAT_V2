...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Công nợ phải thu > Thu tiền > Hiển thị
        </div>
    ...
    <fieldset>
    	<legend class="legendtitle"> Thu tiền</legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" border = "0">							
                <TR>
                    <TD width="170px" class="plainlabel" valign="top">Ngày chứng từ</TD>
                    <TD class="plainlabel" width="300px" valign="top">
                    	<input type="text"  class="days" id="ngaychungtu" name="ngaychungtu" value="<%= tthdBean.getNgaychungtu() %>" 
                    		 readonly /></TD>
                    <TD width="170px" class="plainlabel" valign="top">Ngày ghi sổ</TD>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="5">
                        <select name="noidungId" id="noidungId" style="width: 200px" >
                        	<option value=""> </option>
                        	<%
                        		if(ndList != null)
                        		{
                ...
                <TR>
                    ...
                    <TD class="plainlabel">
                        <input type="text" name="sochungtu" value="<%= tthdBean.getSochungtu() %>" readonly >
                    </TD> 
                    <TD class="plainlabel">Tiền tệ</TD>
                    <TD class="plainlabel" style = "width:100px">
                        <select name="tienteId" id="tienteId" >
                        	<%
                        		if(tienteList != null)
                        		{
                        			try
                      ...
                      <TD class="plainlabel">
                      		<input type="text" name="tigia" Id="tigia" value="<%= formatter.format(Double.parseDouble(tthdBean.getTigia().replaceAll(",","")))  %>" style = "width:100px;text-align: right;"  readonly>
                      </TD> 
...
<TR>
	...
	<%}else if(tthdBean.getNoidungId().equals("100003")){ //THU HOI TAM UNG%>
       			 <TR>
       ...
       <TR>
                    ...
                    <TD class="plainlabel" colspan = 5>
                        <select name="htttId" id="htttId" style="width: 200px" onChange = "ChangeTienTe();">
                        	<!-- <option value=""> </option> -->
                        	<%
                        		if(htttList != null)
                        		{
       		...
       		<% 
       			...
       			<TR>
                    ...
                    <TD class="plainlabel">
                         <input type="text" style="text-align: right;" name="sotienthanhtoanNT" id = "sotienthanhtoanNT" 
                    	   		value="<%= formatterNT.format(Double.parseDouble(tthdBean.getSotienttNT()))%>"  AUTOCOMPLETE="off" readonly>
                     </TD>
                ...
                <TR>
    	             ...
    	             <TD class="plainlabel" valign="top">
                   		...
                   		<input type="text"  id="thuduocNT" name="thuduocNT" value="<%= formatterNT.format(Double.parseDouble(tthdBean.getThuduocNT())) %>"  style="text-align: right;"  readonly/></TD>
	                
	                 <TD width="140px" class="plainlabel" valign="top">Số tiền thực thu (VNĐ)</TD>
    	             <TD class="plainlabel" valign="top" colspan = 3>
                    	<input type="text"  id="thuduoc" name="thuduoc" value="<%= formatter.format(Double.parseDouble(tthdBean.getThuduoc())) %>"  style="text-align: right;"  readonly/>
                    	<input type="hidden"  id="cpnganhangNT" name="cpnganhangNT" value="<%= formatterNT.format(Double.parseDouble(tthdBean.getChiphinganhangNT())) %>"  style="text-align: right;"  readonly/>
                    	<input type="hidden"  id="cpnganhang" name="cpnganhang" value="<%= formatter.format(Double.parseDouble(tthdBean.getChiphinganhang())) %>"  style="text-align: right;"  readonly/>
                    </TD>											
                </TR>
                ...
                <TR>
                	...
                	<TD class="plainlabel" valign="top"> 
                		<input type="text" name="chietkhauNT" id="chietkhauNT" value="<%= formatterNT.format(Double.parseDouble(tthdBean.getChietkhauNT().replace(",", ""))) %>" style="text-align: right;" onchange="TinhChenhLech();" onKeyPress = "return keypress(event);">
                	</TD>
                	
                	<TD class="plainlabel" valign="top">Chiết khấu thanh toán (VNĐ)</TD>
                	<TD class="plainlabel" colspan = "3" valign="top"> 
                		<input type="text" name="chietkhau" id="chietkhau" value="<%= formatter.format(Double.parseDouble(tthdBean.getChietkhau().replace(",", ""))) %>" style="text-align: right;" readonly="readonly">
                	</TD>
                </TR>
                <%} %>
            	...
            	<TR>
                    ...
                    <TD class="plainlabel" >                   
                        <input type="text" name="ghichu" value="<%= tthdBean.getNoidungtt() %>" style = "width:300px" readonly> 
                     </TD> 
             ...
             <%}else if( (tthdBean.getNoidungId().equals("100004")&& tthdBean.getTienteId().equals("100000"))|| (tthdBean.getNoidungId().equals("100000")&& tthdBean.getTienteId().equals("100000"))|| (tthdBean.getNoidungId().equals("100003") && tthdBean.getTienteId().equals("100000")) ){ //Thu tien ban hang/ Thu hoi tam ung va VND  %> 
       			<TR>
                    <TD class="plainlabel">Số tiền hóa đơn (VNĐ) </TD>
                    <TD class="plainlabel" colspan = 5>
                        <input type="text" style="text-align: right;" name="sotienthanhtoan" id = "sotienthanhtoan" 
                ...
                <TR>
                	<TD class="plainlabel" valign="top">Chiết khấu thanh toán (VNĐ)</TD>
                	<TD class="plainlabel" valign="top" colspan = 5> 
                		<input type="text" name="chietkhau" id="chietkhau" value="<%= formatter.format(Double.parseDouble(tthdBean.getChietkhau().replace(",", ""))) %>" style="text-align: right;"  onKeyPress = "return keypress(event);">
                	</TD>
                </TR>
            	...
            	<TR>
                    ...
                    <TD width="140px" class="plainlabel" valign="top">Chênh lệch (VNĐ)</TD>
                    <TD class="plainlabel" valign="top" colspan = "3">
                    	<input type="text"  id="chenhlech" name="chenhlech" value="<%= formatter.format(Double.parseDouble(tthdBean.getChenhlech())) %>"  style="text-align: right;"  readonly/></TD>
                </TR>                
			...
			<%}else  if(tthdBean.getNoidungId().equals("100001") && !tthdBean.getTienteId().equals("100000")){ //Thu tien khach hang ung truoc va ngoai te  %>
                <TR>
    	             ...
    	             <TD class="plainlabel" valign="top" colspan = 3>
                    	<input type="text"  id="thuduoc" name="thuduoc" value="<%= formatter.format(Double.parseDouble(tthdBean.getThuduoc())) %>"  style="text-align: right;"  readonly/>
                    	<input type="hidden"  id="cpnganhangNT" name="cpnganhangNT" value="<%= formatterNT.format(Double.parseDouble(tthdBean.getChiphinganhangNT())) %>"  style="text-align: right;"  readonly/>
                    	<input type="text"  id="cpnganhang" name="cpnganhang" value="<%= formatter.format(Double.parseDouble(tthdBean.getChiphinganhang())) %>"  style="text-align: right;" readonly/>
                    </TD>											
                </TR>
            	...
            	<TR>
                    ...
                    <TD class="plainlabel" valign="top">
                    	...
                    	<input type="text"  id="tongNT" name="tongNT" value="<%= formatterNT.format(Double.parseDouble(tthdBean.getTongNT())) %>"  style="text-align: right;"  readonly/></TD>
                     
                    <TD width="140px" class="plainlabel" valign="top">Tổng tiền trả trước (VNĐ)</TD>
                    <TD class="plainlabel" valign="top" colspan = 3>
                    	<input type="text"  id="tongVND" name="tongVND" value="<%= formatter.format(Double.parseDouble(tthdBean.getTongVND())) %>"  style="text-align: right;"  readonly/>
                    </TD>
			...
			<%}else  if(tthdBean.getNoidungId().equals("100001") & tthdBean.getTienteId().equals("100000")){ //Thu tien khach hang ung truoc va VND  %>
            	...
            	<TR>
                    <TD width="140px" class="plainlabel" valign="top">Tổng tiền trả trước (VNĐ)</TD>
                    <TD class="plainlabel" valign="top" colspan = 5>
                    	<input type="text"  id="tongVND" name="tongVND" value="<%= formatter.format(Double.parseDouble(tthdBean.getTongVND())) %>"  style="text-align: right;"  readoly/>
                    </TD>
			...
			<%}else  if(tthdBean.getNoidungId().equals("100002") && !tthdBean.getTienteId().equals("100000")){ // THU TIỀN KHÁC VÀ NGOẠI TỆ %> 
       			<TR>
			...
			<%-- 	<TR>
       		...
       		<%}else  if(tthdBean.getNoidungId().equals("100002") && tthdBean.getTienteId().equals("100000")){ // THU KHÁC VÀ VND %>
        ...
        <% if(tthdBean.getNoidungId().equals("100000")|| tthdBean.getNoidungId().equals("100003")|| tthdBean.getNoidungId().equals("100004")) { %>  
             ...
             <% // Don vi tien la VND
               ...
               <TR class="tbheader">
                ...
                <%}%>
                	...
                	<TH align="center" width="10%">Ngày đến hạn TT</TH>
			...
			<%} %>
       	 	...
       	 	if(!tthdBean.getTienteId().equals("100000")){ %>
       	 				...
       	 				<td align="center">
       	 					<input type="text" style="width: 100%; text-align: right;" value="<%= formatterNT.format(Double.parseDouble(hoadon.getThanhtoan().replaceAll(",",""))) %>" name= "thanhtoan" id="thanhtoan<%= i %>"  readonly="readonly" >
       	 				</td>
       	 			<%}else{ %>
       	 				<td align="center">
       	 					<input type="text" style="width: 100%; text-align: right;" value="<%= formatter.format(Double.parseDouble(hoadon.getThanhtoan().replaceAll(",",""))) %>" name= "thanhtoan" id="thanhtoan<%= i %>"  readonly="readonly" >
       	 				</td>
       	 			<%} %>
       	 				<td align="center">
       	 				...
       	 				<% 	if(hoadon.getConlai().equals("0")){ %>
       	 					<input type="checkbox" value="<%= hoadon.getId() %>" name = "trahet" id="trahet<%= i %>" checked="checked" disabled >
       	 				<%} else { %>
       	 					<input type="checkbox"  value="<%= hoadon.getId() %>" name = "trahet" id="trahet<%= i %>" disabled>
       	 				<%} %>
       	 				</td>
       	 			</tr>
       	 			<%	} %>
