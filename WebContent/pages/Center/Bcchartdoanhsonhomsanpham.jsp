...
<%@ page import = "geso.dms.center.beans.bcchartdoanhsonhomsanpham.*" %>
...
<%	String userId = (String) session.getAttribute("userId");
	...
	IBcchartdoanhsonhomsanpham obj =(IBcchartdoanhsonhomsanpham)session.getAttribute("obj");
...
<form name="khtt" method="post" action="../../BCChartdoanhsonhomsanphamSvl">
		...
		<TD colspan="4" align="left" valign="top" bgcolor="#FFFFFF">
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR height="22">
								<TD align="left" colspan="2" class="tbnavigation">&nbsp;Báo cáo quản trị > Biểu đồ > Báo cáo doanh số theo nhóm sản phẩm </TD>
			...
			<TABLE width="100%" cellpadding="0" cellspacing="1">
				...
				<TR>
					<TD width="100%">
						<FIELDSET>
							<LEGEND class="legendtitle">&nbsp;Báo cáo doanh số theo nhóm sản phẩm &nbsp;&nbsp;
								...
								<table align="left" id='myTable' >
									...
									<thead>
										<tr>
											<th></th>
											<%  //In ra List địa bàn
												for(int i=0;i<=arrTenNSP.length-1;i++)
												{
													if( arrTenNSP[i]!=null){
													%>
													<th><%= arrTenNSP[i] %></th>
									...
									{ %>
										<tr>
											...
											<%  
											for(int j=0;j<=arrIdNSP.length-1;j++)
											{
												if( arrIdNSP[j]!=null){
													%>
													<td><%= rs.getLong(arrIdNSP[j])%></td>
											<%
												}
											}%>
										</tr>	
