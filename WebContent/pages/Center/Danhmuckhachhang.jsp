					...
					<TD >
						<FIELDSET><LEGEND class="legendtitle">&nbsp;<%=Utility.GLanguage("Tiêu chí tìm kiếm",session,jedis) %>&nbsp;</LEGEND>
							<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
								...
								<TR>
									<TD class="plainlabel" valign="top" style="display:none" >Mã DMS</TD>
                                    	...
                                    	<%}%>
											...
											<TABLE border = 0 cellpadding="0" cellspacing="0">
												...
												<%if(quyen[Utility.XOA]!=0){ %>
													<A href = "../../KhachhangSvl?userId=<%=userId%>&delete=<%=khlist.getString("khId") %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn Xoá khách hàng này?')) return false;"></A>
												<%} %>	
													</TD>
												</TR></TABLE>
											</TD> --%>
