	...
	<TR>
		...
		<TABLE width="100%" cellpadding="0" cellspacing="1">
						...
						<TR>
							...
							<TABLE  width="100%" cellpadding="4" cellspacing="0">
								<TR>
						      	...
						      	<TR>
									<TD width="19%" class="plainlabel"><%=Utility.GLanguage("Đơn vị kinh doanh",session,jedis) %> </TD>
  								  	<TD class="plainlabel" >
				...
				<TR>
					<TD >
						<FIELDSET>
							<LEGEND class="legendtitle">&nbsp;<%=Utility.GLanguage("Nhãn hàng",session,jedis) %> &nbsp; &nbsp; &nbsp;
							<%if(quyen[0]!=0) {%>
						...
						<TABLE width="100%" cellpadding="0" cellspacing="0">
							<TR><TD>
								...
								<TR class="tbheader">
									...
									<TH width="10%"><%=Utility.GLanguage("Đơn vị kinh doanh",session,jedis) %> </TH>
									<TH width="10%"><%=Utility.GLanguage("Trạng thái",session,jedis) %> </TH>
									<TH width="12%"><%=Utility.GLanguage("Ngày tạo",session,jedis) %></TH>
									<TH width="12%"><%=Utility.GLanguage("Người tạo",session,jedis) %> </TH>
									<TH width="12%"><%=Utility.GLanguage("Ngày sửa",session,jedis) %></TH>
								...
								<%	 
									...
									<TD align="center">
										<TABLE border = 0 cellpadding="0" cellspacing="0">
											...
											<TD>
											<%if(quyen[1]!=0) {%>
												<A href = "../../RouterSvl?task=<%= Util.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"NhanhangSvl?userId="+userId+"&delete="+nhlist.getString("pk_seq")+";"+nhlist.getString("dvkdId")+"")%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa nhãn nhãn hàng này?')) return false;"></A>
											<%} %>
											</TD>
											</TR>
										</TABLE>												
