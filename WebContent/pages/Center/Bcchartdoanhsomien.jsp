...
<%@ page import = "geso.dms.center.beans.bcchartdoanhsomien.*" %>
...
<%	String userId = (String) session.getAttribute("userId");
	...
	IBcchartdoanhsomien obj =(IBcchartdoanhsomien)session.getAttribute("obj");
...
<form name="khtt" method="post" action="../../BCChartdoanhsomienSvl">
		...
		<TD colspan="4" align="left" valign="top" bgcolor="#FFFFFF">
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR height="22">
								<TD align="left" colspan="2" class="tbnavigation">&nbsp;Báo cáo quản trị > Biểu đồ > Báo cáo doanh số theo Miền </TD>
			...
			<TABLE width="100%" cellpadding="0" cellspacing="1">
				...
				<TR>
					<TD width="100%">
						<FIELDSET>
							<LEGEND class="legendtitle">&nbsp;Báo cáo doanh số theo Miền &nbsp;&nbsp;
