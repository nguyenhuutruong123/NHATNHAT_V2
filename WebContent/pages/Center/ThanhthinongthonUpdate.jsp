					...
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">
							   		...
							   		Dữ liệu nền > Kinh doanh  > Thành thị nông thôn > Tạo mới
							   		<%} else { %>
							   		Dữ liệu nền > Kinh doanh  > Thành thị nông thôn > Cập nhật 
							   		<%} %>
							   		</TD>
			  	...
			  	<TR>
					<TD align="left" colspan="4" class="legendtitle">
				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
								<LEGEND class="legendtitle">Thông tin thành thị nông thôn
								</LEGEND>
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									<TR>
									  <TD width="15%" class="plainlabel" >Thành thị nông thôn<FONT class="erroralert">*</FONT></TD>
