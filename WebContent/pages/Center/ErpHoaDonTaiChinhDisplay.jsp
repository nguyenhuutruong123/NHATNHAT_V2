...
<%@ page  import = "geso.dms.center.beans.hoadontaichinh.imp.*" %>
...
<% IErpHoadontaichinh lsxBean = (IErpHoadontaichinh)session.getAttribute("lsxBean"); %>
...
<form name="hctmhForm" method="post" action="../../ErpHoadontaichinhUpdateSvl">
<input type="hidden" name="userId" value='<%= userId %>'>
<input type="hidden" name="action" value='1'>
<input type="hidden" name="id" value='<%= lsxBean.getId() %>'>
<input type="hidden" name="NOIBO" value='<%= lsxBean.getNOIBO() %>'>

<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng ETC/Đối tác > Xuất HĐTC > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	...
    	<%-- <A href= "../../ErpHoadontaichinhSvl?userId=<%= userId %>" >
                ...
                <TR>
                 ...
                 <TR>
                   ...
                   <TD class="plainlabel">
                    ...
                    <TD class="plainlabel" >ETC / Đối tác </TD>
                    <TD class="plainlabel" >
