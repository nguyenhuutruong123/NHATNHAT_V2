        	...
        	<fieldset>
            	...
            	<TABLE width="100%" border="0" cellspacing="1px" cellpadding="4px">
					<TR class="tbheader">
						...
						<TH align="left"><%=Utility.GLanguage("Ngày sửa",session,jedis) %> </TH>
                      ...
                      if(m%2==0){
                        	%> 
                             ...
                             <% if(phieu.getTrangThai().equals("0")){ %>
                             	...
                             	<A href = "../../PhieuThanhToanTTSvl?userId=<%=userId%>&delete=<%=phieu.getId()%>"><img src="../images/Delete20.png" alt="Huy phieu" width="20" height="20" longdesc="Huy Phieu" border="0" onclick="if(!confirm('Bạn chắc chắn muốn hủy phiếu thanh toán này ?')) return false;" ></A>
