		...
		<TD colspan="4" align="left" valign="top" bgcolor="#FFFFFF">
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR height="22">
								<TD align="left" colspan="2" class="tbnavigation">&nbsp;Báo cáo quản trị > Biểu đồ >Báo cáo tồn kho theo địa bàn </TD>
			...
			<TABLE width="100%" cellpadding="0" cellspacing="1">
				...
				<TR>
					<TD width="100%">
						<FIELDSET>
							<LEGEND class="legendtitle">&nbsp;Báo cáo tồn kho theo địa bàn &nbsp;&nbsp;
							...
							<TABLE class="" width="100%">
								...
								<table align="left" id='myTable' >
									...
									<caption align="left" >Tồn kho theo địa bàn (Đơn vị tính: sản phẩm)</caption>
