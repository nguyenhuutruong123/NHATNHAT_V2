				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý trưng bày > Tiêu chí thưởng trưng bày > Cập nhật</TD> 
				...
				<TR>
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							<TR>
								<TD width="150px" class="plainlabel" >Tháng <FONT class="erroralert"> *</FONT></TD>
						  ...
						  <TR>
						  	  	<TD class="plainlabel">Chương trình áp dụng</TD>
						  	  	<TD class="plainlabel" colspan="3">
					                ...
					                <div style='display:none; '>
				                        <div id='nhomdieukien' style='padding:0px 5px; background:#fff;'>
				                        	<h4 align="left">Chọn chương trình áp dụng</h4>
				                                	...
				                                	<td colspan="2">
				                                		<table align="left" cellpadding="0px" cellspacing="1px">
					                                		<tr class="tbheader">
					                                			...
					                                			<td width="330px" align="center" ><span style="font-size: 0.9em"><%=Utility.GLanguage("Diễn giải",session,jedis) %></span></td>		                                			
					                                		</tr>
					                                	</table>
						...
						<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
		                    <TR class="tbheader">
		                        <TH align="center" width="20%" rowspan="2" ><%=Utility.GLanguage("Diễn giải",session,jedis) %></TH>
