...
<script language="javascript" type="text/javascript">
	...
	function replaces()
	{
	 ...
	 function TinhTien()
	 {
		...
		var spDongiaBVAT = document.getElementsByName("spDongiaBVAT");
		var giavat = document.getElementsByName("dongia");
		var tongtien = 0;
		var tongthanhtien = 0;
		var tongtienCK = 0;
		var tongtienCKKM = 0;
		...
		{
			var dongiabvat = DinhDangTien(parseFloat(giavat.item(i).value.replace(/,/g,"")) / 1.1);
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý kho trung tâm > Đơn đặt hàng > Tạo mới
        </div>
    	...
    	<legend class="legendtitle">Đơn đặt hàng </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">	
                ...
                <TR>
                    ...
                    <TD class="plainlabel" >
                    	<input type="text"  name="txtTiengiam" id="txtTiengiam" value='<%= lsxBean.getTiengiam() %>' onkeyup="Dinhdang(this);" style="text-align: right;" readonly = "readonly"/>
						...
						if(spMa != null)
						{
							...
							<tr onMouseover="ddrivetip('<%=spGhichu[i] %>', 250)"; onMouseout='hideddrivetip()'>
								...
								if(spSCheme[i].trim().length() <= 0 ) { %>
									...
									<td> <input type="text" name="scheme" value="" style="width: 97%; text-align: right;" readonly="readonly" >
								...
								<% } else { %>
									...
									<td > <input type="text" name="soluong" value="" style="width: 97%; color: red; text-align: right;" readonly="readonly" > </td>
									<td style="display:none"> <input type="text" name="spvat" value="<%= spVat[i] %>" style="width: 100%; text-align: right;" readonly="readonly"  > </td>
