...
<% 
	...
	System.out.println("don hang lkm "+lsxBean.getDhkm());
%>
    	...
    	<legend class="legendtitle">Đơn hàng khuyến mại</legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                    ...
                    <TD class="plainlabel" valign="top"  >
                    	<select name = "khonhapId" class="select2" style="width: 200px" onchange="submitform_KHO();" >
                        	<%
                        		if(khonhapRs != null)
                        		{
                        			try
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
				<tr class="tbheader">
					...
					<th align="center" width="5%" >Số lô</th>
				...
				<% for(int i = count; i < 50; i++) { %>
					...
					<tr>
						...
						<td> <a href="javascript:void(0);" >&nbsp; <img alt="Chọn số lô" src="../images/vitriluu.png"></a></td>
