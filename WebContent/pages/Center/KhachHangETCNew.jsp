...
<SCRIPT language="javascript" type="text/javascript">
 ...
 function saveform()
 {
	 ...
	 var madms = document.getElementById('maSAP');
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền > Dữ liệu Kinh doanh > <%= nppBean.getIsKhachhang().equals("1") ? "Khách hàng ETC" : "Chi nhánh / NPP" %> > Tạo mới</TD> 
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="0">
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
											...
											<TD width="250" class="plainlabel"><INPUT type="text"
												id="maSAP" name="maSAP" value="<%= nppBean.getMaSAP() %>"></TD>
