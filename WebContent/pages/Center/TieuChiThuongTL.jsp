        ...
        <TABLE width="100%" cellpadding="0" cellspacing="1">
            <TR>
                ...
                <TR>
                    <TD width="100%">
                        <FIELDSET>
                            <LEGEND class="legendtitle">&nbsp;<%=Utility.GLanguage("Tiêu chí thưởng tích lũy",session,jedis) %> &nbsp;&nbsp;	   
                              <%if(quyen[0]!=0){ %>                      
                                    ...
                                    while ( tieuchiSKU.next()){
                                        ...
                                        <%}%>
                                                ...
                                                <% if( tieuchiSKU.getString("trangthai").trim().equals("0") ) { %>
					                                ...
					                                <A href = "../../RouterSvl?task=<%= Util.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"TieuchithuongTLSvl?userId="+userId+"&delete="+ tieuchiSKU.getString("pk_seq")+"") %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa tích lũy này?')) return false;"></A>									
							                    	<%} %>
							                    <%} else { %>
