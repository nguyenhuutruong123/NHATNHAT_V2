								...
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR class="tbdarkrow">
										<TD width="30" align="left"><A
											href="../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"NhomkhuyenmaiSvl?userId="+userId+"") %>"><img
							...
							<TD height="100%" width="100%">
								<FIELDSET>
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										<TR>
											<TD width="29%" class="plainlabel"><%=Utility.GLanguage("Tên nhóm khuyến mãi",session,jedis) %>
												<FONT class="erroralert"> *</FONT>
											</TD>
											<TD class="plainlabel"><INPUT type="text" name="ten" id="ten"
									...
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
										<TR class="tbheader">
											<TH width="10%" align="center"><%=Utility.GLanguage("Mã sản phẩm",session,jedis) %></TH>
								   ...
								   int m = 0;
						   	       rs = spSelected;
									   ...
									   if (!(rs == null)){			
										...
										<TR class=<%= darkrow%>>
											<%  } %>
											<TD align="center" class="textfont"><%= rs.getString("ma") %></TD>
