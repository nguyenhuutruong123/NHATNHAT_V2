		...
		<TD colspan="4" align='left' valign='top' bgcolor="#ffffff">
			...
			<TABLE width="100%" border="0" cellpadding="3" cellspacing="0">
				<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
							<TD width="30" align="left"><A href="../../RouterSvl?task=<%= Util1.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"KeHoachNhanVienSvl?userId="+userId+"") %>" ><img src="../images/Back30.png" alt="Trở lại"  title="Trở lại" border="1" longdesc="Trở lại" style="border-style:outset"></A></TD>
