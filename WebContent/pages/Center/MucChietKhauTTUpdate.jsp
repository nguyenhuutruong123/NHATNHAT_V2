...
<SCRIPT language="javascript" type="text/javascript">
	...
	{	  
		 ...
		 document.forms['ghcnForm'].action.value='update';
	     document.forms['ghcnForm'].submit();
	}
...
<form name="ghcnForm" method="post" action="../../MucChietKhauTTNewSvl">
<INPUT name="userId" type="hidden" value='<%=userId %>' size="30">
<input type="hidden" name="id" value='<%=ghcnBean.getId()%>'>
				...
				<TR>
					<TD align="left" class="tbnavigation">
					   <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <TR height="22">
						  	<TD align="left" colspan="2" class="tbnavigation"> &nbsp;Thiết lập dữ liệu nền > Dữ liệu Kinh doanh > Mức chiết khấu &gt; Chỉnh sửa
			...
			<TABLE width="100%" cellpadding="0" cellspacing="2">
				<TR >
					<TD >
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR class = "tbdarkrow">
								<TD width="30" align="left"><A href= "../../MucChietKhauTTSvl?userId=<%=userId %>">		 		
									<img src="../images/Back30.png" alt="Quay ve"  title="Quay về" width="30" height="30" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
				...
				<TR>
				  <TD >
						...
						<TABLE class="tblight" width='100%' cellspacing="0" cellpadding="6">
							<TR>
								<TD width="15%" class="plainlabel"><%=Utility.GLanguage("Diễn giải",session,jedis) %> mức chiết khấu <FONT class="erroralert">*</FONT></TD>
        ...
        <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
				<TR>
					<TD colspan = "6" width='100%'>
						<FIELDSET><LEGEND class="legendtitle"><%=Utility.GLanguage("Nhà phân phối",session,jedis) %> được hưởng mức chiết khấu</LEGEND>
						  	<div class="title" align="left" style="height:30px;background-color:#C5E8CD;padding-top:5px ;padding-left:5px  " > &nbsp;&nbsp;&nbsp;Chi nhánh / NPP thuộc Khu Vực
					...
					<TABLE  border="0" cellspacing="1" cellpadding="6" width='100%'>
								<TR class="tbheader">
									<TH align="center" width="18%"><%=Utility.GLanguage("Khu vực",session,jedis) %></TH>
									<TH align="center" width="18%">Mã Chi nhánh / NPP</TH>
									<TH width="30%">Tên Chi nhánh / NPP </TH>
