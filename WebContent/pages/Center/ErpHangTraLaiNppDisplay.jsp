...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Xuất chuyển hàng > Nhập hàng trả lại  > Cập nhật
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
               <TR>
                ...
                <TR  >
                    ...
                    <TD class="plainlabel"  >
                    	<input type="text" value="<%=lsxBean.getTienvat() %>" id="txtVAT" style="text-align: right;" name="ptVat" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);"  readonly='readonly'  />
                    </TD>
                ...
                <TD class="plainlabel" > Số  </TD>
                    	<TD class="plainlabel" colspan="3" >
                    		<input type="text"  name="so" value="<%=lsxBean.getSo()%>"/>
                    	</TD>
                 </tr>
