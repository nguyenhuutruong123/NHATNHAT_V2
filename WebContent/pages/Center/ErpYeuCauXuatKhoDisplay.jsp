...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Chức năng > Xuất kho > Hiển thị
        </div>
							...
							<td align="center" >
								<a href="" id="scheme_<%= spId[i] + "_" + spLoai[i] + "_" + spSCheme[i] %>" rel="subcontent_<%= spId[i] + "_" + spLoai[i] + "_" + spSCheme[i] %>">
	           	 		 		...
	           	 		 		<DIV id="subcontent_<%= spId[i] + "_" + spLoai[i] + "_" + spSCheme[i] %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; width: 350px; max-height:300px; overflow:auto; padding: 4px;">
				                    <table width="95%" align="center">
		                            	...
		                            	<%
		                            		...
		                            		//System.out.println("----KEY::: " + temID);
		                            		if(sanpham_soluong.get(temID) != null) { 
		                            			
		                            			String value = sanpham_soluong.get(temID);
		                            			String[] arr = value.split(";");
		                            			for(int j = 0; j < arr.length; j++ ) {
		                            				String[] arr2 = arr[j].split("__");
	                        			%>
	                        			
	                        			<tr>
	                        				<td>
	                        					<input type="text" style="width: 100%;text-align: right;" value="<%= arr2[1] %>" readonly="readonly" >
	                        				</td>
	                        				<td>
	                        					<input type="text" style="width: 100%;text-align: center;" value="<%= arr2[0] %>" readonly="readonly" >
	                        				</td>
	                        				<td>
	                        					<input type="text" style="width: 100%;text-align: center;" value="<%= arr2[2] %>" readonly="readonly" >
	                        				</td>
	                        			</tr>
	                        			<% } } %>
