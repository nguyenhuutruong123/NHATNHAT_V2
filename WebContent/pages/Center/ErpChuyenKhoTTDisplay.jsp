		...
		for(i = 0; i < spMa.length; i++)
		{
			if(spMa.item(i).value != "")
			{
				...
				if(pos > 0)
				{
					...
					tonkho.item(i).value = sp.indexOf("]"); 
    ...
    <fieldset>
    	<legend class="legendtitle">Xuất chuyển nội bộ </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                	<TD class="plainlabel" width="15%" >Kho xuất hàng</TD>
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
				...
				<%
					...
					if(spMa != null)
					{
						...
						<tr>
							...
							<td > <input type="text" name="soluong" value="<%= spSoluong[i] %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onchange="submitform();" > </td>
							<td align="center" > 
				...
				<% for(int i = count; i < 50; i++) { %>
					...
					<tr>
						...
						<td > <input type="text" name="soluong" value="" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onchange="submitform();" > </td>
						<td align="center" >
