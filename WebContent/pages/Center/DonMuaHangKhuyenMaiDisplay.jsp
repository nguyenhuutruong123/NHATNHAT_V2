								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý bán hàng > Đơn hàng KM > Hiển thị </TD>								   
							...
							while (m < size){
								...
								%>
							        ...
							        <TD align = "left" >
								     ...
								     <TD align = "left" >
								        <input name="soluongle" type="text" value="<%= sanpham.getSoluongle() %>" onkeypress="return keypress(event);" style="text-align:left;width:100%;" readonly="readonly">
								     </TD>
								     <td align="center">
				                   		<select style="width: 100%" name="ctkmId" id="ctkmId_<%=m%>" disabled="disabled">
				                   			<option value=""> </option>
				                   			<%
				                   				if(ctkmList!=null)
				                   				{
