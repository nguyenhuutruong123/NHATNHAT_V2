				                        ...
				                        <TABLE cellpadding="1" cellspacing="0">
				                          <%if(dsduyet.getString("trangthai").equals("0")){ %>
				                            <TR><TD>
				                                ...
				                                <A href = "../../TrakhuyenmainppUpdateSvl?userId=<%=userId%>&delete=<%= dsduyet.getString("pk_seq") %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa trả khuyến mãi  <% dsduyet.getString("pk_seq") ; %>?')) return false;"></A>
				                            </TD>
