...
<form name="khtt" method="post" action="../../BCChartDophuSvl">
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR height="22">
								<TD align="left" colspan="2" class="tbnavigation">&nbsp;Báo cáo quản trị > Báo cáo chart > Báo cáo độ phủ </TD>
			...
			<TABLE width="100%" cellpadding="0" cellspacing="1">
				...
				<TR>
					<TD width="100%">
						...
						<FIELDSET>
							<LEGEND class="legendtitle">&nbsp;Báo cáo độ phủ &nbsp;&nbsp;
