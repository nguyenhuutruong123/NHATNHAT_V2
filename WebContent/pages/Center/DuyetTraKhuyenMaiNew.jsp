					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
						<TR>
							<TD>
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR class="tbdarkrow">
										<TD width="30" align="left"><A href= "../../RouterSvl?task=<%= Utilback.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"DuyettrakhuyenmaiSvl?userId="+userId+"")%>"><img
							...
							<TD height="100%" width="100%">
								<FIELDSET>
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										...
										<TR>
											<TD width="120px" class="plainlabel"><%=Utility.GLanguage("Từ ngày",session,jedis) %> <%=Utility.GLanguage("tính Doanh số",session,jedis) %> <FONT
												class="erroralert"> *</FONT></TD>
											<TD class="plainlabel"><input
											...
											<TD width="120px" class="plainlabel"><%=Utility.GLanguage("Đến ngày",session,jedis) %> <%=Utility.GLanguage("tính Doanh số",session,jedis) %> <FONT
												class="erroralert"> *</FONT></TD>
											<TD class="plainlabel"><input
										...
										<tr>
											<TD class="plainlabel">Scheme<%=Utility.GLanguage("",session,jedis) %> <FONT class="erroralert">
													*</FONT></TD>
										...
										<TR>
											<td class="plainlabel" colspan="6"><a class="button3"
												onclick="newform()"> <img style="top: -4px;"
													src="../images/button.png" alt=""><%=Utility.GLanguage("Lấy dữ liệu",session,jedis) %>
											</a></td>
										</TR>
