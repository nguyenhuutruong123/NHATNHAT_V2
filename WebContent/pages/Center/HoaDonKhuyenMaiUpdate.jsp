						...
						<TD align="left" >
							...
							<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
											<TD width="30" align="left"><A href = "../../DonmuahangSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay về " style="border-style:outset"></A></TD>
							...
							<TABLE border="1" width="100%" cellpadding = "1" cellspacing = "0" style="border-color:gray;" >
							   ...
							   <td style="text-align: center">
								   Chi Tiết Hóa Đơn Hàng (Vui lòng chọn Chi nhánh / NPP,đơn vị kinh doanh,kênh bán hàng  trước khi sản phẩm cho đơn đặt hàng)
							   </td>
							   </tr>
							   <TR>
							   		<TD>
