...
<div id="main" style="width:99.5%; padding-left:2px">
	...
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:40%; padding:5px; float:left" class="tbnavigation">
        	Báo cáo quản trị > Báo cáo khác > Audit trưng bày
        </div>
    ...
    <div align="left" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
        ...
        <A href= "javascript:exportToExcel();" >
        	<img src="../images/excel.gif" width="30" height="30" alt="Xuất file Excel"  title="Xuất file Excel" border="1px" longdesc="Xuất file Excel" style="border-style:outset"></A>
    </div>
    
    <div style="width:100%; float:none" align="left">
    <fieldset>
    	<legend class="legendtitle">Thông tin audit</legend>
        <TABLE width="100%" cellpadding="4" cellspacing="0">								   
            ...
            <TR>
                <TD class="plainlabel" width="150px" ><%=Utility.GLanguage("Vùng",session,jedis) %> miền </TD>
