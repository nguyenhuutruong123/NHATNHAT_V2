...
<div id="main" style="width:100%; padding-left:2px">
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle"><%=Utility.GLanguage("Nhập kho",session,jedis) %> </legend>
        	<div style="float:none; width:100%" align="left">
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    <TD width="120px" class="plainlabel" valign="top"><%=Utility.GLanguage("Ngày nhập",session,jedis) %> </TD>
                    <TD class="plainlabel" valign="top" >
                    	<input type="text" class="days" readonly="readonly"  name="ngaychuyen" value="<%= lsxBean.getNgayyeucau() %>"/></TD>
                	<TD width="120px" class="plainlabel" valign="top"><%=Utility.GLanguage("Số chứng từ gốc",session,jedis) %></TD>
                    <TD class="plainlabel" valign="top" >
                    	<input type="text"  name="sochungtugoc" value="<%= lsxBean.getSochungtuGoc() %>"/></TD>
                
                </TR>
                <TR>
                    <TD class="plainlabel" valign="top"><%=Utility.GLanguage("Ghi chú",session,jedis) %> </TD>
                    <TD class="plainlabel" valign="top">
                    	<input type="text"  name="ghichu" value="<%= lsxBean.getGhichu() %>"/>
                    </TD>
                    
                    <TD class="plainlabel" valign="top"><%=Utility.GLanguage("Lý do",session,jedis) %></TD>
                    <TD class="plainlabel" valign="top">
                ...
                <TR>
                	<TD class="plainlabel" valign="top"><%=Utility.GLanguage("Kho nhập",session,jedis) %> </TD>
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
				<tr class="tbheader">
					...
					<th align="center" width="34%"><%=Utility.GLanguage("Tên sản phẩm",session,jedis) %></th>
					...
					<th align="center" width="10%"><%=Utility.GLanguage("Số lô",session,jedis) %></th>
				</tr>
					...
					if(spMa != null)
					{
						...
						<tr>
							...
							<td align="center" >
	                    		...
	                    		<a href="" id="sanpham_<%= count %>" rel="subcontent_<%= count %>">
		           	 				&nbsp; <img alt="Chọn số lô" src="../images/vitriluu.png"></a>
		           	 		
	           	 		 		<DIV id="subcontent_<%= count %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                    ...
				                    <table width="95%" align="center">
				                        <tr>
				                            ...
				                            <th width="100px" style="font-size: 11px"><%=Utility.GLanguage("Ngày sản xuất",session,jedis) %></th>
				                    ...
				                    <div style="max-height: 200px; overflow:auto;" >
				                        ...
				                        <%
				                        	...
				                        	if(ct != null)
				                        	{
				                        		...
				                        		for(int j = 0; j <  ctARR.length; j++ )
				                        		{
				                        			...
				                        			System.out.println("ngayhethan la :-------    "+_ct[3]);
				                        			%>
				                        			...
				                        			<tr>
				                        				...
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: center;" name="dong<%= count %>_spNGAYSANXUAT" value="<%= _ct[2] %>" readonly="readonly" class="days"  >
				                        				</td>
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: right;" name="dong<%= count %>_spNGAYHETHAN" value="<%= _ct[3] %>" class="days" readonly="readonly">
				                        				</td>
				                        			</tr>
		                            	...
		                            	<%
		                            		for(int j = stt; j < 30; j++ ) { %>
		                            			...
		                            			<tr>
			                        				...
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: center;" name="dong<%= count %>_spNGAYSANXUAT" value="<%= lsxBean.getDateTime() %>" readonly="readonly" class="days"  >
			                        				</td>
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: right;" name="dong<%= count %>_spNGAYHETHAN" value=value="" readonly="readonly">
			                        				</td>
			                        			</tr>
				                     ...
				                     <div align="right">
				                     	...
				                     	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                     	<a href="javascript:dropdowncontent.hidediv('subcontent_<%= count %>')" > <%=Utility.GLanguage("Đóng lại",session,jedis) %> </a>
				                     </div>
					            </DIV> 
				...
				<% for(int i = count; i < 30; i++) { %>
					...
					<tr>
						...
						<td align="center" >
	                    		...
	                    		<a href="" id="sanpham_<%= i %>" rel="subcontent_<%= i %>">
		           	 				&nbsp; <img alt="Chọn số lô" src="../images/vitriluu.png"></a>
				                    ...
				                    <table width="95%" align="center">
				                        <tr>
				                            <th width="100px" style="font-size: 11px"><%=Utility.GLanguage("Số lượng",session,jedis) %></th>
				                            <th width="100px" style="font-size: 11px"><%=Utility.GLanguage("Số lô",session,jedis) %></th>
				                            <th width="100px" style="font-size: 11px"><%=Utility.GLanguage("Ngày sản xuất",session,jedis) %>t</th>
				                            <th width="100px" style="font-size: 11px"><%=Utility.GLanguage("Ngày hết hạn",session,jedis) %></th>
				                        </tr>
		                            </table>
		                            ...
		                            <div style="max-height: 200px; overflow:auto;" >
			                            	...
			                            	<%
			                            		for(int j = 0; j < 30; j++ ) { %>
			                            			...
			                            			<tr>
				                        				...
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: center;" name="dong<%= i %>_spNGAYSANXUAT" value="" readonly="readonly" class="days" >
				                        				</td>
				                        				<td>
				                     ...
				                     <div align="right">
				                     	<label style="color: red" ></label>
				                     	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                     	<a href="javascript:dropdowncontent.hidediv('subcontent_<%= i %>')" > <%=Utility.GLanguage("Đóng lại",session,jedis) %> </a>
				                     </div>
					            </DIV> 
