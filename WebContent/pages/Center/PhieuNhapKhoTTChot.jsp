...
<input type="hidden" name="tenform" value="chot">
					...
					<TR height="22">
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý kho >Kho trung tâm> Nhập kho > Chốt phiếu  </TD>								   
								...
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
								    		...
								    		<TD width="40" align="left"><A href ="javascript: chotdonhang();" ><img src="../images/Chot.png" alt="Chốt"  title="Chốt đơn hàng" border="1" longdesc="Chốt" style="border-style:outset"></A></TD>
								    		<TD align="left" >&nbsp;</TD>
										</TR>
									</TABLE>
								</TD></TR>
							...
							<TABLE border="0" width="100%" cellpadding = "0" cellspacing = "0" >
								...
								<TR>
									<TD  align="left">						
										...
										<TABLE cellpadding = "6" cellspacing = "0" width = "100%" border = 0>
									  	...
									  	<TD class="plainlabel" >
									  		<input type="hidden" value="<%=dhBean.getKhoID() %>" readonly="readonly" name="khottid">
									  	 	<input type ="text" value="<%=dhBean.getTenKho() %>" readonly="readonly" name="tenkhott">
									  	</TD>
							        	</TR>
								
								<TR >
											  <TD class="plainlabel">Ngày nhập kho </TD>
											  <TD colspan="3" class="plainlabel">	<input style="background-color:white" value="<%=dhBean.getNgayNhap() %>" readonly="readonly" name="ngaynhapkho"> </TD>
							  </TR>
							   ...
							   <TR>
							   		<TD>
										<TABLE width = "100%" border="1" cellpadding="1px" cellspacing="0" >
										<tbody id="san_pham">
												<TR class="tbheader" >
