...
int[] quyen = new  int[5];
quyen = util.Getquyen("116",userId);
													...
													<TR>
														...
														<TD class="plainlabel" align="left" colspan=2><a
															class="button1" href="javascript:submitForm('Hien thi')">
																...
																alt=""><%=Utility.GLanguage("Tìm kiếm",session,jedis) %> </a>
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a class="button2"
							                                       	...
							                                       	if (m % 2 != 0) {
																		  ...
																		  %>
																				...
																				<TR style="<%=chuoi %>"  class=<%= darkrow%>>
																					...
																					<TD>
																					<%
							                                                  		 if (dhlist.getString("trangthai").equals("6")){ %>
																					...
																					<TD align="center">
																						<TABLE border=0 cellpadding="1" cellspacing="0">
																							<TR>
																								...
																								<%if(quyen[3]!=0){ %>
																								<A
																								   href="../../DonmuahangKmUpdateSvl?userId=<%=userId%>&display=<%=dhlist.getString("chungtu") %>"><img
																								...
																								<A id='suaphieu<%=dhlist.getString("chungtu")%>'
																								   ...
																								   border="0" onclick="processing('<%="suaphieu"+dhlist.getString("chungtu")%>' , '../../DonmuahangKmUpdateSvl?userId=<%=userId%>&edit=<%=dhlist.getString("chungtu") %>')" >
																								</A>
																								<%} %>
																								</TD>
																								...
																								<A id='chotphieu<%=dhlist.getString("chungtu")%>'
																								   href=""><img
																								   src="../images/Chot.png" alt="Chốt đơn hàng"
																								   width="20" height="20" title="Chốt đơn hàng" 
																								   border="0" onclick="if(!confirm('Bạn có muốn chốt đơn hàng này?')) {return false ;}else{ processing('<%="chotphieu"+dhlist.getString("chungtu")%>' , '../../DonmuahangKmSvl?userId=<%=userId%>&chot=<%=dhlist.getString("chungtu") %>');}"  >
																								</A>
																								<%} %>
																								</TD>
																								<TD width=25>
																								...
																								<A id='deletephieu<%=dhlist.getString("chungtu")%>'
																								   ...
																								   border="0" onclick="if(!confirm('Bạn có muốn hủy đơn hàng này?')) {return false ;}else{ processing('<%="deletephieu"+dhlist.getString("chungtu")%>' , '../../DonmuahangKmSvl?userId=<%=userId%>&delete=<%=dhlist.getString("chungtu") %>');}"  >
																								</A>
																								<%} %>
																								</TD>
																								<% }
																							...
																							<% if (t == 2 && dhlist.getString("kbh_fk").equals("100025") ){
																							 if( dhlist.getString("loaidonhang").equals("1")){
																									...
																									<A id='huychotphieu<%=dhlist.getString("chungtu")%>'
																									   ...
																									   border="0" onclick="if(!confirm('Bạn có muốn hủy chốt đơn hàng này?')) {return false ;}else{ processing('<%="huychotphieu"+dhlist.getString("chungtu")%>' , '../../DonmuahangKmSvl?userId=<%=userId%>&huychot=<%=dhlist.getString("chungtu") %>');}"  >
																									</A>
																									</TD>		
																									<%} %>
																							<% }}%>
