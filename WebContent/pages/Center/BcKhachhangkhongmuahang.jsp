...
<%@ page  import = "geso.dms.center.util.*" %>
	<%
		...
		String url="";
		url = util.getUrl("NguongDoanhThuSvl","&view=KHKM");
	%>
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../NguongDoanhThuSvl">
	<input type="hidden" name="action" value='1'>
	<input type="hidden" name="userId" value='<%=userId%>'>
	<input type="hidden" name="view" value='DTT'>
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle"> Bc hạn mức doanh thu trần</legend>
