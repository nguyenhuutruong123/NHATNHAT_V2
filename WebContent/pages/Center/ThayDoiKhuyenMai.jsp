                     ...
                     <TABLE border="0" width="100%" cellspacing = 0 cellpadding = 0>
                            ...
                            <TD width="100%" align="left">
								...
								<TR>
									...
									<%if (obj.getTrangthai().equals("0")){ %>								  		
								    	<option value="0" selected><%=Utility.GLanguage("Chưa duyệt",session,jedis) %> </option>
									...
									<%}else{ 							
								    	...
								    	<option value="0" selected><%=Utility.GLanguage("Chưa duyệt",session,jedis) %> </option>
								    	<option value="1" selected><%=Utility.GLanguage("Đã duyệt",session,jedis) %></option>
								    	<option value="2" ><%=Utility.GLanguage("Đã hủy",session,jedis) %></option>
									...
									<% }else{  %>
										<option value="0" ><%=Utility.GLanguage("Chưa duyệt",session,jedis) %> </option>
								    	<option value="1"><%=Utility.GLanguage("Đã duyệt",session,jedis) %></option>
								    	<option value="2" ><%=Utility.GLanguage("Đã hủy",session,jedis) %></option>
									<% }}%>
								    	</select></TD>
                      ...
                      <TABLE width="100%" cellspacing = 0 cellpadding=0>
                        <TR>
                            <TD >
                                <FIELDSET>
                                <LEGEND class="legendtitle">&nbsp;<%=Utility.GLanguage("Thay đổi CTKM",session,jedis) %></LEGEND> 
                                <a
											class="button3" href="javascript:newform()"> <img
											style="top: -4px;" src="../images/New.png" alt=""><%=Utility.GLanguage("Tạo mới",session,jedis) %> </a>
                                ...
                                <TR>
                                    <TD>
                                        ...
                                        <TR class="tbheader">
                                            ...
                                            <TH > <%=Utility.GLanguage("Mã trả KM",session,jedis) %></TH>
                                            <TH> <%=Utility.GLanguage("Mã điều kiện KM",session,jedis) %></TH>
                                            ...
                                            <TH ><%=Utility.GLanguage("Ngày duyệt",session,jedis) %> </TH>
                                	                    ...
                                	                    <%if(quyen[Utility.SUA]!=0){ %>
	                                        	          ...
	                                        	          <%if(quyen[Utility.CHOT]!=0){ %>
                                	                    	<TD>	                                    	                    
																	...
																	<A id='chotphieu<%=nhaphanglist.getString("thaydoiId")%>' href=""><img src="../images/Chot.png" alt="Chốt" width="20" height="20" title="Chốt" border="0" 
																	onclick="if(!confirm('Bạn có muốn thêm sp vào ctkm này hay không?')) {return false ;}else{ 
	                                        	          ...
	                                        	          <%if(quyen[Utility.XOA]!=0){ %>
                                	                    	<TD>	 
																	...
																	<A id='deletephieu<%=nhaphanglist.getString("thaydoiId")%>' href=""><img src="../images/Delete.png" alt="Xóa" width="20" height="20" title="Xóa" border="0" 
																	onclick="if(!confirm('Bạn chắc chắn muốn xóa mục này không?')) {return false ;}else{ 
