   ...
   <script>
    ...
    <script language="javascript" type="text/javascript">
		...
		function upload(trakmId)
		{
			...
			document.forms["ctkmForm"].traKMUploadId.value = "fileup"+trakmId;
			document.forms["ctkmForm"].submit();
		}
		
		function uploadG(trakmId) {
			
			if (document.forms["ctkmForm"].fileup.value == "") {
				alert("Vui lòng chọn file upload !");
				return;
			} else {
				
				// Kiểm tra định dạng file có đúng là xls hay không !
				var res_field = document.forms["ctkmForm"].fileup.value;
...
<div id="main" style="width:100%; padding-left: 1px">
	<div align="left" id="header" style="width:100%; float:none">
  	...
  	<div align="left" style="width:100%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror"  style="width: 100% ; color:#F00 ; font-weight:bold" readonly rows="3"><%= ctkmBean.getMsg() %></textarea>
    	</fieldset>
  	</div>
        	...
        	<TABLE width="100%" cellpadding="4" cellspacing="0" border="0">
        		<TR>
                     ...
                     <TD width="250px" class="plainlabel">
                     	<input type="text" name="scheme" id="scheme" readonly size="30" value="<%= ctkmBean.getScheme() %>"></TD>
                     
                     <TD width="130px" class="plainlabel" valign="top"><%=Utility.GLanguage("Diễn giải",session,jedis) %></TD>
                     <TD class="plainlabel" valign="top">
                     	<input type="text" name="diengiai" id="diengiai" style="width:400px" readonly value="<%= ctkmBean.getDiengiai() %>"></TD>
                     <TD width="130px" class="plainlabel">
				</TR>
				<TR>
					<TD width="130px" class="plainlabel" colspan="6"></TR>
			</TABLE>
		</div>
	...
	<%	while(rsTraKM.next()) 
		{ %>
			...
			<%
			traKMIds += rsTraKM.getString("pk_seq")+",";
			xacsuat +=rsTraKM.getString("xacsuat")+",";
		}
			%>
		...
		<%for(int i=0;i<arrTraKM.length;i++){ %> 
						...
						<div id="tab<%=arrTraKM[i]%>" class="tab_content">
							...
							<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="5px">
								<tr>
									<TD class="plainlabel" colspan="3" height="20px">&nbsp;</TD>
								</tr>
								<tr>
									<TD class="plainlabel" colspan="3">
										...
										&nbsp;&nbsp;
							  			<a class="button" href="javascript:upload(<%=arrTraKM[i]%>)">
							  				<img style="top: -4px;" src="../images/button.png">Upload</a></div>
							  		</TD>
								</tr>
								...
								<tr>
									<TD class="plainlabel" colspan="3">
										<div id="btnSave1">
										<a class="button" href="javascript:xuatexcel(<%=arrTraKM[i]%>);">
