				...
				<TR>
					<TD colspan = "6" width='100%'>
						<FIELDSET><LEGEND class="legendtitle"><%=Utility.GLanguage("Nhà phân phối",session,jedis) %> được hưởng tín dụng</LEGEND>
						  	<div class="title" align="left" style="height:30px;background-color:#C5E8CD;padding-top:5px " >  Chi nhánh / NPP thuộc Khu Vực: &nbsp;&nbsp;&nbsp;&nbsp;
					...
					<TABLE  border="0" cellspacing="1" cellpadding="6" width='100%'>
								...
								<TH width="18%">Tên Khu Vực </TH>
								  <TH align="center" width="17%">Mã Chi nhánh / NPP</TH>
