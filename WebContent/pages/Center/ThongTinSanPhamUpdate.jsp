 ...
 function saveform()
{
	...
	/*  var kl = document.spForm.kl.value;
	 ...
	 document.spForm.action.value='update';
     document.forms["spForm"].submit();
}
 ...
 function Xoafile()
 {
 	...
 	{
 		 document.spForm.action.value='xoaanh';
 	     document.forms["spForm"].submit();
 	}
 ...
 function download(){
		...
		//  alert("yeye");
	  document.spForm.action.value='download';
	  document.forms["spForm"].submit();
	 }
					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
						<TR>
							<TD>
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR class="tbdarkrow">
										<TD width="30" align="left"><A href="../../RouterSvl?task=<%= Util.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"ThongtinsanphamSvl?userId="+userId+"")%>"><img src="../images/Back30.png" alt="Quay ve" title="Quay ve" border="1" longdesc="Quay ve" style="border-style: outset"></A></TD>
																 ...
																 %>
																	...
																	<TD align="center">
																		<%
																			if (!(dvdl2[i] == null))
																					{
																				System.out.print("dvdl2["+i+"] = "+ dvdl2[i] +"----"+sl2[i]);
