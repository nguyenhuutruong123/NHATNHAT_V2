...
<body>
<form name="erpDmhForm" method="post" action="../../BCTonKhoKhachHang">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	&#160; Quản lý kho chi nhánh > Báo cáo > Báo cáo tồn kho khách hàng
        </div>
    ...
    <div align="left" style="width: 100%; float: none; clear: left">
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> Biểu mẫu đơn hàng </legend>
                			...
                			<TD class="plainlabel">Nhà phân phối</TD>
									<TD class="plainlabel" colspan="1">
										<select name="nppId" id="nppId"	 style="width: 300px; text-align: left !important;">
											...
											if (npp != null)
													while (npp.next()) {
														if (npp.getString("pk_seq").equals(obj.getNppId_BCTKKH())) {%>
														<option value="<%=npp.getString("pk_seq")%>" selected><%=npp.getString("ma") + " -- " +npp.getString("ten")%></option>
													<%} else {%>
														<option value="<%=npp.getString("pk_seq")%>"><%=npp.getString("ma") + " -- " +npp.getString("ten")%></option>
							...
							<TD class="plainlabel"><%=Utility.GLanguage("NHÂN VIÊN BÁN HÀNG",session,jedis) %></TD>
									<TD class="plainlabel" colspan="1">
										<select name="ddkdId" id="ddkdId" style="width: 300px; text-align: left !important;">
											...
											if (ddkd != null)
													while (ddkd.next()) {
														if (ddkd.getString("pk_seq").equals(obj.getDdkdId_BCTKKH())) {%>
