...
<form name ="khtt" method="post" action="../../ThongkekhaosatUpdateSvl" >
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;<%=url %> > <%=Utility.GLanguage("Xem kết quả",session,jedis) %></TD> 
				...
				<TR>
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
		                  ...
		                  <TR>
                          		<TD class="plainlabel" valign="middle" ><%=Utility.GLanguage("Tên người trả lời",session,jedis) %> </TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text"  value="<%= obj.getTieude() %>" readonly="readonly" > 
		                        </TD>          
                          		<TD class="plainlabel" valign="middle"  > <%=Utility.GLanguage("Điện thoại",session,jedis) %></TD>   
		                        <TD class="plainlabel" valign="middle" width="220px" >
		                        	<input type="text"  value="<%= obj.getSodienthoai() %>" readonly="readonly" > 
		                        </TD>          
		                        
                          		<TD class="plainlabel" valign="middle" width="120px" ><%=Utility.GLanguage("Địa chỉ",session,jedis) %> </TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                  ...
		                  <TR>
                          		<TD class="plainlabel" valign="middle" ><%=Utility.GLanguage("Đối tượng",session,jedis) %> </TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text"  value="<%= obj.getDoituong() %>" readonly="readonly" > 
		                        </TD>          
                          		<TD class="plainlabel" valign="middle"  ><%=Utility.GLanguage("Mục tiêu",session,jedis) %> </TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text"  value="<%= obj.getMuctieu() %>" readonly="readonly" > 
		                        </TD>          
		                  
                          		<TD class="plainlabel" valign="middle" > <%=Utility.GLanguage("Thu nhập",session,jedis) %></TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                  ...
		                  <TR>
		                  		<TD class="plainlabel" valign="middle"  > <%=Utility.GLanguage("Giới tính",session,jedis) %></TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text"  value="<%= obj.getGioitinh() %>" readonly="readonly" > 
		                        </TD>   
		                        
		                        <TD class="plainlabel" valign="middle"  > <%=Utility.GLanguage("Tuổi",session,jedis) %></TD>   
		                        <TD class="plainlabel" valign="middle" colspan="3" >
		                  	...
		                  	<TD colspan="6" >
		                  		<ul class="tabs">
		                  			<% for(int i = 0; i < Integer.parseInt(obj.getSocauhoi()); i++) { %>
		                  				<li><a href="#"><%=Utility.GLanguage("Câu",session,jedis) %> <%= i + 1 %></a></li>
		                  			<% } %>
		                  		</ul>
