...
function ThemSanPham()
{
	var sottcount = document.getElementsByName("sott");
	 ...
	 {
		 for(var i=0; i < sl ; i++)
			 addRow("san_pham",sottcount.length+1);
	 }
	 else
	 {
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý tồn kho >Kho trung tâm> Nhập kho > Tạo mới </TD>								   
							...
							while (m < size){
								...
								%>
									<TR class= 'tblightrow' >
										...
										<input name="masp" autocomplete="off" type="text"  value="<%=sanpham.getSanPhamId()%>" onkeyup="ajax_showOptions(this,'abc',event)"   style="width:100%;">
