...
<script>
	...
	function save()
	{
	  ...
	  if( tungay == '' )
	  {
		  alert("Bạn phải nhập từ ngày DS");
		  return;
	  }
	  	
	  if( denngay == '' )
	  {
		  alert("Bạn phải nhập đến ngày DS");
		  return;
	  }
	...
	{
		var start = parseInt($("#sizeSanPhamMua").val());
		var end = start + 10;
		for(var x = start ; x < end; x ++)
		{
			$("#tableSPMUA > tbody").append('<tr> '  +
	        		'<td> '  +
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
				...
				<TR>
				  <TD height="100%" width="100%">
						<FIELDSET >
						<LEGEND class="legendtitle" style="color:black"><%=Utility.GLanguage("Thông tin khuyến mại",session,jedis) %></LEGEND>
						...
						<ul class="tabs">
							<li <%=obj.getActiveTab().equals("0") ? "class='current'" : "" %>><a href="#tab1"><%=Utility.GLanguage("Tiêu chí tích lũy",session,jedis) %></a></li>
							<li <%=obj.getActiveTab().equals("1") ? "class='current'" : "" %>><a href="#tab2"><%=Utility.GLanguage("Sản phẩm mua",session,jedis) %> </a></li>			
						</ul>
														...
														<a class="sanphamTRA<%= i %>" href="#">
											                ...
											                <div style='display:none; '>
										                        <div id='sanphamTRA<%= i %>' style='padding:0px 5px; background:#fff;'>
										                            ...
										                            <tr>
									                                	<td width="150px" valign="top" align="left"><span style="font-size: 12px">Hình thức<%=Utility.GLanguage("",session,jedis) %></span>
									                                	</td>
						...
						<div id="tab2" class="tab_content">
								...
								<TABLE id ='tableSPMUA' class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
								...
								<a class="button3" href="javascript:themsanpham()">
                           						<img style="top: -4px;" src="../images/New.png" alt="">Thêm 10 dòng</a> 
								<input type="hidden" name='sizeSanPhamMua' id ='sizeSanPhamMua'  value =<%= count%>>
							</div>
