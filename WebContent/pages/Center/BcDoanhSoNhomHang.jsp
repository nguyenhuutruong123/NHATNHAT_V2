...
<%@page import="geso.dms.center.beans.report.IBcDoanhSoNhomHangList"%>
...
<%
	...
	IBcDoanhSoNhomHangList obj = (IBcDoanhSoNhomHangList) session.getAttribute("obj");
	...
	String url="";
	url = util.getUrl("BcDoanhSoNhomHangSvl","");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="ckParkForm" method="post" action="../../BcDoanhSoNhomHangSvl">
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Doanh số nhóm hàng </legend>
					<div style="width: 100%; float: none" align="left">
						...
						<TD class="plainlabel"  colspan="6" style="display: none">
						
						Không lấy nhóm nhập khẩu     <input type="checkbox" name="klaynhomnk" value="0"   >
