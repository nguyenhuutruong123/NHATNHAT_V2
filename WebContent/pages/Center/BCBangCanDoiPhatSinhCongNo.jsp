	    ...
	    function submitform()
		 ...
		 function xuatExcel() 
		 {
				...
				if (document.forms["ckParkForm"]["nppHOId"].value.length == 0) {
					setErrors("Vui lòng chọn Đối tác/NPP");
					return;
				}	
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> <%=Utility.GLanguage("Tiêu chí tìm kiếm",session,jedis) %></legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >
                	 <TR>
                        <TD class="plainlabel" width="150px"><%=Utility.GLanguage("Từ ngày",session,jedis) %></TD>
                        <TD class="plainlabel" width="350px" >
                            <input type="text" class="days" name="tuNgay" style="width:250px" value="<%= obj.getTungay() %>" maxlength="10"  />
                        </TD>
                    
                        <TD class="plainlabel" width="150px"><%=Utility.GLanguage("Đến ngày",session,jedis) %></TD>
                        <TD class="plainlabel">
