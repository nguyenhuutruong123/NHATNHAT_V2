				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Tích lũy > Khuyến mại tích lũy  > Cập nhật</TD> 
				...
				<TR>
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
						  ...
						  <tr>
		                		<td class="plainlabel" >Kho trả <FONT class="erroralert"> *</FONT> </td>
		                     ...
		                     <Tr>
		                    	<TD class="plainlabel"> Tính theo </TD>
						...
						<ul class="tabs">
							...
							<li <%=obj.getActiveTab().equals("1") ? "class='current'" : "" %>><a href="#tab2"><%=Utility.GLanguage("Sản phẩm",session,jedis) %> mua</a></li>			
						</ul>
						...
						<div id="tab2" class="tab_content">
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
				                    ...
				                    <TR class="tbheader">
				                    	...
				                    	<td align="center" width="10%" >Điểm thưởng</td> 
				                    <% 
				                    int count = 0;
