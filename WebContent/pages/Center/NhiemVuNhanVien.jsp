...
<% INhiemVuNhanVienList obj = (INhiemVuNhanVienList)session.getAttribute("obj"); %>
<% List<INhiemVuNhanVien> nvList = (List<INhiemVuNhanVien>)obj.getList(); %>
...
if(!util.check(userId, userTen, sum)){
	...
	int[] quyen = new  int[5];
	quyen = util.Getquyen("105",userId);
...
<head>
	...
	<title>OneOne - Nhiệm Vụ Nhân Viên</title>
    ...
    <SCRIPT language="javascript" type="text/javascript">
	 ...
	 function submitform()
	 {   
	    document.forms["nvnvForm"].submit();
	 }
	 function newform()
	 {   
		document.forms["nvnvForm"].action.value = "Tao moi";
	    document.forms["nvnvForm"].submit();
	 }
	 function clearform()
	 {   
	    document.forms["nvnvForm"].diengiai.value = "";	   
	    submitform();
	 }
	 
	 function xuatExcel()
	 {
	 	document.forms['nvnvForm'].action.value= 'excel';
	 	document.forms['nvnvForm'].submit();
	 	document.forms['nvnvForm'].action.value= '';
	 }
...
<body>
	<form name="nvnvForm" method="post" action="../../NhiemVuNhanVienSvl">
		<input type="hidden" name="userId" value="<%= userId %>" >
		<input type="hidden" name="action" value="1" >
		<input type="hidden" name="msg" value="<%= obj.getMessage() %>" >
        
		<script type="text/javascript">if(document.forms["nvnvForm"].msg.value != "") alert(document.forms["nvnvForm"].msg.value);</script>
		<%obj.setMessage(""); %>
		<div id="main" style="width:100%; padding-left:2px">
			<div align="left" id="header" style="width:100%; float:none">
		    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
		        	Quản lý chỉ tiêu > Nhiệm vụ nhân viên
		        </div>
		  	...
		  	<div id="cotent" style="width:100%; float:none">
		        ...
		        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
		        	<fieldset>
		            	<legend><span class="legendtitle">Nhiệm Vụ Nhân Viên</span>&nbsp;&nbsp;&nbsp;
		                	<%if(quyen[0]!=0) {%>
		            	...
		            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
			                    ...
			                    %> 
		                         ...
		                         <%} %>
				                    ...
				                    <TD align="center"><%= nv.getThang() %></TD>
				                    <TD align="center"><%= nv.getNam() %></TD>
				                    ...
				                    <TD align="center">
				                        <TABLE cellpadding="1" cellspacing="0">
				                            <TR><TD>
				                            	<%if(quyen[2]!=0) {%>
				                                <A href = "../../NhiemVuNhanVienUpdateSvl?userId=<%=userId%>&update=<%= nv.getId()%>"><IMG src="../images/Edit20.png" alt="Cap nhat" title="Cap nhat" border="0"></A>
				                            	<%} %>
				                            </TD><TD>
				                            	<%if(quyen[1]!=0) {%>
				                                <A href = "../../NhiemVuNhanVienSvl?userId=<%=userId%>&delete=<%= nv.getId() %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa nhiệm vụ nhân viên này ?')) return false;"></A>
				                            	<%} %>
				                            </TD></TR>
				                        </TABLE>									
				                    </TD>
