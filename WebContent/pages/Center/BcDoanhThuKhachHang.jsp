...
String url = util.getChuyenNguUrl("BcDoanhThuKhachHangSvl", "",session);
...
<div class="box" style="border: 1px solid #dddbdb; background-color: #C5E8CD;">
	...
	<div class="box-header">
		<div class="form-group col-md-6">
		  <h3 class="box-title"><%=Utility.GLanguage("Doanh thu theo khách hàng",session,jedis) %> </h3>
		</div> 
	</div>
	...
	<div class="box-body">
		...
		<div class="form-group">
          ...
          <input  class="monthPicker" type="text" autocomplete="off" class="days" name="tungay" id="tungay" size="20" value = "<%=obj.gettungay()%>" data-date-format="yyyy-mm-dd">
        </div>
        </div>
        ...
        <div class="col-md-6">
		<div class="form-group">
		   <div class="col-md-4"><label><%=Utility.GLanguage("Khách hàng",session,jedis) %></label></div> 
...
<table id="example2" class="table table-bordered table-hover table-striped">
  <thead class="colorheader">
     <tr>
		...
		<th  > <%=Utility.GLanguage("TỈNH THÀNH",session,jedis) %> </th>
		<th  ><%=Utility.GLanguage("CHI NHÁNH /ĐT",session,jedis) %></th>
		<th  ><%=Utility.GLanguage("NVBH",session,jedis) %></th>
		<th  ><%=Utility.GLanguage("MÃ KH",session,jedis) %></th>
		<th  ><%=Utility.GLanguage("TÊN KH",session,jedis) %></th>
		<th  ><%=Utility.GLanguage("ĐỊA CHỈ KH",session,jedis) %></th>
		<th  ><%=Utility.GLanguage("LOẠI KH",session,jedis) %></th>
