...
<form name="tcsku" method="post" action="../../TieuchithuongTBReportSvl">
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp; Quản lý trưng bày > Báo cáo > Thưởng trưng bày </TD>  
            ...
            <TR>
                <TD>
                    <TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <FIELDSET>
                            <LEGEND class="legendtitle">&nbsp;Thưởng trưng bày &nbsp;</LEGEND>
							...
							<% if( !obj.getType().equals("1")) { %>
                             <TR id="TheoNgay" >
								<TD class="plainlabel" width="9%"><%=Utility.GLanguage("Từ ngày",session,jedis) %></TD>
								<TD class="plainlabel" >
							...
							<TR>
	                             <TD class="plainlabel" >Mã CTTB </TD>
								 <TD class="plainlabel" >
