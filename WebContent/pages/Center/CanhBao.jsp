								...
								<TD class="plainlabel">
									<select name="trangthai" onChange="submitform();">
										...
										<% if(obj.getTrangthai().equals("Hết hạn sản phẩm")) { %>
										 ...
										 <% if(obj.getTrangthai().equals("Hết hạn hợp đồng ASM")) { %>
											<option value="Hết hạn hợp đồng ASM" selected="selected" >Hết hạn hợp đồng ASM</option>
										 <%  } else { %> 
										 	<option value="Hết hạn hợp đồng ASM" >Hết hạn hợp đồng ASM</option>
										 <% } %>
                        ...
                        <TR>
                            ...
                            <TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
                                <TR class="tbheader">
                                    ...
                                    <TH width="15%" align="center"><%=Utility.GLanguage("Ngày tạo",session,jedis) %></TH>
                                    <TH width="5%" align="center"><%=Utility.GLanguage("Tác vụ",session,jedis) %></TH>
                                </TR>
                                <% 
