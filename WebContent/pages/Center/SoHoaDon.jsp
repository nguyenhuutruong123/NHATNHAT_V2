...
<%@ page  import = "geso.dms.center.beans.chuyentuyen.IChuyenTuyen" %>
...
<form name="tbhForm" method="post" action="../../ChuyenTuyenTTSvl">
							...
							<%
								if(nvId != null){ 
									for(int i = 0; i < nvId.length; i++)
									{
										...
										<%if(bean.getNppId().equals("106210")){ // CN HO CHI MINH %>
										<TR>
											<td>
