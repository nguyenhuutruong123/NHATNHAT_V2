								...
								<TR>
									...
									<%
										if(obj.gettype().equals("0")){
											%>
											<input type="radio" name="type" value="1"  onchange="seach();" /> Chi tiết &nbsp; &nbsp;
											<input type="radio" name="type" value="0"  checked="checked"  onchange="seach();" />Tổng quát
											<%
										}
										else
										{
											%>
												<input type="radio" name="type" value="1"  checked="checked"  onchange="seach();" />Chi tiết  &nbsp; &nbsp;
												<input type="radio" name="type" value="0"  onchange="seach();" /> Tổng quát
											<%
										}
									%>
