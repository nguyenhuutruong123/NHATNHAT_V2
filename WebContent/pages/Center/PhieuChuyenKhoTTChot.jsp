...
<form name="dhForm" method="post" action="../../PhieuChuyenKhoTTNewSvl">
<input type="hidden" name="userId" value='<%=userId %>'>
<input type="hidden" name="userTen" value='<%=userTen%>'>
<input type="hidden" name="action" value='chot'>
<input type="hidden" name="tenform" value="chotform">
					...
					<TR height="22">
							...
							<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý tồn kho > Kho trung tâm > Phiếu chuyển kho  >Chốt phiếu </TD>								   
							...
							<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
											<TD width="30" align="left"><A href = "../../PhieuChuyenKhoTTSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
								    		...
								    		<TD width="30" align="left"><A href="javascript:chotdonhang();" ><img src="../images/Chot.png" alt="Chốt phiếu" title="Chốt phiếu" longdesc="chốt phiếu" border=1 style="border-style:outset"></A></TD>
								    		<TD align="left" >&nbsp;</TD>
										</TR>
									</TABLE>
								</TD>
								...
								<TD align="left" colspan="4" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width: 100% ; color:#F00 ; font-weight:bold" style="width:100%"  rows="2"   title="" ><%=  dhBean.getMessage()%> </textarea>
									</FIELDSET>
							   </TD>
								</tr>
								<TR>
									<TD  align="left">						
										<FIELDSET>
										<LEGEND class="legendtitle">&nbsp;Thông tin phiếu chuyển </LEGEND>
										<TABLE cellpadding = "6" cellspacing = "0" width = "100%" border = 0>																											
										<TR>
									  	<TD class="plainlabel" width="19%">Kho nhận</TD>
									  	<TD class="plainlabel" >
									  	<input type="text" name="khonhanten" readonly="readonly" value="<%=dhBean.getTenKhoNhan()%>">
									  <input type="hidden" name="khonhanid" size="20" value='<%=dhBean.getKhoID_Nhan() %>'>
									  	</TD>
							        	</TR>
							        	<TR >
