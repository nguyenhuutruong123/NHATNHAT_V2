...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Phiếu thanh toán> tạo mới
        </div>
    ...
    <fieldset>
    	<legend class="legendtitle">Phiếu thu tiền</legend>
           <TABLE width="100%" cellpadding="5px" cellspacing="0px">
             <TR>
                <TD class="plainlabel"  width="15%">Ngày thanh toán</TD>
                ...
                if(listdonhang!=null){
                  while(m<listdonhang.size()) {
				   ...
				   <TR class= "tbdarkrow">
					...
					<TD align="center"><input type ="hidden" name ="tiendonhang1"  value ='<%= donhang.getTienDonHang() %>'><%=Math.round(donhang.getTienDonHang()) %></TD>
					<TD align="center"><input type ="hidden" name ="dathanhtoan1"  value ='<%=donhang.getDaThanhToan() %>'><%= Math.round(donhang.getDaThanhToan()) %></TD>
