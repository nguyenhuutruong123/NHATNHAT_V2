...
<% if(nnId == null) {
 ...
 String url = util.getUrl("DuyettrakhuyenmaiSvl","" );
%>
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Tích lũy > Duyệt trả tích lũy > Cập nhật</TD> 
					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
						    ...
						    <A href="javascript: save();"  >
						    	<IMG src="../images/Save30.png" title="Luu lai" alt="Luu lai" border = "1"  style="border-style:outset" onclick="if(!confirm('Cập nhật thông tin sẽ xóa phần xét duyệt đã tính, bạn đồng ý?')) return false;" >
						    </A>
						    </div>
						    </TD>
							<TD >&nbsp; </TD>						
				...
				<TR>
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							<TR>
											<TD width="120px" class="plainlabel">Ngày duyệt <FONT
						  ...
						  <tr class="plainlabel">
							<TD class="plainlabel" >Upload duyệt trả</TD>
						  	<td colspan="3">
						  ...
						  <TR>
						  	  	<td class="plainlabel" colspan="6"><a class="button3"  onclick="newform()">
	    							<img style="top: -4px;" src="../images/button.png" alt="">Lấy dữ liệu</a>
	    						&nbsp;&nbsp;&nbsp;
						...
						<TABLE class="chitieutable">
											<TR class="tbheader">
												...
												<TH align="center" width="30%">Ngày đăng ký</TH>
						...
						<TABLE class = "chitieutable">
							...
							<TR class="tbheader">
		                        ...
		                        <TH align="center" width="7%" >Số điểm</TH>
		                    	...
		                    	if(obj.getKhDuyetRs() != null)
		                    	{
		                    		...
		                    		while(obj.getKhDuyetRs().next())
		                    		{
		                    			...
		                    			<TR>
		                    				...
		                    				<TD>
		                    					<input type="text" name="soluongmua" style="width:100%; border:none; background: transparent;" 
		                    						value="<%= format.format(obj.getKhDuyetRs().getDouble("sodiem"))  %>" style="width: 100%; text-align: right;" readonly="readonly" >
		                    				</TD>
		                    				<TD>
