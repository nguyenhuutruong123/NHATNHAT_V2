										...
										<FIELDSET>
											...
											<TABLE border="0" width="100%" cellpadding="4"
												...
												<TR style="display: none">
													<TD class="plainlabel"><%=Utility.GLanguage("Mã chuẩn",session,jedis) %><FONT
												...
												<TR style="display: none">
													<TD class="plainlabel"><%=Utility.GLanguage("Tên chuẩn",session,jedis) %><FONT
														class="erroralert">*</FONT></TD>
													<TD colspan="3" class="plainlabel"><input
												...
												<TR>
													<TD class="plainlabel"><%=Utility.GLanguage("Đơn vi đo lường",session,jedis) %><FONT class="erroralert"> *</FONT></TD>
													...
													<TD class="plainlabel">
														<INPUT type="text" name="hansudung" style="width: 200px; text-align: right;" value='<%=spBean.getHansudung()%>' onkeypress="return keypress(event);"> &nbsp;<i>tháng</i>
													</TD>
												</TR>
												...
												<TR>
													...
													<TD class="plainlabel" >
														<%=Utility.GLanguage("Sản phẩm khuyến mãi",session,jedis) %> &nbsp; <%
											...
											<table style="width: 100%" cellpadding="4" cellspacing="1">
												<tr class="tbheader">
													...
													<TD width="90%" valign="middle" class="plainlabel"><a
														href="" id="clId" rel="subcontentClId"> &nbsp; <img alt="Loại sản phẩm" src="../images/vitriluu.png"></a>
														<DIV id="subcontentClId" style="position: absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 590px; height: 300px; overflow: auto; padding: 4px;">
															...
															<div align="right">
																...
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
																	href="javascript:dropdowncontent.hidediv('subcontentClId');submitform();">Hoàn tất</a>
															</div>
