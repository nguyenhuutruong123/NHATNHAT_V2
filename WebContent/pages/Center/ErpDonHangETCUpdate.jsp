...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý kho bán hàng > Đơn hàng ETC > Cập nhật
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpDonhangETCSvl?userId=<%= userId %>" >
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					...
					<%
						...
						if(spMa != null)
						{
							...
							<tr>
								...
								<td> <input type="text" name="denngay" class="days" value="<%= spDenngay[i] %>" style="width: 100%; text-align: center;"  > </td>
							</tr>	
					...
					<% for(int i = count; i < 20; i++) { %>
						...
						<tr>
							...
							<td> <input type="text" name="dongia" value="" style="width: 100%; text-align: right;" onkeyup="Dinhdang(this);" readonly="readonly" > </td>
