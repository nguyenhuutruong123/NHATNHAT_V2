		 ...
		 <div  class="tab_content">
											<TABLE width="100%" border="0" cellspacing="1px" cellpadding="3px">
												<TR class="plainlabel" valign="bottom">
													<th  width="8%"  align="center"> <%=Utility.GLanguage("Ngày chứng từ",session,jedis) %></th>
													<th  width="8%"  align="center"><%=Utility.GLanguage("Số chứng từ",session,jedis) %></th>
													<th  width="10%" align="left"><%=Utility.GLanguage("Mã NPP",session,jedis) %></th>
													<th  width="30%" align="left"><%=Utility.GLanguage("Tên NPP",session,jedis) %></th>
													<th  width="12.5%" align="left"><%=Utility.GLanguage("Nghiệp vụ",session,jedis) %></th>
													<th  width="10%" align="left"><%=Utility.GLanguage("Nhập",session,jedis) %></th> 
													<th  width="10%"  align="left"><%=Utility.GLanguage("Xuất",session,jedis) %></th>
