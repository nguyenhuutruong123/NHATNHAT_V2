				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền> Dữ liệu Kinh doanh > khách hàng > Tạo mới
	   						 <TD colspan="2" align="right" class="tbnavigation"><%=Utility.GLanguage("Chào mừng bạn",session,jedis) %>  <%= userTen %>&nbsp; </tr>
						</table>
			 		</TD>
				</TR>
			</TABLE>
				...
				<TR>
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR>
							<TD width="18%" class="plainlabel"><%=Utility.GLanguage("Nhà phân phối",session,jedis) %></TD>
						  ...
						  <TR>
							...
							<TR>
							  ...
							  <TD colspan="3" class="plainlabel"><SELECT name="mckTen" id="mckTen" >
                                	<OPTION value="" selected></OPTION>
                                	<% try{while(mck.next()){ 
							...
							<TR>
								 ...
								 <TD colspan="6" class="plainlabel"><SELECT name="kbhTen" id="kbhTen" onChange="tongleBangGia(this);">
								    <OPTION value="" selected></OPTION>
									<% try{while(kbh.next()){ 
