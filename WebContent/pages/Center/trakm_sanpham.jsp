...
<%
	...
	//command += " and pk_seq in (select distinct c.SANPHAM_FK from NHAPHANPHOI a inner join BANGGIAMUANPP_NPP b on a.PK_SEQ = b.NPP_FK inner join BGMUANPP_SANPHAM c on b.BANGGIAMUANPP_FK = c.BGMUANPP_FK where c.GIAMUANPP > 0)";
