...
<div id="main" style="width:99%; padding-left:2px">
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle"> <%=Utility.GLanguage("Trả trưng bày",session,jedis) %></legend>
                        ...
                        <TD class="plainlabel">
                            <select name="type" id="type" onChange="submitform()">
                                	<% if(tratbBean.getType().equals("1")){ %>		                            	                            	
		                                ...
		                                <option value="2"><%=Utility.GLanguage("Trả sản phẩm",session,jedis) %></option>  
		                                <option value=""> </option>	
	                                <%} else {if(tratbBean.getType().equals("2")){ %>
	                                	<option value="2" selected><%=Utility.GLanguage("Trả sản phẩm",session,jedis) %></option>  
               ...
               <TABLE class="tabledetail" id="content" width="100%" border="0" cellpadding="2" cellspacing="1">
                    <TR class="tbheader">
                        ...
                        <TH align="left" width="60%"><%=Utility.GLanguage("Tên sản phẩm",session,jedis) %></TH>
                        <TH style="display: none;" align="center"> <%=Utility.GLanguage("Đơn giá",session,jedis) %></TH>
                        <% if(tratbBean.getHinhthuc().equals("1")){ %>
				...
				<br><a class="button" href="javascript:clearform()">
					<img style="top: -4px;" src="../images/button.png" alt=""><%=Utility.GLanguage("Nhập lại",session,jedis) %> sản phẩm<%=Utility.GLanguage("",session,jedis) %> </a>                         
            </div>     
     </fieldset>	
    </div>
</div>
