...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="nppForm" method="post" action="../../NhomCTTrungBaySvl">
										...
										<TD width="100%" align="center">
											<FIELDSET>
												...
												<TABLE width="100%" cellpadding="6" cellspacing="0">
													...
													<TR>
														<TD colspan="4" class="plainlabel"><a class="button2" href="javascript:clearform()"> <img style="top: -4px;" src="../images/button.png" alt=""><%=Utility.GLanguage("Nhập lại",session,jedis) %></a></TD>
													</TR>
												</TABLE>
