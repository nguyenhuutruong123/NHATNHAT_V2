...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Dữ liệu nều > Chỉ tiêu > Nhóm thưởng > Cập nhật
        </div>
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle">Thông tin nhóm thưởngs</legend>
				...
				<TD class="plainlabel">
				 <input type="text" name ="diengiai" value="<%=ckBean.getDiengiai() %>" style="width:450px"/></TD>
                    ...
                    <TR>
                     ...
                     <TR>
                    	<TD class="plainlabel" valign="middle" >Nhóm thưởng Bán Ra</TD>
                        <TD class="plainlabel"  valign="middle">
                    ...
                    <TR>
                    	<TD class="plainlabel" valign="middle" >Thưởng riêng </TD>
                        <TD class="plainlabel"  valign="middle">
            ...
            <hr> 
              ...
              <div>
              <FIELDSET  valign="top" >
                        <LEGEND class="legendtitle" style="color:black"><%=Utility.GLanguage("Khu vực",session,jedis) %> quản lý</LEGEND>
                        <TABLE  valign="top"  border="0" width="100%" cellpadding="3" cellspacing="1">
                                
                                 <td valign="top" >
                                  <FIELDSET  valign="top" >
                    	    <LEGEND class="legendtitle" style="color:black"><%=Utility.GLanguage("Khu vực",session,jedis) %></LEGEND>
                    	  <TABLE  class="tabledetail" width="100%" border="0" cellpadding="1" cellspacing="1" >
                    	    	<tr  class="tbheader"> 
                    	    		<th> Khu Vực </th> 
                    	    		<th style="display:none"> Chỉ tiêu </th>
                    	    		<th> Chọn </th>
