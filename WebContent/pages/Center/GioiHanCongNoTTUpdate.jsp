...
<form name="ghcnForm" method="post" action="../../GioiHanCongNoTTNewSvl">
			...
			<TABLE width="100%" cellpadding="0" cellspacing="2">
				<TR >
					<TD >
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR class = "tbdarkrow">
								<TD width="30" align="left"><A href= "../../GioiHanCongNoTTSvl?userId=<%=userId %>">		 		
        ...
        <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
				<TR>
					<TD colspan = "6" width='100%'>
						<FIELDSET><LEGEND class="legendtitle"><%=Utility.GLanguage("Nhà phân phối",session,jedis) %> được hưởng tín dụng</LEGEND>
						  	<div class="title" align="left" style="height:30px;background-color:#C5E8CD;padding-top:5px ;padding-left:5px "><%=Utility.GLanguage("Nhà phân phối",session,jedis) %> thuộc Khu Vực
					...
					<TABLE  border="0" cellspacing="1" cellpadding="6" width='100%'>
								<TR class="tbheader">
								 <TH width="20%"><%=Utility.GLanguage("Khu vực",session,jedis) %> </TH>
								  <TH align="center" width="15%">Mã Chi nhánh / NPP</TH>
									<TH width="25%">Tên Chi nhánh / NPP </TH>
