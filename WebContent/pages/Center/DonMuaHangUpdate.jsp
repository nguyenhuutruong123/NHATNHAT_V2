...
<form name="ddhForm" method="post" action="../../DonmuahangUpdateSvl">
                ...
                <TR ><TD >
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR class = "tbdarkrow">
                            ...
                            <TD width="30" align="left"><A href="../../DondathangSvl?userId=<%=userId%>"  ><img src="../images/Back30.png" alt="Quay về"  title="Quay ve" border="1" longdesc="Quay về" style="border-style:outset"></A></TD>
