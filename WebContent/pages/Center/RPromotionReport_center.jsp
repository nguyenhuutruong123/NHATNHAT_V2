 ...
 <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left" style="width: 100%; float: none; clear: left;font-size: 0.7em">
				<fieldset>
					<legend class="legendtitle"><%=Utility.GLanguage("Báo cáo xuất khuyến mãi",session,jedis) %></legend>
					<div style="width: 100%; float: none" align="left">
						<!-- <div style="width: 100%; float: none" align="left" class="plainlabel"> -->
							<TABLE width="100%" cellpadding="6" cellspacing="0">
								...
								<TR>
									<TD class="plainlabel"> <%=Utility.GLanguage("Bao gồm chương trình ứng hàng trước",session,jedis) %></TD>
								...
								<TR>
									<TD class="plainlabel"> <%=Utility.GLanguage("Bao gồm đơn hàng chưa chốt",session,jedis) %></TD>
									<TD class="plainlabel" colspan='3'>
								...
								<fieldset style="min-height: 200px">
									...
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="4"
										...
										<tbody id="ShowFields">
											...
											<tr class="tbdarkrow">
												<td><%=Utility.GLanguage("Mã sản phẩm",session,jedis) %></td>
												<td align="center"><input name="fieldsHien"
													type="checkbox" value="MaSanPham"></td>
											</tr>
											
											<tr class="tblightrow">
												<td> <%=Utility.GLanguage("Tên sản phẩm",session,jedis) %></td>
												<td align="center"><input name="fieldsHien"
													type="checkbox" value="TenSanPham"></td>
											</tr>

											<tr class="tbdarkrow">
												<td><%=Utility.GLanguage("Số lượng lẻ",session,jedis) %></td>
												<td align="center"><input name="fieldsHien"
													type="checkbox" value="SoLuong(Le)"></td>
											</tr>
											<tr class="tblightrow">
												<td><%=Utility.GLanguage("Số tiền",session,jedis) %></td>
												<td align="center"><input name="fieldsHien"
								...
								<fieldset style="min-height: 200px;">
									...
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="4"
										...
										<tbody id="AllFields">
											<tr class="tbheader">
												<th></th>
												<th align="center"><%=Utility.GLanguage("Chọn hiển thị",session,jedis) %></th>
											</tr>
											<tr class="tbdarkrow">
												<td><%=Utility.GLanguage("Nhãn hàng",session,jedis) %></td>
												<td align="center"><input name="fieldsAn"
													type="checkbox" value="NhanHang"></td>
											</tr>
											<tr class="tblightrow">
												<td><%=Utility.GLanguage("Chủng loại",session,jedis) %></td>
												<td align="center"><input name="fieldsAn"
											...
											<tr class="tbdarkrow">
												<td><%=Utility.GLanguage("Tỉnh/Thành",session,jedis) %></td>
												<td align="center"><input name="fieldsAn"
													type="checkbox" value="Tinh/Thanh"></td>
											</tr>
											<tr class="tblightrow">
												<td><%=Utility.GLanguage("Quận/Huyện",session,jedis) %></td>
												<td align="center"><input name="fieldsAn"
													type="checkbox" value="Quan/Huyen"></td>
											</tr>

											<tr class="tbdarkrow">
												<td><%=Utility.GLanguage("Mã khách hàng",session,jedis) %></td>
												<td align="center"><input name="fieldsAn"
											...
											<tr class="tblightrow">
												<td><%=Utility.GLanguage("Tên khách hàng",session,jedis) %></td>
												<td align="center"><input name="fieldsAn"
													type="checkbox" value="TenKhachHang"></td>
											</tr>
											<tr class="tbdarkrow">
												<td><%=Utility.GLanguage("Ngày",session,jedis) %></td>
												<td align="center"><input name="fieldsAn"
													type="checkbox" value="Ngay"></td>
											</tr>		

											<tr class="tblightrow">
												<td><%=Utility.GLanguage("Loại chương trình",session,jedis) %></td>
												<td align="center"><input name="fieldsAn"
													type="checkbox" value="LoaiChuongTrinh"></td>
											</tr>
																						
											<tr class="tbdarkrow">
												<td><%=Utility.GLanguage("Số lượng thùng",session,jedis) %></td>
												<td align="center"><input name="fieldsAn"
