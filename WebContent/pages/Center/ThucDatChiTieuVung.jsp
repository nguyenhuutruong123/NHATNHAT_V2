...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../ThucDatChiTieuMien">
				...
				<fieldset>
					...
					<div style="width: 100%; float: none" align="left">
						<div style="width: 100%; float: none" align="left"
							...
							<TR>
									<TD class="plainlabel">Chọn nhân viên</TD>
									
									<TD class="plainlabel">
										<SELECT name = "loainv" onchange = "seach();">
										<option value="1" selected="selected" ><%=Utility.GLanguage("Vùng",session,jedis) %></option> 
...
<%-- 									<TR>
								...
								<TR>									
									...
									<TD class="plainlabel">Đại diện kinh doanh</TD>
									<TD class="plainlabel">
										<select name="ddkdId">
