...
function ChotCKTM()
{
	 document.forms['dhForm'].action.value='chotCKTM';
	 document.forms['dhForm'].isDuyetCKTM.value='1';
	 document.getElementById("btnChotCKTM").innerHTML = "<a href='#'><img src='../images/waiting.gif'  title='cho luu..' border='0' longdesc='cho luu..' style='border-style:outset'> Processing...</a>";
	...
	/* 	 while(tongtien.match(',')){
		...
		//kiem tra neu gia =0 thi khong the thuc hien luu
		 ...
		 for(var k = 0; k < masp.length; k++)
		 {
			...
			{
				if(tensp.item(k).value == ""||dongia.item(k).value =="" )			
				{
...
<input type="hidden" name='isDuyetCKTM' value='<%=hdBean.getIsDuyetCKTM() %>'>
						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý bán hàng > Tạo đơn hàng > Cập nhật </TD>								   
										...
										<TR class = "tbdarkrow">
										    ...
										    <TD width="2" align="left" >&nbsp;</TD>
										     <TD width="30" align="left" >
											     <A id = "btnChot" href="javascript:ChotForm()" ><img src="../images/Chot.png" alt="Chôt đặt hàng"  title="Chôt đặt hàng" border="1" longdesc="Chôt đặt hàng" style="border-style:outset"></A>
										     </TD>
										    <TD width="2" align="left" >&nbsp;</TD>
									...
									<TD align="left" >						
										...
										<TABLE  border="0" bordercolor="white" width="100%" cellpadding = "3" cellspacing = "0" style="padding-left:2px ;" >
											...
											<TR class="plainlabel">
											  ...
											  <TD class="plainlabel">                               
                                                 <input type="text" size="10" class="days" id="ngaygiaodich" name="ngaygiaodich" value="<%=hdBean.getNgaygiaodich()%>" maxlength="10"  onchange="GetChietKhau();loadcontent();"    onclick="GetChietKhau();"/> 
											    </TD>
                                          ...
                                          <td><%=Utility.GLanguage("Kênh bán hàng",session,jedis) %></td>
											...
											<TR class="plainlabel" >
											  ...
											  <TD  class="plainlabel">Chiết khấu thương mại</TD>	     
										        ...
										        <%} %>
										          VND 
													<%if(hdBean.getChietKhauThuongMai()>0 && hdBean.getIsDuyetCKTM().equals("0") ) {  %>														          
										          		<A id = "btnChotCKTM" href="javascript:ChotCKTM();" ><img src="../images/Chot.png" alt="Chốt Chiết khấu thương mại "  title="Chốt Chiết khấu thương mại " border="1" longdesc="Chốt Chiết khấu thương mại " style="border-style:outset"    onclick="if(!confirm('Bạn muốn có muốn chốt chiết khấu này ?')) return false;" ></A>
										          <%}else if(hdBean.getChietKhauThuongMai()>0 && hdBean.getIsDuyetCKTM().equals("1")){ %>
										          	(Đã duyệt CKTM)
										          <%} %>
										          </TD>
											       ...
											       <TD  class="plainlabel"> 
											       <%if(hdBean.getIDKenhBanHang().equals("100025")){ %>
											       <input name="chietkhau" id="chietkhau" type="text" value="<%=formatter2.format(hdBean.getChietkhau()) %>" readonly="readonly" onkeypress="return keypress(event);" readonly="readonly">
											       <%}else { %>
									       ...
									       <tr>
										        ...
										        <%} %> 
										          ...
										          Chi nhánh / NPP tự vận chuyển </TD>
					                        	</tr>
												<TR class="plainlabel" >
											  <TD  >Ghi chú</TD>
							  		...
							  		<TD>
										...
										<tbody id="san_pham">
											<TR class="tbheader" >
												...
												<TH width="5%">ĐVT</TH>
												<TH width="5%" >Số lượng duyệt</TH>
												<TH width="5%" >ĐVT duyệt</TH>
							...
							while (m < size){
								...
								%>
								    ...
								    <%}else{ %>
							        	<TD align = "left" >
								        <input name="soluong" type="text" value="<%= sanpham.getSoLuong() %>" onkeypress="return keypress(event);" style="text-align:left;width:100%;" readonly="readonly">
								        </TD>
								    <%} %>
							        ...
							        <TD >
			                   			<select style="width: 100%" name="donviduyetId" onchange="loadcontent();">
			                   			<%
			                   				if(dvList.size() > 0)
			                   				{
