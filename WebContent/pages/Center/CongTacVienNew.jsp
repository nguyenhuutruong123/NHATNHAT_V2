                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">
							 		&nbsp;Dữ liệu nền &gt; Kinh doanh &gt;  Cộng tác viên &gt; Tạo mới</TD> 
                  ...
                  <TD height="100%" width="100%">
                        ...
                        <TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                            <TR>
                               ...
                               <TD width="120px"  class="plainlabel">Mã CTV </TD>
                               <TD width="250px" class="plainlabel"><input name="ma" id="ma" type="text" value="<%= ddkdBean.getMa()%>"></TD>
                                ...
                                <TD width="120px" class="plainlabel" >Địa chỉ </TD>
                          ...
                          <TR>
                            ...
                            <TR>
								...
								<TD class="plainlabel" style = "display:none">Địa bàn<FONT class="erroralert"> *</FONT></TD>
					...
					<%
						...
						if(KhMa != null)
						{
							...
							<tr <%= style %>  >
								<td >
									<input type="text" name="KhMa" value="<%= KhMa[i] %>" style="width: 100%"  onkeyup="ajax_showOptions(this,'nhapkho',event)" AUTOCOMPLETE="off"  > 
									
								</td>
								
								<td>
									<input type="text" name="KhTen" value="<%= KhTen[i].trim() %>" style="width: 100%; text-align: left;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);"  > 
					...
					<% for(int i = count; i < 200; i++) { %>
						...
						<tr>
						<td >
									<input type="text" name="KhMa" value="" style="width: 100%"  onkeyup="ajax_showOptions(this,'nhapkho',event)" AUTOCOMPLETE="off"  > 
									
								</td>
								
								<td>
									<input type="text" name="KhTen" value="" style="width: 100%; text-align: left;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);"  > 
