...
<div id="main" style="width:99%; padding-left:2px">
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle"> <%=Utility.GLanguage("Trả khuyến mãi",session,jedis) %></legend>
                ...
                <TABLE width="100%" cellpadding="6" cellspacing="0">								
                    ...
                    <TR>
                        <TD class="plainlabel"><%=Utility.GLanguage("Loại",session,jedis) %></TD>
                        <TD class="plainlabel">
                            <select name="type" id="type" onChange="submitform()">
                                <% if(trakmBean.getType().equals("1")){ %>
	                                <option value="1" selected><%=Utility.GLanguage("Trả tiền",session,jedis) %></option>
	                            ...
	                            <%}else if(trakmBean.getType().equals("2")){ %>
	                            	<option value="2" selected><%=Utility.GLanguage("Trả chiết khấu",session,jedis) %></option>
	                                <option value="1" ><%=Utility.GLanguage("Trả tiền",session,jedis) %></option>
	                                <option value="3"><%=Utility.GLanguage("Trả sản phẩm",session,jedis) %></option>
	                                <option value="4"><%=Utility.GLanguage("Trả tiền theo điểm",session,jedis) %></option>
	                                <option value=""> </option>
	                            <%}else if(trakmBean.getType().equals("3")){ %>
	                            	<option value="3" selected><%=Utility.GLanguage("Trả sản phẩm",session,jedis) %></option>
	                                <option value="1" ><%=Utility.GLanguage("Trả tiền",session,jedis) %></option>
	                                <option value="2"><%=Utility.GLanguage("Trả chiết khấu",session,jedis) %></option>
	                                 <option value="4"><%=Utility.GLanguage("Trả tiền theo điểm",session,jedis) %></option>
	                                <option value=""> </option>
                    ...
                    <% if(trakmBean.getType().equals("3")){ %>
	                    <TR>
	                        <TD class="plainlabel"><%=Utility.GLanguage("Hình thức",session,jedis) %> </TD>
	                        <TD class="plainlabel">
                    ...
                    <% if(trakmBean.getType().equals("1")||trakmBean.getType().equals("4")){ %>
	                    <TR>
	                        ...
	                        <TD class="plainlabel"><input type="text" name="tongtien" id="tongtien" value="<%= trakmBean.getTongtien() %>" style="text-align:right" style="width:95%"  onkeyup="Dinhdang(this)" onkeypress="return keypress(event);"> VND</TD> 
	                    </TR>
                    <%}else{ if(trakmBean.getType().equals("2")){ %>
	                   	<TR>
                    ...
                    <%}else{ if(trakmBean.getType().equals("3")){ %>  
	                    <TR>
	                        ...
	                        <TD class="plainlabel">
	                        <% if(trakmBean.getHinhthuc().equals("1")){ %>
	                        	<input type="text" name="tongluong" id="tongluong" value="<%= trakmBean.getTongluong() %>" style="text-align:right" style="width:95%" readonly>
	                        <%}else{ %>
	                        	<input type="text" name="tongluong" id="tongluong" value="<%= trakmBean.getTongluong() %>" style="text-align:right" style="width:95%" onkeypress="return keypress(event);">
	                        <%} %>
	                        </TD> 
	                    </TR> 
                    <%}}} %> 
               ...
               <TABLE class="tabledetail" id="content" width="100%" border="0" cellpadding="0" style="padding-right:2px " cellspacing="1">
                    <TR class="tbheader">
                        <TH align="center" width="20%"><%=Utility.GLanguage("Mã sản phẩm",session,jedis) %></TH>
                        <TH align="left" width="70%"><%=Utility.GLanguage("Tên sản phẩm",session,jedis) %></TH>
                        <% if(trakmBean.getHinhthuc().equals("1")){ %>
                       		 <TH align="center" width="10%"><%=Utility.GLanguage("Số lượng",session,jedis) %></TH>
                       	<%}else{ %>
                       		<TH align="center"  style="display: none"><%=Utility.GLanguage("Số lượng",session,jedis) %></TH>
                       	<%} %>
                    </TR>  
