				...
				<TR>
					<TD width="100%" align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <TD align="left" colspan="2" class="tbnavigation">&#160; Quản lý công nợ &#62; Báo cáo &#62; BC Phân tích công nợ</TD>
...
<%-- 								<TR>
					...
					<%-- 
					 		<TR>
									...
									<TD class="plainlabel">
										<select  name="nppId" id="nppId" style="width:230px" onchange="seach();">
								...
								<TR>									
									...
									<TD class="plainlabel" colspan="3"><select name="khId" id="khId" style="width:202px">
											<option value="" selected >All</option>
											<% if(kh != null)
											   while(kh.next()){
