	...
	function addRow(name)
		{
			...
			chietkhau.value = "";
			//chietkhau.setAttribute("style","background-color:white;width:100%");
						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý bán hàng >Tạo đơn hàng bán > tạo mới </TD>								   
							...
							<TABLE border="1" width="100%" cellpadding = "1" cellspacing = "0" style="border-color:gray;" >
										...
										<TABLE  border="0" bordercolor="white" width="100%" cellpadding = "3" cellspacing = "0" style="padding-left:2px ;" >
                                          ...
                                          <td><%=Utility.GLanguage("Kênh bán hàng",session,jedis) %></td>
											...
											<TR class="plainlabel">
									          ...
									          VND </TD>
									         <td>
										          Tiền hưởng khuyến mãi
										          </td>
										          <td>
										          <input name="tienhuongkm" id='tienhuongkm' type="text"  value="<%= hdBean.getSoTienTraKM()%>">
										          </td>
										  ...
										  <tr class="plainlabel">
										   <TD  class="plainlabel">Phải trả </TD>
									          ...
									          VND </TD>
									          <td>
										          Tiền hưởng trưng bày 
										          </td>
										          <td>
										          <input name="tienhuongtrungbay" id='tienhuongtrungbay' type="text"  value="<%= hdBean.getSoTienTraTB()%>">
										          </td>
										  </tr>
										  <tr class="plainlabel">
										  <td>
							   ...
							   <td style="text-align: center">
								   Chi Tiết Đơn Hàng(Vui lòng chọn Chi nhánh / NPP,đơn vị kinh doanh,kênh bán hàng  trước khi sản phẩm cho đơn đặt hàng)
							   </td>
							   </tr>
							   <TR>
							   		<TD>
