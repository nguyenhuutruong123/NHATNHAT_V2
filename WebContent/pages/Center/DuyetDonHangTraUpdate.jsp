...
<form name="dtdhForm" method="post" action="../../DuyettradonhangUpdateSvl">
						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation"> &nbsp;Quản lý kho chi nhánh > Duyệt hàng trả về đối tác > Duyệt trả đơn hàng > Duyệt </TD>								   
							...
							<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
											<TD width="30" align="left"><A href = "../../DuyettradonhangSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
							...
							while (m < size){
								sanpham = splist.get(m);
								 %>										
						        	...
						        	<TD align = "center" >
							        <input name="soluong" type="text" value="<%= sanpham.getSoluong() %>" style="width:100%; text-align:left;" readonly="readonly">
							        </TD>
