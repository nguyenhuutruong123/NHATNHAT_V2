...
<form name="nccForm" method="post" action="../../sitecode_convUpdateSvl" charset="UTF-8">
		...
		<TD colspan="4" align='left' valign='top' bgcolor="#ffffff">
					...
					<TD align="left" class="tbnavigation" >
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">
							   		&nbsp;Thiết lập dữ liệu nền &gt; &nbsp;Dữ liệu nền cơ bản &gt; Nhà phân phôi ERP
							   &gt; Tạo mới </TD>
			...
			<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
				<TR><TD >
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow" >
									<TD width="30" align="left"><A href="../../sitecode_convSvl?userId=<%=userId %>"  ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
								    ...
								    <TD width="30" align="left" ><A href="javascript: submitform()" ><IMG src="../images/Save30.png" title="Luu lai" alt="Luu lai" border = "1"  style="border-style:outset"></A></TD>
									 <TD width="2" align="left" ></TD>
								    <TD width="30" align="left" ><A href="javascript: chot()" ><IMG src="../images/Chot.png" title="Xác Nhận" alt="Chot" border = "1"  style="border-style:outset"></A></TD>
									<TD >&nbsp; </TD>						
								</TR>
						</TABLE>
				</TD></TR>
			...
			<TABLE width = 100% cellpadding = "3" cellspacing = "0" border = "0">
					...
					<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
								<LEGEND class="legendtitle">Thông tin Chi nhánh / NPP ERP 
								</LEGEND>
								...
								<TR>
									...
									<TR>
									  <TD class="plainlabel" >Tên Chi nhánh / NPP ERP<FONT class="erroralert"> *</FONT></TD>
									  <TD class="plainlabel" ><INPUT  name="TenNCC_long" style="width:300px" value ='<%=obj.getten()%>'    type="text"></TD>
								  </TR>
								  <TR>
									  <TD class="plainlabel" >Địa chỉ Chi nhánh / NPP ERP<FONT class="erroralert"> *</FONT></TD>
									  <TD class="plainlabel" ><INPUT  name="diachinppErp" style="width:450px" value ='<%=obj.getDiachi()%>'    type="text" readonly="readonly"></TD>
								  </TR>
									<TR>
									...
									<TR>
									  <TD class="plainlabel" >Chọn Chi nhánh / NPP DMS<FONT class="erroralert">*</FONT></TD>
									  <TD class="plainlabel" >
									     <SELECT name="npptn"  >
								   <option value=""> </option>
								  ...
								  <td colspan="2">
								  	<a class="button2" href="javascript:taomoinpp()">
										<img style="top: -4px;" src="../images/button.png" alt="">Tạo Chi nhánh / NPP mới </a>&nbsp;&nbsp;&nbsp;&nbsp;	
								  </td>
